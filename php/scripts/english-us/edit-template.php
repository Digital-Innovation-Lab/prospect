...
<script id="ractive-base" type='text/ractive'>
	...
	<label for="label-scatt">Audio: </label> <select id="label-scatt" value='{{viewAtts.sc}}'>
		{{#each scAtts}}
			<option>{{this}}</option>
		{{/each}}
	</select>
...
You are defining a dependent Template, which cannot have Attributes of type 'Join'.
</script>
...
Your Template refers to a dependent Template definition, which is missing. You will not be able to proceed editing this Template until the missing dependent Template is loaded or defined.
</script>
