...
var f=this.lineLayer;f.clearLayers();var g=PData.eTNum(),h=0,m,n=0,q,k,l,w,u,x,v,p,A,y,r,C,t,B,z,D,F;B=this.settings.min;"string"===typeof B&&(B=parseInt(B));n=this.settings.max;"string"===typeof n&&(n=parseInt(n));z=n-B;for(h=0;h<g;h++)this.tLCnt[h]=0;for(var E,h=0;h<g;h++)if("disable"!==this.settings.pAtts[h]){E=[];break}h=0;n=-1;a:for(;h<a.l;){if(null==x){do{if(++n==g)break a;q=a.t[n]}while(0===q.n||q.i+q.n===h);x=this.vFrame.getSelLocAtts(n);if(0===x.length){x=null;continue}v=d.vFrame.getSelFeatAtts(n);
if(0===v.length){x=null;continue}d.tLCnt[n]=x.length;d.tUsed[n]=!0;w=d.vFrame.getSelLegend(n);u=PData.aByID(w);p=d.settings.pAtts[n];k=d.settings.lClrs[n];if(C=d.settings.sAtts[n])t=PData.aByID(C),"number"===typeof t.r.min&&"number"===typeof t.r.max?(D=t.r.min,F=t.r.max-D):C=null}m=a.s[h];l=PData.rByN(m);var G;E&&(G={id:l.id,c:[],p:l.a[p],l:k});x.forEach(function(a){if(A=l.a[a])if(y=l.a[w],"undefined"!==typeof y&&(y=PData.lClr(y,u,v))){d.rMap[m>>4]|=1<<(m&15);if("number"===typeof A[0])C?(t=l.a[C],
t="number"===typeof t?Math.floor((t-D)*z/F)+B:B):t=B,r=L.circleMarker(A,{_aid:m,weight:1,radius:t,fillColor:y,color:"#000",opacity:1,fillOpacity:1}),G&&G.c.push(A);else if(r=2===A.length?L.polyline(A,{_aid:m,weight:1,fillColor:y,color:"#000",opacity:1,fillOpacity:1}):L.polygon(A,{_aid:m,weight:1,fillColor:y,color:"#000",opacity:1,fillOpacity:1}),G){var k=[0,0];A.forEach(function(a){k[0]+=a[0];k[1]+=a[1]});k[0]/=A.length;k[1]/=A.length;G.c.push(k)}r.on("click",c);e.addLayer(r)}});G&&0<G.c.length&&
E.push(G);++h==q.i+q.n&&(x=null)}if(E){E.sort(function(a,k){return PData.strcmp(k.id,a.id)});var H=[];E.forEach(function(a){a.p&&a.p.forEach(function(k){h=_.sortedIndex(E,{id:k},"id");if(h<E.length){var c=E[h];c.id===k&&a.c.forEach(function(k){c.c.forEach(function(c){k[0]===c[0]&&k[1]===c[1]||H.push({p:[k,c],c:a.l})})})}})});H.forEach(function(a){f.addLayer(L.polyline(a.p,{color:a.c,weight:2}))})}};VizMap.prototype.teardown=function(){var a=this.vFrame.getIndex();jQuery("#view-frame-"+a+" div.view-controls div.iconbar").remove()};
...
VizCards.prototype.render=function(a){var c=this;this.stream=a;var d=PData.eTNum(),e,f,g,h,m,n,q,k,l,w,u,x,v,p,A=jQuery(this.frameID);A.empty();0<this.recSel.length&&(this.recSel=[]);this.preRender();var y,r="w"+this.settings.w+" h"+this.settings.h;f=a.t[0];for(e=0;e<d;){for(;0===f.n;){if(++e===d)return;f=a.t[e]}f=PData.eTByN(e);f=PData.tByID(f);n=c.vFrame.getSelFeatAtts(e);0!==n.length&&(A.append('<div class="template-label">'+f.l+'</div><div class="cards" data-ti="'+e+'"></div>'),y=jQuery('div.cards[data-ti="'+
e+'"]'),this.tUsed[e]=!0,g=c.vFrame.getSelLegend(e),h=PData.aByID(g),m=c.settings.iAtts[e],w=c.settings.cnt[e],f=c.sAtts[e],f=PData.aByID(f),f=PData.rTOrder(f,a,e),f.forEach(function(a){q=PData.rByN(a.i);u=q.a[g];"undefined"!==typeof u&&(k=PData.lRecs(u,h,n,!1))&&(c.rMap[a.i>>4]|=1<<(a.i&15),v=c.settings.lOn?'<div class="card-title">'+q.l+"</div>":"",l=!1,x="",w&&0<w.length&&(p=k.b?' style="color:black"':"",w.forEach(function(a){if(u=q.a[a])if(u=PData.procAttTxt(a,u))l=!0,x+=u+"<br/>"})),x=m&&(u=
q.a[m])?l?'<div class="card-body"><img src="'+u+'"/><div class="card-cnt"'+p+">"+x+"</div></div>":'<div class="card-body"><img class="full" src="'+u+'"/></div>':'<div class="card-body"><div class="card-cnt"'+p+">"+x+"</div>",y.append('<div class="card '+r+'" style="background-color:'+k.v+'" data-ai="'+a.i+'">'+v+x+"</div>"))}));f=a.t[++e]}};VizCards.prototype.teardown=function(){jQuery(this.frameID).off("click.vf")};
VizCards.prototype.rerender=function(a){var c=this,d=jQuery(this.frameID+' div.cards[data-ti="'+a+'"]');d.empty();var e,f,g,h,m,n,q,k,l,w,u,x,v,p="w"+this.settings.w+" h"+this.settings.h;e=c.vFrame.getSelFeatAtts(a);0!=e.length&&(f=c.vFrame.getSelLegend(a),g=PData.aByID(f),h=c.settings.iAtts[a],m=c.settings.cnt[a],n=c.sAtts[a],n=PData.aByID(n),a=PData.rTOrder(n,c.stream,a),a.forEach(function(a){q=PData.rByN(a.i);k=q.a[f];"undefined"!==typeof k&&(l=PData.lRecs(k,g,e,!1))&&(x=c.settings.lOn?'<div class="card-title">'+
q.l+"</div>":"",w=!1,u="",m&&0<m.length&&(v=l.b?' style="color:black"':"",m.forEach(function(a){if(k=q.a[a])if(k=PData.procAttTxt(a,k))w=!0,u+=k+"<br/>"})),u=h&&(k=q.a[h])?w?'<div class="card-body"><img src="'+k+'"/><div class="card-cnt"'+v+">"+u+"</div></div>":'<div class="card-body"><img class="full" src="'+k+'"/></div>':'<div class="card-body"><div class="card-cnt"'+v+">"+u+"</div>",d.append('<div class="card '+p+(c.isSel(a.i)?" obj-sel":"")+'" style="background-color:'+l.v+'" data-ai="'+a.i+'">'+
x+u+"</div>"))}))};VizCards.prototype.doOptions=function(){var a=this;this.sAtts.forEach(function(a,c){jQuery('#dialog-sortby select[data-ti="'+c+'"]').val(a)});var c=jQuery("#dialog-sortby").dialog({height:220,width:400,modal:!0,buttons:[{text:dlText.ok,click:function(){c.dialog("close");PState.set(PSTATE_BUILD);for(var d=0;d<PData.eTNum();d++){var e=jQuery('#dialog-sortby select[data-ti="'+d+'"]').val();e!=a.sAtts[d]&&(a.sAtts[d]=e,a.rerender(d))}PState.set(PSTATE_READY)}},{text:dlText.cancel,click:function(){c.dialog("close")}}]})};
...
VizPinboard.prototype.render=function(a){var c=this;this.gRecs.selectAll(".recobj").remove();this.gRecs.selectAll(".recline").remove();0<this.recSel.length&&(this.recSel=[]);this.preRender();var d=PData.eTNum(),e,f,g=0,h,m,n,q,k,l,w,u,x,v,p,A,y,r,C,t;for(e=0;e<d;e++)if("disable"!==this.settings.pAtts[e]){t=[];break}A=this.settings.min;"string"===typeof A&&(A=parseInt(A));f=this.settings.max;"string"===typeof f&&(f=parseInt(f));y=f-A;var B=[];e=0;g=-1;a:for(;e<a.l;){if(null==l){do{if(++g===d)break a;
h=a.t[g]}while(0===h.n||h.i+h.n===e);l=this.vFrame.getSelLocAtts(g);if(0===l.length){l=null;continue}l=l[0];w=c.vFrame.getSelFeatAtts(g);if(0===w.length){l=null;continue}c.tUsed[g]=!0;q=c.vFrame.getSelLegend(g);k=PData.aByID(q);u=c.settings.pAtts[g];m=c.settings.lClrs[g];if(p=c.settings.sAtts[g])n=PData.aByID(p),"number"===typeof n.r.min&&"number"===typeof n.r.max?(r=n.r.min,C=n.r.max-r):p=null}f=a.s[e];n=PData.rByN(f);var z;t&&(z={id:n.id,c:null,p:n.a[u],l:m});x=n.a[l];"undefined"!==typeof x&&(v=
n.a[q],"undefined"!==typeof v&&(v=PData.lClr(v,k,w)))&&(c.rMap[f>>4]|=1<<(f&15),p?(n=n.a[p],n="number"===typeof n?Math.floor((n-r)*y/C)+A:A):n=A,B.push({ai:f,v:v,x:x[0],y:x[1],r:n}),z&&(z.c=x));z&&z.c&&t.push(z);++e==h.i+h.n&&(l=null)}this.gRecs.selectAll(".recobj").data(B).enter().append("circle").attr("class","recobj").attr("cx",function(a){return c.xScale(a.x)}).attr("cy",function(a){return c.yScale(a.y)}).attr("r",function(a){return c.yScale(a.r)}).style("fill",function(a){return a.v}).on("click",
function(a,k){var l=c.toggleSel(a.ai);d3.select(this).classed("obj-sel",l)});if(t){t.sort(function(a,k){return PData.strcmp(k.id,a.id)});var D=[];t.forEach(function(a){a.p&&a.p.forEach(function(k){e=_.sortedIndex(t,{id:k},"id");if(e<t.length){var c=t[e];c.id===k&&D.push({f:a.c,t:c.c,c:a.l})}})});this.gRecs.selectAll(".recline").data(D).enter().append("line").attr("class","recline").attr("x1",function(a){return c.xScale(a.f[0])}).attr("y1",function(a){return c.yScale(a.f[1])}).attr("x2",function(a){return c.xScale(a.t[0])}).attr("y2",
...
VizPinboard.prototype.doOptions=function(){function a(){g&&(d3.select("#base-"+d).attr("opacity",c.bOp/100),c.lOps.forEach(function(a,k){d3.select("#ol-"+d+"-"+k).attr("opacity",a/100)}));h.empty()}var c=this,d=this.vFrame.getIndex(),e=this.bOp,f=[],g=!0,h=jQuery("#dialog-opacities div.layer-list"),m=jQuery('<div class="op-layer" data-i="-1">Base Image <input type=range class="op-slider" min=0 max=100 value='+this.bOp+" step=5></div>");m.find(".op-slider").on("change",function(){e=jQuery(this).val();
d3.select("#base-"+d).attr("opacity",e/100)});h.append(m);this.lOps.forEach(function(a,k){m=jQuery('<div class="op-layer" data-i="'+k+'">Overlay '+(k+1)+' <input type=range class="op-slider" min=0 max=100 value='+a+" step=5></div>");m.find(".op-slider").on("change",function(){f[k]=jQuery(this).val();d3.select("#ol-"+d+"-"+k).attr("opacity",f[k]/100)});f.push(a);h.append(m)});var n=jQuery("#dialog-opacities").dialog({height:300,width:320,modal:!0,buttons:[{text:dlText.ok,click:function(){g=!1;n.dialog("close");
...
VizTime.prototype.setup=function(){function a(a){var c={id:a,l:0,t:0,h:0,w:g[1],svgID:"#tl-b-"+m+"-"+a,tHt:0,iHt:0,xScale:d3.time.scale(),yScale:function(a){return a*c.tHt},parts:[],g:null,labels:null,labelSVGs:null,redraw:function(){}};a?(c.tHt=e.settings.bHt,c.iHt=c.tHt-2):(c.tHt=3,c.iHt=2);if(1==a){var k=e.minDate,l=e.maxDate;0<e.settings.zFrom.length&&(k=PData.dStr(e.settings.zFrom,!1));0<e.settings.zTo.length&&(l=PData.dStr(e.settings.zTo,!0));c.xScale.domain([k,l]);e.zMinDate=k;e.zMaxDate=l}else c.xScale.domain([e.minDate,
e.maxDate]);c.xScale.range([0,c.w]);c.g=e.chart.append("g").attr("id",c.svgID.substring(1)).attr("class","tl-band").attr("width",c.w);e.bands[a]=c;e.cmpnts.push(c)}function c(a){var c=e.bands[a],k=d3.svg.axis().scale(c.xScale).orient("bottom").tickSize(6,0);localD3&&k.tickFormat(localD3);var l=c.g.append("g").attr("id","axis-"+m+"-"+a).attr("class","axis").style("font-size","10px");a={redraw:function(){l.call(k)}};c.parts.push(a);e.cmpnts.push(a)}function d(a){var c=e.bands[a],k;k=1===a?32:16;c.labels=
[{name:"s-"+m+"-"+a,x:function(){return 0},left:function(){return 0},anchor:"start",tDelta:2,whichDate:function(a,c){return a}},{name:"e-"+m+"-"+a,x:function(){return c.l+c.w},left:function(){return c.l+c.w-e.settings.xLbl},anchor:"end",tDelta:-3,whichDate:function(a,c){return c}}];var l=d3.select(c.svgID).selectAll(".bLblCntr").data(c.labels).enter().append("g").attr("class","bLblCntr");l.append("rect").attr("class","bLbl").attr("id",function(a){return"rect-"+a.name}).attr("x",function(a){return a.left()}).attr("width",
e.settings.xLbl).attr("height",k);var d=l.append("text").attr("class","bMinMaxLbl").attr("id",function(a){return"txt-"+a.name}).attr("x",function(a){return a.x()+a.tDelta}).attr("y",12).attr("text-anchor",function(a){return a.anchor}),u={redraw:function(){var a=c.xScale.domain(),k=a[0],l=a[1];d.text(function(a){return a.whichDate(k,l).getUTCFullYear()})}};c.parts.push(u);e.cmpnts.push(u);if(1===a){var x=l.append("text").attr("class","bMinMaxLbl").attr("id",function(a){return"m-txt-"+a.name}).attr("x",
function(a){return a.x()+a.tDelta}).attr("y",k-4).attr("text-anchor",function(a){return a.anchor});a={redraw:function(){var a=c.xScale.domain(),k=a[0],l=a[1];x.text(function(a){return l.getUTCFullYear()-k.getUTCFullYear()>e.threshold?"":months[a.whichDate(k,l).getMonth()]})}};c.parts.push(a);e.cmpnts.push(a)}c.labelSVGs=l}var e=this;"number"!==typeof this.settings.xLbl&&(this.settings.xLbl=parseInt(this.settings.xLbl));this.brushSVG=this.brush=null;var f=this.settings;"string"===typeof f.bHt&&(f.bHt=
parseInt(f.bHt,10));(function(){var a,c,k,l,d,u;f.dAtts.forEach(function(e){null!=e&&"disable"!==e&&(e=PData.aByID(e))&&(null==a||e.r.min.y<a?(a=e.r.min.y,"undefined"!==typeof e.r.min.m?(c=e.r.min.m,k="undefined"!==typeof e.r.min.d?e.r.min.d:1):k=c=1):e.r.min.y===a&&"undefined"!==typeof e.r.min.m&&(e.r.min.m<c?(c=e.r.min.m,k="undefined"!==typeof e.r.min.d?e.r.min.d:1):e.r.min.m===c&&"undefined"!==typeof e.r.min.d&&e.r.min.d<k&&(k=e.r.min.d)),null==l?"undefined"===typeof e.r.max.y?(l=TODAY.getUTCFullYear(),
d=TODAY.getMonth()+1,u=TODAY.getDate()):(l=e.r.max.y,"undefined"!==typeof e.r.max.m?(d=e.r.max.m,u="undefined"!==typeof e.r.max.d?e.r.max.d:PData.lenMnth(l,d)):(d=12,u=31)):e.r.max.y>l?(l=e.r.max.y,"undefined"!==typeof e.r.max.m?(d=e.r.max.m,u="undefined"!==typeof e.r.max.d?e.r.max.d:PData.lenMnth(l,d)):(d=12,u=31)):e.r.max.y===l&&"undefined"!==typeof e.r.max.m&&(e.r.max.m>d?(d=e.r.max.m,u="undefined"!==typeof e.r.max.d?e.r.max.d:PData.lenMnth(l,d)):e.r.max.m===d&&"undefined"!==typeof e.r.max.d&&
e.r.max.d>u&&(u=e.r.max.d)))});e.minDate=0<f.from.length?PData.dStr(f.from,!1):PData.d3Nums(a,c,k,!1);e.maxDate=0<f.to.length?PData.dStr(f.to,!0):PData.d3Nums(l,d,u,!0);e.instGap=.015*(e.maxDate-e.minDate)})();var g=e.getWidths(),h=d3.select(this.frameID).append("svg").attr("class","tl-vf").attr("width",g[1]);(function(){var a=[];f.lgnds.forEach(function(c){c.forEach(function(c){a.push(c)})});var a=_.uniq(a),c=[];a.forEach(function(a){(a=PData.aByID(a))&&a.l.forEach(function(a){c.push(a.v)})});c=
_.uniq(c);c.sort();var k=h.append("defs"),l,e;c.forEach(function(a){e=a.substr(1);l=k.append("linearGradient").attr("id",e+"-fs");l.append("stop").attr("offset","0%").attr("stop-color","#C0C0C0");l.append("stop").attr("offset","5%").attr("stop-color",a);l.append("stop").attr("offset","100%").attr("stop-color",a);l=k.append("linearGradient").attr("id",e+"-fe");l.append("stop").attr("offset","0%").attr("stop-color",a);l.append("stop").attr("offset","95%").attr("stop-color",a);l.append("stop").attr("offset",
"100%").attr("stop-color","#C0C0C0");l=k.append("linearGradient").attr("id",e+"-fb");l.append("stop").attr("offset","0%").attr("stop-color","#C0C0C0");l.append("stop").attr("offset","5%").attr("stop-color",a);l.append("stop").attr("offset","95%").attr("stop-color",a);l.append("stop").attr("offset","100%").attr("stop-color","#C0C0C0")})})();var m=this.vFrame.getIndex();h.append("clipPath").attr("id","tl-clip-"+m).append("rect").attr("width",g[1]);e.chart=h.append("g").attr("class","chart").attr("clip-path",
"url(#tl-clip-"+m+")");e.instRad=f.bHt/2-1;e.bands=Array(2);e.cmpnts=[];a(0);a(1);c(0);c(1);d(0);d(1)};
VizTime.prototype.render=function(a){function c(a,c){var k=a.s-c.s;if(0>k)return 1;if(0<k)return-1;k=c.e-a.e;return 0>k?1:0<k?-1:0}function d(a){function c(a){a=g.toggleSel(a.ai);d3.select(this).classed("obj-sel",a)}var k,l,e,d,f=g.bands[a];a?(k=g.bands[0],f.t=k.t+k.h+37,k=l=e=g.instRad,d=2*g.instRad+3):(f.t=0,k=l=e=1);f.h=m*f.tHt+2;f.g.attr("transform","translate(0,"+f.t+")").attr("height",f.h);var v,p;a&&(v=.75*f.iHt+"px",p=.8*f.iHt);var h;h=d3.select(f.svgID).selectAll(".lgBd").remove();h=d3.select(f.svgID).selectAll(".lgBd").data(g.lgBds).enter().append("svg").attr("class",
"lgBd").attr("y",function(a){return f.yScale(a.t)}).attr("height",function(a){return f.yScale(a.h)});h.append("rect").attr("width","100%").attr("height","100%").attr("fill",function(a){return a.d.v});1===a&&h.append("text").attr("class","lgBdLbl").attr("x",2).attr("y",p).attr("fill",function(a){return a.d.b?"#000000":"#FFFFFF"}).style("font-size",v).text(function(a){return a.d.l});var y;d3.select(f.svgID).selectAll(".event").remove();y=d3.select(f.svgID).selectAll(".event").data(g.events).enter().append("svg").attr("class",
function(a){return a.f&EVENT_INSTANT?"event instant":"event range"}).attr("y",function(a){return f.yScale(a.t)}).attr("height",f.iHt);if(1===a)y.on("click",c);var r=d3.select(f.svgID).selectAll(".range");r.append("rect").attr("width","100%").attr("height","100%").attr("fill",function(c){return 1===a&&c.f&(EVENT_F_START|EVENT_F_END)?(c.f&(EVENT_F_START|EVENT_F_END))===(EVENT_F_START|EVENT_F_END)?"url("+c.c.v+"-fb)":(c.f&EVENT_F_START)===EVENT_F_START?"url("+c.c.v+"-fs)":"url("+c.c.v+"-fe)":c.c.v});
1===a&&r.append("text").attr("class","rangeLbl").attr("x",4).attr("y",p).attr("fill",function(a){return a.c.b?"#000000":"#FFFFFF"}).style("font-size",v).text(function(a){return a.l});r=d3.select(f.svgID).selectAll(".instant");r.append("circle").attr("cx",k).attr("cy",l).attr("r",e).attr("fill",function(a){return a.c.v});1===a&&r.append("text").attr("class","instantLbl").attr("x",d).attr("y",p).style("font-size",v).text(function(a){return a.l});f.redraw=function(){h.attr("x",function(a){return f.xScale(a.s)}).attr("width",
function(a){return f.xScale(a.e)-f.xScale(a.s)});y.attr("x",function(a){return f.xScale(a.s)}).attr("width",function(a){return f.xScale(a.e)-f.xScale(a.s)});f.parts.forEach(function(a){a.redraw()})}}function e(a){a=g.bands[a];d3.select(a.svgID).selectAll(".axis").attr("transform","translate(0,"+a.h+")")}function f(a){a=g.bands[a];d3.select(a.svgID).selectAll(".bLblCntr").attr("transform","translate(0,"+(a.h+1).toString()+")")}var g=this,h=this.vFrame.getIndex();0<this.recSel.length&&(this.recSel=
[]);this.preRender();this.events=[];this.lgBds=[];var m=0;(function(){for(var e=PData.eTNum(),d=0,k,l,w,f,x,v,p,h;d<e;){for(k=a.t[d];0===k.n;){if(++d==e)return;k=a.t[d]}w=g.vFrame.getSelLocAtts(d);if(0!==w.length&&(w=g.vFrame.getSelFeatAtts(d),0!==w.length)){g.tUsed[d]=!0;h=g.vFrame.getSelLegend(d);p=PData.aByID(h);f=g.settings.dAtts[d];for(var y,r,C,t,B,z,D,F,E=[],G=k.i;G<k.i+k.n;G++)l=a.s[G],F=PData.rByN(l),x=F.a[h],"undefined"!==typeof x&&(x=PData.lRecs(x,p,w,!1))&&(v=F.a[f])&&"?"!==v&&(g.rMap[l>>
4]|=1<<(l&15),z=v.min.f?EVENT_F_START:0,y=v.min.y,"undefined"===typeof v.min.m?C=r=1:(r=v.min.m,C="undefined"===typeof v.min.d?1:v.min.d),t=PData.d3Nums(y,r,C,!1),"undefined"===typeof v.max?(z|=EVENT_INSTANT,B=t.getTime()+g.instGap):"open"===v.max?B=TODAY:(v.max.f&&(z|=EVENT_F_END),y=v.max.y,"undefined"===typeof v.max.m?(r=12,C=31):(r=v.max.m,C="undefined"===typeof v.max.d?PData.lenMnth(y,r):v.max.d),B=PData.d3Nums(y,r,C,!0)),E.push({s:t,e:B,ai:l,f:z,c:x,l:F.l,t:0}));E.sort(c);var H=[],I;E.forEach(function(a){for(I=
0;I<H.length&&!(a.e<H[I]);I++);a.t=I+m+1;H[I]=a.s});k=PData.aByID(f);k.l.forEach(function(a){D=a.d;y=D.min.y;"undefined"===typeof D.min.m?C=r=1:(r=D.min.m,C="undefined"===typeof D.min.d?1:D.min.d);t=PData.d3Nums(y,r,C,!1);"undefined"===typeof D.max.y?B=TODAY:(y=D.max.y,"undefined"===typeof D.max.m?(r=12,C=31):(r=D.max.m,C="undefined"===typeof D.max.d?PData.lenMnth(y,r):D.max.d),B=PData.d3Nums(y,r,C,!0));g.lgBds.push({s:t,e:B,t:m,h:H.length+1,d:a})});m+=H.length+1;g.events=g.events.concat(E)}d++}})();
...
VizDirectory.prototype.render=function(a){var c=this,d=PData.eTNum(),e=0,f,g,h,m,n,q,k,l=jQuery(this.frameID);l.empty();0<this.recSel.length&&(this.recSel=[]);this.preRender();this.stream=a;for(f=a.t[0];e<d;){for(;0===f.n;){if(++e===d)return;f=a.t[e]}c.tUsed[e]=!0;f=PData.eTByN(e);f=PData.tByID(f);l.append('<div class="template-label">'+f.l+'</div><table cellspacing="0" class="viz-directory" data-ti='+e+"></table>");g=l.find('table[data-ti="'+e+'"]');h=c.settings.cnt[e];k=c.sAtts[e];q="<thead><tr>";
...
VizTextStream.prototype.render=function(a){var c=this,d=PData.eTNum(),e=0,f,g,h,m,n,q,k,l,w,u,x,v,p,A,y,r,C,t=jQuery(this.frameID);t.empty();0<this.recSel.length&&(this.recSel=[]);this.preRender();r=this.settings.max-this.settings.min;for(g=a.t[0];e<d;){for(;0===g.n;){if(++e===d)return;g=a.t[e]}w=c.vFrame.getSelLocAtts(e);if(0!==w.length&&(w=c.vFrame.getSelFeatAtts(e),0!==w.length)){c.tUsed[e]=!0;u=c.vFrame.getSelLegend(e);x=PData.aByID(u);t.append('<div class="viz-textstream" data-ti='+e+"></div>");
h=t.find("div.viz-textstream[data-ti="+e+"]");f=PData.eTByN(e);f=PData.tByID(f);h.append('<div class="template-label">'+f.l+"</div>");l=c.settings.cnt[e];if(A=c.settings.sAtts[e])p=PData.aByID(A),"number"===typeof p.r.min&&"number"===typeof p.r.max?y=p.r.max-p.r.min:A=null;l&&(f=PData.aByID(c.settings.order[e]),f=PData.rTOrder(f,a,e),f.forEach(function(a){m=PData.rByN(a.i);n=m.a[u];"undefined"!==typeof n&&(v=PData.lRecs(n,x,w,!1))&&((q=m.a[l])&&(q=PData.procAttTxt(l,q)),q&&(c.rMap[a.i>>4]|=1<<(a.i&
15),A?(k=m.a[A],k="number"===typeof k?Math.floor((k-p.r.min)*r/y)+c.settings.min:c.settings.min):k=c.settings.min,C=v.b?";background-color:black":"",h.append('<div class="recitem" data-ai='+a.i+' style="color:'+v.v+C+";font-size:"+k+'px">'+q+"</div>")))}))}e++}};VizTextStream.prototype.teardown=function(){jQuery(this.frameID).off("click.vf")};
...
VizNetWheel.prototype.render=function(a){var c=this,d=[],e,f,g;a?this.stream=a:a=this.stream;this.svg.selectAll(".node").remove();this.svg.selectAll(".link").remove();0<this.recSel.length&&(this.recSel=[]);this.preRender();var h={children:[]};(function(){var d,k=0,l=0,e,f,g,v=[],p=null,m,n;d=a.t[0];n=c.vFrame.getSelLegend(0);m=PData.aByID(n);p=c.vFrame.getSelFeatAtts(0);0<p.length&&0<d.n&&(c.tUsed[0]=!0);a:for(;l<a.l;){for(;0===d.n||d.i+d.n===l||0===p.length;){0<v.length&&(h.children.push({ti:k,children:v}),
v=[]);if(++k===PData.eTNum())break a;v=[];d=a.t[k];n=c.vFrame.getSelLegend(k);m=PData.aByID(n);p=c.vFrame.getSelFeatAtts(k);0<p.length&&0<d.n&&(c.tUsed[k]=!0)}g=a.s[l];e=PData.rByN(g);f=e.a[n];"undefined"!==typeof f&&(fData=PData.lRecs(f,m,p,!1))&&(c.rMap[g>>4]|=1<<(g&15),v.push({r:e,ai:g,c:fData.v,l:!1,children:[]}));l++}0<v.length&&h.children.push({ti:k,children:v})})();h.children.forEach(function(a){var k=c.settings.pAtts[a.ti],l;a.children.forEach(function(a){k.forEach(function(c){l=a.r.a[c.pid];
"undefined"!==typeof l&&l.forEach(function(k){var l=!1,e,f=0;a:for(;f<h.children.length;f++)for(var g=h.children[f],q=0;q<g.children.length;q++)if(e=g.children[q],e.r.id==k){l=!0;break a}l&&(a.l=!0,e.l=!0,d.push({source:a,target:e,c:c.clr}))})})})});this.prune&&h.children.forEach(function(a){for(var c=a.children.length-1;0<c;c--)a.children[c].l||a.children.splice(c,1)});var m=0;h.children.forEach(function(a){m+=a.children.length});this.inc=360/(m+h.children.length);f=Math.max((14*m+20)/(2*Math.PI),
...
!0;for(var l=0;l<d.length;l++){var e=d[l];if(e.source===a&&e.target===c.t){d3.select(this).attr("stroke",e.c).classed("thick",!0);this.parentElement.appendChild(this);break}}}else if(c.t===a)for(c.s.linked=!0,l=0;l<d.length;l++){if(e=d[l],e.target===a&&e.source===c.s){d3.select(this).attr("stroke",e.c).classed("thick",!0);this.parentElement.appendChild(this);break}}else d3.select(this).attr("stroke","black").classed("thick",!1)});g.select("text").attr("fill",function(a){return a.linked?"white":"black"});
...
PFilterNum.prototype.evalBoxes=function(a){function c(c,h){function k(){l=!0;a.find(c).addClass("error")}var l=!1,w,u=a.find(c).val();(u=e.exec(u))?(a.find(c).removeClass("error"),w=parseInt(u[1],10)):k();l||(0==h?null!==f&&w<f&&k():null!==g&&w>g&&k());d.uNums[h]=w;return l}var d=this,e=/^(\d+)$/,f="undefined"===typeof this.att.r.min?null:this.att.r.min,g="undefined"===typeof this.att.r.max?null:this.att.r.max,h,m;h=c(".from",0);m=c(".to",1);this.uNums[0]>this.uNums[1]&&(m=!0);a.find(".filter-update").prop("disabled",
...
f.append("g");a.brushg.attr("class","brush").call(a.brush);a.brushg.selectAll("rect").attr("y",-1).attr("height",d+4);a.brushg.selectAll(".resize").append("path").attr("d",function(a){var c=(a=+("e"==a))?1:-1,l=d/4;return"M"+.5*c+","+l+"A6,6 0 0 "+a+" "+6.5*c+","+(l+6)+"V"+(2*l-6)+"A6,6 0 0 "+a+" "+.5*c+","+2*l+"ZM"+2.5*c+","+(l+8)+"V"+(2*l-8)+"M"+4.5*c+","+(l+8)+"V"+(2*l-8)})}else this.min="undefined"===typeof att.r.min?0:att.r.min,this.max="undefined"===typeof att.r.max?100:att.r.max;this.refreshBoxes();
...
PFilterDates.prototype.evalBoxes=function(a){function c(c,g){function h(k){l=!0;a.find(c+k).addClass("error")}function k(k){a.find(c+k).removeClass("error")}var l=!1,w={y:0,m:0,d:0,ms:null},u=a.find(c+"-y"),u=u.val();(u=e.exec(u))?(k("-y"),w.y=parseInt(u[1],10)):h("-y");u=a.find(c+"-m");u=u.val();(u=f.exec(u))?(w.m=parseInt(u[1],10),1>w.m||12<w.m?h("-m"):k("-m")):h("-m");u=a.find(c+"-d");u=u.val();(u=f.exec(u))?(w.d=parseInt(u[1],10),1>w.d||31<w.d?h("-d"):k("-d")):h("-d");l||(w.ms=PData.d3Nums(w.y,
w.m,w.d,!1),0==g?w.ms<d.rCats[0].min&&(h("-y"),h("-m"),h("-d")):w.ms>d.rCats[d.rCats.length-1].max&&(h("-y"),h("-m"),h("-d")));d.uDates[g]=w;return l}var d=this,e=/^(-?\d+)$/,f=/^(\d{1,2})$/,g,h;g=c(".from",0);h=c(".to",1);this.uDates[0].ms>this.uDates[1].ms&&(h=!0);a.find(".filter-update").prop("disabled",g||h);return!(g||h)};
...
"x axis").attr("transform","translate(0,"+c+")").call(m);f.append("g").attr("class","y axis").call(n);f.selectAll(".bar").data(this.rCats).enter().append("rect").attr("class","bar").attr("x",function(a,c){return g(c)+2}).attr("y",function(a){return h(100)}).attr("fill",function(a){return a.c}).attr("height",function(a){return c-h(100)}).attr("width",e-4);a.brush=d3.svg.brush().x(g).extent([0,this.rCats.length]).on("brushend",function(){if(d3.event.sourceEvent){var c=a.brush.extent(),l=[Math.floor(c[0]),
Math.floor(c[1])];l[0]>=l[1]&&(l[0]=Math.floor(c[0]),l[1]=Math.ceil(c[1]));l[1]=Math.max(l[1],l[0]+1);d3.select(this).transition().call(a.brush.extent(l));a.b0=l[0];a.b1=l[1]-1;a.min=a.rCats[a.b0].min;a.max=a.rCats[a.b1].max;a.refreshBoxes();a.isDirty(!0)}});a.brushg=f.append("g");a.brushg.attr("class","brush").call(a.brush);a.brushg.selectAll("rect").attr("y",-1).attr("height",c+4);a.brushg.selectAll(".resize").append("path").attr("d",function(a){var l=(a=+("e"==a))?1:-1,d=c/4;return"M"+.5*l+","+
d+"A6,6 0 0 "+a+" "+6.5*l+","+(d+6)+"V"+(2*d-6)+"A6,6 0 0 "+a+" "+.5*l+","+2*d+"ZM"+2.5*l+","+(d+8)+"V"+(2*d-8)+"M"+4.5*l+","+(d+8)+"V"+(2*d-8)})};PFilterDates.prototype.getState=function(){function a(a){return a.getUTCFullYear()+"-"+(a.getUTCMonth()+1)+"-"+a.getUTCDate()}var c=jQuery("input[name=dctrl-"+this.id+"]:checked").val();return{min:a(this.min),max:a(this.max),c:c,u:this.u}};
...
var PData=function(){function a(a,d,e){jQuery.ajax({type:"POST",url:prspdata.ajax_url,data:{action:"prsp_get_records",tmplt_id:prspdata.t[a].id,from:d,count:e},success:function(d,l,f){l=m[a];d=JSON.parse(d);l.d=l.d?l.d.concat(d):d;l.n+=e;c()},error:function(a,c,k){alert(k)}})}function c(){for(var c=!0,l=0;l<prspdata.t.length;l++){var e=m[l].n,f=prspdata.t[l].n;if(e<f){c=!1;f-=e;a(l,e,f<d?f:d);break}}c&&(q=!0,setTimeout(function(){jQuery("body").trigger("prospect",{s:PSTATE_PROCESS})},500))}var d=
1E3,e,f,g,h=[31,28,31,30,31,30,31,31,30,31,30,31],m=[],n=0,q=!1;return{init:function(){e=document.getElementById("dltext-to").innerHTML;f=document.getElementById("dltext-approximately").innerHTML;g=document.getElementById("dltext-now").innerHTML;"number"==typeof prspdata.x.chunk&&0<prspdata.x.chunk&&(d=prspdata.x.chunk);prspdata.t.forEach(function(a){m.push({i:n,n:0,d:null});n+=a.n});c()},rSize:function(){return n},intersect:function(a,c){for(var d=[],e=a.length,f=c.length,g,p,h=0,m=0;h<e&&m<f;)g=
a[h],p=c[m],g>p?m++:p>g?h++:(d.push(g),h++,m++);return d},union:function(a,c){for(var d=[],e=0,f=0,g,p;e<a.length&&f<c.length;)g=a[e],p=c[f],g<p?(d.push(g),e++):(g==p?(d.push(g),e++):d.push(p),f++);for(;e<a.length;e++)d.push(a[e]);for(;f<c.length;f++)d.push(c[f]);return d},strcmp:function(a,c){for(var d=0,e=Math.max(a.length,c.length);d<e&&a.charAt(d)===c.charAt(d);++d);return d===e?0:a.charAt(d)>c.charAt(d)?-1:1},sNew:function(a){var c={};c.s=new Uint16Array(n);c.t=[];c.l=0;if(a){for(a=0;a<n;a++)c.s[a]=
...
case "t":return c;case "P":if(0<c.length){var u="";c.forEach(function(a){if(a=PData.rByID(a))0<u.length&&(u+=", "),u+='<a href="'+prspdata.site_url+"?p="+a.wp+'" target="_blank">'+a.l+"</a>"});return u}}return null},rAV:function(a,c,d){for(var e=0;e<m.length;e++){var f=m[e];if(0<f.n&&f.i<=a&&a<f.i+f.n){a=f.d[a-f.i].a[c];if(null==a||"undefined"===typeof a)break;return d?a:PData.procAttTxt(c,a)}}return null},nByID:function(a){for(var c=0;c<m.length;c++){var d=m[c];if(0<d.n)for(var e=0,f=d.n-1,g,p;e<=
f;)if(g=e+f>>1,p=d.d[g],p=PData.strcmp(a,p.id),0>p)e=g+1;else if(0<p)f=g-1;else return d.i+g}return null},rByID:function(a){for(var c=0;c<m.length;c++){var d=m[c];if(0<d.n)for(var e=0,f=d.n-1,g,p,h;e<=f;)if(g=e+f>>1,h=d.d[g],p=PData.strcmp(a,h.id),0>p)e=g+1;else if(0<p)f=g-1;else return h}return null},aByID:function(a){for(var c=0,d=prspdata.a.length-1,e,f;c<=d;)if(e=c+d>>1,f=PData.strcmp(a,prspdata.a[e].id),0>f)c=e+1;else if(0<f)d=e-1;else return prspdata.a[e];return null},aByN:function(a){return prspdata.a[a]},
eTNum:function(){return prspdata.e.g.ts.length},eTByN:function(a){return prspdata.e.g.ts[a]},tByID:function(a){for(var c=0;c<prspdata.t.length;c++)if(a==prspdata.t[c].id)return prspdata.t[c].def},lRecs:function(a,c,d,e){var f,g=d.length,p;switch(c.def.t){case "V":var h=function(a){for(var e=0;e<g;e++)if(f=d[e],"number"===typeof f){if(p=c.l[f],p.l===a)return p}else{p=c.l[f[0]];var k=p.z[f[1]];if(k.l===a)return k.v&&""!==k.v?k:p}return null};if(e&&""!==c.def.d){var m=[],r;a.forEach(function(a){r=h(a);
null!=r&&m.push(r)});return 0<m.length?m:null}if(""!=c.def.d){for(e=0;e<a.length;e++)if(r=h(a[e]),null!=r)return r;break}else return h(a[0]);case "T":for(r=0;r<g;r++)if(f=d[r],p=c.l[f],-1!=a.indexOf(p.d))return p;break;case "N":r=0;if(-1===d[0]){if("?"===a){if("undefined"===typeof c.r.u)break;return c.r.u}r=1}if("?"===a)break;for(;r<g;r++)if(f=d[r],p=c.l[f],"undefined"!==typeof p.d.min){if(p.d.min<=a)if("undefined"!==typeof p.d.max){if(a<=p.d.max)return p}else return p}else if(a<=p.d.max)return p;
break;case "D":r=0;if(-1===d[0]){if("?"===a){if("undefined"===typeof c.r.u)break;return c.r.u}r=1}if("?"!==a)for(;r<g;r++)if(f=d[r],p=c.l[f],"undefined"!==typeof p.d.max.y){if("undefined"!==typeof a.max&&"open"!==a.max){if(a.max.y<p.d.min.y)continue;if(a.max.y===p.d.min.y&&a.max.m&&p.d.min.m){if(a.max.m<p.d.min.m)continue;if(a.max.m==p.d.min.m&&a.max.d&&p.d.min.d&&a.max.d<p.d.min.d)continue}}if(!(a.min.y>p.d.max.y)){if(a.min.y===p.d.max.y&&a.min.m&&p.d.max.m){if(a.min.m>p.d.max.m)continue;if(a.min.m===
p.d.max.m&&a.min.d&&p.d.max.d&&a.min.d>p.d.max.d)continue}return p}}else if("undefined"!==typeof a.max){if("open"===a.max)return p;if(!(a.max.y<p.d.min.y)){if(a.max.y===p.d.min.y&&a.max.m&&p.d.min.m){if(a.max.m<p.d.min.m)continue;if(a.max.m===p.d.min.m&&a.max.d&&p.d.min.d&&a.max.d<p.d.min.d)continue}return p}}else if(!(a.min.y<p.d.min.y)){if(a.min.y===p.d.min.y&&a.min.m&&p.d.min.m){if(a.min.m<p.d.min.m)continue;if(a.min.m===p.d.min.m&&a.min.d&&p.d.min.d&&a.min.d<p.d.min.d)continue}return p}}return null},
...
c:a.v,i:[]}):e.push({l:a.l,c:a.v});a.z.forEach(function(d){var f=""===d?a.v:d.v;c?e.push({l:d.l,c:f,i:[]}):e.push({l:d.l,c:f})})}),e;case "N":if("undefined"===typeof a.r.min||"undefined"===typeof a.r.max)return null;d&&"undefined"!==typeof a.r.u&&(c?e.push({l:"?",c:a.r.u.v,min:"?",max:"?",i:[]}):e.push({l:"?",c:a.r.u.v,min:"?",max:"?"}));var f=Math.pow(10,a.r.g),g=a.r.min,p=0,h,m,r;for(0<a.l.length&&(h=a.l[0]);g<=a.r.max;){for(;p<a.l.length&&"undefined"!==typeof h.d.max&&g>h.d.max;)h=a.l[++p];r=0==
a.l.length||g<h.d.min?"#777777":p===a.l.length?"#777777":"undefined"===typeof h.d.max||g<=h.d.max?h.v:"#777777";m=g;g+=f;max=g-1;max>a.r.max&&(max=a.r.max);var n=m.toString();1<f&&4>n.length&&m!==max&&(n+="-"+max.toString());c?e.push({l:n,c:r,min:m,max:max,i:[]}):e.push({l:n,c:r,min:m,max:max})}return e;case "D":g=function(a){var c,d;if("undefined"===typeof a.y)return TODAY;c=a.y;"undefined"===typeof a.m?(d=12,a=31):(d=a.m,a="undefined"===typeof a.d?PData.lenMnth(c,d):a.d);return PData.d3Nums(c,d,
a,!1)};m=function(a,c,d,e){"undefined"!==typeof e.m&&(c=e.m,"undefined"!==typeof e.d&&(d=e.d));return PData.d3Nums(a,c,d,!1)};r=g(a.r.max);var f=a.r.g,n=a.r.min.y,t=1,q=1;"undefined"!==typeof a.r.min.m&&(t=a.r.min.m,"undefined"!==typeof a.r.min.d&&(q=a.r.min.d));var z=PData.d3Nums(n,t,q,!1),p=0,D,F;0<a.l.length&&(h=a.l[0],D=m(h.d.min.y,1,1,h.d.min),F=g(h.d.max));for(d&&"undefined"!==typeof a.r.u&&(c?e.push({l:"?",c:a.r.u.v,min:"?",max:"?",i:[]}):e.push({l:"?",c:a.r.u.v,min:"?",max:"?"}));z<=r;){d=
{};c&&(d.i=[]);switch(f){case "d":d.l=n.toString()+"-"+t.toString()+"-"+q.toString();break;case "m":d.l=n.toString()+"-"+t.toString();break;case "y":case "t":case "c":d.l=n.toString()}for(;p<a.l.length&&z>F;)h=a.l[++p],p<a.l.length&&(D=m(h.d.min.y,1,1,h.d.min),F=g(h.d.max));d.c=0==a.l.length||z<D?"#777777":p==a.l.length?"#777777":z<=F?h.v:"#777777";d.min=z;switch(f){case "d":++q>PData.lenMnth(n,t)&&(q=1,12<++t&&(t=1,n++));break;case "m":12<++t&&(t=1,n++);break;case "y":n++;break;case "t":n+=10;break;
case "c":n+=100}z=PData.d3Nums(n,t,q,!1);z>TODAY&&(z=TODAY);z.setTime(z.getTime()+10);d.max=z;e.push(d);z=PData.d3Nums(n,t,q,!1)}return e}},cFill:function(a,c,d,e){var f=PData.eTNum(),g=0,h,m=0,n,r,q,t,B=PData.aByID(c);for(h=e.t[0];m<e.l;){for(;0===h.n||h.i+h.n===m||!PData.aInT(c,g)||d&&!PData.aInT(d,g);){if(++g===f)return;h=e.t[g];m=h.i}n=e.s[m];r=PData.rByN(n);r=r.a[c];if("undefined"!==typeof r)switch(B.def.t){case "T":for(q=0;q<a.length;q++)if(t=a[q],-1!==r.indexOf(t.x)){t.i.push(n);break}break;
case "g":r.forEach(function(c){for(q=0;q<a.length;q++)if(t=a[q],c===t.l){t.i.push(n);break}q===a.length&&a.push({l:c,i:[n],c:"#"+Math.floor(16777215*Math.random()).toString(16)})});break;case "V":r.forEach(function(c){for(q=0;q<a.length;q++)if(t=a[q],c==t.l){t.i.push(n);break}});break;case "N":q=0;t=a[0];if("?"===t.min){if("?"===r){t.i.push(n);break}q=1}if("?"===r)break;for(;q<a.length;q++){t=a[q];if(r<t.min)break;if(t.min<=r&&r<=t.max){t.i.push(n);break}}break;case "D":q=0;t=a[0];if("?"===t.min){if("?"===
r){t.i.push(n);break}q=1}if("?"!==r)for(r=PData.dObj(r.min,1,!1);q<a.length;q++){t=a[q];if(r<t.min)break;if(t.min<=r&&r<t.max){t.i.push(n);break}}}m++}"g"==B.def.t&&a.sort(function(a,c){return PData.strcmp(c.l,a.l)})},cSort:function(a,c,d){var e=c.id,f,g,h;a.forEach(function(a){f=PData.rByN(a);datum=f.a[e];if("undefined"!==typeof datum)switch(c.def.t){case "T":for(g=0;g<d.length;g++)if(h=d[g],-1!==datum.indexOf(h.x)){h.i.push(a);break}break;case "g":datum.forEach(function(c){for(g=0;g<d.length;g++)if(h=
...
case "N":h=e;n=a.r.max;break;case "D":h=g,n=TODAY}var q=[],r=c.t[d];d=m[d];for(var C=0,t,B;C<r.n;)t=c.s[r.i+C++],B=d.d[t-d.i],B=B.a[a.id],"undefined"===typeof B?q.push({i:t,v:n}):q.push({i:t,v:h(B)});switch(a.def.t){case "T":case "g":case "V":q.sort(function(a,c){return PData.strcmp(c.v,a.v)});break;case "D":case "N":q.sort(function(a,c){return"?"===a.v?-1:"?"===c.v?1:a.v-c.v})}return q},vByN:function(a){return prspdata.e.vf[a]},ready:function(){return q}}}();