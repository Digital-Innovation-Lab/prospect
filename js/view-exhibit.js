...
//				p = array of associated Perspectives { l, s, n }
    ...
    function PViewFrame(vfIndex)
    {
        ...
        {
            var selector = jQuery(getFrameID()+'select.view-viz-select option:selected');
    ...
    //			doSelBtns(true);
        ...
        {
            if (vI != vizSelIndex) {
                var select = jQuery(getFrameID()+'select.view-viz-select');
                select.val(vI);
        ...
        instance.initDOM = function(vI)
        {
            ...
            var select = frame.find('select.view-viz-select');
    ...
    jQuery(document).ready(function($) {
        ...
        jQuery('#dropdownmenu1').click(function() {
            jQuery('#menu1').toggle(500);
          });
          jQuery('#advancedsetting').click(function() {
          ...
          jQuery('#closemenu2').click(function() {
            jQuery('#menu2').toggle(500);
          });
    ...
    // 
        ...
        jQuery('.logo').attr("src", prspdata.assets+"prospectlogo.jpg");
