...
var EVENT_INSTANT=1,EVENT_F_START=2,EVENT_F_END=4,PSTATE_INIT=0,PSTATE_LOAD=1,PSTATE_PROCESS=2,PSTATE_BUILD=3,PSTATE_UPDATE=4,PSTATE_READY=5,D3FG_BAR_WIDTH=25,D3FG_MARGINS={top:4,right:7,bottom:22,left:30},D3SC_MARGINS={top:30,right:5,bottom:5,left:40},V_FLAG_LGND=1,V_FLAG_SEL=2,V_FLAG_LOC=4,V_FLAG_SLGND=8,V_FLAG_OPT=16,V_FLAG_VSCRL=32,V_FLAG_HSCRL=64,parseTC=/(\d\d)\:(\d\d)\:(\d\d)\.(\d\d?)/,mnthDays=[31,28,31,30,31,30,31,31,30,31,30,31],TODAY=new Date,localD3,months,dlText={},xhbtURL,widgetData=
...
VizMap.prototype.getLocAtts=function(a){return null!=a?this.settings.cAtts[a]:this.settings.cAtts};VizMap.prototype.getFeatureAtts=function(a){return null!=a?this.settings.lgnds[a]:this.settings.lgnds};
...
var g=PData.getNumETmplts(),l=0,n,p=0,t,h,q,v,y,m,u,k,z,A,r,D,w,x,B,C,E;x=this.settings.min;"string"==typeof x&&(x=parseInt(x));p=this.settings.max;"string"==typeof p&&(p=parseInt(p));B=p-x;for(l=0;l<g;l++)this.tLCnt[l]=0;for(var G,l=0;l<g;l++)if("disable"!=this.settings.pAtts[l]){G=[];break}l=0;p=-1;a:for(;l<a.l;){if(null==m){do{if(++p==g)break a;t=a.t[p]}while(0==t.n||t.i+t.n==l);m=this.vFrame.getSelLocAtts(p);if(0==m.length){m=null;continue}u=e.vFrame.getSelFeatAtts(p);if(0==u.length){m=null;continue}e.tLCnt[p]=
m.length;v=e.vFrame.getSelLegend(p);y=PData.getAttID(v);k=e.settings.pAtts[p];h=e.settings.lClrs[p];if(D=e.settings.sAtts[p])w=PData.getAttID(D),"number"==typeof w.r.min&&"number"==typeof w.r.max?(C=w.r.min,E=w.r.max-C):D=null}n=a.s[l];q=PData.getRecByIndex(n);var F;G&&(F={id:q.id,c:[],p:q.a[k],l:h});m.forEach(function(a){if(z=q.a[a])if(A=q.a[v],"undefined"!=typeof A&&(A=PData.getAttLgndVal(A,y,u))){if("number"==typeof z[0])D?(w=q.a[D],w="undefined"!=typeof w?Math.floor((w-C)*B/E)+x:x):w=x,r=L.circleMarker(z,
{_aid:n,weight:1,radius:w,fillColor:A,color:"#000",opacity:1,fillOpacity:1}),F&&F.c.push(z);else if(r=2==z.length?L.polyline(z,{_aid:n,weight:1,fillColor:A,color:"#000",opacity:1,fillOpacity:1}):L.polygon(z,{_aid:n,weight:1,fillColor:A,color:"#000",opacity:1,fillOpacity:1}),F){var h=[0,0];z.forEach(function(a){h[0]+=a[0];h[1]+=a[1]});h[0]/=z.length;h[1]/=z.length;F.c.push(h)}r.on("click",c);d.addLayer(r)}});F&&0<F.c.length&&G.push(F);++l==t.i+t.n&&(m=null)}if(G){G.sort(function(a,h){return PData.strcmp(h.id,
...
VizCards.prototype.setup=function(){var a=this;jQuery(this.frameID).on("click.vf",function(c){if("DIV"==c.target.nodeName&&(c=jQuery(c.target).closest("div.card"),1==c.size())){var e=c.data("ai");null!=e&&(a.toggleSel(e)?c.addClass("obj-sel"):c.removeClass("obj-sel"))}});a.sAtts=[];for(var c=0;c<PData.getNumETmplts();c++){var e=jQuery('#dialog-sortby select[data-ti="'+c+'"] :first').val();a.sAtts.push(e)}for(c=0;c<PData.getNumETmplts();c++)jQuery('#dialog-sortby select[data-ti="'+c+'"]').val(this.sAtts[c])};
VizCards.prototype.render=function(a){var c=this;this.stream=a;var e=PData.getNumETmplts(),d,f,g,l,n,p,t,h,q,v,y,m,u,k,z=jQuery(this.frameID);z.empty();0<this.recSel.length&&(this.recSel=[]);var A,r="w"+this.settings.w+" h"+this.settings.h;f=a.t[0];for(d=0;d<e;){for(;0==f.n;){if(++d==e)return;f=a.t[d]}f=PData.getETmpltIndex(d);f=PData.getTmpltID(f);p=c.vFrame.getSelFeatAtts(d);0!=p.length&&(z.append('<div class="template-label">'+f.l+'</div><div class="cards" data-ti="'+d+'"></div>'),A=jQuery('div.cards[data-ti="'+
d+'"]'),g=c.vFrame.getSelLegend(d),l=PData.getAttID(g),n=c.settings.iAtts[d],v=c.settings.cnt[d],f=c.sAtts[d],f=PData.getAttID(f),f=PData.orderTBy(f,a,d),f.forEach(function(a){t=PData.getRecByIndex(a.i);y=t.a[g];"undefined"!=typeof y&&(h=PData.getAttLgndRecs(y,l,p,!1))&&(u=c.settings.lOn?'<div class="card-title">'+t.l+"</div>":"",q=!1,m="",v&&0<v.length&&(k=h.b?' style="color:black"':"",v.forEach(function(a){if(y=t.a[a])if(y=PData.procAttTxt(a,y))q=!0,m+=y+"<br/>"})),m=n&&(y=t.a[n])?q?'<div class="card-body"><img src="'+
...
VizCards.prototype.rerender=function(a){var c=this,e=jQuery(this.frameID+' div.cards[data-ti="'+a+'"]');e.empty();var d,f,g,l,n,p,t,h,q,v,y,m,u,k="w"+this.settings.w+" h"+this.settings.h;d=c.vFrame.getSelFeatAtts(a);0!=d.length&&(f=c.vFrame.getSelLegend(a),g=PData.getAttID(f),l=c.settings.iAtts[a],n=c.settings.cnt[a],p=c.sAtts[a],p=PData.getAttID(p),a=PData.orderTBy(p,c.stream,a),a.forEach(function(a){t=PData.getRecByIndex(a.i);h=t.a[f];"undefined"!=typeof h&&(q=PData.getAttLgndRecs(h,g,d,!1))&&(m=
c.settings.lOn?'<div class="card-title">'+t.l+"</div>":"",v=!1,y="",n&&0<n.length&&(u=q.b?' style="color:black"':"",n.forEach(function(a){if(h=t.a[a])if(h=PData.procAttTxt(a,h))v=!0,y+=h+"<br/>"})),y=l&&(h=t.a[l])?v?'<div class="card-body"><img src="'+h+'"/><div class="card-cnt"'+u+">"+y+"</div></div>":'<div class="card-body"><img class="full" src="'+h+'"/></div>':'<div class="card-body"><div class="card-cnt"'+u+">"+y+"</div>",e.append('<div class="card '+k+(c.isSel(a.i)?" obj-sel":"")+'" style="background-color:'+
...
VizPinboard.prototype.getLocAtts=function(a){return null!=a?[this.settings.cAtts[a]]:[this.settings.cAtts]};VizPinboard.prototype.getFeatureAtts=function(a){return null!=a?this.settings.lgnds[a]:this.settings.lgnds};
...
VizPinboard.prototype.render=function(a){var c=this;this.gRecs.selectAll(".recobj").remove();this.gRecs.selectAll(".recline").remove();0<this.recSel.length&&(this.recSel=[]);var e=PData.getNumETmplts(),d,f,g=0,l,n,p,t,h,q,v,y,m,u,k,z,A,r,D,w;for(d=0;d<e;d++)if("disable"!=this.settings.pAtts[d]){w=[];break}z=this.settings.min;"string"==typeof z&&(z=parseInt(z));f=this.settings.max;"string"==typeof f&&(f=parseInt(f));A=f-z;var x=[];d=0;g=-1;a:for(;d<a.l;){if(null==q){do{if(++g==e)break a;l=a.t[g]}while(0==
l.n||l.i+l.n==d);q=this.vFrame.getSelLocAtts(g);if(0==q.length){q=null;continue}q=q[0];v=c.vFrame.getSelFeatAtts(g);if(0==v.length){q=null;continue}t=c.vFrame.getSelLegend(g);h=PData.getAttID(t);y=c.settings.pAtts[g];n=c.settings.lClrs[g];if(k=c.settings.sAtts[g])p=PData.getAttID(k),"number"==typeof p.r.min&&"number"==typeof p.r.max?(r=p.r.min,D=p.r.max-r):k=null}f=a.s[d];p=PData.getRecByIndex(f);var B;w&&(B={id:p.id,c:null,p:p.a[y],l:n});m=p.a[q];"undefined"!=typeof m&&(u=p.a[t],"undefined"!=typeof u&&
(u=PData.getAttLgndVal(u,h,v)))&&(k?(p=p.a[k],p="undefined"!=typeof p?Math.floor((p-r)*A/D)+z:z):p=z,x.push({ai:f,v:u,x:m[0],y:m[1],r:p}),B&&(B.c=m));B&&B.c&&w.push(B);++d==l.i+l.n&&(q=null)}this.gRecs.selectAll(".recobj").data(x).enter().append("circle").attr("class","recobj").attr("cx",function(a){return c.xScale(a.x)}).attr("cy",function(a){return c.yScale(a.y)}).attr("r",function(a){return c.yScale(a.r)}).style("fill",function(a){return a.v}).on("click",function(a,h){var q=c.toggleSel(a.ai);d3.select(this).classed("obj-sel",
q)});if(w){w.sort(function(a,h){return PData.strcmp(h.id,a.id)});var C=[];w.forEach(function(a){a.p&&a.p.forEach(function(h){d=_.sortedIndex(w,{id:h},"id");if(d<w.length){var c=w[d];c.id==h&&C.push({f:a.c,t:c.c,c:a.l})}})});this.gRecs.selectAll(".recline").data(C).enter().append("line").attr("class","recline").attr("x1",function(a){return c.xScale(a.f[0])}).attr("y1",function(a){return c.yScale(a.f[1])}).attr("x2",function(a){return c.xScale(a.t[0])}).attr("y2",function(a){return c.yScale(a.t[1])}).attr("stroke",
...
typeof d.r.max.d&&d.r.max.d>e&&(e=d.r.max.d)))});d.minDate=0<f.from.length?PData.parseDate(f.from,1,1):PData.date3Nums(a,c,h);d.maxDate=0<f.to.length?PData.parseDate(f.to,12,31):PData.date3Nums(q,v,e);d.instGap=.015*(d.maxDate-d.minDate)})();var g=d.getWidths(),l=d3.select(this.frameID).append("svg").attr("class","tl-vf").attr("width",g[1]);(function(){var a=[];f.lgnds.forEach(function(c){c.forEach(function(c){a.push(c)})});var a=_.uniq(a),c=[];a.forEach(function(a){(a=PData.getAttID(a))&&a.l.forEach(function(a){c.push(a.v)})});
...
a&&r.append("text").attr("class","rangeLbl").attr("x",4).attr("y",k).attr("fill",function(a){return a.c.b?"#000000":"#FFFFFF"}).style("font-size",u).text(function(a){return a.l});r=d3.select(m.svgID).selectAll(".instant");r.append("circle").attr("cx",h).attr("cy",q).attr("r",d).attr("fill",function(a){return a.c.v});1==a&&r.append("text").attr("class","instantLbl").attr("x",e).attr("y",k).style("font-size",u).style("filter","url(#xortext)").text(function(a){return a.l});m.redraw=function(){f.attr("x",
function(a){return m.xScale(a.s)}).attr("width",function(a){return m.xScale(a.e)-m.xScale(a.s)});l.attr("x",function(a){return m.xScale(a.s)}).attr("width",function(a){return m.xScale(a.e)-m.xScale(a.s)});m.parts.forEach(function(a){a.redraw()})}}function d(a){a=g.bands[a];d3.select(a.svgID).selectAll(".axis").attr("transform","translate(0,"+a.h+")")}function f(a){a=g.bands[a];d3.select(a.svgID).selectAll(".bLblCntr").attr("transform","translate(0,"+(a.h+1).toString()+")")}var g=this,l=g.vFrame.getIndex();
0<this.recSel.length&&(this.recSel=[]);g.events=[];g.lgBds=[];var n=0;(function(){for(var d=PData.getNumETmplts(),e=0,h,q,v,f,m,u,k,l;e<d;){for(h=a.t[e];0==h.n;){if(++e==d)return;h=a.t[e]}v=g.vFrame.getSelLocAtts(e);if(0!=v.length&&(v=g.vFrame.getSelFeatAtts(e),0!=v.length)){l=g.vFrame.getSelLegend(e);k=PData.getAttID(l);f=g.settings.dAtts[e];for(var A,r,D,w,x,B,C,E,G=[],F=h.i;F<h.i+h.n;F++)q=a.s[F],E=PData.getRecByIndex(q),m=E.a[l],"undefined"!=typeof m&&(m=PData.getAttLgndRecs(m,k,v,!1))&&(u=E.a[f])&&
(B=u.min.f?EVENT_F_START:0,A=u.min.y,"undefined"==typeof u.min.m?D=r=1:(r=u.min.m,D="undefined"==typeof u.min.d?1:u.min.d),w=PData.date3Nums(A,r,D),"undefined"==typeof u.max?(B|=EVENT_INSTANT,x=w.getTime()+g.instGap):"open"==u.max?x=TODAY:(u.max.f&&(B|=EVENT_F_END),A=u.max.y,"undefined"==typeof u.max.m?(r=12,D=31):(r=u.max.m,D="undefined"==typeof u.max.d?mnthDays[r-1]:u.max.d),x=PData.date3Nums(A,r,D)),G.push({s:w,e:x,ai:q,f:B,c:m,l:E.l,t:0}));G.sort(c);var H=[],I;G.forEach(function(a){for(I=0;I<
H.length&&!(a.e<H[I]);I++);a.t=I+n+1;H[I]=a.s});h=PData.getAttID(f);h.l.forEach(function(a){C=a.d;A=C.min.y;"undefined"==typeof C.min.m?D=r=1:(r=C.min.m,D="undefined"==typeof C.min.d?1:C.min.d);w=PData.date3Nums(A,r,D);"undefined"==typeof C.max.y?x=TODAY:(A=C.max.y,"undefined"==typeof C.max.m?(r=12,D=31):(r=C.max.m,D="undefined"==typeof C.max.d?mnthDays[r-1]:C.max.d),x=PData.date3Nums(A,r,D));g.lgBds.push({s:w,e:x,t:n,h:H.length+1,d:a})});n+=H.length+1;g.events=g.events.concat(G)}e++}})();g.getWidths();
e(0);e(1);(function(){var a=function(){function a(c,h){this._height=h;this.g=c;this.mask=this.g.attr("class","brush").call(g.brush);this.mask.selectAll("rect").attr("y",0).attr("height",h);this.left=this.mask.append("polygon").attr("class","dragger");this.right=this.mask.append("polygon").attr("class","dragger");this._bottom=this._top=this._x=null}a.prototype.style=function(a,c){this.left.style(a,c);this.right.style(a,c);return this};a.prototype.x=function(a){if(null==a)return this._x;this._x=a;return this};
...
VizDirectory.prototype.render=function(a){var c=PData.getNumETmplts(),e=0,d,f,g,l,n,p,t=jQuery(this.frameID);t.empty();0<this.recSel.length&&(this.recSel=[]);this.stream=a;for(d=a.t[0];e<c;){for(;0==d.n;){if(++e==c)return;d=a.t[e]}d=PData.getETmpltIndex(e);d=PData.getTmpltID(d);t.append('<div class="template-label">'+d.l+'</div><table cellspacing="0" class="viz-directory" data-ti='+e+"></table>");f=t.find('table[data-ti="'+e+'"]');g=this.settings.cnt[e];p="<thead><tr>";g.forEach(function(a){a=PData.getAttID(a);
p+="<th>"+a.def.l+"</th>"});f.append(p+"<tr></thead><tbody></tbody>");f=f.find("tbody");d=this.sAtts[e];d=PData.getAttID(d);d=PData.orderTBy(d,this.stream,e);d.forEach(function(a){n=PData.getRecByIndex(a.i);p='<tr data-id="'+n.id+'" data-ai='+a.i+">";g.forEach(function(a){l=n.a[a];"undefined"!=typeof l?p=(l=PData.procAttTxt(a,l))?p+("<td>"+l+"</td>"):p+"<td></td>":p+="<td></td>"});f.append(p+"</tr>")});d=a.t[++e]}};
...
VizTextStream.prototype.getLocAtts=function(a){return null!=a?[this.settings.order[a]]:_.map(this.settings.order,function(a){return[a]})};VizTextStream.prototype.getFeatureAtts=function(a){return null!=a?this.settings.lgnds[a]:this.settings.lgnds};VizTextStream.prototype.setup=function(){var a=this;jQuery(this.frameID).on("click.vf",function(c){if("DIV"==c.target.nodeName){c=jQuery(c.target);var e=c.data("ai");"undefined"!=typeof e&&0<=e&&(a.toggleSel(e)?c.addClass("obj-sel"):c.removeClass("obj-sel"))}})};
VizTextStream.prototype.render=function(a){var c=this,e=PData.getNumETmplts(),d=0,f,g,l,n,p,t,h,q,v,y,m,u,k,z,A,r,D,w=jQuery(this.frameID);w.empty();0<this.recSel.length&&(this.recSel=[]);r=this.settings.max-this.settings.min;for(g=a.t[0];d<e;){for(;0==g.n;){if(++d==e)return;g=a.t[d]}v=c.vFrame.getSelLocAtts(d);if(0!=v.length&&(v=c.vFrame.getSelFeatAtts(d),0!=v.length)){y=c.vFrame.getSelLegend(d);m=PData.getAttID(y);w.append('<div class="viz-textstream" data-ti='+d+"></div>");l=w.find("div.viz-textstream[data-ti="+
d+"]");f=PData.getETmpltIndex(d);f=PData.getTmpltID(f);l.append('<div class="template-label">'+f.l+"</div>");q=c.settings.cnt[d];if(z=c.settings.sAtts[d])k=PData.getAttID(z),"number"==typeof k.r.min&&"number"==typeof k.r.max?A=k.r.max-k.r.min:z=null;q&&(f=PData.getAttID(c.settings.order[d]),f=PData.orderTBy(f,a,d),f.forEach(function(a){n=PData.getRecByIndex(a.i);p=n.a[y];"undefined"!=typeof p&&(u=PData.getAttLgndRecs(p,m,v,!1))&&((t=n.a[q])&&(t=PData.procAttTxt(q,t)),t&&(z?(h=n.a[z],h="undefined"!=
...
VizNetWheel.prototype.render=function(a){var c=this,e=[],d,f,g;this.svg.selectAll(".node").remove();this.svg.selectAll(".link").remove();this.inc=360/(a.l+a.t.length);f=Math.max((14*a.l+20)/(2*Math.PI),30);var l=this.settings.lw;"string"==typeof l&&(l=parseInt(l));this.cr=l+12+f;l=2*this.cr;this.svg.attr("width",l).attr("height",l);this.center.attr("transform","translate("+this.cr+","+this.cr+")");0<this.recSel.length&&(this.recSel=[]);var n={children:[]};(function(){var d,e=0,h=0,q,v,f,m=[],u=null,
k,g;d=a.t[0];g=c.vFrame.getSelLegend(0);k=PData.getAttID(g);u=c.vFrame.getSelFeatAtts(0);a:for(;h<a.l;){for(;0==d.n||d.i+d.n==h||0==u.length;){0<m.length&&(n.children.push({ti:e,children:m}),m=[]);if(++e==PData.getNumETmplts())break a;m=[];d=a.t[e];g=c.vFrame.getSelLegend(e);k=PData.getAttID(g);u=c.vFrame.getSelFeatAtts(e)}f=a.s[h];q=PData.getRecByIndex(f);v=q.a[g];"undefined"!=typeof v&&(fData=PData.getAttLgndRecs(v,k,u,!1))&&m.push({r:q,ai:f,c:fData.v,children:[]});h++}0<m.length&&n.children.push({ti:e,
...
a.x?"10":"-10"}).attr("transform",function(a){return 180>a.x?"":"rotate(180)"}).style("text-anchor",function(a){return 180>a.x?"start":"end"}).attr("fill","white").text(function(a){return a.r.l}).on("click",function(a){PState.set(PSTATE_UPDATE);g.each(function(a){a.linked=!1});d.each(function(c){if(c.s===a){c.t.linked=!0;for(var h=0;h<e.length;h++){var d=e[h];if(d.source===a&&d.target===c.t){d3.select(this).attr("stroke",d.c).classed("thick",!0);break}}}else if(c.t===a)for(c.s.linked=!0,h=0;h<e.length;h++){if(d=
e[h],d.target===a&&d.source===c.s){d3.select(this).attr("stroke",d.c).classed("thick",!0);break}}else d3.select(this).attr("stroke","white").classed("thick",!1)});g.select("text").attr("fill",function(a){return a.linked?"black":"white"});d3.select(this).attr("fill","red");PState.set(PSTATE_READY)});f=d3.layout.bundle();l=d3.svg.line.radial().interpolate("bundle").tension(.85).radius(function(a){return a.y}).angle(function(a){return a.x/180*Math.PI});n.children.forEach(function(a){var d=c.settings.pAtts[a.ti],
h;a.children.forEach(function(a){d.forEach(function(c){h=a.r.a[c.pid];"undefined"!=typeof h&&h.forEach(function(h){var d=!1,f,k=0;a:for(;k<n.children.length;k++)for(var g=n.children[k],l=0;l<g.children.length;l++)if(f=g.children[l],f.r.id==h){d=!0;break a}d&&e.push({source:a,target:f,c:c.clr})})})})});d=this.center.append("g").selectAll(".link").data(f(e)).enter().append("path").each(function(a){a.s=a[0];a.t=a[a.length-1]}).attr("class","link").attr("d",l).attr("stroke","white")};
...
VizNetWheel.prototype.setState=function(a){this.vFrame.setLgndSels(a.l)};var VizFlow=function(a,c){PVizModel.call(this,a,c);this.bSel=[];this.fSel=[]};VizFlow.prototype=Object.create(PVizModel.prototype);VizFlow.prototype.constructor=VizFlow;VizFlow.prototype.flags=function(){return V_FLAG_VSCRL|V_FLAG_HSCRL};
...
VizFlow.prototype.render=function(a){var c=this;this.bSel=[];this.fSel=[];this.barG.selectAll(".bar").remove();this.flowG.selectAll(".flow").remove();this.titleG.selectAll(".att-title").remove();var e=this.settings.w;c.bars=[];c.atts=[];c.settings.fcts.forEach(function(d,f){var g,l=PData.getAttID(d);"T"==l.def.t&&c.settings.tlit?(g=[],PData.fillCats(g,d,null,a,!0)):(g=c.settings.gr?PData.getRCats(l,!0):PData.getLCats(l,null),PData.fillCats(g,d,null,a,!1));var n=[],p=0;g.forEach(function(a){0<a.i.length&&
(n.push(a),p+=a.i.length)});var t=0,h=31+f*c.bH;n.forEach(function(a){c.bars.push({x:5+t*e/p,w:a.i.length*e/p,y:h,c:a});t+=a.i.length});c.atts.push({l:l.def.l,c:n,t:p,y:h})});this.barG.selectAll(".bar").data(c.bars).enter().append("rect").attr("class","bar").attr("x",function(a){return a.x}).attr("y",function(a){return a.y}).attr("fill",function(a){return a.c.c}).attr("height","8").attr("width",function(a){return a.w}).on("click",function(a,e){var g=c.bSel.length,l=_.sortedIndex(c.bSel,e);c.bSel[l]==
e?(d3.select(this).classed("obj-sel",!1),c.bSel.splice(l,1),0<g&&0==c.bSel.length&&c.vFrame.selBtns(!1)):(d3.select(this).classed("obj-sel",!0),c.bSel.splice(l,0,e),0==g&&0<c.bSel.length&&c.vFrame.selBtns(!0))}).append("title").text(function(a){return a.c.l});c.ints=[];c.atts.forEach(function(a,f){if(f!=c.atts.length-1){for(var g=c.atts[f+1],l=Array(a.c.length),n=0;n<g.c.length;n++)l[n]=Array(g.c.length);a.c.forEach(function(a,c){g.c.forEach(function(h,d){l[c][d]=PData.intersect(a.i,h.i)})});for(var p=
Array(g.c.length),t=0;t<g.c.length;t++){for(var h=0,n=0;n<a.c.length;n++)0<l[n][t].length&&h++;p[t]=h-1}for(var q=Array(g.c.length),t=0;t<g.c.length;t++)q[t]=0;var v=0;a.c.forEach(function(h,m){for(var f=0,k=0;k<g.c.length;k++)0<l[m][k].length&&f++;--f;var z=h.i.length*e/a.t,n=0,r=0;g.c.forEach(function(k,w){var x=l[m][w];if(0<x.length){var B=x.length*e,t=B/a.t,B=B/g.t,E=k.i.length*e/g.t;c.ints.push({i:x,c:h.c,l:h.l+" > "+k.l,x1:5+v*e/a.t+(f?(z-t)*n/f:0),x2:5+r*e/g.t+(p[w]?(E-B)*q[w]/p[w]:0),w1:t,
w2:B,y1:a.y+10,y2:g.y-1});n++;q[w]++}r+=k.i.length});v+=h.i.length})}});this.flowG.selectAll(".flow").data(c.ints).enter().append("path").attr("class","flow").attr("d",function(a){return"M "+a.x1+" "+a.y1+"  L "+(a.x1+a.w1)+" "+a.y1+" L "+(a.x2+a.w2)+" "+a.y2+" L "+a.x2+" "+a.y2+" L "+a.x1+" "+a.y1}).attr("fill",function(a){return a.c}).on("click",function(a,e){var g=c.fSel.length,l=_.sortedIndex(c.fSel,e);c.fSel[l]==e?(d3.select(this).classed("obj-sel",!1),c.fSel.splice(l,1),0<g&&0==c.fSel.length&&
c.vFrame.selBtns(!1)):(d3.select(this).classed("obj-sel",!0),c.fSel.splice(l,0,e),0==g&&0<c.fSel.length&&c.vFrame.selBtns(!0))}).on("mouseover",function(){d3.select(this).classed("active",!0);this.parentElement.appendChild(this)}).on("mouseout",function(){d3.select(this).classed("active",!1)}).append("title").text(function(a){return a.l});this.titleG.selectAll(".att-title").data(c.atts).enter().append("text").attr("class","att-title").attr("x","5").attr("y",function(a){return a.y-8}).text(function(a){return a.l})};
VizFlow.prototype.setSel=function(a){};VizFlow.prototype.clearSel=function(){0<this.bSel.length&&(this.bSel=[],this.svg.selectAll(".bar").classed("obj-sel",!1));0<this.fSel.length&&(this.fSel=[],this.svg.selectAll(".flow").classed("obj-sel",!1))};VizFlow.prototype.getSel=function(){var a=this,c=[];this.bSel.forEach(function(e){c=PData.union(c,a.bars[e].c.i)});this.fSel.forEach(function(e){c=PData.union(c,a.ints[e].i)});return c};function PFilterModel(a,c){this.id=a;this.att=c;this.dirty=!0}
PFilterModel.prototype.isDirty=function(a){null!=a&&(!this.dirty&&a&&0<this.id&&jQuery("#btn-recompute").addClass("pulse"),this.dirty=a);return this.dirty};PFilterModel.prototype.title=function(){return this.att.def.l};PFilterModel.prototype.insertPt=function(){return jQuery('div.filter-instance[data-id="'+this.id+'"] div.filter-body')};PFilterModel.prototype.teardown=function(){};var PFilterRemove=function(a){PFilterModel.call(this,a,null)};PFilterRemove.prototype=Object.create(PFilterModel.prototype);
PFilterRemove.prototype.constructor=PFilterRemove;PFilterRemove.prototype.title=function(){return dlText.rha};PFilterRemove.prototype.evalPrep=function(){};PFilterRemove.prototype.eval=function(a){return!1};PFilterRemove.prototype.setup=function(){var a=this.insertPt(),c=document.getElementById("dltext-filter-remove").innerHTML;a.append(c)};PFilterRemove.prototype.getState=function(){return{}};PFilterRemove.prototype.setState=function(a){};var PFilterText=function(a,c){PFilterModel.call(this,a,c)};
PFilterText.prototype=Object.create(PFilterModel.prototype);PFilterText.prototype.constructor=PFilterText;PFilterText.prototype.evalPrep=function(){this.fStr=this.insertPt().find("input.filter-text").val()};PFilterText.prototype.eval=function(a){var c=this.fStr;if(null==c||""==c)return!0;a=a.a[this.att.id];return"undefined"==typeof a?!1:-1!=a.indexOf(c)};PFilterText.prototype.setup=function(){var a=this,c=this.insertPt(),e=document.getElementById("dltext-filter-text").innerHTML;c.append(e);c.find("input.filter-text").change(function(){a.isDirty(!0)})};
PFilterText.prototype.getState=function(){return{t:this.insertPt().find("input.filter-text").val()}};PFilterText.prototype.setState=function(a){this.insertPt().find("input.filter-text").val(a.t)};var PFilterVocab=function(a,c){PFilterModel.call(this,a,c)};PFilterVocab.prototype=Object.create(PFilterModel.prototype);PFilterVocab.prototype.constructor=PFilterVocab;
PFilterVocab.prototype.evalPrep=function(){var a=this;this.sel=[];this.insertPt().find("div.filter-vocab-row input:checked").each(function(){var c=jQuery(this).parent().data("id");a.sel.push(c)});a.sel.sort()};PFilterVocab.prototype.eval=function(a){if(0==this.sel.length)return!1;a=a.a[this.att.id];if("undefined"==typeof a)return!1;for(var c,e,d=0;d<a.length;d++)if(e=a[d],c=_.sortedIndex(this.sel,e),this.sel[c]==e)return!0;return!1};
...
this.rCats.length]).rangeRound([0,e]),n=d3.scale.linear().domain([0,100]).range([f,0]),d=d3.scale.ordinal().rangeRoundBands([0,e]);d.domain(this.rCats.map(function(a){return a.l}));var d=d3.svg.axis().scale(d).orient("bottom"),p=d3.svg.axis().scale(n).orient("left").ticks(4),e=d3.select(c.get(0)).append("svg").attr("width",e+D3FG_MARGINS.left+D3FG_MARGINS.right).attr("height",f+D3FG_MARGINS.top+D3FG_MARGINS.bottom).append("g").attr("transform","translate("+D3FG_MARGINS.left+","+D3FG_MARGINS.top+")");
e.append("g").attr("class","x axis").attr("transform","translate(0,"+f+")").call(d);e.append("g").attr("class","y axis").call(p);e.selectAll(".bar").data(this.rCats).enter().append("rect").attr("class","bar").attr("x",function(a,c){return l(c)+2}).attr("y",function(a){return n(100)}).attr("fill",function(a){return a.c}).attr("height",function(a){return f-n(100)}).attr("width",g-4);a.brush=d3.svg.brush().x(l).extent([0,this.rCats.length]).on("brushend",function(){if(d3.event.sourceEvent){var c=a.brush.extent(),
...
var l=d3.svg.axis().scale(l).orient("bottom"),n=d3.svg.axis().scale(g).orient("left").ticks(4),p=this.insertPt(),t=_.template(document.getElementById("dltext-filter-date-ctrl").innerHTML);p.append(t({id:this.id}));p.find("input[name=dctrl-"+a.id+"]").change(function(){a.isDirty(!0)});d=d3.select(p.get(0)).append("svg").attr("width",d+D3FG_MARGINS.left+D3FG_MARGINS.right).attr("height",c+D3FG_MARGINS.top+D3FG_MARGINS.bottom).append("g").attr("transform","translate("+D3FG_MARGINS.left+","+D3FG_MARGINS.top+
...
widgetData.extract[0]);var v=a.indexOf(widgetData.extract[1]);if(-1==v)throw Error("Transcript excerpt error: Cannot find timestamp "+widgetData.extract[1]);a=a.substring(q-1,v-1)}if(a=a.trim().split(/\r\n|\r|\n/g)){var k=0,m,f=0,g=0,u="",r=jQuery("#xscript-tbl");_.each(a,function(a){a=a.trim();1<a.length&&("["===a.charAt(0)&&"0"<=a.charAt(1)&&"9">=a.charAt(1)?(m=c(a),0<u.length&&(g&&e.push({s:f,e:m}),r.append('<div class="row"><div class="timecode" data-timecode="'+f+'" data-tcindex="'+k++ +'">'+
g+'</div><div class="xscript">'+u+"</div></div>"),u=""),g=a,f=m):u+=a)});0<u.length&&(e.push({s:f,e:324E5}),r.append('<div class="row"><div class="timecode" data-timecode="'+f+'" data-tcindex="'+k+'">'+g+'</div><div class="xscript">'+u+"</div></div>"));if("undefined"!=typeof n&&null!=n){var F=new XMLHttpRequest;F.onload=function(a){h(F.responseText,r)};F.open("GET",n,!0);F.send()}}}function e(a){var c,h=widgetData.tcIndex;_.find(widgetData.tcArray,function(d,e){if((c=d.s<=a&&a<d.e)&&e!=h){var q=jQuery("#xscript-tbl");
...
widgetData.xscriptOn=!0;jQuery("#xscript-tbl").click(function(a){if(l&&jQuery(a.target).hasClass("timecode"))switch(a=jQuery(a.target).data("timecode"),l){case 1:widgetData.playing||(widgetData.playing=!0,widgetData.widget.play());widgetData.widget.seekTo(a);break;case 2:widgetData.playing||(widgetData.playing=!0,widgetData.widget.playVideo()),widgetData.widget.seekTo(a/1E3)}});n=null;(r=prspdata.e.i.t.t2Atts[m])&&""!==r&&"disable"!=r&&(n=A.a[r]);var F=new XMLHttpRequest;F.onload=function(a){d(F.responseText)};
F.open("GET",k,!0);F.send()}}function m(a){a=t+a;-1==a?a=z.length-1:a==z.length&&(a=0);a!=t&&(t=a,v())}function f(a){m(-1)}function g(a){m(1)}var u=jQuery("#inspect-content"),y=null,l=0,n,z=null;k&&(z=k.getSel());if(null!=z&&0!=z.length){var p,A,t=0;v();jQuery("#btn-inspect-left").click(f);jQuery("#btn-inspect-right").click(g);var J=450,K=400;prspdata.e.i.modal.scOn&&(J=550);prspdata.e.i.modal.ytOn&&(J=Math.max(J,460),K=500);prspdata.e.i.tOn&&(K+=100,J=prspdata.e.i.t2On?750:Math.max(J,500));p=jQuery("#dialog-inspector").dialog({width:J,
...
var n=f.find("div.lgnd-container div.lgnd-scroll");n.empty();if(l&V_FLAG_SLGND){var p=y.getFeatureAtts(),F=PData.getAttID(p);n.append('<div class="lgnd-template" data-index="0"><div class="lgnd-title">'+F.def.l+'</div><div class="lgnd-entry lgnd-sh"><input type="checkbox" checked="checked" class="lgnd-entry-check"/>'+dlText.sha+'</div><div class="lgnd-group"></div></div>');z.push(p);v(0,p)}else prspdata.e.g.ts.forEach(function(a,c){var h=PData.getTmpltID(a),d=y.getLocAtts(c);if(d&&0<d.length||!(l&
...
"</option>"});k+="</select>";d=jQuery(k);d.change(q);jQuery(e).append(d);jQuery(e).append('<div class="lgnd-entry lgnd-sh"><input type="checkbox" checked="checked" class="lgnd-entry-check"/>'+dlText.sha+'</div><div class="lgnd-group"></div>');n.append(e);c!=prspdata.t.length-1&&n.append("<hr/>");h=0<h.length?h[0]:null;z.push(h);h&&v(c,h)}});f.find("div.lgnd-container").show()}else f.find(".hslgnd").button("disable"),f.find("div.lgnd-container").hide();p=jQuery("#selector-v"+a);l&V_FLAG_SEL?(p.removeAttr("disabled"),
p.prop("checked",!0)):(p.attr("disabled",!0),p.prop("checked",!1));l&V_FLAG_OPT?f.find(".vopts").button("enable"):f.find(".vopts").button("disable");(p=y.hint())||"string"==typeof e.n&&""!=e.n?(f.find(".vnote").button("enable"),p=p?"string"==typeof e.n&&""!=e.n?p+(".<br/>"+e.n):p+".":e.n,jQuery("#vnotes-txt").empty().append(p)):f.find(".vnote").button("disable");y.setup();g(!1);A&&d&&y.render(A);k=y}var m={},u=0,k=null,z=[],A=null;m.getFrameID=c;m.getIndex=function(){return a};m.setViz=function(a,
...
prspdata.e.vf.forEach(function(a,c){m.append('<option value="'+c+'">'+a.l+"</option>")});m.val(q);m.change(e);k.find("div.view-control-bar button:first").button({icons:{primary:"ui-icon-bookmark"},text:!1}).click(d).next().button({icons:{primary:"ui-icon-search"},text:!1}).click(f).next().button({icons:{primary:"ui-icon-cancel"},text:!1}).click(l).next().button({icons:{primary:"ui-icon-gear"},text:!1}).click(n).next().button({icons:{primary:"ui-icon-help"},text:!1}).click(p).next();k.find("div.lgnd-container").click(h);
...
0;c<prspdata.t.length;c++)if(a==prspdata.t[c].id)return prspdata.t[c].def},getAttLgndRecs:function(a,c,d,e){var f,g=d.length,k;switch(c.def.t){case "V":var l=function(a){for(var e=0;e<g;e++)if(f=d[e],"number"===typeof f){if(k=c.l[f],k.l==a)return k}else{k=c.l[f[0]];var h=k.z[f[1]];if(h.l==a)return h.v&&""!=h.v?h:k}return null};if(e&&""!=c.def.d){var n=[],r;a.forEach(function(a){r=l(a);null!=r&&n.push(r)});return 0<n.length?n:null}if(""!=c.def.d){for(e=0;e<a.length;e++)if(r=l(a[e]),null!=r)return r;
...
a||99<a?c=new Date(a,c-1,d):0==a?c=new Date(-1,c-1,d):(c=new Date(a,c-1,d),c.setUTCFullYear(("0000"+a).slice(-4)));return c},objDate:function(a,c){var d;"undefined"!=typeof a.m&&null!=a.m?(c=a.m,d="undefined"!=typeof a.d&&null!=a.d?a.d:mnthDays[c-1]):d=mnthDays[c-1];return PData.date3Nums(a.y,c,d)},parseDate:function(a,c,d){if("open"==a)return TODAY;var e=1;"-"==a.charAt(0)&&(e=-1,a=a.substring(1));a=a.split("-");e*=parseInt(a[0]);1<a.length&&(c=parseInt(a[1]),3==a.length&&(d=parseInt(a[2])));return PData.date3Nums(e,
c,d)},makeDates:function(a){var c,d,e,f,g=!1;d=a.min.y;"undefined"==typeof a.min.m?f=e=1:(e=a.min.m,"undefined"==typeof a.min.d?f=1:(f=a.min.d,g=!0));c=PData.date3Nums(d,e,f);if("undefined"!=typeof a.max)"open"==a.max?a=TODAY:(d=a.max.y,"undefined"==typeof a.max.m?(e=12,f=31):(e=a.max.m,f="undefined"==typeof a.max.d?mnthDays[e-1]:a.max.d),a=PData.date3Nums(d,e,f));else{if(g)return[c,null];"undefined"==typeof a.min.m?(e=12,f=31):f=mnthDays[e-1];a=PData.date3Nums(d,e,f)}return[c,a]},getLCats:function(a,
c){var d=[];switch(a.def.t){case "T":return a.l.forEach(function(e){(null==c||PData.getAttLgndRecs(e.d,a,c,!1))&&d.push({l:e.l,x:e.d,c:e.v,i:[]})}),d;case "V":return a.l.forEach(function(e){(null==c||PData.getAttLgndRecs([e.l],a,c,!1))&&d.push({l:e.l,c:e.v,i:[]});e.z.forEach(function(e){(null==c||PData.getAttLgndRecs([e.l],a,c,!1))&&d.push({l:e.l,c:e.v,i:[]})})}),d;case "N":return a.l.forEach(function(e){(null==c||PData.getAttLgndRecs(e.d.min,a,c,!1))&&d.push({l:e.l,c:e.v,min:e.d.min,max:e.d.max,
i:[]})}),d;case "D":var e,f;a.l.forEach(function(g){e=PData.objDate(g.min,1);if(null==c||PData.getAttLgndRecs(e,a,c,!1))f=null==g.max.y?TODAY:PData.objDate(g.max,12),d.push({l:g.l,c:g.v,min:e,max:f})});return d}},getRCats:function(a,c){var d=[];switch(a.def.t){case "T":return a.l.forEach(function(a){c?d.push({l:a.l,x:a.d,c:a.v,i:[]}):d.push({l:a.l,x:a.d,c:a.v})}),d;case "V":return a.l.forEach(function(a){c?d.push({l:a.l,c:a.v,i:[]}):d.push({l:a.l,c:a.v});a.z.forEach(function(a){c?d.push({l:a.l,c:a.v,
i:[]}):d.push({l:a.l,c:a.v})})}),d;case "N":if("undefined"==typeof a.r.min||"undefined"==typeof a.r.max)return null;var e=Math.pow(10,a.r.g),f=a.r.min,g=0,k,l,n;for(0<a.l.length&&(k=a.l[0]);f<=a.r.max;){for(;g<a.l.length&&"undefined"!=typeof k.d.max&&f>k.d.max;)k=a.l[++g];n=0==a.l.length||f<k.d.min?"#777777":g==a.l.length?"#777777":"undefined"==typeof k.d.max||f<=k.d.max?k.v:"#777777";l=f;max=f+=e;var r=l.toString();1<e&&4>r.length&&(r+="-"+(max-1).toString());c?d.push({l:r,c:n,min:l,max:f,i:[]}):
d.push({l:r,c:n,min:l,max:f})}return d;case "D":f=function(a){var c,d;if("undefined"==typeof a.y)return TODAY;c=a.y;"undefined"==typeof a.m?(d=12,a=31):(d=a.m,a="undefined"==typeof a.d?mnthDays[d-1]:a.d);return PData.date3Nums(c,d,a)};l=function(a,c,d,e){"undefined"!=typeof e.m&&(c=e.m,"undefined"!=typeof e.d&&(d=e.d));return PData.date3Nums(a,c,d)};n=f(a.r.max);var e=a.r.g,r=a.r.min.y,p=1,w=1;"undefined"!=typeof a.r.min.m&&(p=a.r.min.m,"undefined"!=typeof a.r.min.d&&(w=a.r.min.d));var x=PData.date3Nums(r,
p,w),g=0,t,C;0<a.l.length&&(k=a.l[0],t=l(k.d.min.y,1,1,k.d.min),C=f(k.d.max));for(;x<=n;){var E={};c&&(E.i=[]);switch(e){case "d":E.l=r.toString()+"-"+p.toString()+"-"+w.toString();break;case "m":E.l=r.toString()+"-"+p.toString();break;case "y":case "t":case "c":E.l=r.toString()}for(;g<a.l.length&&x>C;)k=a.l[++g],g<a.l.length&&(t=l(k.d.min.y,1,1,k.d.min),C=f(k.d.max));E.c=0==a.l.length||x<t?"#777777":g==a.l.length?"#777777":x<=C?k.v:"#777777";E.min=x;switch(e){case "d":E.max=PData.date3Nums(r,p,w+
1);w++;break;case "m":E.max=PData.date3Nums(r,p+1,w);p++;break;case "y":E.max=PData.date3Nums(r+1,p,w);r++;break;case "t":E.max=PData.date3Nums(r+10,p,w);r+=10;break;case "c":E.max=PData.date3Nums(r+100,p,w),r+=100}d.push(E);x=PData.date3Nums(r,p,w)}return d}},fillCats:function(a,c,d,e,f){var g=PData.getNumETmplts(),k=0,l,p=0,n,t,w,x,B=PData.getAttID(c);for(l=e.t[0];p<e.l;){for(;0==l.n||l.i+l.n==p||!PData.attInTmplt(c,k)||d&&!PData.attInTmplt(d,k);){if(++k==g)return;l=e.t[k];p=l.i}n=e.s[p];t=PData.getRecByIndex(n);
t=t.a[c];if("undefined"!=typeof t)switch(B.def.t){case "T":if(f){for(w=0;w<a.length;w++)if(x=a[w],t==x.l){x.i.push(n);break}w==a.length&&a.push({l:t,i:[n]})}else for(w=0;w<a.length;w++)if(x=a[w],-1!=t.indexOf(x.x)){x.i.push(n);break}break;case "V":t.forEach(function(c){for(w=0;w<a.length;w++)if(x=a[w],c==x.l){x.i.push(n);break}});break;case "N":for(w=0;w<a.length;w++){x=a[w];if(t<x.min)break;if(x.min<=t&&t<=x.max){x.i.push(n);break}}break;case "D":for(t=PData.objDate(t.min,1),w=0;w<a.length;w++){x=
a[w];if(t<x.min)break;if(x.min<=t&&t<=x.max){x.i.push(n);break}}}p++}f&&a.sort(function(a,c){return PData.strcmp(c.l,a.l)})},sortCats:function(a,c,d){var e=c.id,f,g,k;a.forEach(function(a){f=PData.getRecByIndex(a);datum=f.a[e];if("undefined"!=typeof datum)switch(c.def.t){case "T":for(g=0;g<d.length;g++)if(k=d[g],-1!=datum.indexOf(k.x)){k.i.push(a);break}break;case "V":datum.forEach(function(c){for(g=0;g<d.length;g++)if(k=d[g],c==k.l){k.i.push(a);break}});break;case "N":for(g=0;g<d.length;g++){k=d[g];
if(datum<k.min)break;if(k.min<=datum&&datum<=k.max){k.i.push(a);break}}break;case "D":var h=PData.objDate(datum.min,1);for(g=0;g<d.length;g++){k=d[g];if(h<k.min)break;if(k.min<=h&&h<=k.max){k.i.push(a);break}}}})},orderTBy:function(a,c,d){function e(a){return a}function f(a){return a[0]}function g(a){var c=1,d=1;"undefined"!=typeof a.min.m&&(c=a.min.m,"undefined"!=typeof a.min.d&&(d=a.min.d));return PData.date3Nums(a.min.y,c,d)}var k,l;switch(a.def.t){case "T":k=e;l="~";break;case "V":k=f;l="~";break;
case "N":k=e;l=a.r.max;break;case "D":k=g,l=TODAY}var p=[],r=c.t[d];d=n[d];for(var t=0,w,x;t<r.n;)w=c.s[r.i+t++],x=d.d[w-d.i],x=x.a[a.id],"undefined"==typeof x?p.push({i:w,v:l}):p.push({i:w,v:k(x)});switch(a.def.t){case "T":case "V":p.sort(function(a,c){return PData.strcmp(c.v,a.v)});break;case "D":case "N":p.sort(function(a,c){return a.v-c.v})}return p},getVizIndex:function(a){return prspdata.e.vf[a]},ready:function(){return t}}}();
jQuery(document).ready(function(a){function c(){var a;PState.set(PSTATE_PROCESS);null==w&&(w=PData.newIndexStream(!0));x=w;var c=!1,d,e;for(d=0;d<z.length;d++)if(e=z[d],a=jQuery('div.filter-instance[data-id="'+e.id+'"]'),c||e.f.isDirty(null)){c=!0;e.f.evalPrep();var f=PData.newIndexStream(!1),h=0,g,l,m=0,p=x.t[0],n=0,q;for(q=a.find(".apply-tmplt-0").is(":checked");h<x.l;){for(;0==p.n||p.i+p.n==h;)f.t.push({i:f.l-n,n:n}),n=0,p=x.t[++m],q=a.find(".apply-tmplt-"+m).is(":checked");g=x.s[h++];q?(l=PData.getRecByIndex(g),
e.f.eval(l)&&(f.s[f.l++]=g,n++)):(f.s[f.l++]=g,n++)}for(;m++<PData.getNumETmplts();)f.t.push({i:f.l-n,n:n}),n=0;e.f.isDirty(!1);x=e.f.out=f}else x=e.f.out;PState.set(PSTATE_BUILD);u.showStream(x);k&&k.showStream(x);jQuery("#btn-recompute").removeClass("pulse")}function e(a){var c=jQuery("#annote");c.text(a);0<a.length?(jQuery("#btn-annote").button("enable"),c.show()):(jQuery("#btn-annote").button("disable"),c.hide())}function d(a){var c=_.find(prspdata.p,function(c){return a==c.id});return c?c:null==
...
a.s.a0);jQuery("#selector-v1").prop("checked",a.s.a1);PData.ready()&&w&&(c(),A&&v());return!0}function m(a,c){var d=prspdata.bClrs[a];d&&0<d.length&&jQuery(c).css("background-color",d)}var u,k,z=[],A=null,r,D,w,x,B=null,C=[];jQuery("body").addClass("waiting");m("cb","#command-bar");m("fs","#filter-frame");m("sf","#selector-frame");PState.init();PMapHub.init(prspdata.m);(function(){function a(d,e){c=document.getElementById(d).innerHTML;dlText[e]=c.trim()}var c;a("dltext-removehideall","rha");a("dltext-showhideall",
...
[{text:dlText.ok,click:function(){e.dialog("close");var a=c.find("li.selected");a.length&&(a=a.data("id"),y(a),PState.set(PSTATE_READY))}},{text:dlText.cancel,click:function(){e.dialog("close")}}];B&&d.push({text:dlText.manage,click:function(){e.dialog("close");g()}});var e=jQuery("#dialog-show-prsrctv").dialog({width:350,height:350,modal:!0,buttons:d});a.preventDefault()});jQuery("#btn-save-prspctv").button({icons:{primary:"ui-icon-pencil"},text:!1}).click(function(a){var c,e=/[^\w\-]/;jQuery("#save-psrctv-id").val("");
