...
var f=this.lineLayer;f.clearLayers();var g=PData.eTNum(),k=0,m,n=0,p,h,r,q,w,x,y,l,A,v,u,C,t,z,B,D,E;z=this.settings.min;"string"===typeof z&&(z=parseInt(z));n=this.settings.max;"string"===typeof n&&(n=parseInt(n));B=n-z;for(k=0;k<g;k++)this.tLCnt[k]=0;for(var F,k=0;k<g;k++)if("disable"!==this.settings.pAtts[k]){F=[];break}k=0;n=-1;a:for(;k<a.l;){if(null==x){do{if(++n==g)break a;p=a.t[n]}while(0===p.n||p.i+p.n===k);x=this.vFrame.getSelLocAtts(n);if(0===x.length){x=null;continue}y=d.vFrame.getSelFeatAtts(n);
if(0===y.length){x=null;continue}d.tLCnt[n]=x.length;d.tUsed[n]=!0;q=d.vFrame.getSelLegend(n);w=PData.aByID(q);l=d.settings.pAtts[n];h=d.settings.lClrs[n];if(C=d.settings.sAtts[n])t=PData.aByID(C),"number"===typeof t.r.min&&"number"===typeof t.r.max?(D=t.r.min,E=t.r.max-D):C=null}m=a.s[k];r=PData.rByN(m);var G;F&&(G={id:r.id,c:[],p:r.a[l],l:h});x.forEach(function(a){if(A=r.a[a])if(v=r.a[q],"undefined"!==typeof v&&(v=PData.lClr(v,w,y))){d.rMap[m>>4]|=1<<(m&15);if("number"===typeof A[0])C?(t=r.a[C],
t="number"===typeof t?Math.floor((t-D)*B/E)+z:z):t=z,u=L.circleMarker(A,{_aid:m,weight:1,radius:t,fillColor:v,color:"#000",opacity:1,fillOpacity:1}),G&&G.c.push(A);else if(u=2===A.length?L.polyline(A,{_aid:m,weight:1,fillColor:v,color:"#000",opacity:1,fillOpacity:1}):L.polygon(A,{_aid:m,weight:1,fillColor:v,color:"#000",opacity:1,fillOpacity:1}),G){var h=[0,0];A.forEach(function(a){h[0]+=a[0];h[1]+=a[1]});h[0]/=A.length;h[1]/=A.length;G.c.push(h)}u.on("click",c);e.addLayer(u)}});G&&0<G.c.length&&
F.push(G);++k==p.i+p.n&&(x=null)}if(F){F.sort(function(a,c){return PData.strcmp(c.id,a.id)});var I=[];F.forEach(function(a){a.p&&a.p.forEach(function(c){k=_.sortedIndex(F,{id:c},"id");if(k<F.length){var h=F[k];h.id===c&&a.c.forEach(function(c){h.c.forEach(function(h){c[0]===h[0]&&c[1]===h[1]||I.push({p:[c,h],c:a.l})})})}})});I.forEach(function(a){f.addLayer(L.polyline(a.p,{color:a.c,weight:2}))})}};VizMap.prototype.teardown=function(){var a=this.vFrame.getIndex();jQuery("#view-frame-"+a+" div.view-controls div.iconbar").remove()};
...
VizCards.prototype.render=function(a){var c=this;this.stream=a;var d=PData.eTNum(),e,f,g,k,m,n,p,h,r,q,w,x,y,l,A=jQuery(this.frameID);A.empty();0<this.recSel.length&&(this.recSel=[]);this.preRender();var v,u="w"+this.settings.w+" h"+this.settings.h;f=a.t[0];for(e=0;e<d;){for(;0===f.n;){if(++e===d)return;f=a.t[e]}f=PData.eTByN(e);f=PData.tByID(f);n=c.vFrame.getSelFeatAtts(e);0!==n.length&&(A.append('<div class="template-label">'+f.l+'</div><div class="cards" data-ti="'+e+'"></div>'),v=jQuery('div.cards[data-ti="'+
e+'"]'),this.tUsed[e]=!0,g=c.vFrame.getSelLegend(e),k=PData.aByID(g),m=c.settings.iAtts[e],q=c.settings.cnt[e],f=c.sAtts[e],f=PData.aByID(f),f=PData.rTOrder(f,a,e),f.forEach(function(a){p=PData.rByN(a.i);w=p.a[g];"undefined"!==typeof w&&(h=PData.lRecs(w,k,n,!1))&&(c.rMap[a.i>>4]|=1<<(a.i&15),y=c.settings.lOn?'<div class="card-title">'+p.l+"</div>":"",r=!1,x="",q&&0<q.length&&(l=h.b?' style="color:black"':"",q.forEach(function(a){if(w=p.a[a])if(w=PData.procAttTxt(a,w))r=!0,x+=w+"<br/>"})),x=m&&(w=
p.a[m])?r?'<div class="card-body"><img src="'+w+'"/><div class="card-cnt"'+l+">"+x+"</div></div>":'<div class="card-body"><img class="full" src="'+w+'"/></div>':'<div class="card-body"><div class="card-cnt"'+l+">"+x+"</div>",v.append('<div class="card '+u+'" style="background-color:'+h.v+'" data-ai="'+a.i+'">'+y+x+"</div>"))}));f=a.t[++e]}};VizCards.prototype.teardown=function(){jQuery(this.frameID).off("click.vf")};
VizCards.prototype.rerender=function(a){var c=this,d=jQuery(this.frameID+' div.cards[data-ti="'+a+'"]');d.empty();var e,f,g,k,m,n,p,h,r,q,w,x,y,l="w"+this.settings.w+" h"+this.settings.h;e=c.vFrame.getSelFeatAtts(a);0!=e.length&&(f=c.vFrame.getSelLegend(a),g=PData.aByID(f),k=c.settings.iAtts[a],m=c.settings.cnt[a],n=c.sAtts[a],n=PData.aByID(n),a=PData.rTOrder(n,c.stream,a),a.forEach(function(a){p=PData.rByN(a.i);h=p.a[f];"undefined"!==typeof h&&(r=PData.lRecs(h,g,e,!1))&&(x=c.settings.lOn?'<div class="card-title">'+
p.l+"</div>":"",q=!1,w="",m&&0<m.length&&(y=r.b?' style="color:black"':"",m.forEach(function(a){if(h=p.a[a])if(h=PData.procAttTxt(a,h))q=!0,w+=h+"<br/>"})),w=k&&(h=p.a[k])?q?'<div class="card-body"><img src="'+h+'"/><div class="card-cnt"'+y+">"+w+"</div></div>":'<div class="card-body"><img class="full" src="'+h+'"/></div>':'<div class="card-body"><div class="card-cnt"'+y+">"+w+"</div>",d.append('<div class="card '+l+(c.isSel(a.i)?" obj-sel":"")+'" style="background-color:'+r.v+'" data-ai="'+a.i+'">'+
x+w+"</div>"))}))};VizCards.prototype.doOptions=function(){var a=this,c=jQuery("#dialog-sortby").dialog({height:220,width:400,modal:!0,buttons:[{text:dlText.ok,click:function(){c.dialog("close");PState.set(PSTATE_BUILD);for(var d=0;d<PData.eTNum();d++){var e=jQuery('#dialog-sortby select[data-ti="'+d+'"]').val();e!=a.sAtts[d]&&(a.sAtts[d]=e,a.rerender(d))}PState.set(PSTATE_READY)}},{text:dlText.cancel,click:function(){c.dialog("close")}}]})};
...
VizPinboard.prototype.render=function(a){var c=this;this.gRecs.selectAll(".recobj").remove();this.gRecs.selectAll(".recline").remove();0<this.recSel.length&&(this.recSel=[]);this.preRender();var d=PData.eTNum(),e,f,g=0,k,m,n,p,h,r,q,w,x,y,l,A,v,u,C,t;for(e=0;e<d;e++)if("disable"!==this.settings.pAtts[e]){t=[];break}A=this.settings.min;"string"===typeof A&&(A=parseInt(A));f=this.settings.max;"string"===typeof f&&(f=parseInt(f));v=f-A;var z=[];e=0;g=-1;a:for(;e<a.l;){if(null==r){do{if(++g===d)break a;
k=a.t[g]}while(0===k.n||k.i+k.n===e);r=this.vFrame.getSelLocAtts(g);if(0===r.length){r=null;continue}r=r[0];q=c.vFrame.getSelFeatAtts(g);if(0===q.length){r=null;continue}c.tUsed[g]=!0;p=c.vFrame.getSelLegend(g);h=PData.aByID(p);w=c.settings.pAtts[g];m=c.settings.lClrs[g];if(l=c.settings.sAtts[g])n=PData.aByID(l),"number"===typeof n.r.min&&"number"===typeof n.r.max?(u=n.r.min,C=n.r.max-u):l=null}f=a.s[e];n=PData.rByN(f);var B;t&&(B={id:n.id,c:null,p:n.a[w],l:m});x=n.a[r];"undefined"!==typeof x&&(y=
n.a[p],"undefined"!==typeof y&&(y=PData.lClr(y,h,q)))&&(c.rMap[f>>4]|=1<<(f&15),l?(n=n.a[l],n="number"===typeof n?Math.floor((n-u)*v/C)+A:A):n=A,z.push({ai:f,v:y,x:x[0],y:x[1],r:n}),B&&(B.c=x));B&&B.c&&t.push(B);++e==k.i+k.n&&(r=null)}this.gRecs.selectAll(".recobj").data(z).enter().append("circle").attr("class","recobj").attr("cx",function(a){return c.xScale(a.x)}).attr("cy",function(a){return c.yScale(a.y)}).attr("r",function(a){return c.yScale(a.r)}).style("fill",function(a){return a.v}).on("click",
function(a,h){var d=c.toggleSel(a.ai);d3.select(this).classed("obj-sel",d)});if(t){t.sort(function(a,c){return PData.strcmp(c.id,a.id)});var D=[];t.forEach(function(a){a.p&&a.p.forEach(function(c){e=_.sortedIndex(t,{id:c},"id");if(e<t.length){var h=t[e];h.id===c&&D.push({f:a.c,t:h.c,c:a.l})}})});this.gRecs.selectAll(".recline").data(D).enter().append("line").attr("class","recline").attr("x1",function(a){return c.xScale(a.f[0])}).attr("y1",function(a){return c.yScale(a.f[1])}).attr("x2",function(a){return c.xScale(a.t[0])}).attr("y2",
...
parseInt(f.bHt,10));(function(){var a,c,h,d,q,w;f.dAtts.forEach(function(e){null!=e&&"disable"!==e&&(e=PData.aByID(e))&&(null==a||e.r.min.y<a?(a=e.r.min.y,"undefined"!==typeof e.r.min.m?(c=e.r.min.m,h="undefined"!==typeof e.r.min.d?e.r.min.d:1):h=c=1):e.r.min.y===a&&"undefined"!==typeof e.r.min.m&&(e.r.min.m<c?(c=e.r.min.m,h="undefined"!==typeof e.r.min.d?e.r.min.d:1):e.r.min.m===c&&"undefined"!==typeof e.r.min.d&&e.r.min.d<h&&(h=e.r.min.d)),null==d?"undefined"===typeof e.r.max.y?(d=TODAY.getUTCFullYear(),
q=TODAY.getMonth()+1,w=TODAY.getDate()):(d=e.r.max.y,"undefined"!==typeof e.r.max.m?(q=e.r.max.m,w="undefined"!==typeof e.r.max.d?e.r.max.d:PData.lenMnth(d,q)):(q=12,w=31)):e.r.max.y>d?(d=e.r.max.y,"undefined"!==typeof e.r.max.m?(q=e.r.max.m,w="undefined"!==typeof e.r.max.d?e.r.max.d:PData.lenMnth(d,q)):(q=12,w=31)):e.r.max.y===d&&"undefined"!==typeof e.r.max.m&&(e.r.max.m>q?(q=e.r.max.m,w="undefined"!==typeof e.r.max.d?e.r.max.d:PData.lenMnth(d,q)):e.r.max.m===q&&"undefined"!==typeof e.r.max.d&&
e.r.max.d>w&&(w=e.r.max.d)))});e.minDate=0<f.from.length?PData.dStr(f.from,!1):PData.d3Nums(a,c,h,!1);e.maxDate=0<f.to.length?PData.dStr(f.to,!0):PData.d3Nums(d,q,w,!0);e.instGap=.015*(e.maxDate-e.minDate)})();var g=e.getWidths(),k=d3.select(this.frameID).append("svg").attr("class","tl-vf").attr("width",g[1]);(function(){var a=[];f.lgnds.forEach(function(c){c.forEach(function(c){a.push(c)})});var a=_.uniq(a),c=[];a.forEach(function(a){(a=PData.aByID(a))&&a.l.forEach(function(a){c.push(a.v)})});c=
...
VizTime.prototype.render=function(a){function c(a,c){var h=a.s-c.s;if(0>h)return 1;if(0<h)return-1;h=c.e-a.e;return 0>h?1:0<h?-1:0}function d(a){function c(a){a=g.toggleSel(a.ai);d3.select(this).classed("obj-sel",a)}var h,d,e,f,x=g.bands[a];a?(h=g.bands[0],x.t=h.t+h.h+37,h=d=e=g.instRad,f=2*g.instRad+3):(x.t=0,h=d=e=1);x.h=m*x.tHt+2;x.g.attr("transform","translate(0,"+x.t+")").attr("height",x.h);var k,l;a&&(k=.75*x.iHt+"px",l=.8*x.iHt);var A;A=d3.select(x.svgID).selectAll(".lgBd").remove();A=d3.select(x.svgID).selectAll(".lgBd").data(g.lgBds).enter().append("svg").attr("class",
"lgBd").attr("y",function(a){return x.yScale(a.t)}).attr("height",function(a){return x.yScale(a.h)});A.append("rect").attr("width","100%").attr("height","100%").attr("fill",function(a){return a.d.v});1===a&&A.append("text").attr("class","lgBdLbl").attr("x",2).attr("y",l).attr("fill",function(a){return a.d.b?"#000000":"#FFFFFF"}).style("font-size",k).text(function(a){return a.d.l});var v;d3.select(x.svgID).selectAll(".event").remove();v=d3.select(x.svgID).selectAll(".event").data(g.events).enter().append("svg").attr("class",
function(a){return a.f&EVENT_INSTANT?"event instant":"event range"}).attr("y",function(a){return x.yScale(a.t)}).attr("height",x.iHt);if(1===a)v.on("click",c);var u=d3.select(x.svgID).selectAll(".range");u.append("rect").attr("width","100%").attr("height","100%").attr("fill",function(c){return 1===a&&c.f&(EVENT_F_START|EVENT_F_END)?(c.f&(EVENT_F_START|EVENT_F_END))===(EVENT_F_START|EVENT_F_END)?"url("+c.c.v+"-fb)":(c.f&EVENT_F_START)===EVENT_F_START?"url("+c.c.v+"-fs)":"url("+c.c.v+"-fe)":c.c.v});
1===a&&u.append("text").attr("class","rangeLbl").attr("x",4).attr("y",l).attr("fill",function(a){return a.c.b?"#000000":"#FFFFFF"}).style("font-size",k).text(function(a){return a.l});u=d3.select(x.svgID).selectAll(".instant");u.append("circle").attr("cx",h).attr("cy",d).attr("r",e).attr("fill",function(a){return a.c.v});1===a&&u.append("text").attr("class","instantLbl").attr("x",f).attr("y",l).style("font-size",k).text(function(a){return a.l});x.redraw=function(){A.attr("x",function(a){return x.xScale(a.s)}).attr("width",
function(a){return x.xScale(a.e)-x.xScale(a.s)});v.attr("x",function(a){return x.xScale(a.s)}).attr("width",function(a){return x.xScale(a.e)-x.xScale(a.s)});x.parts.forEach(function(a){a.redraw()})}}function e(a){a=g.bands[a];d3.select(a.svgID).selectAll(".axis").attr("transform","translate(0,"+a.h+")")}function f(a){a=g.bands[a];d3.select(a.svgID).selectAll(".bLblCntr").attr("transform","translate(0,"+(a.h+1).toString()+")")}var g=this,k=this.vFrame.getIndex();0<this.recSel.length&&(this.recSel=
[]);this.preRender();this.events=[];this.lgBds=[];var m=0;(function(){for(var d=PData.eTNum(),e=0,h,r,q,f,k,y,l,A;e<d;){for(h=a.t[e];0===h.n;){if(++e==d)return;h=a.t[e]}q=g.vFrame.getSelLocAtts(e);if(0!==q.length&&(q=g.vFrame.getSelFeatAtts(e),0!==q.length)){g.tUsed[e]=!0;A=g.vFrame.getSelLegend(e);l=PData.aByID(A);f=g.settings.dAtts[e];for(var v,u,C,t,z,B,D,E,F=[],G=h.i;G<h.i+h.n;G++)r=a.s[G],E=PData.rByN(r),k=E.a[A],"undefined"!==typeof k&&(k=PData.lRecs(k,l,q,!1))&&(y=E.a[f])&&"?"!==y&&(g.rMap[r>>
4]|=1<<(r&15),B=y.min.f?EVENT_F_START:0,v=y.min.y,"undefined"===typeof y.min.m?C=u=1:(u=y.min.m,C="undefined"===typeof y.min.d?1:y.min.d),t=PData.d3Nums(v,u,C,!1),"undefined"===typeof y.max?(B|=EVENT_INSTANT,z=t.getTime()+g.instGap):"open"===y.max?z=TODAY:(y.max.f&&(B|=EVENT_F_END),v=y.max.y,"undefined"===typeof y.max.m?(u=12,C=31):(u=y.max.m,C="undefined"===typeof y.max.d?PData.lenMnth(v,u):y.max.d),z=PData.d3Nums(v,u,C,!0)),F.push({s:t,e:z,ai:r,f:B,c:k,l:E.l,t:0}));F.sort(c);var I=[],K;F.forEach(function(a){for(K=
0;K<I.length&&!(a.e<I[K]);K++);a.t=K+m+1;I[K]=a.s});h=PData.aByID(f);h.l.forEach(function(a){D=a.d;v=D.min.y;"undefined"===typeof D.min.m?C=u=1:(u=D.min.m,C="undefined"===typeof D.min.d?1:D.min.d);t=PData.d3Nums(v,u,C,!1);"undefined"===typeof D.max.y?z=TODAY:(v=D.max.y,"undefined"===typeof D.max.m?(u=12,C=31):(u=D.max.m,C="undefined"===typeof D.max.d?PData.lenMnth(v,u):D.max.d),z=PData.d3Nums(v,u,C,!0));g.lgBds.push({s:t,e:z,t:m,h:I.length+1,d:a})});m+=I.length+1;g.events=g.events.concat(F)}e++}})();
...
VizTextStream.prototype.render=function(a){var c=this,d=PData.eTNum(),e=0,f,g,k,m,n,p,h,r,q,w,x,y,l,A,v,u,C,t=jQuery(this.frameID);t.empty();0<this.recSel.length&&(this.recSel=[]);this.preRender();u=this.settings.max-this.settings.min;for(g=a.t[0];e<d;){for(;0===g.n;){if(++e===d)return;g=a.t[e]}q=c.vFrame.getSelLocAtts(e);if(0!==q.length&&(q=c.vFrame.getSelFeatAtts(e),0!==q.length)){c.tUsed[e]=!0;w=c.vFrame.getSelLegend(e);x=PData.aByID(w);t.append('<div class="viz-textstream" data-ti='+e+"></div>");
k=t.find("div.viz-textstream[data-ti="+e+"]");f=PData.eTByN(e);f=PData.tByID(f);k.append('<div class="template-label">'+f.l+"</div>");r=c.settings.cnt[e];if(A=c.settings.sAtts[e])l=PData.aByID(A),"number"===typeof l.r.min&&"number"===typeof l.r.max?v=l.r.max-l.r.min:A=null;r&&(f=PData.aByID(c.settings.order[e]),f=PData.rTOrder(f,a,e),f.forEach(function(a){m=PData.rByN(a.i);n=m.a[w];"undefined"!==typeof n&&(y=PData.lRecs(n,x,q,!1))&&((p=m.a[r])&&(p=PData.procAttTxt(r,p)),p&&(c.rMap[a.i>>4]|=1<<(a.i&
15),A?(h=m.a[A],h="number"===typeof h?Math.floor((h-l.r.min)*u/v)+c.settings.min:c.settings.min):h=c.settings.min,C=y.b?";background-color:black":"",k.append('<div class="recitem" data-ai='+a.i+' style="color:'+y.v+C+";font-size:"+h+'px">'+p+"</div>")))}))}e++}};VizTextStream.prototype.teardown=function(){jQuery(this.frameID).off("click.vf")};
...
p=0;p<g.c.length;p++){for(var h=0,m=0;m<a.c.length;m++)0<k[m][p].length&&h++;n[p]=h-1}for(var r=Array(g.c.length),p=0;p<g.c.length;p++)r[p]=0;var q=0;a.c.forEach(function(h,f){for(var y=0,l=0;l<g.c.length;l++)0<k[f][l].length&&y++;--y;var m=h.i.length*d/a.t,p=0,u=0;g.c.forEach(function(l,t){var z=k[f][t];if(0<z.length){var B=z.length*d,D=B/a.t,B=B/g.t,E=l.i.length*d/g.t;c.ints.push({i:z,c:h.c,l:h.l+" > "+l.l,x1:5+q*d/a.t+(y?(m-D)*p/y:0),x2:5+u*d/g.t+(n[t]?(E-B)*r[t]/n[t]:0),w1:D,w2:B,y1:a.y+10,y2:g.y-
1});p++;r[t]++}u+=l.i.length});q+=h.i.length})}});this.flowG.selectAll(".flow").data(c.ints).enter().append("path").attr("class","flow").attr("d",function(a){return"M "+a.x1+" "+a.y1+"  L "+(a.x1+a.w1)+" "+a.y1+" L "+(a.x2+a.w2)+" "+a.y2+" L "+a.x2+" "+a.y2+" L "+a.x1+" "+a.y1}).attr("fill",function(a){return a.c}).on("click",function(a,d){var g=c.fSel.length,k=_.sortedIndex(c.fSel,d);c.fSel[k]===d?(d3.select(this).classed("obj-sel",!1),c.fSel.splice(k,1),0<g&&0===c.fSel.length&&0===c.bSel.length&&
...
VizMBMap.prototype.renderTree=function(a){function c(){var a=0,c=d.settings.w,g=null!==d.sbkSel?d.sbkSel.i:d.bkSel.i;PState.set(PSTATE_UPDATE);d.fcts.forEach(function(k,m){var n=[],p=0;k.c.forEach(function(a){a=PData.intersect(g,a.i);n.push(a);p+=a.length});var h=0,r;n.forEach(function(q){r=d.bars[a++];r.x=p?h*c/p:0;r.w=p?q.length*c/p:0;h+=q.length})});d.attsG.selectAll(".bar").transition().attr("x",function(a){return a.x}).attr("width",function(a){return a.w});PState.set(PSTATE_READY)}var d=this;
...
PFilterNum.prototype.evalBoxes=function(a){function c(c,k){function h(){r=!0;a.find(c).addClass("error")}var r=!1,q,w=a.find(c).val();(w=e.exec(w))?(a.find(c).removeClass("error"),q=parseInt(w[1],10)):h();r||(0==k?null!==f&&q<f&&h():null!==g&&q>g&&h());d.uNums[k]=q;return r}var d=this,e=/^(\d+)$/,f="undefined"===typeof this.att.r.min?null:this.att.r.min,g="undefined"===typeof this.att.r.max?null:this.att.r.max,k,m;k=c(".from",0);m=c(".to",1);this.uNums[0]>this.uNums[1]&&(m=!0);a.find(".filter-update").prop("disabled",
...
PFilterDates.prototype.evalBoxes=function(a){function c(c,g){function k(d){r=!0;a.find(c+d).addClass("error")}function h(d){a.find(c+d).removeClass("error")}var r=!1,q={y:0,m:0,d:0,ms:null},w=a.find(c+"-y"),w=w.val();(w=e.exec(w))?(h("-y"),q.y=parseInt(w[1],10)):k("-y");w=a.find(c+"-m");w=w.val();(w=f.exec(w))?(q.m=parseInt(w[1],10),1>q.m||12<q.m?k("-m"):h("-m")):k("-m");w=a.find(c+"-d");w=w.val();(w=f.exec(w))?(q.d=parseInt(w[1],10),1>q.d||31<q.d?k("-d"):h("-d")):k("-d");r||(q.ms=PData.d3Nums(q.y,
q.m,q.d,!1),0==g?q.ms<d.rCats[0].min&&(k("-y"),k("-m"),k("-d")):q.ms>d.rCats[d.rCats.length-1].max&&(k("-y"),k("-m"),k("-d")));d.uDates[g]=q;return r}var d=this,e=/^(-?\d+)$/,f=/^(\d{1,2})$/,g,k;g=c(".from",0);k=c(".to",1);this.uDates[0].ms>this.uDates[1].ms&&(k=!0);a.find(".filter-update").prop("disabled",g||k);return!(g||k)};
...
!1}},onReady:function(){widgetData.extract&&widgetData.widget.cueVideoById({videoId:widgetData.ytCode,startSeconds:widgetData.sTime/1E3,endSeconds:widgetData.eTime/1E3})}}})}function q(){widgetData.playing=!0}function r(){widgetData.playing=!1}function g(){widgetData.playing&&widgetData.xscriptOn&&f(1E3*widgetData.widget.currentTime)}function w(){switch(n){case 3:null!=widgetData.widget&&(widgetData.widget.removeEventListener("ended",r),widgetData.widget.removeEventListener("pause",r),widgetData.widget.removeEventListener("playing",
q),widgetData.widget.removeEventListener("timeupdate",g));case 1:null!=widgetData.widget&&widgetData.playing&&widgetData.widget.pause();widgetData.playing=!1;widgetData.widget=null;break;case 2:widgetData.ytCall=null,null!=widgetData.widget&&widgetData.playing&&widgetData.widget.stopVideo(),widgetData.widget=null,widgetData.playing=!1,null!=widgetData.timer&&(window.clearInterval(widgetData.timer),widgetData.timer=null)}}function x(){function a(){widgetData.sTime=widgetData.eTime=null;var c;(c=prspdata.e.i.t.tcAtts[w])&&
(c=H.a[c])&&""!==c&&(widgetData.extract=c,c=c.split("-"),widgetData.sTime=d(c[0]),widgetData.eTime=d(c[1]))}var c=J[M];H=PData.rByN(c);var h=" "+H.l+" ("+(M+1)+"/"+J.length+") ",k=jQuery("#inspect-name");k.text(h);k.prop("title",H.id);var w=PData.n2T(c);u.empty();t=null;n=0;widgetData.extract=null;widgetData.xscriptOn=!1;widgetData.playing=!1;if(prspdata.e.i.modal.scOn||"boolean"===typeof prspdata.e.i.modal.aOn&&prspdata.e.i.modal.aOn)if(t=prspdata.e.i.sc.atts[w])if(h=H.a[t])if(a(),h.match(/soundcloud\.com/)){var y=
!0;n=1;u.append('<iframe id="sc-widget" class="player" width="100%" height="110" src="http://w.soundcloud.com/player/?url='+h+'"></iframe>');var z=SC.Widget(document.getElementById("sc-widget"));widgetData.widget=z;z.bind(SC.Widget.Events.READY,function(){z.play();z.bind(SC.Widget.Events.PLAY,function(){widgetData.playing=!0});z.bind(SC.Widget.Events.PAUSE,function(){widgetData.playing=!1});z.bind(SC.Widget.Events.PLAY_PROGRESS,function(a){y&&(z.pause(),y=!1,widgetData.playing=!1);widgetData.extract&&
(a.currentPosition<widgetData.sTime?z.seekTo(widgetData.sTime):a.currentPosition>widgetData.eTime&&(z.pause(),widgetData.playing=!1));widgetData.playing&&widgetData.xscriptOn&&f(a.currentPosition)});z.bind(SC.Widget.Events.FINISH,function(){widgetData.playing=!1})})}else n=3,widgetData.extract&&(k=widgetData.extract.split("-"),h+="#t="+k[0]+","+k[1]),u.append('<audio id="na-widget" controls src="'+h+'"></audio>'),widgetData.widget=document.getElementById("na-widget"),widgetData.widget.addEventListener("ended",
r),widgetData.widget.addEventListener("pause",r),widgetData.widget.addEventListener("playing",q),widgetData.widget.addEventListener("timeupdate",g);0===n&&prspdata.e.i.modal.ytOn&&(t=prspdata.e.i.yt.atts[w])&&(h=H.a[t])&&(a(),widgetData.ytCode=h,u.append('<div id="yt-widget"></div>'),widgetData.ytCall=l,widgetData.ytLoaded?l():(widgetData.ytLoaded=!0,h=document.createElement("script"),h.src="https://www.youtube.com/iframe_api",k=document.getElementsByTagName("script")[0],k.parentNode.insertBefore(h,
k)),n=2);prspdata.e.i.modal.tOn&&(h=prspdata.e.i.t.t1Atts[w])&&""!==h&&"disable"!==h&&(h=H.a[h],"string"===typeof h&&""!==h&&(0<n&&u.append("<div>"+document.getElementById("dltext-sync-xscript").innerHTML+"</div>"),u.find("#xscript-tbl").remove(),u.append('<div id="xscript-tbl"><div>'),widgetData.xscriptOn=!0,jQuery("#xscript-tbl").click(function(a){if(n&&jQuery(a.target).hasClass("timecode"))switch(a=jQuery(a.target).data("timecode"),n){case 1:widgetData.playing||(widgetData.playing=!0,widgetData.widget.play());
widgetData.widget.seekTo(a);break;case 2:widgetData.playing||(widgetData.playing=!0,widgetData.widget.playVideo());widgetData.widget.seekTo(a/1E3);break;case 3:widgetData.playing||(widgetData.playing=!0,widgetData.widget.play()),widgetData.widget.currentTime=a/1E3}}),C=null,(k=prspdata.e.i.t.t2Atts[w])&&""!==k&&"disable"!==k&&(C=H.a[k]),jQuery.ajax({type:"POST",url:prspdata.ajax_url,data:{action:"prsp_get_transcript",transcript:h,excerpt:widgetData.extract},success:function(a,c,d){e(JSON.parse(a))},
error:function(a,c,d){alert(d)}})));prspdata.e.i.modal.atts[w].forEach(function(a){var d=PData.rAV(c,a,!1);if(d){a=PData.aByID(a);var h;"_"==a.def.l.charAt(0)?h="<div>"+d+"</div>":(h='<div><span class="att-label">'+a.def.l+":</span> ","I"==a.def.t&&(h+="<br/>"),h+=d+"</div>");u.append(h)}})}function y(a){a=M+a;-1==a?a=J.length-1:a==J.length&&(a=0);a!=M&&(M=a,w(),x())}function m(a){y(-1)}function A(a){y(1)}var u=jQuery("#inspect-content"),t=null,n=0,C,p=450,N=400,J=null;v&&(J=v.getSel());if(null!=
J&&0!=J.length){var O,H,M=0;prspdata.e.i.modal.scOn&&(p=550);prspdata.e.i.modal.ytOn&&(p=Math.max(p,475),N=500);prspdata.e.i.modal.tOn&&(N+=100,prspdata.e.i.modal.t2On?(p=Math.max(750,Math.floor(.8*jQuery(document).width())),p=Math.min(900,p)):p=Math.max(p,550));"number"===typeof prspdata.e.i.modal.w&&(p=prspdata.e.i.modal.w);"number"===typeof prspdata.e.i.modal.h&&(N=prspdata.e.i.modal.h);k(!1);x();jQuery("#btn-inspect-left").click(m);jQuery("#btn-inspect-right").click(A);O=jQuery("#dialog-inspector").dialog({width:p,
height:N,modal:!0,buttons:[{text:dlText.seerec,click:function(){window.open(prspdata.site_url+"?p="+H.wp,"_blank")}},{text:dlText.close,click:function(){O.dialog("close")}}]});O.on("dialogclose",function(a,c){w();jQuery("#btn-inspect-left").off("click");jQuery("#btn-inspect-right").off("click");k(!0)});a.preventDefault()}}function k(a){var c=jQuery(d()+" div.view-controls");a?(c.find(".osel").button("enable"),c.find(".osel").addClass("pulse"),c.find(".xsel").button("enable")):(c.find(".osel").button("disable"),
c.find(".osel").removeClass("pulse"),c.find(".xsel").button("disable"))}function m(c){jQuery("body").trigger("prospect",{s:PSTATE_HILITE,v:a,t:v.tUsed});c.preventDefault()}function n(a){PState.set(PSTATE_UPDATE);v&&v.clearSel();k(!1);PState.set(PSTATE_READY);a.preventDefault()}function p(a){v&&v.doOptions();a.preventDefault()}function h(a){var c=jQuery("#dialog-vnotes").dialog({width:300,height:300,modal:!0,buttons:[{text:dlText.ok,click:function(){c.dialog("close")}}]});a.preventDefault()}function r(a,
h){jQuery(d()+' div.lgnd-container div.lgnd-scroll div.lgnd-template[data-index="'+a+'"] div.lgnd-group input.lgnd-entry-check').prop("checked",h);c(!0)}function q(a){var h=jQuery(a.target).closest("div.lgnd-template").data("index"),e=a.target.className;switch(e){case "lgnd-update":v&&t&&(PState.set(PSTATE_BUILD),k(!1),v.render(t),c(!1),PState.set(PSTATE_READY));break;case "lgnd-entry-check":e=jQuery(a.target).closest("div.lgnd-entry");a=jQuery(a.target).is(":checked");e.hasClass("lgnd-sh")?r(h,a):
e.hasClass("lgnd-locate")?(e.data("id"),c(!0)):e.hasClass("lgnd-value")&&(e.data("index"),c(!0));break;case "lgnd-viz":case "lgnd-value-title":e=jQuery(a.target).closest("div.lgnd-entry");e.hasClass("lgnd-locate")?(a=e.data("id"),jQuery(d()+' div.lgnd-container div.lgnd-scroll div.lgnd-template[data-index="'+h+'"] div.lgnd-locate input.lgnd-entry-check').prop("checked",!1),jQuery(d()+' div.lgnd-container div.lgnd-scroll div.lgnd-template[data-index="'+h+'"] div.lgnd-locate[data-id="'+a+'"] input.lgnd-entry-check').prop("checked",
!0),c(!0)):e.hasClass("lgnd-value")&&(a=e.data("index"),jQuery(d()+' div.lgnd-container div.lgnd-scroll div.lgnd-template[data-index="'+h+'"] div.lgnd-group input.lgnd-entry-check').prop("checked",!1),jQuery(d()+' div.lgnd-container div.lgnd-scroll div.lgnd-template[data-index="'+h+'"] div.lgnd-group div.lgnd-value[data-index="'+a+'"] input.lgnd-entry-check').prop("checked",!0),c(!0));break;case "lgnd-template":case "lgnd-select":case "":break;default:e.match(/lgnd-sh/i)&&(e=jQuery(a.target).find("input.lgnd-entry-check"),
a=!e.is(":checked"),e.prop("checked",a),r(h,a))}}function w(a){var d=jQuery(a.target).closest("div.lgnd-template").data("index");a=jQuery(a.target).val();x(d,a);c(!0)}function x(a,c){var h,e=jQuery(d()+' div.lgnd-container div.lgnd-scroll div.lgnd-template[data-index="'+a+'"] div.lgnd-group');e.empty();u[a]=c;var f=PData.aByID(c);"undefined"!==typeof f.r.u&&(h='<div class="lgnd-value lgnd-entry" data-index="-1"><input type="checkbox" checked="checked" class="lgnd-entry-check"/><div class="lgnd-viz" style="background-color: '+
...
u=[];if(g&V_FLAG_LGND){q.find(".hslgnd").button("enable");var y=q.find("div.lgnd-container div.lgnd-scroll");y.empty();if(g&V_FLAG_SLGND){var m=r.getFeatureAtts(),P=PData.aByID(m);y.append('<div class="lgnd-template" data-index="0"><div class="lgnd-title">'+P.def.l+'</div><div class="lgnd-entry lgnd-sh"><input type="checkbox" checked="checked" class="lgnd-entry-check"/><i>'+dlText.sha+'</i></div><div class="lgnd-group"></div></div>');u.push(m);x(0,m)}else{var n=!1;prspdata.e.g.ts.forEach(function(a,
...
e.forEach(function(a,c){var d=PData.aByID(a);q+='<option value="'+a+'">'+d.def.l+"</option>"});q+="</select>";d=jQuery(q);d.change(w);jQuery(f).append(d);jQuery(f).append('<div class="lgnd-entry lgnd-sh"><input type="checkbox" checked="checked" class="lgnd-entry-check"/><i>'+dlText.sha+'</i></div><div class="lgnd-group"></div>');y.append(f);e=e[0];u.push(e);x(c,e);n=!0}}})}q.find("div.lgnd-container").show()}else q.find("button.hslgnd").button("disable"),q.find("div.lgnd-container").hide();c(!1);
...
r.setup();k(!1);t&&e&&r.render(t);v=r}var l={},A=0,v=null,u=[],C=null,t=null;l.getFrameID=d;l.getIndex=function(){return a};l.setViz=function(a,c){a!=A&&(jQuery(d()+" div.view-controls select.view-viz-select").val(a),y(a,c))};l.initDOM=function(c){var r=document.getElementById("dltext-view-controls").innerHTML;jQuery("#viz-frame").append('<div id="view-frame-'+a+'">'+r+"</div>");var r=jQuery(d()),l=prspdata.bClrs.vf;l&&0<l.length&&r.find("div.view-controls").css("background-color",l);r.find("div.lgnd-container").draggable({handle:r.find("div.lgnd-handle"),
containment:"parent"});var k=r.find("div.view-controls select.view-viz-select");prspdata.e.vf.forEach(function(a,c){k.append('<option value="'+c+'">'+a.l+"</option>")});k.val(c);k.change(e);r.find("div.view-controls button:first").button({icons:{primary:"ui-icon-bookmark"},text:!1}).click(f).next().button({icons:{primary:"ui-icon-wrench"},text:!1}).click(p).next().button({icons:{primary:"ui-icon-info"},text:!1}).click(h).next().button({icons:{primary:"ui-icon-star"},text:!1}).click(m).next().button({icons:{primary:"ui-icon-cancel"},
text:!1}).click(n).next().button({icons:{primary:"ui-icon-search"},text:!1}).click(g).next();r.find("div.lgnd-container").click(q);y(c,!1)};l.getSelLocAtts=function(a){var c=[];jQuery(d()+' div.lgnd-container div.lgnd-scroll div.lgnd-template[data-index="'+a+'"] div.lgnd-locate input:checked').each(function(){var a=jQuery(this).parent().data("id");c.push(a)});return c};l.getSelFeatAtts=function(a){var c=[],h,e;jQuery(d()+' div.lgnd-container div.lgnd-scroll div.lgnd-template[data-index="'+a+'"] div.lgnd-group div.lgnd-value input:checked').each(function(){h=
jQuery(this).parent().data("index");"number"==typeof h?c.push(h):-1!=(e=h.indexOf(","))?c.push([parseInt(h.substring(0,e),10),parseInt(h.substring(e+1),10)]):c.push(parseInt(h,10))});return c};l.getSelLegend=function(a){return u[a]};l.getLgndSels=function(){return u.slice(0)};l.setLgndSels=function(a){a.forEach(function(a,c){jQuery(d()+' div.lgnd-container div.lgnd-scroll div.lgnd-template[data-index="'+c+'"] select.lgnd-select').val(a);x(c,a)})};l.getState=function(){return v?v.getState():null};
l.setState=function(a){v&&v.setState(a)};l.showStream=function(a){t=a;v&&v.render(a);c(!1)};l.setStream=function(a){t=a};l.selBtns=function(a){k(a)};l.clearSel=function(){v&&v.clearSel();k(!1)};l.setSel=function(a){return v&&v.flags()&V_FLAG_SEL?(v.setSel(a),k(0<a.length),!0):!1};l.resize=function(){v&&v.resize()};l.title=function(){return PData.vByN(A).l};l.flushLgnd=function(){jQuery(d()).find("div.lgnd-container").css("left","10px")};l.getBMData=function(){return v?{t:v.tUsed,r:v.rMap}:null};return l}
var PData=function(){function a(a,d,e){jQuery.ajax({type:"POST",url:prspdata.ajax_url,data:{action:"prsp_get_records",tmplt_id:prspdata.t[a].id,from:d,count:e},success:function(d,f,r){f=m[a];d=JSON.parse(d);f.d=f.d?f.d.concat(d):d;f.n+=e;c()},error:function(a,c,d){alert(d)}})}function c(){for(var c=!0,e=0;e<prspdata.t.length;e++){var f=m[e].n,g=prspdata.t[e].n;if(f<g){c=!1;g-=f;a(e,f,g<d?g:d);break}}c&&(p=!0,setTimeout(function(){jQuery("body").trigger("prospect",{s:PSTATE_PROCESS})},500))}var d=
...
c:f,i:[]}):e.push({l:d.l,c:f})})}),e;case "N":if("undefined"===typeof a.r.min||"undefined"===typeof a.r.max)return null;d&&"undefined"!==typeof a.r.u&&(c?e.push({l:"?",c:a.r.u.v,min:"?",max:"?",i:[]}):e.push({l:"?",c:a.r.u.v,min:"?",max:"?"}));var f=Math.pow(10,a.r.g),g=a.r.min,l=0,k,m,u;for(0<a.l.length&&(k=a.l[0]);g<=a.r.max;){for(;l<a.l.length&&"undefined"!==typeof k.d.max&&g>k.d.max;)k=a.l[++l];u=0==a.l.length||g<k.d.min?"#777777":l===a.l.length?"#777777":"undefined"===typeof k.d.max||g<=k.d.max?
k.v:"#777777";m=g;g+=f;max=g-1;max>a.r.max&&(max=a.r.max);var n=m.toString();1<f&&4>n.length&&m!==max&&(n+="-"+max.toString());c?e.push({l:n,c:u,min:m,max:max,i:[]}):e.push({l:n,c:u,min:m,max:max})}return e;case "D":g=function(a){var c,d;if("undefined"===typeof a.y)return TODAY;c=a.y;"undefined"===typeof a.m?(d=12,a=31):(d=a.m,a="undefined"===typeof a.d?PData.lenMnth(c,d):a.d);return PData.d3Nums(c,d,a,!1)};m=function(a,c,d,e){"undefined"!==typeof e.m&&(c=e.m,"undefined"!==typeof e.d&&(d=e.d));return PData.d3Nums(a,
c,d,!1)};u=g(a.r.max);var f=a.r.g,n=a.r.min.y,t=1,p=1;"undefined"!==typeof a.r.min.m&&(t=a.r.min.m,"undefined"!==typeof a.r.min.d&&(p=a.r.min.d));var B=PData.d3Nums(n,t,p,!1),l=0,D,E;0<a.l.length&&(k=a.l[0],D=m(k.d.min.y,1,1,k.d.min),E=g(k.d.max));for(d&&"undefined"!==typeof a.r.u&&(c?e.push({l:"?",c:a.r.u.v,min:"?",max:"?",i:[]}):e.push({l:"?",c:a.r.u.v,min:"?",max:"?"}));B<=u;){d={};c&&(d.i=[]);switch(f){case "d":d.l=n.toString()+"-"+t.toString()+"-"+p.toString();break;case "m":d.l=n.toString()+
"-"+t.toString();break;case "y":case "t":case "c":d.l=n.toString()}for(;l<a.l.length&&B>E;)k=a.l[++l],l<a.l.length&&(D=m(k.d.min.y,1,1,k.d.min),E=g(k.d.max));d.c=0==a.l.length||B<D?"#777777":l==a.l.length?"#777777":B<=E?k.v:"#777777";d.min=B;switch(f){case "d":++p>PData.lenMnth(n,t)&&(p=1,12<++t&&(t=1,n++));break;case "m":12<++t&&(t=1,n++);break;case "y":n++;break;case "t":n+=10;break;case "c":n+=100}B=PData.d3Nums(n,t,p,!1);B>TODAY&&(B=TODAY);B.setTime(B.getTime()+10);d.max=B;e.push(d);B=PData.d3Nums(n,
t,p,!1)}return e}},cFill:function(a,c,d,e){var f=PData.eTNum(),g=0,l,k=0,m,n,p,t,z=PData.aByID(c);for(l=e.t[0];k<e.l;){for(;0==l.n||l.i+l.n==k||!PData.aInT(c,g)||d&&!PData.aInT(d,g);){if(++g==f)return;l=e.t[g];k=l.i}m=e.s[k];n=PData.rByN(m);n=n.a[c];if("undefined"!==typeof n)switch(z.def.t){case "T":for(p=0;p<a.length;p++)if(t=a[p],-1!==n.indexOf(t.x)){t.i.push(m);break}break;case "g":n.forEach(function(c){for(p=0;p<a.length;p++)if(t=a[p],c===t.l){t.i.push(m);break}p===a.length&&a.push({l:c,i:[m],
c:"#"+Math.floor(16777215*Math.random()).toString(16)})});break;case "V":n.forEach(function(c){for(p=0;p<a.length;p++)if(t=a[p],c==t.l){t.i.push(m);break}});break;case "N":p=0;t=a[0];if("?"===t.min){if("?"===n){t.i.push(m);break}p=1}if("?"===n)break;for(;p<a.length;p++){t=a[p];if(n<t.min)break;if(t.min<=n&&n<=t.max){t.i.push(m);break}}break;case "D":p=0;t=a[0];if("?"===t.min){if("?"===n){t.i.push(m);break}p=1}if("?"!==n)for(n=PData.dObj(n.min,1,!1);p<a.length;p++){t=a[p];if(n<t.min)break;if(t.min<=
n&&n<t.max){t.i.push(m);break}}}k++}"g"==z.def.t&&a.sort(function(a,c){return PData.strcmp(c.l,a.l)})},cSort:function(a,c,d){var e=c.id,f,g,l;a.forEach(function(a){f=PData.rByN(a);datum=f.a[e];if("undefined"!==typeof datum)switch(c.def.t){case "T":for(g=0;g<d.length;g++)if(l=d[g],-1!==datum.indexOf(l.x)){l.i.push(a);break}break;case "g":datum.forEach(function(c){for(g=0;g<d.length;g++)if(l=d[g],c===l.l){l.i.push(a);break}g===d.length&&d.push({l:c,i:[a],c:"#777777"})});break;case "V":datum.forEach(function(c){for(g=
...
c){return PData.strcmp(c.l,a.l)})},rTOrder:function(a,c,d){function e(a){return a}function f(a){return a[0]}function g(a){if("?"===a)return"?";var c=1,d=1;"undefined"!==typeof a.min.m&&(c=a.min.m,"undefined"!==typeof a.min.d&&(d=a.min.d));return PData.d3Nums(a.min.y,c,d,!1)}var l,k;switch(a.def.t){case "T":l=e;k="~";break;case "V":l=f;k="~";break;case "g":l=f;k="~";break;case "N":l=e;k=a.r.max;break;case "D":l=g,k=TODAY}var n=[],p=c.t[d];d=m[d];for(var C=0,t,z;C<p.n;)t=c.s[p.i+C++],z=d.d[t-d.i],z=
z.a[a.id],"undefined"===typeof z?n.push({i:t,v:k}):n.push({i:t,v:l(z)});switch(a.def.t){case "T":case "g":case "V":n.sort(function(a,c){return PData.strcmp(c.v,a.v)});break;case "D":case "N":n.sort(function(a,c){return"?"===a.v?-1:"?"===c.v?1:a.v-c.v})}return n},vByN:function(a){return prspdata.e.vf[a]},ready:function(){return p}}}();
jQuery(document).ready(function(a){function c(){var a;PState.set(PSTATE_PROCESS);null==t&&(t=PData.sNew(!0));z=t;var c=!1,d,e;for(d=0;d<v.length;d++)if(e=v[d],a=jQuery('div.filter-instance[data-id="'+e.id+'"]'),c||e.f.isDirty(null)){c=!0;e=e.f;e.evalPrep();for(var f=PData.sNew(!1),g=0,h,k,m=0,n=z.t[0],p=0,q=0,r=a.find(".apply-tmplt-0").is(":checked");g<z.l;){for(;0==n.n||n.i+n.n==g;)f.t.push({i:f.l-p,n:p}),p=0,n=z.t[++m],r=a.find(".apply-tmplt-"+m).is(":checked");h=z.s[g++];r?(k=PData.rByN(h),e.eval(k)&&
(f.s[f.l++]=h,p++),q++):(f.s[f.l++]=h,p++)}for(;m++<PData.eTNum();)f.t.push({i:f.l-p,n:p}),p=0;e.isDirty(!1);e.out=f;e.evalDone(q);z=f}else z=e.f.out;PState.set(PSTATE_BUILD);l.forEach(function(a){a&&a.showStream(z)});0<v.length?jQuery("#btn-f-state").prop("disabled",!0).html(dlText.filtered):jQuery("#btn-f-state").prop("disabled",!0).html(dlText.nofilter)}function d(a){var c=jQuery("#annote");c.text(a);0<a.length?(jQuery("#btn-annote").button("enable"),c.show()):(jQuery("#btn-annote").button("disable"),
c.hide())}function e(a){var c=_.find(prspdata.p,function(c){return a==c.id});return c?c:null==B||0==D.length?null:(c=_.find(D,function(c){return a==c.id}))?c:null}function f(a,c){var d=jQuery("input[name=save-prspctv-dest]:checked").val();if(""==d)return null;var e=jQuery("#save-prspctv-note").val(),e=e.replace(/"/,""),f={f:[],h0:null,h1:null,v0:null,v1:null};l.forEach(function(a,c){a&&(f["v"+c]={l:a.title(),s:a.getState()})});v.forEach(function(a){for(var c=[],d=jQuery('div.filter-instance[data-id="'+
...
k.n=jQuery("#edit-prspctv-note").val();f.find(".label").text(k.l);"x"==g?d=!0:B.setItem(prspdata.e.id,JSON.stringify(D));l.dialog("close")}},{text:dlText.cancel,click:function(){l.dialog("close")}}]})}}});a=jQuery("#dialog-manage-prsrctv").dialog({width:450,height:350,modal:!0,buttons:[{text:dlText.ok,click:function(){d&&c.forEach(function(a){0<a.ps.length?B.setItem(a.id,JSON.stringify(a.ps)):B.removeItem(a.id)});jQuery("#prspctv-mlist").off("click");a.dialog("close")}}]})}function k(a){window.location.href=
...
title:f.title(),apply:A}));d=jQuery('div.filter-instance[data-id="'+e+'"]');for(a=0;a<PData.eTNum();a++){var h=d.find(".apply-tmplt-"+a);h.prop("disabled",!g.t[a]);h.prop("checked",c[a]&&g.t[a]);h.click(n)}d.find("button.btn-filter-toggle").button({text:!1,icons:{primary:"ui-icon-carat-2-n-s"}}).click(m);d.find("button.btn-filter-del").button({text:!1,icons:{primary:"ui-icon-trash"}}).click(p);jQuery("#btn-f-state").prop("disabled",!1).html(dlText.dofilters)}f.setup();return f}function r(a,c,d,e){jQuery("#filter-list li").removeClass("selected");
...
function q(a){PState.set(PSTATE_PROCESS);var c=l[a],d=c.getBMData(),e=[];a=u[a];if(null!==z){a.evalPrep();var f=0,g,h,k=0,m=z.t[0];a:for(;f<z.l;){for(;!d.t[k]||0==m.n||m.i+m.n==f;){if(++k===PData.eTNum())break a;m=z.t[k];f=m.i}g=z.s[f++];d.r[g>>4]&1<<(g&15)&&(h=PData.rByN(g),a.eval(h)&&e.push(g))}a.evalDone(z.l)}PState.set(PSTATE_UPDATE);0<e.length?c.setSel(e):c.clearSel();PState.set(PSTATE_READY)}function w(a,c){var d;d=jQuery("#dialog-hilite-"+a).dialog({height:275,width:Math.min(jQuery(window).width()-
20,675),modal:!0,appendTo:"#dialog-1",buttons:[{text:dlText.chsatt,click:function(){r(!1,!0,c,function(c){C[a]=c;u[a]=h(c,null,a)})}},{text:dlText.ok,click:function(){d.dialog("close");null!==u[a]&&q(a)}},{text:dlText.cancel,click:function(){d.dialog("close")}}]})}function x(a){function f(a){return prspdata.e.vf.findIndex(function(c){return a==c.l})}a=e(a);if(null==a)return!1;PState.set(PSTATE_PROCESS);jQuery("#filter-frame").hide();v.forEach(function(a){a.f.teardown()});v=[];jQuery("#filter-instances").empty();
a.s.f.forEach(function(a){h(a.id,a.a,null).setState(a.s)});jQuery("#filter-instances").hide();jQuery("#btn-toggle-filters").button(0==a.s.f.length?"disable":"enable");for(var g=0;2>g;g++)if(null!=a.s["h"+g]){var k=a.s["h"+g];C[g]=k.id;var m=h(k.id,null,g);u[g]=m;m.setState(k.s)}else u[g]=null,C[g]=null;var k=l[0],m=l[1],n=!1;PState.set(PSTATE_BUILD);g=f(a.s.v0.l);k?(k.setViz(g,!1),k.selBtns(!1)):(l[0]=PViewFrame(0),k=l[0],k.initDOM(g));null!==a.s.v1?(g=f(a.s.v1.l),m?(m.selBtns(!1),m.setViz(g,!1),
m.setState(a.s.v1.s)):(k.flushLgnd(),l[1]=PViewFrame(1),m=l[1],m.initDOM(g),m.setState(a.s.v1.s),n=!0)):m&&(l[1]=null,jQuery("#view-frame-1").remove(),n=!0);n&&k.resize();k.setState(a.s.v0.s);d(a.n);if(PData.ready()&&t)for(c(),g=0;2>g;g++)null!==C[g]&&q(g);return!0}function y(a,c){var d=prspdata.bClrs[a];d&&0<d.length&&jQuery(c).css("background-color",d)}var l=[null,null],A,v=[],u=[null,null],C=[null,null],t,z,B=null,D=[];jQuery("body").addClass("waiting");y("cb","#command-bar");y("fs","#filter-frame");
...
"LI"==a.target.nodeName&&(jQuery("#filter-list li").removeClass("selected"),jQuery(a.target).addClass("selected"))});jQuery("#prspctv-slist").click(function(a){"LI"==a.target.nodeName&&(jQuery("#prspctv-slist li").removeClass("selected"),jQuery(a.target).addClass("selected"))});jQuery("#btn-new-filter").button({icons:{primary:"ui-icon-plus"},text:!1}).click(function(a){r(!0,!1,null,function(a){jQuery("#filter-instances").show(400);h(a,[!0,!0,!0,!0],null);jQuery("#btn-toggle-filters").button("enable")});
...
d){switch(d.s){case PSTATE_PROCESS:PState.set(PSTATE_PROCESS);c();for(var e=0;2>e;e++)null!==u[e]&&q(e);PState.set(PSTATE_READY);jQuery("body").removeClass("waiting");break;case PSTATE_FDIRTY:jQuery("#btn-f-state").prop("disabled",!1).html(dlText.dofilters);break;case PSTATE_HILITE:w(d.v,d.t)}});PState.set(PSTATE_LOAD);PData.init()});function onYouTubeIframeAPIReady(){widgetData.ytCall&&widgetData.ytCall()};