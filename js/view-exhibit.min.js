...
h.empty();var m=jQuery('<div class="op-layer" data-i="-1">Base Map <input type=range class="op-slider" min=0 max=100 value=100 step=5></div>');h.append(m);_.each(this.settings.lyrs,function(c,k){g=c.o||1;var d;d=PMapHub.createMapLayer(c.lid,g,a.lMap,null);a.mapLayers.push(d);m=jQuery('<div class="op-layer" data-i="'+k+'">'+d.options.layerName+' <input type=range class="op-slider" min=0 max=100 value='+100*c.o+" step=5></div>");h.append(m)});var p=_.template(document.getElementById("dltext-v-map").innerHTML);
...
var f=this.lineLayer;f.clearLayers();var g=PData.eTNum(),h=0,m,p=0,n,k,r,q,v,D,w,l,z,t,x,B,u,y,A,C,E;y=this.settings.min;"string"===typeof y&&(y=parseInt(y));p=this.settings.max;"string"===typeof p&&(p=parseInt(p));A=p-y;for(h=0;h<g;h++)this.tLCnt[h]=0;for(var F,h=0;h<g;h++)if("disable"!==this.settings.pAtts[h]){F=[];break}h=0;p=-1;a:for(;h<a.l;){if(null==D){do{if(++p==g)break a;n=a.t[p]}while(0===n.n||n.i+n.n===h);D=this.vFrame.getSelLocAtts(p);if(0===D.length){D=null;continue}w=d.vFrame.getSelFeatAtts(p);
if(0===w.length){D=null;continue}d.tLCnt[p]=D.length;d.tUsed[p]=!0;q=d.vFrame.getSelLegend(p);v=PData.aByID(q);l=d.settings.pAtts[p];k=d.settings.lClrs[p];if(B=d.settings.sAtts[p])u=PData.aByID(B),"number"===typeof u.r.min&&"number"===typeof u.r.max?(C=u.r.min,E=u.r.max-C):B=null}m=a.s[h];r=PData.rByN(m);var G;F&&(G={id:r.id,c:[],p:r.a[l],l:k});D.forEach(function(a){if(z=r.a[a])if(t=r.a[q],"undefined"!==typeof t&&(t=PData.lClr(t,v,w))){d.rMap[m>>4]|=1<<(m&15);if("number"===typeof z[0])B?(u=r.a[B],
u="number"===typeof u?Math.floor((u-C)*A/E)+y:y):u=y,x=L.circleMarker(z,{_aid:m,weight:1,radius:u,fillColor:t,color:"#000",opacity:1,fillOpacity:1}),G&&G.c.push(z);else if(x=2===z.length?L.polyline(z,{_aid:m,weight:1,fillColor:t,color:"#000",opacity:1,fillOpacity:1}):L.polygon(z,{_aid:m,weight:1,fillColor:t,color:"#000",opacity:1,fillOpacity:1}),G){var k=[0,0];z.forEach(function(a){k[0]+=a[0];k[1]+=a[1]});k[0]/=z.length;k[1]/=z.length;G.c.push(k)}x.on("click",c);e.addLayer(x)}});G&&0<G.c.length&&
F.push(G);++h==n.i+n.n&&(D=null)}if(F){F.sort(function(a,c){return PData.strcmp(c.id,a.id)});var I=[];F.forEach(function(a){a.p&&a.p.forEach(function(c){h=_.sortedIndex(F,{id:c},"id");if(h<F.length){var k=F[h];k.id===c&&a.c.forEach(function(c){k.c.forEach(function(k){c[0]===k[0]&&c[1]===k[1]||I.push({p:[c,k],c:a.l})})})}})});I.forEach(function(a){f.addLayer(L.polyline(a.p,{color:a.c,weight:2}))})}};VizMap.prototype.teardown=function(){var a=this.vFrame.getIndex();jQuery("#view-frame-"+a+" div.view-controls div.iconbar").remove()};
...
VizCards.prototype.render=function(a){var c=this;this.stream=a;var d=PData.eTNum(),e,f,g,h,m,p,n,k,r,q,v,D,w,l,z=jQuery(this.frameID);z.empty();0<this.recSel.length&&(this.recSel=[]);this.preRender();var t,x="w"+this.settings.w+" h"+this.settings.h;f=a.t[0];for(e=0;e<d;){for(;0===f.n;){if(++e===d)return;f=a.t[e]}f=PData.eTByN(e);f=PData.tByID(f);p=c.vFrame.getSelFeatAtts(e);0!==p.length&&(z.append('<div class="template-label">'+f.l+'</div><div class="cards" data-ti="'+e+'"></div>'),t=jQuery('div.cards[data-ti="'+
e+'"]'),this.tUsed[e]=!0,g=c.vFrame.getSelLegend(e),h=PData.aByID(g),m=c.settings.iAtts[e],q=c.settings.cnt[e],f=c.sAtts[e],f=PData.aByID(f),f=PData.rTOrder(f,a,e),f.forEach(function(a){n=PData.rByN(a.i);v=n.a[g];"undefined"!==typeof v&&(k=PData.lRecs(v,h,p,!1))&&(c.rMap[a.i>>4]|=1<<(a.i&15),w=c.settings.lOn?'<div class="card-title">'+n.l+"</div>":"",r=!1,D="",q&&0<q.length&&(l=k.b?' style="color:black"':"",q.forEach(function(a){if(v=n.a[a])if(v=PData.procAttTxt(a,v))r=!0,D+=v+"<br/>"})),D=m&&(v=
n.a[m])?r?'<div class="card-body"><img src="'+v+'"/><div class="card-cnt"'+l+">"+D+"</div></div>":'<div class="card-body"><img class="full" src="'+v+'"/></div>':'<div class="card-body"><div class="card-cnt"'+l+">"+D+"</div>",t.append('<div class="card '+x+'" style="background-color:'+k.v+'" data-ai="'+a.i+'">'+w+D+"</div>"))}));f=a.t[++e]}};VizCards.prototype.teardown=function(){jQuery(this.frameID).off("click.vf")};
VizCards.prototype.rerender=function(a){var c=this,d=jQuery(this.frameID+' div.cards[data-ti="'+a+'"]');d.empty();var e,f,g,h,m,p,n,k,r,q,v,D,w,l="w"+this.settings.w+" h"+this.settings.h;e=c.vFrame.getSelFeatAtts(a);0!=e.length&&(f=c.vFrame.getSelLegend(a),g=PData.aByID(f),h=c.settings.iAtts[a],m=c.settings.cnt[a],p=c.sAtts[a],p=PData.aByID(p),a=PData.rTOrder(p,c.stream,a),a.forEach(function(a){n=PData.rByN(a.i);k=n.a[f];"undefined"!==typeof k&&(r=PData.lRecs(k,g,e,!1))&&(D=c.settings.lOn?'<div class="card-title">'+
n.l+"</div>":"",q=!1,v="",m&&0<m.length&&(w=r.b?' style="color:black"':"",m.forEach(function(a){if(k=n.a[a])if(k=PData.procAttTxt(a,k))q=!0,v+=k+"<br/>"})),v=h&&(k=n.a[h])?q?'<div class="card-body"><img src="'+k+'"/><div class="card-cnt"'+w+">"+v+"</div></div>":'<div class="card-body"><img class="full" src="'+k+'"/></div>':'<div class="card-body"><div class="card-cnt"'+w+">"+v+"</div>",d.append('<div class="card '+l+(c.isSel(a.i)?" obj-sel":"")+'" style="background-color:'+r.v+'" data-ai="'+a.i+'">'+
D+v+"</div>"))}))};VizCards.prototype.doOptions=function(){var a=this,c=jQuery("#dialog-sortby").dialog({height:220,width:400,modal:!0,buttons:[{text:dlText.ok,click:function(){c.dialog("close");PState.set(PSTATE_BUILD);for(var d=0;d<PData.eTNum();d++){var e=jQuery('#dialog-sortby select[data-ti="'+d+'"]').val();e!=a.sAtts[d]&&(a.sAtts[d]=e,a.rerender(d))}PState.set(PSTATE_READY)}},{text:dlText.cancel,click:function(){c.dialog("close")}}]})};
...
"y axis").call(this.yAxis);this.chart.append("image").attr("id","base-"+d).attr("xlink:href",a.img).attr("x",0).attr("y",0).attr("height",a.dh).attr("width",a.dw);this.settings.lyrs.forEach(function(a,e){c.chart.append("svg").attr("id","ol-"+d+"-"+e).attr("opacity",a.o)});this.settings.lyrs.forEach(function(a,c){d3.xml(a.url,function(a,e){if(!a){var n=e.getElementsByTagName("svg")[0];d3.select("#ol-"+d+"-"+c).node().appendChild(n)}})});this.gRecs=this.chart.append("g").attr("id","recs")};
VizPinboard.prototype.render=function(a){var c=this;this.gRecs.selectAll(".recobj").remove();this.gRecs.selectAll(".recline").remove();0<this.recSel.length&&(this.recSel=[]);this.preRender();var d=PData.eTNum(),e,f,g=0,h,m,p,n,k,r,q,v,D,w,l,z,t,x,B,u;for(e=0;e<d;e++)if("disable"!==this.settings.pAtts[e]){u=[];break}z=this.settings.min;"string"===typeof z&&(z=parseInt(z));f=this.settings.max;"string"===typeof f&&(f=parseInt(f));t=f-z;var y=[];e=0;g=-1;a:for(;e<a.l;){if(null==r){do{if(++g===d)break a;
h=a.t[g]}while(0===h.n||h.i+h.n===e);r=this.vFrame.getSelLocAtts(g);if(0===r.length){r=null;continue}r=r[0];q=c.vFrame.getSelFeatAtts(g);if(0===q.length){r=null;continue}c.tUsed[g]=!0;n=c.vFrame.getSelLegend(g);k=PData.aByID(n);v=c.settings.pAtts[g];m=c.settings.lClrs[g];if(l=c.settings.sAtts[g])p=PData.aByID(l),"number"===typeof p.r.min&&"number"===typeof p.r.max?(x=p.r.min,B=p.r.max-x):l=null}f=a.s[e];p=PData.rByN(f);var A;u&&(A={id:p.id,c:null,p:p.a[v],l:m});D=p.a[r];"undefined"!==typeof D&&(w=
p.a[n],"undefined"!==typeof w&&(w=PData.lClr(w,k,q)))&&(c.rMap[f>>4]|=1<<(f&15),l?(p=p.a[l],p="number"===typeof p?Math.floor((p-x)*t/B)+z:z):p=z,y.push({ai:f,v:w,x:D[0],y:D[1],r:p}),A&&(A.c=D));A&&A.c&&u.push(A);++e==h.i+h.n&&(r=null)}this.gRecs.selectAll(".recobj").data(y).enter().append("circle").attr("class","recobj").attr("cx",function(a){return c.xScale(a.x)}).attr("cy",function(a){return c.yScale(a.y)}).attr("r",function(a){return c.yScale(a.r)}).style("fill",function(a){return a.v}).on("click",
...
VizTime.prototype.render=function(a){function c(a,c){var k=a.s-c.s;if(0>k)return 1;if(0<k)return-1;k=c.e-a.e;return 0>k?1:0<k?-1:0}function d(a){function c(a){a=g.toggleSel(a.ai);d3.select(this).classed("obj-sel",a)}var k,d,e,f,h=g.bands[a];a?(k=g.bands[0],h.t=k.t+k.h+37,k=d=e=g.instRad,f=2*g.instRad+3):(h.t=0,k=d=e=1);h.h=m*h.tHt+2;h.g.attr("transform","translate(0,"+h.t+")").attr("height",h.h);var w,l;a&&(w=.75*h.iHt+"px",l=.8*h.iHt);var z;z=d3.select(h.svgID).selectAll(".lgBd").remove();z=d3.select(h.svgID).selectAll(".lgBd").data(g.lgBds).enter().append("svg").attr("class",
"lgBd").attr("y",function(a){return h.yScale(a.t)}).attr("height",function(a){return h.yScale(a.h)});z.append("rect").attr("width","100%").attr("height","100%").attr("fill",function(a){return a.d.v});1===a&&z.append("text").attr("class","lgBdLbl").attr("x",2).attr("y",l).attr("fill",function(a){return a.d.b?"#000000":"#FFFFFF"}).style("font-size",w).text(function(a){return a.d.l});var t;d3.select(h.svgID).selectAll(".event").remove();t=d3.select(h.svgID).selectAll(".event").data(g.events).enter().append("svg").attr("class",
function(a){return a.f&EVENT_INSTANT?"event instant":"event range"}).attr("y",function(a){return h.yScale(a.t)}).attr("height",h.iHt);if(1===a)t.on("click",c);var x=d3.select(h.svgID).selectAll(".range");x.append("rect").attr("width","100%").attr("height","100%").attr("fill",function(c){return 1===a&&c.f&(EVENT_F_START|EVENT_F_END)?(c.f&(EVENT_F_START|EVENT_F_END))===(EVENT_F_START|EVENT_F_END)?"url("+c.c.v+"-fb)":(c.f&EVENT_F_START)===EVENT_F_START?"url("+c.c.v+"-fs)":"url("+c.c.v+"-fe)":c.c.v});
1===a&&x.append("text").attr("class","rangeLbl").attr("x",4).attr("y",l).attr("fill",function(a){return a.c.b?"#000000":"#FFFFFF"}).style("font-size",w).text(function(a){return a.l});x=d3.select(h.svgID).selectAll(".instant");x.append("circle").attr("cx",k).attr("cy",d).attr("r",e).attr("fill",function(a){return a.c.v});1===a&&x.append("text").attr("class","instantLbl").attr("x",f).attr("y",l).style("font-size",w).text(function(a){return a.l});h.redraw=function(){z.attr("x",function(a){return h.xScale(a.s)}).attr("width",
function(a){return h.xScale(a.e)-h.xScale(a.s)});t.attr("x",function(a){return h.xScale(a.s)}).attr("width",function(a){return h.xScale(a.e)-h.xScale(a.s)});h.parts.forEach(function(a){a.redraw()})}}function e(a){a=g.bands[a];d3.select(a.svgID).selectAll(".axis").attr("transform","translate(0,"+a.h+")")}function f(a){a=g.bands[a];d3.select(a.svgID).selectAll(".bLblCntr").attr("transform","translate(0,"+(a.h+1).toString()+")")}var g=this,h=this.vFrame.getIndex();0<this.recSel.length&&(this.recSel=
[]);this.preRender();this.events=[];this.lgBds=[];var m=0;(function(){for(var d=PData.eTNum(),e=0,k,r,q,f,h,w,l,z;e<d;){for(k=a.t[e];0===k.n;){if(++e==d)return;k=a.t[e]}q=g.vFrame.getSelLocAtts(e);if(0!==q.length&&(q=g.vFrame.getSelFeatAtts(e),0!==q.length)){g.tUsed[e]=!0;z=g.vFrame.getSelLegend(e);l=PData.aByID(z);f=g.settings.dAtts[e];for(var t,x,B,u,y,A,C,E,F=[],G=k.i;G<k.i+k.n;G++)r=a.s[G],E=PData.rByN(r),h=E.a[z],"undefined"!==typeof h&&(h=PData.lRecs(h,l,q,!1))&&(w=E.a[f])&&"?"!==w&&(g.rMap[r>>
4]|=1<<(r&15),A=w.min.f?EVENT_F_START:0,t=w.min.y,"undefined"===typeof w.min.m?B=x=1:(x=w.min.m,B="undefined"===typeof w.min.d?1:w.min.d),u=PData.d3Nums(t,x,B,!1),"undefined"===typeof w.max?(A|=EVENT_INSTANT,y=u.getTime()+g.instGap):"open"===w.max?y=TODAY:(w.max.f&&(A|=EVENT_F_END),t=w.max.y,"undefined"===typeof w.max.m?(x=12,B=31):(x=w.max.m,B="undefined"===typeof w.max.d?PData.lenMnth(t,x):w.max.d),y=PData.d3Nums(t,x,B,!0)),F.push({s:u,e:y,ai:r,f:A,c:h,l:E.l,t:0}));F.sort(c);var I=[],K;F.forEach(function(a){for(K=
0;K<I.length&&!(a.e<I[K]);K++);a.t=K+m+1;I[K]=a.s});k=PData.aByID(f);k.l.forEach(function(a){C=a.d;t=C.min.y;"undefined"===typeof C.min.m?B=x=1:(x=C.min.m,B="undefined"===typeof C.min.d?1:C.min.d);u=PData.d3Nums(t,x,B,!1);"undefined"===typeof C.max.y?y=TODAY:(t=C.max.y,"undefined"===typeof C.max.m?(x=12,B=31):(x=C.max.m,B="undefined"===typeof C.max.d?PData.lenMnth(t,x):C.max.d),y=PData.d3Nums(t,x,B,!0));g.lgBds.push({s:u,e:y,t:m,h:I.length+1,d:a})});m+=I.length+1;g.events=g.events.concat(F)}e++}})();
...
VizDirectory.prototype.render=function(a){var c=this,d=PData.eTNum(),e=0,f,g,h,m,p,n,k=jQuery(this.frameID);k.empty();0<this.recSel.length&&(this.recSel=[]);this.preRender();this.stream=a;for(f=a.t[0];e<d;){for(;0===f.n;){if(++e===d)return;f=a.t[e]}c.tUsed[e]=!0;f=PData.eTByN(e);f=PData.tByID(f);k.append('<div class="template-label">'+f.l+'</div><table cellspacing="0" class="viz-directory" data-ti='+e+"></table>");g=k.find('table[data-ti="'+e+'"]');h=c.settings.cnt[e];n="<thead><tr>";h.forEach(function(a){a=
PData.aByID(a);n+="<th>"+a.def.l+"</th>"});g.append(n+"<tr></thead><tbody></tbody>");g=g.find("tbody");f=c.sAtts[e];f=PData.aByID(f);f=PData.rTOrder(f,c.stream,e);f.forEach(function(a){p=PData.rByN(a.i);c.rMap[a.i>>4]|=1<<(a.i&15);n='<tr data-id="'+p.id+'" data-ai='+a.i+">";h.forEach(function(a){m=p.a[a];"undefined"!==typeof m?n=(m=PData.procAttTxt(a,m))?n+("<td>"+m+"</td>"):n+"<td></td>":n+="<td></td>"});g.append(n+"</tr>")});f=a.t[++e]}};
...
VizTextStream.prototype.render=function(a){var c=this,d=PData.eTNum(),e=0,f,g,h,m,p,n,k,r,q,v,D,w,l,z,t,x,B,u=jQuery(this.frameID);u.empty();0<this.recSel.length&&(this.recSel=[]);this.preRender();x=this.settings.max-this.settings.min;for(g=a.t[0];e<d;){for(;0===g.n;){if(++e===d)return;g=a.t[e]}q=c.vFrame.getSelLocAtts(e);if(0!==q.length&&(q=c.vFrame.getSelFeatAtts(e),0!==q.length)){c.tUsed[e]=!0;v=c.vFrame.getSelLegend(e);D=PData.aByID(v);u.append('<div class="viz-textstream" data-ti='+e+"></div>");
h=u.find("div.viz-textstream[data-ti="+e+"]");f=PData.eTByN(e);f=PData.tByID(f);h.append('<div class="template-label">'+f.l+"</div>");r=c.settings.cnt[e];if(z=c.settings.sAtts[e])l=PData.aByID(z),"number"===typeof l.r.min&&"number"===typeof l.r.max?t=l.r.max-l.r.min:z=null;r&&(f=PData.aByID(c.settings.order[e]),f=PData.rTOrder(f,a,e),f.forEach(function(a){m=PData.rByN(a.i);p=m.a[v];"undefined"!==typeof p&&(w=PData.lRecs(p,D,q,!1))&&((n=m.a[r])&&(n=PData.procAttTxt(r,n)),n&&(c.rMap[a.i>>4]|=1<<(a.i&
15),z?(k=m.a[z],k="number"===typeof k?Math.floor((k-l.r.min)*x/t)+c.settings.min:c.settings.min):k=c.settings.min,B=w.b?";background-color:black":"",h.append('<div class="recitem" data-ai='+a.i+' style="color:'+w.v+B+";font-size:"+k+'px">'+n+"</div>")))}))}e++}};VizTextStream.prototype.teardown=function(){jQuery(this.frameID).off("click.vf")};
...
n=0;n<g.c.length;n++){for(var k=0,m=0;m<a.c.length;m++)0<h[m][n].length&&k++;p[n]=k-1}for(var r=Array(g.c.length),n=0;n<g.c.length;n++)r[n]=0;var q=0;a.c.forEach(function(k,f){for(var w=0,l=0;l<g.c.length;l++)0<h[f][l].length&&w++;--w;var m=k.i.length*d/a.t,n=0,x=0;g.c.forEach(function(l,u){var y=h[f][u];if(0<y.length){var A=y.length*d,C=A/a.t,A=A/g.t,E=l.i.length*d/g.t;c.ints.push({i:y,c:k.c,l:k.l+" > "+l.l,x1:5+q*d/a.t+(w?(m-C)*n/w:0),x2:5+x*d/g.t+(p[u]?(E-A)*r[u]/p[u]:0),w1:C,w2:A,y1:a.y+10,y2:g.y-
1});n++;r[u]++}x+=l.i.length});q+=k.i.length})}});this.flowG.selectAll(".flow").data(c.ints).enter().append("path").attr("class","flow").attr("d",function(a){return"M "+a.x1+" "+a.y1+"  L "+(a.x1+a.w1)+" "+a.y1+" L "+(a.x2+a.w2)+" "+a.y2+" L "+a.x2+" "+a.y2+" L "+a.x1+" "+a.y1}).attr("fill",function(a){return a.c}).on("click",function(a,d){var g=c.fSel.length,h=_.sortedIndex(c.fSel,d);c.fSel[h]===d?(d3.select(this).classed("obj-sel",!1),c.fSel.splice(h,1),0<g&&0===c.fSel.length&&0===c.bSel.length&&
...
VizBrowser.prototype.render=function(a){var c=this,d=this.vFrame.getIndex();this.recSel=[];this.stream=a;this.svg.selectAll(".facet-col").remove();var e=0;this.fcts=[];this.settings.fcts.forEach(function(d,f){var g,n=PData.aByID(d);g="g"===n.def.t?[]:c.settings.gr?PData.cRNew(n,!0,!0):PData.cLNew(n,null,!0);PData.cFill(g,d,null,a);var k=[],r=0;g.forEach(function(a){0<a.i.length&&(a.n=r++,k.push(a))});c.fcts.push({c:k,x:250*f,i:f,l:n.def.l,n:n.id,s:-1});e=Math.max(e,27+22*(k.length+1))});c.svg.attr("height",
...
VizMBMap.prototype.renderTree=function(a){function c(){var a=0,c=d.settings.w,g=null!==d.sbkSel?d.sbkSel.i:d.bkSel.i;PState.set(PSTATE_UPDATE);d.fcts.forEach(function(h,m){var p=[],n=0;h.c.forEach(function(a){a=PData.intersect(g,a.i);p.push(a);n+=a.length});var k=0,r;p.forEach(function(q){r=d.bars[a++];r.x=n?k*c/n:0;r.w=n?q.length*c/n:0;k+=q.length})});d.attsG.selectAll(".bar").transition().attr("x",function(a){return a.x}).attr("width",function(a){return a.w});PState.set(PSTATE_READY)}var d=this;
...
PFilterNum.prototype.evalBoxes=function(a){function c(c,h){function k(){r=!0;a.find(c).addClass("error")}var r=!1,q,v=a.find(c).val();(v=e.exec(v))?(a.find(c).removeClass("error"),q=parseInt(v[1],10)):k();r||(0==h?null!==f&&q<f&&k():null!==g&&q>g&&k());d.uNums[h]=q;return r}var d=this,e=/^(\d+)$/,f="undefined"===typeof this.att.r.min?null:this.att.r.min,g="undefined"===typeof this.att.r.max?null:this.att.r.max,h,m;h=c(".from",0);m=c(".to",1);this.uNums[0]>this.uNums[1]&&(m=!0);a.find(".filter-update").prop("disabled",
...
PFilterDates.prototype.evalBoxes=function(a){function c(c,g){function h(d){r=!0;a.find(c+d).addClass("error")}function k(d){a.find(c+d).removeClass("error")}var r=!1,q={y:0,m:0,d:0,ms:null},v=a.find(c+"-y"),v=v.val();(v=e.exec(v))?(k("-y"),q.y=parseInt(v[1],10)):h("-y");v=a.find(c+"-m");v=v.val();(v=f.exec(v))?(q.m=parseInt(v[1],10),1>q.m||12<q.m?h("-m"):k("-m")):h("-m");v=a.find(c+"-d");v=v.val();(v=f.exec(v))?(q.d=parseInt(v[1],10),1>q.d||31<q.d?h("-d"):k("-d")):h("-d");r||(q.ms=PData.d3Nums(q.y,
q.m,q.d,!1),0==g?q.ms<d.rCats[0].min&&(h("-y"),h("-m"),h("-d")):q.ms>d.rCats[d.rCats.length-1].max&&(h("-y"),h("-m"),h("-d")));d.uDates[g]=q;return r}var d=this,e=/^(-?\d+)$/,f=/^(\d{1,2})$/,g,h;g=c(".from",0);h=c(".to",1);this.uDates[0].ms>this.uDates[1].ms&&(h=!0);a.find(".filter-update").prop("disabled",g||h);return!(g||h)};
...
c+'"]').next().after('<div class="xscript">'+a+"</div>")})}function e(a){widgetData.tcArray=[];widgetData.tcIndex=-1;var f=widgetData.tcArray;a=new String(a);if(a=c(a).split(/\r\n|\r|\n/g)){var l=jQuery("#xscript-tbl"),q=0,r,g=0,h=0,v="";_.each(a,function(a){a=c(a);1<a.length&&("["===a.charAt(0)&&"0"<=a.charAt(1)&&"9">=a.charAt(1)?(r=d(a),0<v.length&&(h&&f.push({s:g,e:r}),l.append('<div class="row"><div class="timecode" data-timecode="'+g+'" data-tcindex="'+q++ +'">'+h+'</div><div class="xscript">'+
v+"</div></div>"),v=""),h=a,g=r):(0<v.length&&(v+="<br/>"),v+=a))});0<v.length&&(f.push({s:g,e:324E5}),l.append('<div class="row"><div class="timecode" data-timecode="'+g+'" data-tcindex="'+q+'">'+h+'</div><div class="xscript">'+v+"</div></div>"));"undefined"!==typeof B&&null!=B&&jQuery.ajax({type:"POST",url:prspdata.ajax_url,data:{action:"prsp_get_transcript",transcript:B,excerpt:widgetData.extract},success:function(a,c,d){k(JSON.parse(a),l)},error:function(a,c,d){alert(d)}})}}function f(a){var c,
...
!1}},onReady:function(){widgetData.extract&&widgetData.widget.cueVideoById({videoId:widgetData.ytCode,startSeconds:widgetData.sTime/1E3,endSeconds:widgetData.eTime/1E3})}}})}function q(){widgetData.playing=!0}function r(){widgetData.playing=!1}function g(){widgetData.playing&&widgetData.xscriptOn&&f(1E3*widgetData.widget.currentTime)}function v(){switch(p){case 3:null!=widgetData.widget&&(widgetData.widget.removeEventListener("ended",r),widgetData.widget.removeEventListener("pause",r),widgetData.widget.removeEventListener("playing",
q),widgetData.widget.removeEventListener("timeupdate",g));case 1:null!=widgetData.widget&&widgetData.playing&&widgetData.widget.pause();widgetData.playing=!1;widgetData.widget=null;break;case 2:widgetData.ytCall=null,null!=widgetData.widget&&widgetData.playing&&widgetData.widget.stopVideo(),widgetData.widget=null,widgetData.playing=!1,null!=widgetData.timer&&(window.clearInterval(widgetData.timer),widgetData.timer=null)}}function w(){function a(){widgetData.sTime=widgetData.eTime=null;var c;(c=prspdata.e.i.t.tcAtts[v])&&
(c=H.a[c])&&""!==c&&(widgetData.extract=c,c=c.split("-"),widgetData.sTime=d(c[0]),widgetData.eTime=d(c[1]))}var c=J[M];H=PData.rByN(c);var k=" "+H.l+" ("+(M+1)+"/"+J.length+") ",h=jQuery("#inspect-name");h.text(k);h.prop("title",H.id);var v=PData.n2T(c);x.empty();u=null;p=0;widgetData.extract=null;widgetData.xscriptOn=!1;widgetData.playing=!1;if(prspdata.e.i.modal.scOn||"boolean"===typeof prspdata.e.i.modal.aOn&&prspdata.e.i.modal.aOn)if(u=prspdata.e.i.sc.atts[v])if(k=H.a[u])if(a(),k.match(/soundcloud\.com/)){var y=
!0;p=1;x.append('<iframe id="sc-widget" class="player" width="100%" height="110" src="http://w.soundcloud.com/player/?url='+k+'"></iframe>');var t=SC.Widget(document.getElementById("sc-widget"));widgetData.widget=t;t.bind(SC.Widget.Events.READY,function(){t.play();t.bind(SC.Widget.Events.PLAY,function(){widgetData.playing=!0});t.bind(SC.Widget.Events.PAUSE,function(){widgetData.playing=!1});t.bind(SC.Widget.Events.PLAY_PROGRESS,function(a){y&&(t.pause(),y=!1,widgetData.playing=!1);widgetData.extract&&
(a.currentPosition<widgetData.sTime?t.seekTo(widgetData.sTime):a.currentPosition>widgetData.eTime&&(t.pause(),widgetData.playing=!1));widgetData.playing&&widgetData.xscriptOn&&f(a.currentPosition)});t.bind(SC.Widget.Events.FINISH,function(){widgetData.playing=!1})})}else p=3,widgetData.extract&&(h=widgetData.extract.split("-"),k+="#t="+h[0]+","+h[1]),x.append('<audio id="na-widget" controls src="'+k+'"></audio>'),widgetData.widget=document.getElementById("na-widget"),widgetData.widget.addEventListener("ended",
r),widgetData.widget.addEventListener("pause",r),widgetData.widget.addEventListener("playing",q),widgetData.widget.addEventListener("timeupdate",g);0===p&&prspdata.e.i.modal.ytOn&&(u=prspdata.e.i.yt.atts[v])&&(k=H.a[u])&&(a(),widgetData.ytCode=k,x.append('<div id="yt-widget"></div>'),widgetData.ytCall=l,widgetData.ytLoaded?l():(widgetData.ytLoaded=!0,k=document.createElement("script"),k.src="https://www.youtube.com/iframe_api",h=document.getElementsByTagName("script")[0],h.parentNode.insertBefore(k,
h)),p=2);prspdata.e.i.modal.tOn&&(k=prspdata.e.i.t.t1Atts[v])&&""!==k&&"disable"!==k&&(k=H.a[k],"string"===typeof k&&""!==k&&(0<p&&x.append("<div>"+document.getElementById("dltext-sync-xscript").innerHTML+"</div>"),x.find("#xscript-tbl").remove(),x.append('<div id="xscript-tbl"><div>'),widgetData.xscriptOn=!0,jQuery("#xscript-tbl").click(function(a){if(p&&jQuery(a.target).hasClass("timecode"))switch(a=jQuery(a.target).data("timecode"),p){case 1:widgetData.playing||(widgetData.playing=!0,widgetData.widget.play());
widgetData.widget.seekTo(a);break;case 2:widgetData.playing||(widgetData.playing=!0,widgetData.widget.playVideo());widgetData.widget.seekTo(a/1E3);break;case 3:widgetData.playing||(widgetData.playing=!0,widgetData.widget.play()),widgetData.widget.currentTime=a/1E3}}),B=null,(h=prspdata.e.i.t.t2Atts[v])&&""!==h&&"disable"!==h&&(B=H.a[h]),jQuery.ajax({type:"POST",url:prspdata.ajax_url,data:{action:"prsp_get_transcript",transcript:k,excerpt:widgetData.extract},success:function(a,c,d){e(JSON.parse(a))},
error:function(a,c,d){alert(d)}})));prspdata.e.i.modal.atts[v].forEach(function(a){var d=PData.rAV(c,a,!1);if(d){a=PData.aByID(a);var k;"_"==a.def.l.charAt(0)?k="<div>"+d+"</div>":(k='<div><span class="att-label">'+a.def.l+":</span> ","I"==a.def.t&&(k+="<br/>"),k+=d+"</div>");x.append(k)}})}function m(a){a=M+a;-1==a?a=J.length-1:a==J.length&&(a=0);a!=M&&(M=a,v(),w())}function z(a){m(-1)}function D(a){m(1)}var x=jQuery("#inspect-content"),u=null,p=0,B,n=450,N=400,J=null;t&&(J=t.getSel());if(null!=
J&&0!=J.length){var O,H,M=0;prspdata.e.i.modal.scOn&&(n=550);prspdata.e.i.modal.ytOn&&(n=Math.max(n,475),N=500);prspdata.e.i.modal.tOn&&(N+=100,prspdata.e.i.modal.t2On?(n=Math.max(750,Math.floor(.8*jQuery(document).width())),n=Math.min(900,n)):n=Math.max(n,550));"number"===typeof prspdata.e.i.modal.w&&(n=prspdata.e.i.modal.w);"number"===typeof prspdata.e.i.modal.h&&(N=prspdata.e.i.modal.h);h(!1);w();jQuery("#btn-inspect-left").click(z);jQuery("#btn-inspect-right").click(D);O=jQuery("#dialog-inspector").dialog({width:n,
...
(c.find(".osel").button("disable"),c.find(".osel").removeClass("pulse"),c.find(".xsel").button("disable"))}function m(c){jQuery("body").trigger("prospect",{s:PSTATE_HILITE,v:a,t:t.tUsed});c.preventDefault()}function p(a){PState.set(PSTATE_UPDATE);t&&t.clearSel();h(!1);PState.set(PSTATE_READY);a.preventDefault()}function n(a){t&&t.doOptions();a.preventDefault()}function k(a){var c=jQuery("#dialog-vnotes").dialog({width:300,height:300,modal:!0,buttons:[{text:dlText.ok,click:function(){c.dialog("close")}}]});
a.preventDefault()}function r(a,k){jQuery(d()+' div.lgnd-container div.lgnd-scroll div.lgnd-template[data-index="'+a+'"] div.lgnd-group input.lgnd-entry-check').prop("checked",k);c(!0)}function q(a){var k=jQuery(a.target).closest("div.lgnd-template").data("index"),e=a.target.className;switch(e){case "lgnd-update":t&&u&&(PState.set(PSTATE_BUILD),h(!1),t.render(u),c(!1),PState.set(PSTATE_READY));break;case "lgnd-entry-check":e=jQuery(a.target).closest("div.lgnd-entry");a=jQuery(a.target).is(":checked");
...
x=[];if(g&V_FLAG_LGND){q.find(".hslgnd").button("enable");var w=q.find("div.lgnd-container div.lgnd-scroll");w.empty();if(g&V_FLAG_SLGND){var m=r.getFeatureAtts(),P=PData.aByID(m);w.append('<div class="lgnd-template" data-index="0"><div class="lgnd-title">'+P.def.l+'</div><div class="lgnd-entry lgnd-sh"><input type="checkbox" checked="checked" class="lgnd-entry-check"/><i>'+dlText.sha+'</i></div><div class="lgnd-group"></div></div>');x.push(m);D(0,m)}else{var p=!1;prspdata.e.g.ts.forEach(function(a,
c){var d=PData.tByID(a),k=r.getLocAtts(c);if(k&&0<k.length||!(g&V_FLAG_LOC)){var e=r.getFeatureAtts(c);if(0<e.length){p&&w.append("<hr/>");var f=jQuery('<div class="lgnd-template" data-index="'+c+'"><div class="lgnd-title">'+d.l+"</div></div>");k&&k.forEach(function(a,c){var d=PData.aByID(a);f.append('<div class="lgnd-entry lgnd-locate" data-id="'+a+'"><input type="checkbox" checked="checked" class="lgnd-entry-check"/><span class="lgnd-value-title">'+d.def.l+"</span></div>")});var q='<select class="lgnd-select">';
e.forEach(function(a,c){var d=PData.aByID(a);q+='<option value="'+a+'">'+d.def.l+"</option>"});q+="</select>";d=jQuery(q);d.change(v);jQuery(f).append(d);jQuery(f).append('<div class="lgnd-entry lgnd-sh"><input type="checkbox" checked="checked" class="lgnd-entry-check"/><i>'+dlText.sha+'</i></div><div class="lgnd-group"></div>');w.append(f);e=e[0];x.push(e);D(c,e);p=!0}}})}q.find("div.lgnd-container").show()}else q.find("button.hslgnd").button("disable"),q.find("div.lgnd-container").hide();c(!1);
...
r.setup();h(!1);u&&e&&r.render(u);t=r}var l={},z=0,t=null,x=[],B=null,u=null;l.getFrameID=d;l.getIndex=function(){return a};l.setViz=function(a,c){a!=z&&(jQuery(d()+" div.view-controls select.view-viz-select").val(a),w(a,c))};l.initDOM=function(c){var r=document.getElementById("dltext-view-controls").innerHTML;jQuery("#viz-frame").append('<div id="view-frame-'+a+'">'+r+"</div>");var r=jQuery(d()),l=prspdata.bClrs.vf;l&&0<l.length&&r.find("div.view-controls").css("background-color",l);r.find("div.lgnd-container").draggable({handle:r.find("div.lgnd-handle"),
...
text:!1}).click(p).next().button({icons:{primary:"ui-icon-search"},text:!1}).click(g).next();r.find("div.lgnd-container").click(q);w(c,!1)};l.getSelLocAtts=function(a){var c=[];jQuery(d()+' div.lgnd-container div.lgnd-scroll div.lgnd-template[data-index="'+a+'"] div.lgnd-locate input:checked').each(function(){var a=jQuery(this).parent().data("id");c.push(a)});return c};l.getSelFeatAtts=function(a){var c=[],k,e;jQuery(d()+' div.lgnd-container div.lgnd-scroll div.lgnd-template[data-index="'+a+'"] div.lgnd-group div.lgnd-value input:checked').each(function(){k=
jQuery(this).parent().data("index");"number"==typeof k?c.push(k):-1!=(e=k.indexOf(","))?c.push([parseInt(k.substring(0,e),10),parseInt(k.substring(e+1),10)]):c.push(parseInt(k,10))});return c};l.getSelLegend=function(a){return x[a]};l.getLgndSels=function(){return x.slice(0)};l.setLgndSels=function(a){a.forEach(function(a,c){a&&(jQuery(d()+' div.lgnd-container div.lgnd-scroll div.lgnd-template[data-index="'+c+'"] select.lgnd-select').val(a),D(c,a))})};l.getState=function(){return t?t.getState():null};
l.setState=function(a){t&&t.setState(a)};l.showStream=function(a){u=a;t&&t.render(a);c(!1)};l.setStream=function(a){u=a};l.selBtns=function(a){h(a)};l.clearSel=function(){t&&t.clearSel();h(!1)};l.setSel=function(a){return t&&t.flags()&V_FLAG_SEL?(t.setSel(a),h(0<a.length),!0):!1};l.resize=function(){t&&t.resize()};l.title=function(){return PData.vByN(z).l};l.flushLgnd=function(){jQuery(d()).find("div.lgnd-container").css("left","10px")};l.getBMData=function(){return t?{t:t.tUsed,r:t.rMap}:null};return l}
...
eTByN:function(a){return prspdata.e.g.ts[a]},tByID:function(a){for(var c=0;c<prspdata.t.length;c++)if(a==prspdata.t[c].id)return prspdata.t[c].def},lRecs:function(a,c,d,e){var f,g=d.length,l;switch(c.def.t){case "V":var h=function(a){for(var e=0;e<g;e++)if(f=d[e],"number"===typeof f){if(l=c.l[f],l.l===a)return l}else{l=c.l[f[0]];var k=l.z[f[1]];if(k.l===a)return k.v&&""!==k.v?k:l}return null};if(e&&""!==c.def.d){var t=[],m;a.forEach(function(a){m=h(a);null!=m&&t.push(m)});return 0<t.length?t:null}if(""!=
c.def.d){for(e=0;e<a.length;e++)if(m=h(a[e]),null!=m)return m;break}else return h(a[0]);case "T":for(m=0;m<g;m++)if(f=d[m],l=c.l[f],-1!=a.indexOf(l.d))return l;break;case "N":m=0;if(-1===d[0]){if("?"===a){if("undefined"===typeof c.r.u)break;return c.r.u}m=1}if("?"===a)break;for(;m<g;m++)if(f=d[m],l=c.l[f],"undefined"!==typeof l.d.min){if(l.d.min<=a)if("undefined"!==typeof l.d.max){if(a<=l.d.max)return l}else return l}else if(a<=l.d.max)return l;break;case "D":m=0;if(-1===d[0]){if("?"===a){if("undefined"===
typeof c.r.u)break;return c.r.u}m=1}if("?"!==a)for(;m<g;m++)if(f=d[m],l=c.l[f],"undefined"!==typeof l.d.max.y){if("undefined"!==typeof a.max&&"open"!==a.max){if(a.max.y<l.d.min.y)continue;if(a.max.y===l.d.min.y&&a.max.m&&l.d.min.m){if(a.max.m<l.d.min.m)continue;if(a.max.m==l.d.min.m&&a.max.d&&l.d.min.d&&a.max.d<l.d.min.d)continue}}if(!(a.min.y>l.d.max.y)){if(a.min.y===l.d.max.y&&a.min.m&&l.d.max.m){if(a.min.m>l.d.max.m)continue;if(a.min.m===l.d.max.m&&a.min.d&&l.d.max.d&&a.min.d>l.d.max.d)continue}return l}}else if("undefined"!==
...
c:f,i:[]}):e.push({l:d.l,c:f})})}),e;case "N":if("undefined"===typeof a.r.min||"undefined"===typeof a.r.max)return null;d&&"undefined"!==typeof a.r.u&&(c?e.push({l:"?",c:a.r.u.v,min:"?",max:"?",i:[]}):e.push({l:"?",c:a.r.u.v,min:"?",max:"?"}));var f=Math.pow(10,a.r.g),g=a.r.min,l=0,h,m,p;for(0<a.l.length&&(h=a.l[0]);g<=a.r.max;){for(;l<a.l.length&&"undefined"!==typeof h.d.max&&g>h.d.max;)h=a.l[++l];p=0==a.l.length||g<h.d.min?"#777777":l===a.l.length?"#777777":"undefined"===typeof h.d.max||g<=h.d.max?
h.v:"#777777";m=g;g+=f;max=g-1;max>a.r.max&&(max=a.r.max);var n=m.toString();1<f&&4>n.length&&m!==max&&(n+="-"+max.toString());c?e.push({l:n,c:p,min:m,max:max,i:[]}):e.push({l:n,c:p,min:m,max:max})}return e;case "D":g=function(a){var c,d;if("undefined"===typeof a.y)return TODAY;c=a.y;"undefined"===typeof a.m?(d=12,a=31):(d=a.m,a="undefined"===typeof a.d?PData.lenMnth(c,d):a.d);return PData.d3Nums(c,d,a,!1)};m=function(a,c,d,e){"undefined"!==typeof e.m&&(c=e.m,"undefined"!==typeof e.d&&(d=e.d));return PData.d3Nums(a,
c,d,!1)};p=g(a.r.max);var f=a.r.g,n=a.r.min.y,u=1,y=1;"undefined"!==typeof a.r.min.m&&(u=a.r.min.m,"undefined"!==typeof a.r.min.d&&(y=a.r.min.d));var A=PData.d3Nums(n,u,y,!1),l=0,C,E;0<a.l.length&&(h=a.l[0],C=m(h.d.min.y,1,1,h.d.min),E=g(h.d.max));for(d&&"undefined"!==typeof a.r.u&&(c?e.push({l:"?",c:a.r.u.v,min:"?",max:"?",i:[]}):e.push({l:"?",c:a.r.u.v,min:"?",max:"?"}));A<=p;){d={};c&&(d.i=[]);switch(f){case "d":d.l=n.toString()+"-"+u.toString()+"-"+y.toString();break;case "m":d.l=n.toString()+
"-"+u.toString();break;case "y":case "t":case "c":d.l=n.toString()}for(;l<a.l.length&&A>E;)h=a.l[++l],l<a.l.length&&(C=m(h.d.min.y,1,1,h.d.min),E=g(h.d.max));d.c=0==a.l.length||A<C?"#777777":l==a.l.length?"#777777":A<=E?h.v:"#777777";d.min=A;switch(f){case "d":++y>PData.lenMnth(n,u)&&(y=1,12<++u&&(u=1,n++));break;case "m":12<++u&&(u=1,n++);break;case "y":n++;break;case "t":n+=10;break;case "c":n+=100}A=PData.d3Nums(n,u,y,!1);A>TODAY&&(A=TODAY);A.setTime(A.getTime()+10);d.max=A;e.push(d);A=PData.d3Nums(n,
u,y,!1)}return e}},cFill:function(a,c,d,e){var f=PData.eTNum(),g=0,h,m=0,t,n,p,u,y=PData.aByID(c);for(h=e.t[0];m<e.l;){for(;0==h.n||h.i+h.n==m||!PData.aInT(c,g)||d&&!PData.aInT(d,g);){if(++g==f)return;h=e.t[g];m=h.i}t=e.s[m];n=PData.rByN(t);n=n.a[c];if("undefined"!==typeof n)switch(y.def.t){case "T":for(p=0;p<a.length;p++)if(u=a[p],-1!==n.indexOf(u.x)){u.i.push(t);break}break;case "g":n.forEach(function(c){for(p=0;p<a.length;p++)if(u=a[p],c===u.l){u.i.push(t);break}p===a.length&&a.push({l:c,i:[t],
c:"#"+Math.floor(16777215*Math.random()).toString(16)})});break;case "V":n.forEach(function(c){for(p=0;p<a.length;p++)if(u=a[p],c==u.l){u.i.push(t);break}});break;case "N":p=0;u=a[0];if("?"===u.min){if("?"===n){u.i.push(t);break}p=1}if("?"===n)break;for(;p<a.length;p++){u=a[p];if(n<u.min)break;if(u.min<=n&&n<=u.max){u.i.push(t);break}}break;case "D":p=0;u=a[0];if("?"===u.min){if("?"===n){u.i.push(t);break}p=1}if("?"!==n)for(n=PData.dObj(n.min,1,!1);p<a.length;p++){u=a[p];if(n<u.min)break;if(u.min<=
n&&n<u.max){u.i.push(t);break}}}m++}"g"==y.def.t&&a.sort(function(a,c){return PData.strcmp(c.l,a.l)})},cSort:function(a,c,d){var e=c.id,f,g,h;a.forEach(function(a){f=PData.rByN(a);datum=f.a[e];if("undefined"!==typeof datum)switch(c.def.t){case "T":for(g=0;g<d.length;g++)if(h=d[g],-1!==datum.indexOf(h.x)){h.i.push(a);break}break;case "g":datum.forEach(function(c){for(g=0;g<d.length;g++)if(h=d[g],c===h.l){h.i.push(a);break}g===d.length&&d.push({l:c,i:[a],c:"#777777"})});break;case "V":datum.forEach(function(c){for(g=
...
c){return PData.strcmp(c.l,a.l)})},rTOrder:function(a,c,d){function e(a){return a}function f(a){return a[0]}function g(a){if("?"===a)return"?";var c=1,d=1;"undefined"!==typeof a.min.m&&(c=a.min.m,"undefined"!==typeof a.min.d&&(d=a.min.d));return PData.d3Nums(a.min.y,c,d,!1)}var h,n;switch(a.def.t){case "T":h=e;n="~";break;case "V":h=f;n="~";break;case "g":h=f;n="~";break;case "N":h=e;n=a.r.max;break;case "D":h=g,n=TODAY}var p=[],x=c.t[d];d=m[d];for(var B=0,u,y;B<x.n;)u=c.s[x.i+B++],y=d.d[u-d.i],y=
y.a[a.id],"undefined"===typeof y?p.push({i:u,v:n}):p.push({i:u,v:h(y)});switch(a.def.t){case "T":case "g":case "V":p.sort(function(a,c){return PData.strcmp(c.v,a.v)});break;case "D":case "N":p.sort(function(a,c){return"?"===a.v?-1:"?"===c.v?1:a.v-c.v})}return p},vByN:function(a){return prspdata.e.vf[a]},ready:function(){return n}}}();
jQuery(document).ready(function(a){function c(){var a;PState.set(PSTATE_PROCESS);null==u&&(u=PData.sNew(!0));y=u;var c=!1,d,e;for(d=0;d<t.length;d++)if(e=t[d],a=jQuery('div.filter-instance[data-id="'+e.id+'"]'),c||e.f.isDirty(null)){c=!0;e=e.f;e.evalPrep();for(var f=PData.sNew(!1),g=0,h,k,m=0,n=y.t[0],p=0,q=0,r=a.find(".apply-tmplt-0").is(":checked");g<y.l;){for(;0==n.n||n.i+n.n==g;)f.t.push({i:f.l-p,n:p}),p=0,n=y.t[++m],r=a.find(".apply-tmplt-"+m).is(":checked");h=y.s[g++];r?(k=PData.rByN(h),e.eval(k)&&
(f.s[f.l++]=h,p++),q++):(f.s[f.l++]=h,p++)}for(;m++<PData.eTNum();)f.t.push({i:f.l-p,n:p}),p=0;e.isDirty(!1);e.out=f;e.evalDone(q);y=f}else y=e.f.out;PState.set(PSTATE_BUILD);l.forEach(function(a){a&&a.showStream(y)});0<t.length?jQuery("#btn-f-state").prop("disabled",!0).html(dlText.filtered):jQuery("#btn-f-state").prop("disabled",!0).html(dlText.nofilter)}function d(a){var c=jQuery("#annote");c.text(a);0<a.length?(jQuery("#btn-annote").button("enable"),c.show()):(jQuery("#btn-annote").button("disable"),
c.hide())}function e(a){var c=_.find(prspdata.p,function(c){return a==c.id});return c?c:null==A||0==C.length?null:(c=_.find(C,function(c){return a==c.id}))?c:null}function f(a,c){var d=jQuery("input[name=save-prspctv-dest]:checked").val();if(""==d)return null;var e=jQuery("#save-prspctv-note").val(),e=e.replace(/"/g,""),f={f:[],h0:null,h1:null,v0:null,v1:null};l.forEach(function(a,c){a&&(f["v"+c]={l:a.title(),s:a.getState()})});t.forEach(function(a){for(var c=[],d=jQuery('div.filter-instance[data-id="'+
a.id+'"]'),e=0;e<PData.eTNum();e++)c.push(d.find(".apply-tmplt-"+e).is(":checked"));f.f.push({id:a.attID,a:c,s:a.f.getState()})});for(var g=0;2>g;g++){var h=x[g];null!==h&&jQuery("#save-prspctv-h"+g).is(":checked")&&(f["h"+g]={id:B[g],s:h.getState()})}var k={id:a,l:c,n:e,s:f};"local"==d?(C.push(k),A.setItem(prspdata.e.id,JSON.stringify(C))):"server"==d&&jQuery.ajax({type:"POST",url:prspdata.ajax_url,data:{action:"prsp_save_prspctv",id:a,l:c,x:prspdata.e.id,n:e,s:JSON.stringify(f)},success:function(a,
...
prspdata.e.g.hurl;a.preventDefault()}function m(a){jQuery(this).parent().next().slideToggle(400);a.preventDefault()}function p(a){if(a=jQuery(this).closest("div.filter-instance")){var c=a.data("id");c&&""!==c&&(a=t.find(function(a){return a.id==c}),null==a?alert("Bad Filter ID "+c):a.f.isDirty(!0))}}function n(a){var d=jQuery(this).closest("div.filter-instance"),e=d.data("id"),f,g;f=t.findIndex(function(a){return a.id==e});if(-1===f)alert("Bad Filter ID "+e);else{g=t[f].f;g.teardown();t.splice(f,
1);if(f>=t.length){var h;h=0===t.length?u:t[f-1].out;l.forEach(function(a){a&&a.setStream(h)})}else t[f].f.isDirty(!0);d.remove();0===t.length?(jQuery("#btn-toggle-filters").button("disable"),l.forEach(function(a){a&&a.clearSel(h)}),c(),PState.set(PSTATE_READY)):jQuery("#btn-f-state").prop("disabled",!1).html(dlText.dofilters);a.preventDefault()}}function k(a,c,d){var e,f,g;if(null!==d)e=d;else{do e=Math.floor(1E3*Math.random()+2),-1!=t.findIndex(function(a){return a.id==e})&&(e=-1);while(-1==e)}if("_remove"==
a)f=new PFilterRemove(e),g={t:[!0,!0,!0,!0]};else switch(g=PData.aByID(a),g.def.t){case "V":f=new PFilterVocab(e,g);break;case "T":f=new PFilterText(e,g);break;case "g":f=new PFilterTags(e,g);break;case "N":f=new PFilterNum(e,g);break;case "D":f=new PFilterDates(e,g)}if(null!==d)c=jQuery("#dialog-hilite-"+d+" span.filter-id").html(g.def.l),c=jQuery("#hilite-"+d),c.empty();else{t.push({id:e,attID:a,f:f,out:null});d=_.template(document.getElementById("dltext-filter-head").innerHTML);jQuery("#filter-instances").append(d({newID:e,
title:f.title(),apply:z}));d=jQuery('div.filter-instance[data-id="'+e+'"]');for(a=0;a<PData.eTNum();a++){var h=d.find(".apply-tmplt-"+a);h.prop("disabled",!g.t[a]);h.prop("checked",c[a]&&g.t[a]);h.click(p)}d.find("button.btn-filter-toggle").button({text:!1,icons:{primary:"ui-icon-carat-2-n-s"}}).click(m);d.find("button.btn-filter-del").button({text:!1,icons:{primary:"ui-icon-trash"}}).click(n);jQuery("#btn-f-state").prop("disabled",!1).html(dlText.dofilters)}f.setup();return f}function r(a,c,d,e){jQuery("#filter-list li").removeClass("selected");
...
function q(a){PState.set(PSTATE_PROCESS);var c=l[a],d=c.getBMData(),e=[];a=x[a];if(null!==y){a.evalPrep();var f=0,g,h,k=0,m=y.t[0];a:for(;f<y.l;){for(;!d.t[k]||0==m.n||m.i+m.n==f;){if(++k===PData.eTNum())break a;m=y.t[k];f=m.i}g=y.s[f++];d.r[g>>4]&1<<(g&15)&&(h=PData.rByN(g),a.eval(h)&&e.push(g))}a.evalDone(y.l)}PState.set(PSTATE_UPDATE);0<e.length?c.setSel(e):c.clearSel();PState.set(PSTATE_READY)}function v(a,c){var d;d=jQuery("#dialog-hilite-"+a).dialog({height:275,width:Math.min(jQuery(window).width()-
20,675),modal:!0,appendTo:"#dialog-1",buttons:[{text:dlText.chsatt,click:function(){r(!1,!0,c,function(c){B[a]=c;x[a]=k(c,null,a)})}},{text:dlText.ok,click:function(){d.dialog("close");null!==x[a]&&q(a)}},{text:dlText.cancel,click:function(){d.dialog("close")}}]})}function D(a){function f(a){return prspdata.e.vf.findIndex(function(c){return a==c.l})}a=e(a);if(null==a)return!1;PState.set(PSTATE_PROCESS);jQuery("#filter-frame").hide();t.forEach(function(a){a.f.teardown()});t=[];jQuery("#filter-instances").empty();
a.s.f.forEach(function(a){k(a.id,a.a,null).setState(a.s)});jQuery("#filter-instances").hide();jQuery("#btn-toggle-filters").button(0==a.s.f.length?"disable":"enable");for(var g=0;2>g;g++)if(null!=a.s["h"+g]){var h=a.s["h"+g];B[g]=h.id;var m=k(h.id,null,g);x[g]=m;m.setState(h.s)}else x[g]=null,B[g]=null;var h=l[0],m=l[1],n=!1;PState.set(PSTATE_BUILD);g=f(a.s.v0.l);h?(h.setViz(g,!1),h.selBtns(!1)):(l[0]=PViewFrame(0),h=l[0],h.initDOM(g));null!==a.s.v1?(g=f(a.s.v1.l),m?(m.selBtns(!1),m.setViz(g,!1),
m.setState(a.s.v1.s)):(h.flushLgnd(),l[1]=PViewFrame(1),m=l[1],m.initDOM(g),m.setState(a.s.v1.s),n=!0)):m&&(l[1]=null,jQuery("#view-frame-1").remove(),n=!0);n&&h.resize();h.setState(a.s.v0.s);d(a.n);if(PData.ready()&&u)for(c(),g=0;2>g;g++)null!==B[g]&&q(g);return!0}function w(a,c){var d=prspdata.bClrs[a];d&&0<d.length&&jQuery(c).css("background-color",d)}var l=[null,null],z,t=[],x=[null,null],B=[null,null],u,y,A=null,C=[];jQuery("body").addClass("waiting");w("cb","#command-bar");w("fs","#filter-frame");
...
!1);jQuery("#save-prspctv-h1").prop("checked",!1);for(var g=0;2>g;g++){var h=null===x[g]||null===l[g];jQuery("#save-prspctv-h"+g).prop("disabled",h)}c=jQuery("#dialog-save-prsrctv").dialog({width:350,height:370,modal:!0,buttons:[{text:dlText.ok,click:function(){var a=jQuery("#save-prspctv-id").val().trim(),g=a.match(d),h=jQuery("#save-prspctv-lbl").val().trim(),h=h.replace(/"/g,"");if(0===a.length||20<a.length||g)g="#dialog-prspctv-id-badchars";else if(e(a))g="#dialog-prspctv-id-used";else if(0===
...
d){switch(d.s){case PSTATE_PROCESS:PState.set(PSTATE_PROCESS);c();for(var e=0;2>e;e++)null!==x[e]&&q(e);PState.set(PSTATE_READY);jQuery("body").removeClass("waiting");break;case PSTATE_FDIRTY:jQuery("#btn-f-state").prop("disabled",!1).html(dlText.dofilters);break;case PSTATE_HILITE:v(d.v,d.t)}});PState.set(PSTATE_LOAD);PData.init()});function onYouTubeIframeAPIReady(){widgetData.ytCall&&widgetData.ytCall()};