...
var f=this.lineLayer;f.clearLayers();var g=PData.eTNum(),k=0,m,p=0,n,h,r,q,v,x,y,l,A,w,u,C,t,z,B,D,E;z=this.settings.min;"string"===typeof z&&(z=parseInt(z));p=this.settings.max;"string"===typeof p&&(p=parseInt(p));B=p-z;for(k=0;k<g;k++)this.tLCnt[k]=0;for(var F,k=0;k<g;k++)if("disable"!==this.settings.pAtts[k]){F=[];break}k=0;p=-1;a:for(;k<a.l;){if(null==x){do{if(++p==g)break a;n=a.t[p]}while(0===n.n||n.i+n.n===k);x=this.vFrame.getSelLocAtts(p);if(0===x.length){x=null;continue}y=d.vFrame.getSelFeatAtts(p);
if(0===y.length){x=null;continue}d.tLCnt[p]=x.length;d.tUsed[p]=!0;q=d.vFrame.getSelLegend(p);v=PData.aByID(q);l=d.settings.pAtts[p];h=d.settings.lClrs[p];if(C=d.settings.sAtts[p])t=PData.aByID(C),"number"===typeof t.r.min&&"number"===typeof t.r.max?(D=t.r.min,E=t.r.max-D):C=null}m=a.s[k];r=PData.rByN(m);var G;F&&(G={id:r.id,c:[],p:r.a[l],l:h});x.forEach(function(a){if(A=r.a[a])if(w=r.a[q],"undefined"!==typeof w&&(w=PData.lClr(w,v,y))){d.rMap[m>>4]|=1<<(m&15);if("number"===typeof A[0])C?(t=r.a[C],
t="number"===typeof t?Math.floor((t-D)*B/E)+z:z):t=z,u=L.circleMarker(A,{_aid:m,weight:1,radius:t,fillColor:w,color:"#000",opacity:1,fillOpacity:1}),G&&G.c.push(A);else if(u=2===A.length?L.polyline(A,{_aid:m,weight:1,fillColor:w,color:"#000",opacity:1,fillOpacity:1}):L.polygon(A,{_aid:m,weight:1,fillColor:w,color:"#000",opacity:1,fillOpacity:1}),G){var h=[0,0];A.forEach(function(a){h[0]+=a[0];h[1]+=a[1]});h[0]/=A.length;h[1]/=A.length;G.c.push(h)}u.on("click",c);e.addLayer(u)}});G&&0<G.c.length&&
F.push(G);++k==n.i+n.n&&(x=null)}if(F){F.sort(function(a,c){return PData.strcmp(c.id,a.id)});var I=[];F.forEach(function(a){a.p&&a.p.forEach(function(c){k=_.sortedIndex(F,{id:c},"id");if(k<F.length){var h=F[k];h.id===c&&a.c.forEach(function(c){h.c.forEach(function(h){c[0]===h[0]&&c[1]===h[1]||I.push({p:[c,h],c:a.l})})})}})});I.forEach(function(a){f.addLayer(L.polyline(a.p,{color:a.c,weight:2}))})}};VizMap.prototype.teardown=function(){var a=this.vFrame.getIndex();jQuery("#view-frame-"+a+" div.view-controls div.iconbar").remove()};
...
VizCards.prototype.render=function(a){var c=this;this.stream=a;var d=PData.eTNum(),e,f,g,k,m,p,n,h,r,q,v,x,y,l,A=jQuery(this.frameID);A.empty();0<this.recSel.length&&(this.recSel=[]);this.preRender();var w,u="w"+this.settings.w+" h"+this.settings.h;f=a.t[0];for(e=0;e<d;){for(;0===f.n;){if(++e===d)return;f=a.t[e]}f=PData.eTByN(e);f=PData.tByID(f);p=c.vFrame.getSelFeatAtts(e);0!==p.length&&(A.append('<div class="template-label">'+f.l+'</div><div class="cards" data-ti="'+e+'"></div>'),w=jQuery('div.cards[data-ti="'+
e+'"]'),this.tUsed[e]=!0,g=c.vFrame.getSelLegend(e),k=PData.aByID(g),m=c.settings.iAtts[e],q=c.settings.cnt[e],f=c.sAtts[e],f=PData.aByID(f),f=PData.rTOrder(f,a,e),f.forEach(function(a){n=PData.rByN(a.i);v=n.a[g];"undefined"!==typeof v&&(h=PData.lRecs(v,k,p,!1))&&(c.rMap[a.i>>4]|=1<<(a.i&15),y=c.settings.lOn?'<div class="card-title">'+n.l+"</div>":"",r=!1,x="",q&&0<q.length&&(l=h.b?' style="color:black"':"",q.forEach(function(a){if(v=n.a[a])if(v=PData.procAttTxt(a,v))r=!0,x+=v+"<br/>"})),x=m&&(v=
n.a[m])?r?'<div class="card-body"><img src="'+v+'"/><div class="card-cnt"'+l+">"+x+"</div></div>":'<div class="card-body"><img class="full" src="'+v+'"/></div>':'<div class="card-body"><div class="card-cnt"'+l+">"+x+"</div>",w.append('<div class="card '+u+'" style="background-color:'+h.v+'" data-ai="'+a.i+'">'+y+x+"</div>"))}));f=a.t[++e]}};VizCards.prototype.teardown=function(){jQuery(this.frameID).off("click.vf")};
VizCards.prototype.rerender=function(a){var c=this,d=jQuery(this.frameID+' div.cards[data-ti="'+a+'"]');d.empty();var e,f,g,k,m,p,n,h,r,q,v,x,y,l="w"+this.settings.w+" h"+this.settings.h;e=c.vFrame.getSelFeatAtts(a);0!=e.length&&(f=c.vFrame.getSelLegend(a),g=PData.aByID(f),k=c.settings.iAtts[a],m=c.settings.cnt[a],p=c.sAtts[a],p=PData.aByID(p),a=PData.rTOrder(p,c.stream,a),a.forEach(function(a){n=PData.rByN(a.i);h=n.a[f];"undefined"!==typeof h&&(r=PData.lRecs(h,g,e,!1))&&(x=c.settings.lOn?'<div class="card-title">'+
n.l+"</div>":"",q=!1,v="",m&&0<m.length&&(y=r.b?' style="color:black"':"",m.forEach(function(a){if(h=n.a[a])if(h=PData.procAttTxt(a,h))q=!0,v+=h+"<br/>"})),v=k&&(h=n.a[k])?q?'<div class="card-body"><img src="'+h+'"/><div class="card-cnt"'+y+">"+v+"</div></div>":'<div class="card-body"><img class="full" src="'+h+'"/></div>':'<div class="card-body"><div class="card-cnt"'+y+">"+v+"</div>",d.append('<div class="card '+l+(c.isSel(a.i)?" obj-sel":"")+'" style="background-color:'+r.v+'" data-ai="'+a.i+'">'+
...
VizPinboard.prototype.render=function(a){var c=this;this.gRecs.selectAll(".recobj").remove();this.gRecs.selectAll(".recline").remove();0<this.recSel.length&&(this.recSel=[]);this.preRender();var d=PData.eTNum(),e,f,g=0,k,m,p,n,h,r,q,v,x,y,l,A,w,u,C,t;for(e=0;e<d;e++)if("disable"!==this.settings.pAtts[e]){t=[];break}A=this.settings.min;"string"===typeof A&&(A=parseInt(A));f=this.settings.max;"string"===typeof f&&(f=parseInt(f));w=f-A;var z=[];e=0;g=-1;a:for(;e<a.l;){if(null==r){do{if(++g===d)break a;
k=a.t[g]}while(0===k.n||k.i+k.n===e);r=this.vFrame.getSelLocAtts(g);if(0===r.length){r=null;continue}r=r[0];q=c.vFrame.getSelFeatAtts(g);if(0===q.length){r=null;continue}c.tUsed[g]=!0;n=c.vFrame.getSelLegend(g);h=PData.aByID(n);v=c.settings.pAtts[g];m=c.settings.lClrs[g];if(l=c.settings.sAtts[g])p=PData.aByID(l),"number"===typeof p.r.min&&"number"===typeof p.r.max?(u=p.r.min,C=p.r.max-u):l=null}f=a.s[e];p=PData.rByN(f);var B;t&&(B={id:p.id,c:null,p:p.a[v],l:m});x=p.a[r];"undefined"!==typeof x&&(y=
p.a[n],"undefined"!==typeof y&&(y=PData.lClr(y,h,q)))&&(c.rMap[f>>4]|=1<<(f&15),l?(p=p.a[l],p="number"===typeof p?Math.floor((p-u)*w/C)+A:A):p=A,z.push({ai:f,v:y,x:x[0],y:x[1],r:p}),B&&(B.c=x));B&&B.c&&t.push(B);++e==k.i+k.n&&(r=null)}this.gRecs.selectAll(".recobj").data(z).enter().append("circle").attr("class","recobj").attr("cx",function(a){return c.xScale(a.x)}).attr("cy",function(a){return c.yScale(a.y)}).attr("r",function(a){return c.yScale(a.r)}).style("fill",function(a){return a.v}).on("click",
...
"lgBd").attr("y",function(a){return x.yScale(a.t)}).attr("height",function(a){return x.yScale(a.h)});A.append("rect").attr("width","100%").attr("height","100%").attr("fill",function(a){return a.d.v});1===a&&A.append("text").attr("class","lgBdLbl").attr("x",2).attr("y",l).attr("fill",function(a){return a.d.b?"#000000":"#FFFFFF"}).style("font-size",k).text(function(a){return a.d.l});var w;d3.select(x.svgID).selectAll(".event").remove();w=d3.select(x.svgID).selectAll(".event").data(g.events).enter().append("svg").attr("class",
...
1===a&&u.append("text").attr("class","rangeLbl").attr("x",4).attr("y",l).attr("fill",function(a){return a.c.b?"#000000":"#FFFFFF"}).style("font-size",k).text(function(a){return a.l});u=d3.select(x.svgID).selectAll(".instant");u.append("circle").attr("cx",h).attr("cy",e).attr("r",d).attr("fill",function(a){return a.c.v});1===a&&u.append("text").attr("class","instantLbl").attr("x",f).attr("y",l).style("font-size",k).text(function(a){return a.l});x.redraw=function(){A.attr("x",function(a){return x.xScale(a.s)}).attr("width",
...
[]);this.preRender();this.events=[];this.lgBds=[];var m=0;(function(){for(var e=PData.eTNum(),d=0,h,r,q,f,k,y,l,A;d<e;){for(h=a.t[d];0===h.n;){if(++d==e)return;h=a.t[d]}q=g.vFrame.getSelLocAtts(d);if(0!==q.length&&(q=g.vFrame.getSelFeatAtts(d),0!==q.length)){g.tUsed[d]=!0;A=g.vFrame.getSelLegend(d);l=PData.aByID(A);f=g.settings.dAtts[d];for(var w,u,C,t,z,B,D,E,F=[],G=h.i;G<h.i+h.n;G++)r=a.s[G],E=PData.rByN(r),k=E.a[A],"undefined"!==typeof k&&(k=PData.lRecs(k,l,q,!1))&&(y=E.a[f])&&"?"!==y&&(g.rMap[r>>
4]|=1<<(r&15),B=y.min.f?EVENT_F_START:0,w=y.min.y,"undefined"===typeof y.min.m?C=u=1:(u=y.min.m,C="undefined"===typeof y.min.d?1:y.min.d),t=PData.d3Nums(w,u,C,!1),"undefined"===typeof y.max?(B|=EVENT_INSTANT,z=t.getTime()+g.instGap):"open"===y.max?z=TODAY:(y.max.f&&(B|=EVENT_F_END),w=y.max.y,"undefined"===typeof y.max.m?(u=12,C=31):(u=y.max.m,C="undefined"===typeof y.max.d?PData.lenMnth(w,u):y.max.d),z=PData.d3Nums(w,u,C,!0)),F.push({s:t,e:z,ai:r,f:B,c:k,l:E.l,t:0}));F.sort(c);var I=[],K;F.forEach(function(a){for(K=
0;K<I.length&&!(a.e<I[K]);K++);a.t=K+m+1;I[K]=a.s});h=PData.aByID(f);h.l.forEach(function(a){D=a.d;w=D.min.y;"undefined"===typeof D.min.m?C=u=1:(u=D.min.m,C="undefined"===typeof D.min.d?1:D.min.d);t=PData.d3Nums(w,u,C,!1);"undefined"===typeof D.max.y?z=TODAY:(w=D.max.y,"undefined"===typeof D.max.m?(u=12,C=31):(u=D.max.m,C="undefined"===typeof D.max.d?PData.lenMnth(w,u):D.max.d),z=PData.d3Nums(w,u,C,!0));g.lgBds.push({s:t,e:z,t:m,h:I.length+1,d:a})});m+=I.length+1;g.events=g.events.concat(F)}d++}})();
...
jQuery('#dialog-sortby select[data-ti="'+g+'"]').val(d)}}});a.sAtts=[];for(var c=0;c<PData.eTNum();c++){var d=jQuery('#dialog-sortby select[data-ti="'+c+'"] :first').val();a.sAtts.push(d)}for(c=0;c<PData.eTNum();c++)jQuery('#dialog-sortby select[data-ti="'+c+'"]').val(a.sAtts[c])};
VizDirectory.prototype.render=function(a){var c=this,d=PData.eTNum(),e=0,f,g,k,m,p,n,h,r=jQuery(this.frameID);r.empty();0<this.recSel.length&&(this.recSel=[]);this.preRender();this.stream=a;for(f=a.t[0];e<d;){for(;0===f.n;){if(++e===d)return;f=a.t[e]}c.tUsed[e]=!0;f=PData.eTByN(e);f=PData.tByID(f);r.append('<div class="template-label">'+f.l+'</div><table cellspacing="0" class="viz-directory" data-ti='+e+"></table>");g=r.find('table[data-ti="'+e+'"]');k=c.settings.cnt[e];h=c.sAtts[e];n="<thead><tr>";
k.forEach(function(a){var c=PData.aByID(a);n+='<th data-aid="'+a;a===h&&(n+='" class="sel');n+='">'+c.def.l+"</th>"});g.append(n+"</tr></thead><tbody></tbody>");g=g.find("tbody");f=PData.aByID(h);f=PData.rTOrder(f,c.stream,e);f.forEach(function(a){p=PData.rByN(a.i);c.rMap[a.i>>4]|=1<<(a.i&15);n='<tr data-id="'+p.id+'" data-ai='+a.i+">";k.forEach(function(a){m=p.a[a];"undefined"!==typeof m?n=(m=PData.procAttTxt(a,m))?n+("<td>"+m+"</td>"):n+"<td></td>":n+="<td></td>"});g.append(n+"</tr>")});f=a.t[++e]}};
...
VizTextStream.prototype.render=function(a){var c=this,d=PData.eTNum(),e=0,f,g,k,m,p,n,h,r,q,v,x,y,l,A,w,u,C,t=jQuery(this.frameID);t.empty();0<this.recSel.length&&(this.recSel=[]);this.preRender();u=this.settings.max-this.settings.min;for(g=a.t[0];e<d;){for(;0===g.n;){if(++e===d)return;g=a.t[e]}q=c.vFrame.getSelLocAtts(e);if(0!==q.length&&(q=c.vFrame.getSelFeatAtts(e),0!==q.length)){c.tUsed[e]=!0;v=c.vFrame.getSelLegend(e);x=PData.aByID(v);t.append('<div class="viz-textstream" data-ti='+e+"></div>");
k=t.find("div.viz-textstream[data-ti="+e+"]");f=PData.eTByN(e);f=PData.tByID(f);k.append('<div class="template-label">'+f.l+"</div>");r=c.settings.cnt[e];if(A=c.settings.sAtts[e])l=PData.aByID(A),"number"===typeof l.r.min&&"number"===typeof l.r.max?w=l.r.max-l.r.min:A=null;r&&(f=PData.aByID(c.settings.order[e]),f=PData.rTOrder(f,a,e),f.forEach(function(a){m=PData.rByN(a.i);p=m.a[v];"undefined"!==typeof p&&(y=PData.lRecs(p,x,q,!1))&&((n=m.a[r])&&(n=PData.procAttTxt(r,n)),n&&(c.rMap[a.i>>4]|=1<<(a.i&
15),A?(h=m.a[A],h="number"===typeof h?Math.floor((h-l.r.min)*u/w)+c.settings.min:c.settings.min):h=c.settings.min,C=y.b?";background-color:black":"",k.append('<div class="recitem" data-ai='+a.i+' style="color:'+y.v+C+";font-size:"+h+'px">'+n+"</div>")))}))}e++}};VizTextStream.prototype.teardown=function(){jQuery(this.frameID).off("click.vf")};
...
VizFlow.prototype.render=function(a){var c=this;this.bSel=[];this.fSel=[];this.barG.selectAll(".bar").remove();this.flowG.selectAll(".flow").remove();this.titleG.selectAll(".att-title").remove();var d=this.settings.w;c.bars=[];c.atts=[];c.settings.fcts.forEach(function(e,f){var g,k=PData.aByID(e);g="g"!==k.def.t?c.settings.gr?PData.cRNew(k,!0,!0):PData.cLNew(k,null,!0):[];PData.cFill(g,e,null,a);var m=[],p=0;g.forEach(function(a){0<a.i.length&&(m.push(a),p+=a.i.length)});var n=0,h=31+f*c.bH;m.forEach(function(a){c.bars.push({x:5+
n*d/p,w:a.i.length*d/p,y:h,c:a});n+=a.i.length});c.atts.push({l:k.def.l,c:m,t:p,y:h})});this.barG.selectAll(".bar").data(c.bars).enter().append("rect").attr("class","bar").attr("x",function(a){return a.x}).attr("y",function(a){return a.y}).attr("fill",function(a){return a.c.c}).attr("height","8").attr("width",function(a){return a.w}).on("click",function(a,d){var g=c.bSel.length,k=_.sortedIndex(c.bSel,d);c.bSel[k]===d?(d3.select(this).classed("obj-sel",!1),c.bSel.splice(k,1),0<g&&0===c.bSel.length&&
0===c.fSel.length&&c.vFrame.selBtns(!1)):(d3.select(this).classed("obj-sel",!0),c.bSel.splice(k,0,d),0===g&&0===c.fSel.length&&0<c.bSel.length&&c.vFrame.selBtns(!0))}).append("title").text(function(a){return a.c.l+" ("+a.c.i.length+")"});c.ints=[];c.atts.forEach(function(a,f){if(f!==c.atts.length-1){for(var g=c.atts[f+1],k=Array(a.c.length),m=0;m<a.c.length;m++)k[m]=Array(g.c.length);a.c.forEach(function(a,c){g.c.forEach(function(d,h){k[c][h]=PData.intersect(a.i,d.i)})});for(var p=Array(g.c.length),
n=0;n<g.c.length;n++){for(var h=0,m=0;m<a.c.length;m++)0<k[m][n].length&&h++;p[n]=h-1}for(var r=Array(g.c.length),n=0;n<g.c.length;n++)r[n]=0;var q=0;a.c.forEach(function(h,f){for(var y=0,l=0;l<g.c.length;l++)0<k[f][l].length&&y++;--y;var n=h.i.length*d/a.t,m=0,u=0;g.c.forEach(function(l,t){var z=k[f][t];if(0<z.length){var B=z.length*d,D=B/a.t,B=B/g.t,E=l.i.length*d/g.t;c.ints.push({i:z,c:h.c,l:h.l+" > "+l.l,x1:5+q*d/a.t+(y?(n-D)*m/y:0),x2:5+u*d/g.t+(p[t]?(E-B)*r[t]/p[t]:0),w1:D,w2:B,y1:a.y+10,y2:g.y-
1});m++;r[t]++}u+=l.i.length});q+=h.i.length})}});this.flowG.selectAll(".flow").data(c.ints).enter().append("path").attr("class","flow").attr("d",function(a){return"M "+a.x1+" "+a.y1+"  L "+(a.x1+a.w1)+" "+a.y1+" L "+(a.x2+a.w2)+" "+a.y2+" L "+a.x2+" "+a.y2+" L "+a.x1+" "+a.y1}).attr("fill",function(a){return a.c}).on("click",function(a,d){var g=c.fSel.length,k=_.sortedIndex(c.fSel,d);c.fSel[k]===d?(d3.select(this).classed("obj-sel",!1),c.fSel.splice(k,1),0<g&&0===c.fSel.length&&0===c.bSel.length&&
...
VizBrowser.prototype.render=function(a){var c=this,d=this.vFrame.getIndex();this.recSel=[];this.stream=a;this.svg.selectAll(".facet-col").remove();var e=0;this.fcts=[];this.settings.fcts.forEach(function(d,f){var g,n=PData.aByID(d);g="g"===n.def.t?[]:c.settings.gr?PData.cRNew(n,!0,!0):PData.cLNew(n,null,!0);PData.cFill(g,d,null,a);var h=[],r=0;g.forEach(function(a){0<a.i.length&&(a.n=r++,h.push(a))});c.fcts.push({c:h,x:250*f,i:f,l:n.def.l,n:n.id,s:-1});e=Math.max(e,27+22*(h.length+1))});c.svg.attr("height",
...
VizMBMap.prototype.renderTree=function(a){function c(){var a=0,c=d.settings.w,g=null!==d.sbkSel?d.sbkSel.i:d.bkSel.i;PState.set(PSTATE_UPDATE);d.fcts.forEach(function(k,m){var p=[],n=0;k.c.forEach(function(a){a=PData.intersect(g,a.i);p.push(a);n+=a.length});var h=0,r;p.forEach(function(q){r=d.bars[a++];r.x=n?h*c/n:0;r.w=n?q.length*c/n:0;h+=q.length})});d.attsG.selectAll(".bar").transition().attr("x",function(a){return a.x}).attr("width",function(a){return a.w});PState.set(PSTATE_READY)}var d=this;
...
PFilterNum.prototype.evalBoxes=function(a){function c(c,k){function h(){r=!0;a.find(c).addClass("error")}var r=!1,q,v=a.find(c).val();(v=e.exec(v))?(a.find(c).removeClass("error"),q=parseInt(v[1],10)):h();r||(0==k?null!==f&&q<f&&h():null!==g&&q>g&&h());d.uNums[k]=q;return r}var d=this,e=/^(\d+)$/,f="undefined"===typeof this.att.r.min?null:this.att.r.min,g="undefined"===typeof this.att.r.max?null:this.att.r.max,k,m;k=c(".from",0);m=c(".to",1);this.uNums[0]>this.uNums[1]&&(m=!0);a.find(".filter-update").prop("disabled",
...
PFilterDates.prototype.evalBoxes=function(a){function c(c,g){function k(d){r=!0;a.find(c+d).addClass("error")}function h(d){a.find(c+d).removeClass("error")}var r=!1,q={y:0,m:0,d:0,ms:null},v=a.find(c+"-y"),v=v.val();(v=e.exec(v))?(h("-y"),q.y=parseInt(v[1],10)):k("-y");v=a.find(c+"-m");v=v.val();(v=f.exec(v))?(q.m=parseInt(v[1],10),1>q.m||12<q.m?k("-m"):h("-m")):k("-m");v=a.find(c+"-d");v=v.val();(v=f.exec(v))?(q.d=parseInt(v[1],10),1>q.d||31<q.d?k("-d"):h("-d")):k("-d");r||(q.ms=PData.d3Nums(q.y,
...
c+'"]').next().after('<div class="xscript">'+a+"</div>")})}function e(a){widgetData.tcArray=[];widgetData.tcIndex=-1;var f=widgetData.tcArray;a=new String(a);if(a=c(a).split(/\r\n|\r|\n/g)){var l=jQuery("#xscript-tbl"),q=0,r,g=0,v=0,k="";_.each(a,function(a){a=c(a);1<a.length&&("["===a.charAt(0)&&"0"<=a.charAt(1)&&"9">=a.charAt(1)?(r=d(a),0<k.length&&(v&&f.push({s:g,e:r}),l.append('<div class="row"><div class="timecode" data-timecode="'+g+'" data-tcindex="'+q++ +'">'+v+'</div><div class="xscript">'+
k+"</div></div>"),k=""),v=a,g=r):(0<k.length&&(k+="<br/>"),k+=a))});0<k.length&&(f.push({s:g,e:324E5}),l.append('<div class="row"><div class="timecode" data-timecode="'+g+'" data-tcindex="'+q+'">'+v+'</div><div class="xscript">'+k+"</div></div>"));"undefined"!==typeof C&&null!=C&&jQuery.ajax({type:"POST",url:prspdata.ajax_url,data:{action:"prsp_get_transcript",transcript:C,excerpt:widgetData.extract},success:function(a,c,d){h(JSON.parse(a),l)},error:function(a,c,d){alert(d)}})}}function f(a){var c,
...
height:Math.floor(9*(n-40)/16),videoId:widgetData.ytCode,events:{onError:function(a){console.log("YouTube Error: "+a.data)},onStateChange:function(a){var c;switch(a.data){case 1:widgetData.playing=!0;null==widgetData.timer&&(widgetData.timer=setInterval(function(){c=1E3*widgetData.widget.getCurrentTime();widgetData.playing&&widgetData.xscriptOn&&f(c)},300));break;case 0:case 2:widgetData.playing=!1;window.clearInterval(widgetData.timer);widgetData.timer=null;break;case 3:case 5:widgetData.playing=
!1}},onReady:function(){widgetData.extract&&widgetData.widget.cueVideoById({videoId:widgetData.ytCode,startSeconds:widgetData.sTime/1E3,endSeconds:widgetData.eTime/1E3})}}})}function r(){widgetData.playing=!0}function q(){widgetData.playing=!1}function g(){widgetData.playing&&widgetData.xscriptOn&&f(1E3*widgetData.widget.currentTime)}function v(){switch(p){case 3:null!=widgetData.widget&&(widgetData.widget.removeEventListener("ended",q),widgetData.widget.removeEventListener("pause",q),widgetData.widget.removeEventListener("playing",
r),widgetData.widget.removeEventListener("timeupdate",g));case 1:null!=widgetData.widget&&widgetData.playing&&widgetData.widget.pause();widgetData.playing=!1;widgetData.widget=null;break;case 2:widgetData.ytCall=null,null!=widgetData.widget&&widgetData.playing&&widgetData.widget.stopVideo(),widgetData.widget=null,widgetData.playing=!1,null!=widgetData.timer&&(window.clearInterval(widgetData.timer),widgetData.timer=null)}}function x(){function a(){widgetData.sTime=widgetData.eTime=null;var c;(c=prspdata.e.i.t.tcAtts[k])&&
(c=H.a[c])&&""!==c&&(widgetData.extract=c,c=c.split("-"),widgetData.sTime=d(c[0]),widgetData.eTime=d(c[1]))}var c=J[M];H=PData.rByN(c);var h=" "+H.l+" ("+(M+1)+"/"+J.length+") ",v=jQuery("#inspect-name");v.text(h);v.prop("title",H.id);var k=PData.n2T(c);u.empty();t=null;p=0;widgetData.extract=null;widgetData.xscriptOn=!1;widgetData.playing=!1;if(prspdata.e.i.modal.scOn||"boolean"===typeof prspdata.e.i.modal.aOn&&prspdata.e.i.modal.aOn)if(t=prspdata.e.i.sc.atts[k])if(h=H.a[t])if(a(),h.match(/soundcloud\.com/)){var y=
!0;p=1;u.append('<iframe id="sc-widget" class="player" width="100%" height="110" src="http://w.soundcloud.com/player/?url='+h+'"></iframe>');var z=SC.Widget(document.getElementById("sc-widget"));widgetData.widget=z;z.bind(SC.Widget.Events.READY,function(){z.play();z.bind(SC.Widget.Events.PLAY,function(){widgetData.playing=!0});z.bind(SC.Widget.Events.PAUSE,function(){widgetData.playing=!1});z.bind(SC.Widget.Events.PLAY_PROGRESS,function(a){y&&(z.pause(),y=!1,widgetData.playing=!1);widgetData.extract&&
(a.currentPosition<widgetData.sTime?z.seekTo(widgetData.sTime):a.currentPosition>widgetData.eTime&&(z.pause(),widgetData.playing=!1));widgetData.playing&&widgetData.xscriptOn&&f(a.currentPosition)});z.bind(SC.Widget.Events.FINISH,function(){widgetData.playing=!1})})}else p=3,widgetData.extract&&(v=widgetData.extract.split("-"),h+="#t="+v[0]+","+v[1]),u.append('<audio id="na-widget" controls src="'+h+'"></audio>'),widgetData.widget=document.getElementById("na-widget"),widgetData.widget.addEventListener("ended",
q),widgetData.widget.addEventListener("pause",q),widgetData.widget.addEventListener("playing",r),widgetData.widget.addEventListener("timeupdate",g);0===p&&prspdata.e.i.modal.ytOn&&(t=prspdata.e.i.yt.atts[k])&&(h=H.a[t])&&(a(),widgetData.ytCode=h,u.append('<div id="yt-widget"></div>'),widgetData.ytCall=l,widgetData.ytLoaded?l():(widgetData.ytLoaded=!0,h=document.createElement("script"),h.src="https://www.youtube.com/iframe_api",v=document.getElementsByTagName("script")[0],v.parentNode.insertBefore(h,
v)),p=2);prspdata.e.i.modal.tOn&&(h=prspdata.e.i.t.t1Atts[k])&&""!==h&&"disable"!==h&&(h=H.a[h],"string"===typeof h&&""!==h&&(0<p&&u.append("<div>"+document.getElementById("dltext-sync-xscript").innerHTML+"</div>"),u.find("#xscript-tbl").remove(),u.append('<div id="xscript-tbl"><div>'),widgetData.xscriptOn=!0,jQuery("#xscript-tbl").click(function(a){if(p&&jQuery(a.target).hasClass("timecode"))switch(a=jQuery(a.target).data("timecode"),p){case 1:widgetData.playing||(widgetData.playing=!0,widgetData.widget.play());
widgetData.widget.seekTo(a);break;case 2:widgetData.playing||(widgetData.playing=!0,widgetData.widget.playVideo());widgetData.widget.seekTo(a/1E3);break;case 3:widgetData.playing||(widgetData.playing=!0,widgetData.widget.play()),widgetData.widget.currentTime=a/1E3}}),C=null,(v=prspdata.e.i.t.t2Atts[k])&&""!==v&&"disable"!==v&&(C=H.a[v]),jQuery.ajax({type:"POST",url:prspdata.ajax_url,data:{action:"prsp_get_transcript",transcript:h,excerpt:widgetData.extract},success:function(a,c,d){e(JSON.parse(a))},
error:function(a,c,d){alert(d)}})));prspdata.e.i.modal.atts[k].forEach(function(a){var d=PData.rAV(c,a,!1);if(d){a=PData.aByID(a);var h;"_"==a.def.l.charAt(0)?h="<div>"+d+"</div>":(h='<div><span class="att-label">'+a.def.l+":</span> ","I"==a.def.t&&(h+="<br/>"),h+=d+"</div>");u.append(h)}})}function y(a){a=M+a;-1==a?a=J.length-1:a==J.length&&(a=0);a!=M&&(M=a,v(),x())}function m(a){y(-1)}function A(a){y(1)}var u=jQuery("#inspect-content"),t=null,p=0,C,n=450,N=400,J=null;w&&(J=w.getSel());if(null!=
J&&0!=J.length){var O,H,M=0;prspdata.e.i.modal.scOn&&(n=550);prspdata.e.i.modal.ytOn&&(n=Math.max(n,475),N=500);prspdata.e.i.modal.tOn&&(N+=100,prspdata.e.i.modal.t2On?(n=Math.max(750,Math.floor(.8*jQuery(document).width())),n=Math.min(900,n)):n=Math.max(n,550));"number"===typeof prspdata.e.i.modal.w&&(n=prspdata.e.i.modal.w);"number"===typeof prspdata.e.i.modal.h&&(N=prspdata.e.i.modal.h);k(!1);x();jQuery("#btn-inspect-left").click(m);jQuery("#btn-inspect-right").click(A);O=jQuery("#dialog-inspector").dialog({width:n,
height:N,modal:!0,buttons:[{text:dlText.seerec,click:function(){window.open(prspdata.site_url+"?p="+H.wp,"_blank")}},{text:dlText.close,click:function(){O.dialog("close")}}]});O.on("dialogclose",function(a,c){v();jQuery("#btn-inspect-left").off("click");jQuery("#btn-inspect-right").off("click");k(!0);O.off("dialogclose")});a.preventDefault()}}function k(a){var c=jQuery(d()+" div.view-controls");a?(c.find(".osel").button("enable"),c.find(".osel").addClass("pulse"),c.find(".xsel").button("enable")):
(c.find(".osel").button("disable"),c.find(".osel").removeClass("pulse"),c.find(".xsel").button("disable"))}function m(c){jQuery("body").trigger("prospect",{s:PSTATE_HILITE,v:a,t:w.tUsed});c.preventDefault()}function p(a){PState.set(PSTATE_UPDATE);w&&w.clearSel();k(!1);PState.set(PSTATE_READY);a.preventDefault()}function n(a){w&&w.doOptions();a.preventDefault()}function h(a){var c=jQuery("#dialog-vnotes").dialog({width:300,height:300,modal:!0,buttons:[{text:dlText.ok,click:function(){c.dialog("close")}}]});
a.preventDefault()}function r(a,h){jQuery(d()+' div.lgnd-container div.lgnd-scroll div.lgnd-template[data-index="'+a+'"] div.lgnd-group input.lgnd-entry-check').prop("checked",h);c(!0)}function q(a){var h=jQuery(a.target).closest("div.lgnd-template").data("index"),e=a.target.className;switch(e){case "lgnd-update":w&&t&&(PState.set(PSTATE_BUILD),k(!1),w.render(t),c(!1),PState.set(PSTATE_READY));break;case "lgnd-entry-check":e=jQuery(a.target).closest("div.lgnd-entry");a=jQuery(a.target).is(":checked");
e.hasClass("lgnd-sh")?r(h,a):e.hasClass("lgnd-locate")?(e.data("id"),c(!0)):e.hasClass("lgnd-value")&&(e.data("index"),c(!0));break;case "lgnd-viz":case "lgnd-value-title":e=jQuery(a.target).closest("div.lgnd-entry");e.hasClass("lgnd-locate")?(a=e.data("id"),jQuery(d()+' div.lgnd-container div.lgnd-scroll div.lgnd-template[data-index="'+h+'"] div.lgnd-locate input.lgnd-entry-check').prop("checked",!1),jQuery(d()+' div.lgnd-container div.lgnd-scroll div.lgnd-template[data-index="'+h+'"] div.lgnd-locate[data-id="'+
...
e.forEach(function(a,c){var d=PData.aByID(a);q+='<option value="'+a+'">'+d.def.l+"</option>"});q+="</select>";d=jQuery(q);d.change(v);jQuery(f).append(d);jQuery(f).append('<div class="lgnd-entry lgnd-sh"><input type="checkbox" checked="checked" class="lgnd-entry-check"/><i>'+dlText.sha+'</i></div><div class="lgnd-group"></div>');y.append(f);e=e[0];u.push(e);x(c,e);n=!0}}})}q.find("div.lgnd-container").show()}else q.find("button.hslgnd").button("disable"),q.find("div.lgnd-container").hide();c(!1);
...
z.a[a.id],"undefined"===typeof z?n.push({i:t,v:k}):n.push({i:t,v:l(z)});switch(a.def.t){case "T":case "g":case "V":n.sort(function(a,c){return PData.strcmp(c.v,a.v)});break;case "D":case "N":n.sort(function(a,c){return"?"===a.v?-1:"?"===c.v?1:a.v-c.v})}return n},vByN:function(a){return prspdata.e.vf[a]},ready:function(){return n}}}();
...
(f.s[f.l++]=h,p++),q++):(f.s[f.l++]=h,p++)}for(;m++<PData.eTNum();)f.t.push({i:f.l-p,n:p}),p=0;e.isDirty(!1);e.out=f;e.evalDone(q);z=f}else z=e.f.out;PState.set(PSTATE_BUILD);l.forEach(function(a){a&&a.showStream(z)});0<w.length?jQuery("#btn-f-state").prop("disabled",!0).html(dlText.filtered):jQuery("#btn-f-state").prop("disabled",!0).html(dlText.nofilter)}function d(a){var c=jQuery("#annote");c.text(a);0<a.length?(jQuery("#btn-annote").button("enable"),c.show()):(jQuery("#btn-annote").button("disable"),
...
prspdata.e.g.hurl;a.preventDefault()}function m(a){jQuery(this).parent().next().slideToggle(400);a.preventDefault()}function p(a){if(a=jQuery(this).closest("div.filter-instance")){var c=a.data("id");c&&""!==c&&(a=w.find(function(a){return a.id==c}),null==a?alert("Bad Filter ID "+c):a.f.isDirty(!0))}}function n(a){var d=jQuery(this).closest("div.filter-instance"),e=d.data("id"),f,g;f=w.findIndex(function(a){return a.id==e});if(-1===f)alert("Bad Filter ID "+e);else{g=w[f].f;g.teardown();w.splice(f,
...
d){switch(d.s){case PSTATE_PROCESS:PState.set(PSTATE_PROCESS);c();for(var e=0;2>e;e++)null!==u[e]&&q(e);PState.set(PSTATE_READY);jQuery("body").removeClass("waiting");break;case PSTATE_FDIRTY:jQuery("#btn-f-state").prop("disabled",!1).html(dlText.dofilters);break;case PSTATE_HILITE:v(d.v,d.t)}});PState.set(PSTATE_LOAD);PData.init()});function onYouTubeIframeAPIReady(){widgetData.ytCall&&widgetData.ytCall()};