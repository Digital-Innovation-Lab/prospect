...
function(c,e){g=c.o||1;a.lOps.push(100*g);var d;d=PMapHub.createMapLayer(c.lid,g,a.lMap,null);a.mapLayers.push(d)});var h=_.template(document.getElementById("dltext-v-map").innerHTML);jQuery("#view-frame-"+f+" div.view-controls").append(h({vi:f}));jQuery("#map-zoom-"+f).button({text:!1,icons:{primary:"ui-icon-plus"}}).click(function(){a.lMap.zoomIn()});jQuery("#map-unzoom-"+f).button({text:!1,icons:{primary:"ui-icon-minus"}}).click(function(){a.lMap.zoomOut()});jQuery("#map-reset-"+f).button({text:!1,
...
var f=this.lineLayer;f.clearLayers();var g=PData.eTNum(),h=0,m,n=0,p,k,t,q,w,D,x,l,z,v,r,B,u,y,A,C,E;y=this.settings.min;"string"===typeof y&&(y=parseInt(y));n=this.settings.max;"string"===typeof n&&(n=parseInt(n));A=n-y;for(h=0;h<g;h++)this.tLCnt[h]=0;for(var F,h=0;h<g;h++)if("disable"!==this.settings.pAtts[h]){F=[];break}h=0;n=-1;a:for(;h<a.l;){if(null==D){do{if(++n==g)break a;p=a.t[n]}while(0===p.n||p.i+p.n===h);D=this.vFrame.getSelLocAtts(n);if(0===D.length){D=null;continue}x=d.vFrame.getSelFeatAtts(n);
if(0===x.length){D=null;continue}d.tLCnt[n]=D.length;d.tUsed[n]=!0;q=d.vFrame.getSelLegend(n);w=PData.aByID(q);l=d.settings.pAtts[n];k=d.settings.lClrs[n];if(B=d.settings.sAtts[n])u=PData.aByID(B),"number"===typeof u.r.min&&"number"===typeof u.r.max?(C=u.r.min,E=u.r.max-C):B=null}m=a.s[h];t=PData.rByN(m);var G;F&&(G={id:t.id,c:[],p:t.a[l],l:k});D.forEach(function(a){if(z=t.a[a])if(v=t.a[q],"undefined"!==typeof v&&(v=PData.lClr(v,w,x))){d.rMap[m>>4]|=1<<(m&15);if("number"===typeof z[0])B?(u=t.a[B],
u="number"===typeof u?Math.floor((u-C)*A/E)+y:y):u=y,r=L.circleMarker(z,{_aid:m,weight:1,radius:u,fillColor:v,color:"#000",opacity:1,fillOpacity:1}),G&&G.c.push(z);else if(r=2===z.length?L.polyline(z,{_aid:m,weight:1,fillColor:v,color:"#000",opacity:1,fillOpacity:1}):L.polygon(z,{_aid:m,weight:1,fillColor:v,color:"#000",opacity:1,fillOpacity:1}),G){var k=[0,0];z.forEach(function(a){k[0]+=a[0];k[1]+=a[1]});k[0]/=z.length;k[1]/=z.length;G.c.push(k)}r.on("click",c);e.addLayer(r)}});G&&0<G.c.length&&
F.push(G);++h==p.i+p.n&&(D=null)}if(F){F.sort(function(a,c){return PData.strcmp(c.id,a.id)});var I=[];F.forEach(function(a){a.p&&a.p.forEach(function(c){h=_.sortedIndex(F,{id:c},"id");if(h<F.length){var k=F[h];k.id===c&&a.c.forEach(function(c){k.c.forEach(function(k){c[0]===k[0]&&c[1]===k[1]||I.push({p:[c,k],c:a.l})})})}})});I.forEach(function(a){f.addLayer(L.polyline(a.p,{color:a.c,weight:2}))})}};VizMap.prototype.teardown=function(){var a=this.vFrame.getIndex();jQuery("#view-frame-"+a+" div.view-controls div.iconbar").remove()};
...
VizMap.prototype.doOptions=function(){function a(){f&&(c.baseMap.setOpacity(c.bOp/100),c.lOps.forEach(function(a,e){c.mapLayers[e].setOpacity(a/100)}));g.empty()}var c=this,d=this.bOp,e=[],f=!0,g=jQuery("#dialog-opacities div.layer-list"),h=jQuery('<div class="op-layer" data-i="-1">Base Map <input type=range class="op-slider" min=0 max=100 value='+this.bOp+" step=5></div>");h.find(".op-slider").on("change",function(){d=jQuery(this).val();c.baseMap.setOpacity(d/100)});g.append(h);this.settings.lyrs.forEach(function(a,
d){h=jQuery('<div class="op-layer" data-i="'+d+'">'+c.mapLayers[d].options.layerName+' <input type=range class="op-slider" min=0 max=100 value='+c.lOps[d]+" step=5></div>");h.find(".op-slider").on("change",function(){e[d]=jQuery(this).val();c.mapLayers[d].setOpacity(e[d]/100)});e.push(c.lOps[d]);g.append(h)});var m=jQuery("#dialog-opacities").dialog({height:300,width:500,modal:!0,buttons:[{text:dlText.ok,click:function(){f=!1;m.dialog("close");c.bOp=d;e.forEach(function(a,d){c.lOps[d]=e[d]})}},{text:dlText.cancel,
click:function(){m.dialog("close")}}]});m.on("dialogclose",function(c,d){a();m.off("dialogclose")})};var VizCards=function(a,c){PVizModel.call(this,a,c)};VizCards.prototype=Object.create(PVizModel.prototype);VizCards.prototype.constructor=VizCards;VizCards.prototype.flags=function(){return V_FLAG_LGND|V_FLAG_SEL|V_FLAG_VSCRL|V_FLAG_OPT};VizCards.prototype.getFeatureAtts=function(a){return null!=a?this.settings.lgnds[a]:this.settings.lgnds};
...
VizCards.prototype.render=function(a){var c=this;this.stream=a;var d=PData.eTNum(),e,f,g,h,m,n,p,k,t,q,w,D,x,l,z=jQuery(this.frameID);z.empty();0<this.recSel.length&&(this.recSel=[]);this.preRender();var v,r="w"+this.settings.w+" h"+this.settings.h;f=a.t[0];for(e=0;e<d;){for(;0===f.n;){if(++e===d)return;f=a.t[e]}f=PData.eTByN(e);f=PData.tByID(f);n=c.vFrame.getSelFeatAtts(e);0!==n.length&&(z.append('<div class="template-label">'+f.l+'</div><div class="cards" data-ti="'+e+'"></div>'),v=jQuery('div.cards[data-ti="'+
e+'"]'),this.tUsed[e]=!0,g=c.vFrame.getSelLegend(e),h=PData.aByID(g),m=c.settings.iAtts[e],q=c.settings.cnt[e],f=c.sAtts[e],f=PData.aByID(f),f=PData.rTOrder(f,a,e),f.forEach(function(a){p=PData.rByN(a.i);w=p.a[g];"undefined"!==typeof w&&(k=PData.lRecs(w,h,n,!1))&&(c.rMap[a.i>>4]|=1<<(a.i&15),x=c.settings.lOn?'<div class="card-title">'+p.l+"</div>":"",t=!1,D="",q&&0<q.length&&(l=k.b?' style="color:black"':"",q.forEach(function(a){if(w=p.a[a])if(w=PData.procAttTxt(a,w))t=!0,D+=w+"<br/>"})),D=m&&(w=
p.a[m])?t?'<div class="card-body"><img src="'+w+'"/><div class="card-cnt"'+l+">"+D+"</div></div>":'<div class="card-body"><img class="full" src="'+w+'"/></div>':'<div class="card-body"><div class="card-cnt"'+l+">"+D+"</div>",v.append('<div class="card '+r+'" style="background-color:'+k.v+'" data-ai="'+a.i+'">'+x+D+"</div>"))}));f=a.t[++e]}};VizCards.prototype.teardown=function(){jQuery(this.frameID).off("click.vf")};
VizCards.prototype.rerender=function(a){var c=this,d=jQuery(this.frameID+' div.cards[data-ti="'+a+'"]');d.empty();var e,f,g,h,m,n,p,k,t,q,w,D,x,l="w"+this.settings.w+" h"+this.settings.h;e=c.vFrame.getSelFeatAtts(a);0!=e.length&&(f=c.vFrame.getSelLegend(a),g=PData.aByID(f),h=c.settings.iAtts[a],m=c.settings.cnt[a],n=c.sAtts[a],n=PData.aByID(n),a=PData.rTOrder(n,c.stream,a),a.forEach(function(a){p=PData.rByN(a.i);k=p.a[f];"undefined"!==typeof k&&(t=PData.lRecs(k,g,e,!1))&&(D=c.settings.lOn?'<div class="card-title">'+
p.l+"</div>":"",q=!1,w="",m&&0<m.length&&(x=t.b?' style="color:black"':"",m.forEach(function(a){if(k=p.a[a])if(k=PData.procAttTxt(a,k))q=!0,w+=k+"<br/>"})),w=h&&(k=p.a[h])?q?'<div class="card-body"><img src="'+k+'"/><div class="card-cnt"'+x+">"+w+"</div></div>":'<div class="card-body"><img class="full" src="'+k+'"/></div>':'<div class="card-body"><div class="card-cnt"'+x+">"+w+"</div>",d.append('<div class="card '+l+(c.isSel(a.i)?" obj-sel":"")+'" style="background-color:'+t.v+'" data-ai="'+a.i+'">'+
D+w+"</div>"))}))};VizCards.prototype.doOptions=function(){var a=this;this.sAtts.forEach(function(a,c){jQuery('#dialog-sortby select[data-ti="'+c+'"]').val(a)});var c=jQuery("#dialog-sortby").dialog({height:220,width:400,modal:!0,buttons:[{text:dlText.ok,click:function(){c.dialog("close");PState.set(PSTATE_BUILD);for(var d=0;d<PData.eTNum();d++){var e=jQuery('#dialog-sortby select[data-ti="'+d+'"]').val();e!=a.sAtts[d]&&(a.sAtts[d]=e,a.rerender(d))}PState.set(PSTATE_READY)}},{text:dlText.cancel,click:function(){c.dialog("close")}}]})};
...
function(a,e){if(!a){var m=e.getElementsByTagName("svg")[0];d3.select("#ol-"+d+"-"+c).node().appendChild(m)}})});this.gRecs=this.chart.append("g").attr("id","recs")};
VizPinboard.prototype.render=function(a){var c=this;this.gRecs.selectAll(".recobj").remove();this.gRecs.selectAll(".recline").remove();0<this.recSel.length&&(this.recSel=[]);this.preRender();var d=PData.eTNum(),e,f,g=0,h,m,n,p,k,t,q,w,D,x,l,z,v,r,B,u;for(e=0;e<d;e++)if("disable"!==this.settings.pAtts[e]){u=[];break}z=this.settings.min;"string"===typeof z&&(z=parseInt(z));f=this.settings.max;"string"===typeof f&&(f=parseInt(f));v=f-z;var y=[];e=0;g=-1;a:for(;e<a.l;){if(null==t){do{if(++g===d)break a;
h=a.t[g]}while(0===h.n||h.i+h.n===e);t=this.vFrame.getSelLocAtts(g);if(0===t.length){t=null;continue}t=t[0];q=c.vFrame.getSelFeatAtts(g);if(0===q.length){t=null;continue}c.tUsed[g]=!0;p=c.vFrame.getSelLegend(g);k=PData.aByID(p);w=c.settings.pAtts[g];m=c.settings.lClrs[g];if(l=c.settings.sAtts[g])n=PData.aByID(l),"number"===typeof n.r.min&&"number"===typeof n.r.max?(r=n.r.min,B=n.r.max-r):l=null}f=a.s[e];n=PData.rByN(f);var A;u&&(A={id:n.id,c:null,p:n.a[w],l:m});D=n.a[t];"undefined"!==typeof D&&(x=
n.a[p],"undefined"!==typeof x&&(x=PData.lClr(x,k,q)))&&(c.rMap[f>>4]|=1<<(f&15),l?(n=n.a[l],n="number"===typeof n?Math.floor((n-r)*v/B)+z:z):n=z,y.push({ai:f,v:x,x:D[0],y:D[1],r:n}),A&&(A.c=D));A&&A.c&&u.push(A);++e==h.i+h.n&&(t=null)}this.gRecs.selectAll(".recobj").data(y).enter().append("circle").attr("class","recobj").attr("cx",function(a){return c.xScale(a.x)}).attr("cy",function(a){return c.yScale(a.y)}).attr("r",function(a){return c.yScale(a.r)}).style("fill",function(a){return a.v}).on("click",
function(a,k){var d=c.toggleSel(a.ai);d3.select(this).classed("obj-sel",d)});if(u){u.sort(function(a,c){return PData.strcmp(c.id,a.id)});var C=[];u.forEach(function(a){a.p&&a.p.forEach(function(c){e=_.sortedIndex(u,{id:c},"id");if(e<u.length){var k=u[e];k.id===c&&C.push({f:a.c,t:k.c,c:a.l})}})});this.gRecs.selectAll(".recline").data(C).enter().append("line").attr("class","recline").attr("x1",function(a){return c.xScale(a.f[0])}).attr("y1",function(a){return c.yScale(a.f[1])}).attr("x2",function(a){return c.xScale(a.t[0])}).attr("y2",
...
VizPinboard.prototype.doOptions=function(){function a(){g&&(d3.select("#base-"+d).attr("opacity",c.bOp/100),c.lOps.forEach(function(a,c){d3.select("#ol-"+d+"-"+c).attr("opacity",a/100)}));h.empty()}var c=this,d=this.vFrame.getIndex(),e=this.bOp,f=[],g=!0,h=jQuery("#dialog-opacities div.layer-list"),m=jQuery('<div class="op-layer" data-i="-1">Base Image <input type=range class="op-slider" min=0 max=100 value='+this.bOp+" step=5></div>");m.find(".op-slider").on("change",function(){e=jQuery(this).val();
d3.select("#base-"+d).attr("opacity",e/100)});h.append(m);this.lOps.forEach(function(a,c){m=jQuery('<div class="op-layer" data-i="'+c+'">Overlay '+(c+1)+' <input type=range class="op-slider" min=0 max=100 value='+a+" step=5></div>");m.find(".op-slider").on("change",function(){f[c]=jQuery(this).val();d3.select("#ol-"+d+"-"+c).attr("opacity",f[c]/100)});f.push(a);h.append(m)});var n=jQuery("#dialog-opacities").dialog({height:300,width:320,modal:!0,buttons:[{text:dlText.ok,click:function(){g=!1;n.dialog("close");
c.bOp=e;f.forEach(function(a,k){c.lOps[k]=a})}},{text:dlText.cancel,click:function(){n.dialog("close")}}]});n.on("dialogclose",function(c,k){a();n.off("dialogclose")})};VizPinboard.prototype.getState=function(){return{l:this.vFrame.getLgndSels()}};VizPinboard.prototype.setState=function(a){this.vFrame.setLgndSels(a.l)};
...
e.r.max.d>w&&(w=e.r.max.d)))});e.minDate=0<f.from.length?PData.dStr(f.from,!1):PData.d3Nums(a,c,k,!1);e.maxDate=0<f.to.length?PData.dStr(f.to,!0):PData.d3Nums(d,q,w,!0);e.instGap=.015*(e.maxDate-e.minDate)})();var g=e.getWidths(),h=d3.select(this.frameID).append("svg").attr("class","tl-vf").attr("width",g[1]);(function(){var a=[];f.lgnds.forEach(function(c){c.forEach(function(c){a.push(c)})});var a=_.uniq(a),c=[];a.forEach(function(a){(a=PData.aByID(a))&&a.l.forEach(function(a){c.push(a.v)})});c=
...
VizTime.prototype.render=function(a){function c(a,c){var k=a.s-c.s;if(0>k)return 1;if(0<k)return-1;k=c.e-a.e;return 0>k?1:0<k?-1:0}function d(a){function c(a){a=g.toggleSel(a.ai);d3.select(this).classed("obj-sel",a)}var k,d,e,f,h=g.bands[a];a?(k=g.bands[0],h.t=k.t+k.h+37,k=d=e=g.instRad,f=2*g.instRad+3):(h.t=0,k=d=e=1);h.h=m*h.tHt+2;h.g.attr("transform","translate(0,"+h.t+")").attr("height",h.h);var x,l;a&&(x=.75*h.iHt+"px",l=.8*h.iHt);var z;z=d3.select(h.svgID).selectAll(".lgBd").remove();z=d3.select(h.svgID).selectAll(".lgBd").data(g.lgBds).enter().append("svg").attr("class",
"lgBd").attr("y",function(a){return h.yScale(a.t)}).attr("height",function(a){return h.yScale(a.h)});z.append("rect").attr("width","100%").attr("height","100%").attr("fill",function(a){return a.d.v});1===a&&z.append("text").attr("class","lgBdLbl").attr("x",2).attr("y",l).attr("fill",function(a){return a.d.b?"#000000":"#FFFFFF"}).style("font-size",x).text(function(a){return a.d.l});var v;d3.select(h.svgID).selectAll(".event").remove();v=d3.select(h.svgID).selectAll(".event").data(g.events).enter().append("svg").attr("class",
function(a){return a.f&EVENT_INSTANT?"event instant":"event range"}).attr("y",function(a){return h.yScale(a.t)}).attr("height",h.iHt);if(1===a)v.on("click",c);var r=d3.select(h.svgID).selectAll(".range");r.append("rect").attr("width","100%").attr("height","100%").attr("fill",function(c){return 1===a&&c.f&(EVENT_F_START|EVENT_F_END)?(c.f&(EVENT_F_START|EVENT_F_END))===(EVENT_F_START|EVENT_F_END)?"url("+c.c.v+"-fb)":(c.f&EVENT_F_START)===EVENT_F_START?"url("+c.c.v+"-fs)":"url("+c.c.v+"-fe)":c.c.v});
1===a&&r.append("text").attr("class","rangeLbl").attr("x",4).attr("y",l).attr("fill",function(a){return a.c.b?"#000000":"#FFFFFF"}).style("font-size",x).text(function(a){return a.l});r=d3.select(h.svgID).selectAll(".instant");r.append("circle").attr("cx",k).attr("cy",d).attr("r",e).attr("fill",function(a){return a.c.v});1===a&&r.append("text").attr("class","instantLbl").attr("x",f).attr("y",l).style("font-size",x).text(function(a){return a.l});h.redraw=function(){z.attr("x",function(a){return h.xScale(a.s)}).attr("width",
function(a){return h.xScale(a.e)-h.xScale(a.s)});v.attr("x",function(a){return h.xScale(a.s)}).attr("width",function(a){return h.xScale(a.e)-h.xScale(a.s)});h.parts.forEach(function(a){a.redraw()})}}function e(a){a=g.bands[a];d3.select(a.svgID).selectAll(".axis").attr("transform","translate(0,"+a.h+")")}function f(a){a=g.bands[a];d3.select(a.svgID).selectAll(".bLblCntr").attr("transform","translate(0,"+(a.h+1).toString()+")")}var g=this,h=this.vFrame.getIndex();0<this.recSel.length&&(this.recSel=
[]);this.preRender();this.events=[];this.lgBds=[];var m=0;(function(){for(var d=PData.eTNum(),e=0,k,t,q,f,h,x,l,z;e<d;){for(k=a.t[e];0===k.n;){if(++e==d)return;k=a.t[e]}q=g.vFrame.getSelLocAtts(e);if(0!==q.length&&(q=g.vFrame.getSelFeatAtts(e),0!==q.length)){g.tUsed[e]=!0;z=g.vFrame.getSelLegend(e);l=PData.aByID(z);f=g.settings.dAtts[e];for(var v,r,B,u,y,A,C,E,F=[],G=k.i;G<k.i+k.n;G++)t=a.s[G],E=PData.rByN(t),h=E.a[z],"undefined"!==typeof h&&(h=PData.lRecs(h,l,q,!1))&&(x=E.a[f])&&"?"!==x&&(g.rMap[t>>
4]|=1<<(t&15),A=x.min.f?EVENT_F_START:0,v=x.min.y,"undefined"===typeof x.min.m?B=r=1:(r=x.min.m,B="undefined"===typeof x.min.d?1:x.min.d),u=PData.d3Nums(v,r,B,!1),"undefined"===typeof x.max?(A|=EVENT_INSTANT,y=u.getTime()+g.instGap):"open"===x.max?y=TODAY:(x.max.f&&(A|=EVENT_F_END),v=x.max.y,"undefined"===typeof x.max.m?(r=12,B=31):(r=x.max.m,B="undefined"===typeof x.max.d?PData.lenMnth(v,r):x.max.d),y=PData.d3Nums(v,r,B,!0)),F.push({s:u,e:y,ai:t,f:A,c:h,l:E.l,t:0}));F.sort(c);var I=[],K;F.forEach(function(a){for(K=
0;K<I.length&&!(a.e<I[K]);K++);a.t=K+m+1;I[K]=a.s});k=PData.aByID(f);k.l.forEach(function(a){C=a.d;v=C.min.y;"undefined"===typeof C.min.m?B=r=1:(r=C.min.m,B="undefined"===typeof C.min.d?1:C.min.d);u=PData.d3Nums(v,r,B,!1);"undefined"===typeof C.max.y?y=TODAY:(v=C.max.y,"undefined"===typeof C.max.m?(r=12,B=31):(r=C.max.m,B="undefined"===typeof C.max.d?PData.lenMnth(v,r):C.max.d),y=PData.d3Nums(v,r,B,!0));g.lgBds.push({s:u,e:y,t:m,h:I.length+1,d:a})});m+=I.length+1;g.events=g.events.concat(F)}e++}})();
...
VizDirectory.prototype.render=function(a){var c=this,d=PData.eTNum(),e=0,f,g,h,m,n,p,k,t=jQuery(this.frameID);t.empty();0<this.recSel.length&&(this.recSel=[]);this.preRender();this.stream=a;for(f=a.t[0];e<d;){for(;0===f.n;){if(++e===d)return;f=a.t[e]}c.tUsed[e]=!0;f=PData.eTByN(e);f=PData.tByID(f);t.append('<div class="template-label">'+f.l+'</div><table cellspacing="0" class="viz-directory" data-ti='+e+"></table>");g=t.find('table[data-ti="'+e+'"]');h=c.settings.cnt[e];k=c.sAtts[e];p="<thead><tr>";
h.forEach(function(a){var c=PData.aByID(a);p+='<th data-aid="'+a;a===k&&(p+='" class="sel');p+='">'+c.def.l+"</th>"});g.append(p+"</tr></thead><tbody></tbody>");g=g.find("tbody");f=PData.aByID(k);f=PData.rTOrder(f,c.stream,e);f.forEach(function(a){n=PData.rByN(a.i);c.rMap[a.i>>4]|=1<<(a.i&15);p='<tr data-id="'+n.id+'" data-ai='+a.i+">";h.forEach(function(a){m=n.a[a];"undefined"!==typeof m?p=(m=PData.procAttTxt(a,m))?p+("<td>"+m+"</td>"):p+"<td></td>":p+="<td></td>"});g.append(p+"</tr>")});f=a.t[++e]}};
...
VizTextStream.prototype.render=function(a){var c=this,d=PData.eTNum(),e=0,f,g,h,m,n,p,k,t,q,w,D,x,l,z,v,r,B,u=jQuery(this.frameID);u.empty();0<this.recSel.length&&(this.recSel=[]);this.preRender();r=this.settings.max-this.settings.min;for(g=a.t[0];e<d;){for(;0===g.n;){if(++e===d)return;g=a.t[e]}q=c.vFrame.getSelLocAtts(e);if(0!==q.length&&(q=c.vFrame.getSelFeatAtts(e),0!==q.length)){c.tUsed[e]=!0;w=c.vFrame.getSelLegend(e);D=PData.aByID(w);u.append('<div class="viz-textstream" data-ti='+e+"></div>");
h=u.find("div.viz-textstream[data-ti="+e+"]");f=PData.eTByN(e);f=PData.tByID(f);h.append('<div class="template-label">'+f.l+"</div>");t=c.settings.cnt[e];if(z=c.settings.sAtts[e])l=PData.aByID(z),"number"===typeof l.r.min&&"number"===typeof l.r.max?v=l.r.max-l.r.min:z=null;t&&(f=PData.aByID(c.settings.order[e]),f=PData.rTOrder(f,a,e),f.forEach(function(a){m=PData.rByN(a.i);n=m.a[w];"undefined"!==typeof n&&(x=PData.lRecs(n,D,q,!1))&&((p=m.a[t])&&(p=PData.procAttTxt(t,p)),p&&(c.rMap[a.i>>4]|=1<<(a.i&
15),z?(k=m.a[z],k="number"===typeof k?Math.floor((k-l.r.min)*r/v)+c.settings.min:c.settings.min):k=c.settings.min,B=x.b?";background-color:black":"",h.append('<div class="recitem" data-ai='+a.i+' style="color:'+x.v+B+";font-size:"+k+'px">'+p+"</div>")))}))}e++}};VizTextStream.prototype.teardown=function(){jQuery(this.frameID).off("click.vf")};
...
VizStackChart.prototype.render=function(a){var c=this;this.bSel=[];var d=this.settings.oAtt,e=PData.aByID(d),f=this.settings.sAtt;this.cats="g"!==e.def.t?this.settings.gr?PData.cRNew(e,!0,!0):PData.cLNew(e,null,!0):[];PData.cFill(this.cats,d,f,a);var g=0;this.cats.forEach(function(a){g=Math.max(g,a.l.length)});this.colW=g=Math.max(D3FG_BAR_WIDTH,8*g+4);a=this.cats.length*g;d=this.settings.h;this.xScale.domain([0,this.cats.length]).rangeRound([0,a]);this.rScale.rangeRoundBands([0,a]);this.rScale.domain(this.cats.map(function(a){return a.l}));
this.svg.attr("width",a+D3SC_MARGINS.left+D3SC_MARGINS.right).attr("height",d+D3SC_MARGINS.top+D3SC_MARGINS.bottom);this.svg.selectAll(".block").remove();this.blocks=[];f=PData.aByID(f);a=0;for(var d=c.vFrame.getSelFeatAtts(0),d=PData.cLNew(f,d,!0),h=0;h<this.cats.length;h++){if(0<h)for(e=0;e<d.length;e++)d[e].i=[];PData.cSort(c.cats[h].i,f,d);var m=0;d.forEach(function(a){0<a.i.length&&(c.blocks.push({x:h,c:a.c,y:m,h:a.i.length,a:a.i}),m+=a.i.length)});a=Math.max(a,m)}c.yScale.domain([0,a]);c.svg.select(".x.axis").call(c.xAxis);
c.svg.select(".y.axis").call(c.yAxis);f=c.colW-7;this.svg.selectAll(".block").data(c.blocks).enter().append("rect").attr("class","block").attr("x",function(a){return D3SC_MARGINS.left+5+c.xScale(a.x)}).attr("y",function(a){return c.yScale(a.y)+D3SC_MARGINS.top}).attr("fill",function(a){return a.c}).attr("height",function(a){return Math.max(1,c.yScale(a.h)-1)}).attr("width",f).on("click",function(a,d){var k=c.bSel.length,e=_.sortedIndex(c.bSel,d);c.bSel[e]===d?(d3.select(this).classed("obj-sel",!1),
c.bSel.splice(e,1),0<k&&0==c.bSel.length&&c.vFrame.selBtns(!1)):(d3.select(this).classed("obj-sel",!0),c.bSel.splice(e,0,d),0==k&&0<c.bSel.length&&c.vFrame.selBtns(!0))})};VizStackChart.prototype.setSel=function(a){};VizStackChart.prototype.clearSel=function(){0<this.bSel.length&&(this.bSel=[],this.svg.selectAll(".block").classed("obj-sel",!1))};VizStackChart.prototype.getSel=function(){var a=this,c=[];this.bSel.forEach(function(d){c=PData.union(c,a.blocks[d].a)});return c};
VizStackChart.prototype.getState=function(){return{l:this.vFrame.getLgndSels()}};VizStackChart.prototype.setState=function(a){this.vFrame.setLgndSels(a.l)};VizStackChart.prototype.hint=function(){var a=dlText.xaxis+": ",c=PData.aByID(this.settings.oAtt),a=a+(c.def.l+", "+dlText.yaxis+": "),c=PData.aByID(this.settings.sAtt);return a+=c.def.l};var VizNetWheel=function(a,c){PVizModel.call(this,a,c);this.bSel=[]};VizNetWheel.prototype=Object.create(PVizModel.prototype);
VizNetWheel.prototype.constructor=VizNetWheel;VizNetWheel.prototype.flags=function(){return V_FLAG_LGND|V_FLAG_SEL|V_FLAG_VSCRL|V_FLAG_HSCRL};VizNetWheel.prototype.getFeatureAtts=function(a){return null!=a?this.settings.lgnds[a]:this.settings.lgnds};
...
VizNetWheel.prototype.render=function(a){var c=this,d=[],e,f,g;this.svg.selectAll(".node").remove();this.svg.selectAll(".link").remove();this.inc=360/(a.l+a.t.length);f=Math.max((14*a.l+20)/(2*Math.PI),30);var h=this.settings.lw;"string"===typeof h&&(h=parseInt(h));this.cr=h+12+f;h=2*this.cr;this.svg.attr("width",h).attr("height",h);this.center.attr("transform","translate("+this.cr+","+this.cr+")");0<this.recSel.length&&(this.recSel=[]);this.preRender();var m={children:[]};(function(){var d,e=0,k=
0,t,q,f,h=[],g=null,l,z;d=a.t[0];z=c.vFrame.getSelLegend(0);l=PData.aByID(z);g=c.vFrame.getSelFeatAtts(0);0<g.length&&0<d.n&&(c.tUsed[0]=!0);a:for(;k<a.l;){for(;0===d.n||d.i+d.n===k||0===g.length;){0<h.length&&(m.children.push({ti:e,children:h}),h=[]);if(++e===PData.eTNum())break a;h=[];d=a.t[e];z=c.vFrame.getSelLegend(e);l=PData.aByID(z);g=c.vFrame.getSelFeatAtts(e);0<g.length&&0<d.n&&(c.tUsed[e]=!0)}f=a.s[k];t=PData.rByN(f);q=t.a[z];"undefined"!==typeof q&&(fData=PData.lRecs(q,l,g,!1))&&(c.rMap[f>>
4]|=1<<(f&15),h.push({r:t,ai:f,c:fData.v,children:[]}));k++}0<h.length&&m.children.push({ti:e,children:h})})();f=d3.layout.cluster().size([360,f]).sort(null).nodes(m);g=this.center.append("g").selectAll(".node").data(f.filter(function(a){return!a.children})).enter().append("g").attr("class","node").attr("transform",function(a){return"rotate("+(a.x-90)+")translate("+(a.y+8)+",0)"});g.append("circle").attr("r","5").style("fill",function(a){return a.c}).on("click",function(a){a=c.toggleSel(a.ai);d3.select(this).classed("obj-sel",
a)});g.append("text").attr("dy",".31em").attr("dx",function(a){return 180>a.x?"10":"-10"}).attr("transform",function(a){return 180>a.x?"":"rotate(180)"}).style("text-anchor",function(a){return 180>a.x?"start":"end"}).attr("fill","black").text(function(a){return a.r.l}).on("click",function(a){PState.set(PSTATE_UPDATE);g.each(function(a){a.linked=!1});e.each(function(c){if(c.s===a){c.t.linked=!0;for(var k=0;k<d.length;k++){var e=d[k];if(e.source===a&&e.target===c.t){d3.select(this).attr("stroke",e.c).classed("thick",
!0);this.parentElement.appendChild(this);break}}}else if(c.t===a)for(c.s.linked=!0,k=0;k<d.length;k++){if(e=d[k],e.target===a&&e.source===c.s){d3.select(this).attr("stroke",e.c).classed("thick",!0);this.parentElement.appendChild(this);break}}else d3.select(this).attr("stroke","black").classed("thick",!1)});g.select("text").attr("fill",function(a){return a.linked?"white":"black"});d3.select(this).attr("fill","yellow");PState.set(PSTATE_READY)});f=d3.layout.bundle();h=d3.svg.line.radial().interpolate("bundle").tension(.85).radius(function(a){return a.y}).angle(function(a){return a.x/
180*Math.PI});m.children.forEach(function(a){var e=c.settings.pAtts[a.ti],k;a.children.forEach(function(a){e.forEach(function(c){k=a.r.a[c.pid];"undefined"!==typeof k&&k.forEach(function(k){var e=!1,f,l=0;a:for(;l<m.children.length;l++)for(var h=m.children[l],g=0;g<h.children.length;g++)if(f=h.children[g],f.r.id==k){e=!0;break a}e&&d.push({source:a,target:f,c:c.clr})})})})});e=this.center.append("g").selectAll(".link").data(f(d)).enter().append("path").each(function(a){a.s=a[0];a.t=a[a.length-1]}).attr("class",
...
VizFlow.prototype.render=function(a){var c=this;this.bSel=[];this.fSel=[];this.barG.selectAll(".bar").remove();this.flowG.selectAll(".flow").remove();this.titleG.selectAll(".att-title").remove();var d=this.settings.w;c.bars=[];c.atts=[];c.settings.fcts.forEach(function(e,f){var g,h=PData.aByID(e);g="g"!==h.def.t?c.settings.gr?PData.cRNew(h,!0,!0):PData.cLNew(h,null,!0):[];PData.cFill(g,e,null,a);var m=[],n=0;g.forEach(function(a){0<a.i.length&&(m.push(a),n+=a.i.length)});var p=0,k=31+f*c.bH;m.forEach(function(a){c.bars.push({x:5+
p*d/n,w:a.i.length*d/n,y:k,c:a});p+=a.i.length});c.atts.push({l:h.def.l,c:m,t:n,y:k})});this.barG.selectAll(".bar").data(c.bars).enter().append("rect").attr("class","bar").attr("x",function(a){return a.x}).attr("y",function(a){return a.y}).attr("fill",function(a){return a.c.c}).attr("height","8").attr("width",function(a){return a.w}).on("click",function(a,d){var g=c.bSel.length,h=_.sortedIndex(c.bSel,d);c.bSel[h]===d?(d3.select(this).classed("obj-sel",!1),c.bSel.splice(h,1),0<g&&0===c.bSel.length&&
0===c.fSel.length&&c.vFrame.selBtns(!1)):(d3.select(this).classed("obj-sel",!0),c.bSel.splice(h,0,d),0===g&&0===c.fSel.length&&0<c.bSel.length&&c.vFrame.selBtns(!0))}).append("title").text(function(a){return a.c.l+" ("+a.c.i.length+")"});c.ints=[];c.atts.forEach(function(a,f){if(f!==c.atts.length-1){for(var g=c.atts[f+1],h=Array(a.c.length),m=0;m<a.c.length;m++)h[m]=Array(g.c.length);a.c.forEach(function(a,c){g.c.forEach(function(d,k){h[c][k]=PData.intersect(a.i,d.i)})});for(var n=Array(g.c.length),
p=0;p<g.c.length;p++){for(var k=0,m=0;m<a.c.length;m++)0<h[m][p].length&&k++;n[p]=k-1}for(var t=Array(g.c.length),p=0;p<g.c.length;p++)t[p]=0;var q=0;a.c.forEach(function(k,f){for(var m=0,l=0;l<g.c.length;l++)0<h[f][l].length&&m++;--m;var p=k.i.length*d/a.t,v=0,r=0;g.c.forEach(function(l,u){var y=h[f][u];if(0<y.length){var A=y.length*d,C=A/a.t,A=A/g.t,E=l.i.length*d/g.t;c.ints.push({i:y,c:k.c,l:k.l+" > "+l.l,x1:5+q*d/a.t+(m?(p-C)*v/m:0),x2:5+r*d/g.t+(n[u]?(E-A)*t[u]/n[u]:0),w1:C,w2:A,y1:a.y+10,y2:g.y-
1});v++;t[u]++}r+=l.i.length});q+=k.i.length})}});this.flowG.selectAll(".flow").data(c.ints).enter().append("path").attr("class","flow").attr("d",function(a){return"M "+a.x1+" "+a.y1+"  L "+(a.x1+a.w1)+" "+a.y1+" L "+(a.x2+a.w2)+" "+a.y2+" L "+a.x2+" "+a.y2+" L "+a.x1+" "+a.y1}).attr("fill",function(a){return a.c}).on("click",function(a,d){var g=c.fSel.length,h=_.sortedIndex(c.fSel,d);c.fSel[h]===d?(d3.select(this).classed("obj-sel",!1),c.fSel.splice(h,1),0<g&&0===c.fSel.length&&0===c.bSel.length&&
...
VizMBMap.prototype.renderTree=function(a){function c(){var a=0,c=d.settings.w,g=null!==d.sbkSel?d.sbkSel.i:d.bkSel.i;PState.set(PSTATE_UPDATE);d.fcts.forEach(function(h,m){var n=[],p=0;h.c.forEach(function(a){a=PData.intersect(g,a.i);n.push(a);p+=a.length});var k=0,t;n.forEach(function(q){t=d.bars[a++];t.x=p?k*c/p:0;t.w=p?q.length*c/p:0;k+=q.length})});d.attsG.selectAll(".bar").transition().attr("x",function(a){return a.x}).attr("width",function(a){return a.w});PState.set(PSTATE_READY)}var d=this;
...
VizMBMap.prototype.render=function(a){var c=this;this.sbkSel=this.bkSel=null;this.attSel=0;var d=this.settings.w;this.attsG.selectAll(".bar").remove();this.attsG.selectAll(".mbm-att-title").remove();this.infoG.select(".mbm-select").remove();this.fcts=[];this.bars=[];this.settings.fcts.forEach(function(e,f){var k,t=PData.aByID(e),q=30*f;k="g"!==t.def.t?c.settings.gr?PData.cRNew(t,!0,!0):PData.cLNew(t,null,!0):[];PData.cFill(k,e,null,a);var g=[],h=0;k.forEach(function(a){0<a.i.length&&(g.push(a),h+=
a.i.length)});var m=0;g.forEach(function(a){c.bars.push({x0:m*d/h,w0:a.i.length*d/h,x:0,w:0,y:q+18,c:a});m+=a.i.length});c.fcts.push({i:f,l:t.def.l,y:q+14,c:g})});this.attsG.selectAll(".mbm-att-title").data(c.fcts).enter().append("text").attr("class",function(a,c){return 0===c?"mbm-att-title obj-sel":"mbm-att-title"}).attr("x","0").attr("y",function(a){return a.y}).text(function(a){return a.l}).on("click",function(a,d){c.attSel!=d&&(PState.set(PSTATE_UPDATE),c.attsG.selectAll(".mbm-att-title").classed("obj-sel",
...
PFilterNum.prototype.evalBoxes=function(a){function c(c,h){function k(){t=!0;a.find(c).addClass("error")}var t=!1,q,w=a.find(c).val();(w=e.exec(w))?(a.find(c).removeClass("error"),q=parseInt(w[1],10)):k();t||(0==h?null!==f&&q<f&&k():null!==g&&q>g&&k());d.uNums[h]=q;return t}var d=this,e=/^(\d+)$/,f="undefined"===typeof this.att.r.min?null:this.att.r.min,g="undefined"===typeof this.att.r.max?null:this.att.r.max,h,m;h=c(".from",0);m=c(".to",1);this.uNums[0]>this.uNums[1]&&(m=!0);a.find(".filter-update").prop("disabled",
...
PFilterDates.prototype.evalBoxes=function(a){function c(c,g){function h(d){t=!0;a.find(c+d).addClass("error")}function k(d){a.find(c+d).removeClass("error")}var t=!1,q={y:0,m:0,d:0,ms:null},w=a.find(c+"-y"),w=w.val();(w=e.exec(w))?(k("-y"),q.y=parseInt(w[1],10)):h("-y");w=a.find(c+"-m");w=w.val();(w=f.exec(w))?(q.m=parseInt(w[1],10),1>q.m||12<q.m?h("-m"):k("-m")):h("-m");w=a.find(c+"-d");w=w.val();(w=f.exec(w))?(q.d=parseInt(w[1],10),1>q.d||31<q.d?h("-d"):k("-d")):h("-d");t||(q.ms=PData.d3Nums(q.y,
q.m,q.d,!1),0==g?q.ms<d.rCats[0].min&&(h("-y"),h("-m"),h("-d")):q.ms>d.rCats[d.rCats.length-1].max&&(h("-y"),h("-m"),h("-d")));d.uDates[g]=q;return t}var d=this,e=/^(-?\d+)$/,f=/^(\d{1,2})$/,g,h;g=c(".from",0);h=c(".to",1);this.uDates[0].ms>this.uDates[1].ms&&(h=!0);a.find(".filter-update").prop("disabled",g||h);return!(g||h)};
...
function PViewFrame(a){function c(a){a!==B&&(B=a,jQuery(d()+" div.lgnd-container div.lgnd-handle button.lgnd-update").prop("disabled",!a))}function d(){return"#view-frame-"+a}function e(a){a=jQuery(d()+" div.view-controls select.view-viz-select option:selected").val();PState.set(PSTATE_BUILD);x(a,!0);PState.set(PSTATE_READY)}function f(a){v.flags()&V_FLAG_LGND&&jQuery(d()+" div.lgnd-container").toggle("slide",{direction:"left"});a.preventDefault()}function g(a){function c(a){return a.replace(/^[ \f\t\v\u200b]+|[ \f\t\v\u200b]+$/g,
"")}function d(a){var c=new Number,k=parseTC.exec(a);if(null!==k)c=1E3*(3600*parseInt(k[1])+60*parseInt(k[2])+parseFloat(k[3])),c=1==k[4].length?c+100*parseInt(k[4]):c+10*parseInt(k[4]);else throw Error("Error in transcript file: Cannot parse "+a+" as timecode.");return c}function k(a,d){var e=new String(a),e=c(e).split(/\r\n|\r|\n/g),f=[];if(e){var l,q=0;_.each(e,function(a){a=c(a);0<a.length&&("["===a.charAt(0)?(0<q&&f.push(l),l=""):(0<l.length&&(l+="<br/>"),l+=a),q++)})}_.each(f,function(a,c){d.find('div.timecode[data-tcindex="'+
c+'"]').next().after('<div class="xscript">'+a+"</div>")})}function e(a){widgetData.tcArray=[];widgetData.tcIndex=-1;var f=widgetData.tcArray;a=new String(a);if(a=c(a).split(/\r\n|\r|\n/g)){var l=jQuery("#xscript-tbl"),q=0,t,g=0,h=0,w="";_.each(a,function(a){a=c(a);1<a.length&&("["===a.charAt(0)&&"0"<=a.charAt(1)&&"9">=a.charAt(1)?(t=d(a),0<w.length&&(h&&f.push({s:g,e:t}),l.append('<div class="row"><div class="timecode" data-timecode="'+g+'" data-tcindex="'+q++ +'">'+h+'</div><div class="xscript">'+
w+"</div></div>"),w=""),h=a,g=t):(0<w.length&&(w+="<br/>"),w+=a))});0<w.length&&(f.push({s:g,e:324E5}),l.append('<div class="row"><div class="timecode" data-timecode="'+g+'" data-tcindex="'+q+'">'+h+'</div><div class="xscript">'+w+"</div></div>"));"undefined"!==typeof B&&null!=B&&jQuery.ajax({type:"POST",url:prspdata.ajax_url,data:{action:"prsp_get_transcript",transcript:B,excerpt:widgetData.extract},success:function(a,c,d){k(JSON.parse(a),l)},error:function(a,c,d){alert(d)}})}}function f(a){var c,
d=widgetData.tcIndex;_.find(widgetData.tcArray,function(k,e){if((c=k.s<=a&&a<k.e)&&e!=d){var f=jQuery("#xscript-tbl");if(document.getElementById("sync-xscript").checked){var l=f.find('[data-tcindex="'+e+'"]').offset().top-f.offset().top,l=f.scrollTop()+l;f.animate({scrollTop:l},300)}-1!=d&&f.find('[data-tcindex="'+d+'"]').removeClass("current");f.find('[data-tcindex="'+e+'"]').addClass("current");widgetData.tcIndex=e}return c})}function l(){widgetData.widget=new YT.Player("yt-widget",{width:p-40,
...
!1}},onReady:function(){widgetData.extract&&widgetData.widget.cueVideoById({videoId:widgetData.ytCode,startSeconds:widgetData.sTime/1E3,endSeconds:widgetData.eTime/1E3})}}})}function t(){widgetData.playing=!0}function q(){widgetData.playing=!1}function g(){widgetData.playing&&widgetData.xscriptOn&&f(1E3*widgetData.widget.currentTime)}function w(){switch(n){case 3:null!=widgetData.widget&&(widgetData.widget.removeEventListener("ended",q),widgetData.widget.removeEventListener("pause",q),widgetData.widget.removeEventListener("playing",
t),widgetData.widget.removeEventListener("timeupdate",g));case 1:null!=widgetData.widget&&widgetData.playing&&widgetData.widget.pause();widgetData.playing=!1;widgetData.widget=null;break;case 2:widgetData.ytCall=null,null!=widgetData.widget&&widgetData.playing&&widgetData.widget.stopVideo(),widgetData.widget=null,widgetData.playing=!1,null!=widgetData.timer&&(window.clearInterval(widgetData.timer),widgetData.timer=null)}}function m(){function a(){widgetData.sTime=widgetData.eTime=null;var c;(c=prspdata.e.i.t.tcAtts[w])&&
(c=H.a[c])&&""!==c&&(widgetData.extract=c,c=c.split("-"),widgetData.sTime=d(c[0]),widgetData.eTime=d(c[1]))}var c=J[M];H=PData.rByN(c);var k=" "+H.l+" ("+(M+1)+"/"+J.length+") ",h=jQuery("#inspect-name");h.text(k);h.prop("title",H.id);var w=PData.n2T(c);r.empty();u=null;n=0;widgetData.extract=null;widgetData.xscriptOn=!1;widgetData.playing=!1;if(prspdata.e.i.modal.scOn||"boolean"===typeof prspdata.e.i.modal.aOn&&prspdata.e.i.modal.aOn)if(u=prspdata.e.i.sc.atts[w])if(k=H.a[u])if(a(),k.match(/soundcloud\.com/)){var x=
!0;n=1;r.append('<iframe id="sc-widget" class="player" width="100%" height="110" src="http://w.soundcloud.com/player/?url='+k+'"></iframe>');var y=SC.Widget(document.getElementById("sc-widget"));widgetData.widget=y;y.bind(SC.Widget.Events.READY,function(){y.play();y.bind(SC.Widget.Events.PLAY,function(){widgetData.playing=!0});y.bind(SC.Widget.Events.PAUSE,function(){widgetData.playing=!1});y.bind(SC.Widget.Events.PLAY_PROGRESS,function(a){x&&(y.pause(),x=!1,widgetData.playing=!1);widgetData.extract&&
(a.currentPosition<widgetData.sTime?y.seekTo(widgetData.sTime):a.currentPosition>widgetData.eTime&&(y.pause(),widgetData.playing=!1));widgetData.playing&&widgetData.xscriptOn&&f(a.currentPosition)});y.bind(SC.Widget.Events.FINISH,function(){widgetData.playing=!1})})}else n=3,widgetData.extract&&(h=widgetData.extract.split("-"),k+="#t="+h[0]+","+h[1]),r.append('<audio id="na-widget" controls src="'+k+'"></audio>'),widgetData.widget=document.getElementById("na-widget"),widgetData.widget.addEventListener("ended",
q),widgetData.widget.addEventListener("pause",q),widgetData.widget.addEventListener("playing",t),widgetData.widget.addEventListener("timeupdate",g);0===n&&prspdata.e.i.modal.ytOn&&(u=prspdata.e.i.yt.atts[w])&&(k=H.a[u])&&(a(),widgetData.ytCode=k,r.append('<div id="yt-widget"></div>'),widgetData.ytCall=l,widgetData.ytLoaded?l():(widgetData.ytLoaded=!0,k=document.createElement("script"),k.src="https://www.youtube.com/iframe_api",h=document.getElementsByTagName("script")[0],h.parentNode.insertBefore(k,
h)),n=2);prspdata.e.i.modal.tOn&&(k=prspdata.e.i.t.t1Atts[w])&&""!==k&&"disable"!==k&&(k=H.a[k],"string"===typeof k&&""!==k&&(0<n&&r.append("<div>"+document.getElementById("dltext-sync-xscript").innerHTML+"</div>"),r.find("#xscript-tbl").remove(),r.append('<div id="xscript-tbl"></div>'),widgetData.xscriptOn=!0,jQuery("#xscript-tbl").click(function(a){if(n&&jQuery(a.target).hasClass("timecode"))switch(a=jQuery(a.target).data("timecode"),n){case 1:widgetData.playing||(widgetData.playing=!0,widgetData.widget.play());
widgetData.widget.seekTo(a);break;case 2:widgetData.playing||(widgetData.playing=!0,widgetData.widget.playVideo());widgetData.widget.seekTo(a/1E3);break;case 3:widgetData.playing||(widgetData.playing=!0,widgetData.widget.play()),widgetData.widget.currentTime=a/1E3}}),B=null,(h=prspdata.e.i.t.t2Atts[w])&&""!==h&&"disable"!==h&&(B=H.a[h]),jQuery.ajax({type:"POST",url:prspdata.ajax_url,data:{action:"prsp_get_transcript",transcript:k,excerpt:widgetData.extract},success:function(a,c,d){e(JSON.parse(a))},
error:function(a,c,d){alert(d)}})));prspdata.e.i.modal.atts[w].forEach(function(a){var d=PData.rAV(c,a,!1);if(d){a=PData.aByID(a);var k;"_"==a.def.l.charAt(0)?k="<div>"+d+"</div>":(k='<div><span class="att-label">'+a.def.l+":</span> ","I"==a.def.t&&(k+="<br/>"),k+=d+"</div>");r.append(k)}})}function x(a){a=M+a;-1==a?a=J.length-1:a==J.length&&(a=0);a!=M&&(M=a,w(),m())}function z(a){x(-1)}function D(a){x(1)}var r=jQuery("#inspect-content"),u=null,n=0,B,p=450,N=400,J=null;v&&(J=v.getSel());if(null!=
J&&0!=J.length){var O,H,M=0;prspdata.e.i.modal.scOn&&(p=550);prspdata.e.i.modal.ytOn&&(p=Math.max(p,475),N=500);prspdata.e.i.modal.tOn&&(N+=100,prspdata.e.i.modal.t2On?(p=Math.max(750,Math.floor(.8*jQuery(document).width())),p=Math.min(900,p)):p=Math.max(p,550));"number"===typeof prspdata.e.i.modal.w&&(p=prspdata.e.i.modal.w);"number"===typeof prspdata.e.i.modal.h&&(N=prspdata.e.i.modal.h);h(!1);m();jQuery("#btn-inspect-left").click(z);jQuery("#btn-inspect-right").click(D);O=jQuery("#dialog-inspector").dialog({width:p,
...
(c.find(".osel").button("disable"),c.find(".osel").removeClass("pulse"),c.find(".xsel").button("disable"))}function m(c){jQuery("body").trigger("prospect",{s:PSTATE_HILITE,v:a,t:v.tUsed});c.preventDefault()}function n(a){PState.set(PSTATE_UPDATE);v&&v.clearSel();h(!1);PState.set(PSTATE_READY);a.preventDefault()}function p(a){v&&v.doOptions();a.preventDefault()}function k(a){var c=jQuery("#dialog-vnotes").dialog({width:300,height:300,modal:!0,buttons:[{text:dlText.ok,click:function(){c.dialog("close")}}]});
a.preventDefault()}function t(a,k){jQuery(d()+' div.lgnd-container div.lgnd-scroll div.lgnd-template[data-index="'+a+'"] div.lgnd-group input.lgnd-entry-check').prop("checked",k);c(!0)}function q(a){var k=jQuery(a.target).closest("div.lgnd-template").data("index"),e=a.target.className;switch(e){case "lgnd-update":v&&u&&(PState.set(PSTATE_BUILD),h(!1),v.render(u),c(!1),PState.set(PSTATE_READY));break;case "lgnd-entry-check":e=jQuery(a.target).closest("div.lgnd-entry");a=jQuery(a.target).is(":checked");
e.hasClass("lgnd-sh")?t(k,a):e.hasClass("lgnd-locate")?(e.data("id"),c(!0)):e.hasClass("lgnd-value")&&(e.data("index"),c(!0));break;case "lgnd-viz":case "lgnd-value-title":e=jQuery(a.target).closest("div.lgnd-entry");e.hasClass("lgnd-locate")?(a=e.data("id"),jQuery(d()+' div.lgnd-container div.lgnd-scroll div.lgnd-template[data-index="'+k+'"] div.lgnd-locate input.lgnd-entry-check').prop("checked",!1),jQuery(d()+' div.lgnd-container div.lgnd-scroll div.lgnd-template[data-index="'+k+'"] div.lgnd-locate[data-id="'+
a+'"] input.lgnd-entry-check').prop("checked",!0),c(!0)):e.hasClass("lgnd-value")&&(a=e.data("index"),jQuery(d()+' div.lgnd-container div.lgnd-scroll div.lgnd-template[data-index="'+k+'"] div.lgnd-group input.lgnd-entry-check').prop("checked",!1),jQuery(d()+' div.lgnd-container div.lgnd-scroll div.lgnd-template[data-index="'+k+'"] div.lgnd-group div.lgnd-value[data-index="'+a+'"] input.lgnd-entry-check').prop("checked",!0),c(!0));break;case "lgnd-template":case "lgnd-select":case "":break;default:e.match(/lgnd-sh/i)&&
(e=jQuery(a.target).find("input.lgnd-entry-check"),a=!e.is(":checked"),e.prop("checked",a),t(k,a))}}function w(a){var d=jQuery(a.target).closest("div.lgnd-template").data("index");a=jQuery(a.target).val();D(d,a);c(!0)}function D(a,c){var k,e=jQuery(d()+' div.lgnd-container div.lgnd-scroll div.lgnd-template[data-index="'+a+'"] div.lgnd-group');e.empty();r[a]=c;var f=PData.aByID(c);"undefined"!==typeof f.r.u&&(k='<div class="lgnd-value lgnd-entry" data-index="-1"><input type="checkbox" checked="checked" class="lgnd-entry-check"/><div class="lgnd-viz" style="background-color: '+
f.r.u.v+'"> </div> <span class="lgnd-value-title">'+dlText.undef+"</span></div>",e.append(k));f.l.forEach(function(a,c){k='<div class="lgnd-value lgnd-entry" data-index="'+c+'"><input type="checkbox" checked="checked" class="lgnd-entry-check"/><div class="lgnd-viz" style="background-color: '+a.v+'"> </div> <span class="lgnd-value-title">'+a.l+"</span></div>";e.append(k);a.z&&0<a.z.length&&a.z.forEach(function(a,d){k='<div class="lgnd-value lgnd-entry" data-index="'+c+","+d+'"><input type="checkbox" checked="checked" class="lgnd-entry-check"/>';
k=a.v&&""!==a.v?k+('<div class="lgnd-viz" style="background-color: '+a.v+'"></div>'):k+'<div class="lgnd-viz lgnd-viz-empty"></div>';k+=' <span class="lgnd-value-title">&raquo; '+a.l+"</span></div>";e.append(k)})});jQuery(d()+' div.lgnd-container div.lgnd-scroll div.lgnd-template[data-index="'+a+'"] div.lgnd-sh input').prop("checked",!0)}function x(k,e){var f=PData.vByN(k);v&&(v.teardown(),v=null);var q=jQuery(d());q.find("div.viz-content div.viz-result").empty();var t;switch(f.vf){case "M":t=new VizMap(l,
f.c);break;case "C":t=new VizCards(l,f.c);break;case "P":t=new VizPinboard(l,f.c);break;case "T":t=new VizTime(l,f.c);break;case "D":t=new VizDirectory(l,f.c);break;case "t":t=new VizTextStream(l,f.c);break;case "S":t=new VizStackChart(l,f.c);break;case "N":t=new VizNetWheel(l,f.c);break;case "F":t=new VizFlow(l,f.c);break;case "B":t=new VizBrowser(l,f.c);break;case "m":t=new VizMBMap(l,f.c)}z=k;var g=t.flags();g&V_FLAG_HSCRL?(q.find("div.viz-content").addClass("h-scroll"),q.find("div.viz-result").addClass("viz-fit-w"),
...
r=[];if(g&V_FLAG_LGND){q.find(".hslgnd").button("enable");var m=q.find("div.lgnd-container div.lgnd-scroll");m.empty();if(g&V_FLAG_SLGND){var x=t.getFeatureAtts(),P=PData.aByID(x);m.append('<div class="lgnd-template" data-index="0"><div class="lgnd-title">'+P.def.l+'</div><div class="lgnd-entry lgnd-sh"><input type="checkbox" checked="checked" class="lgnd-entry-check"/><i>'+dlText.sha+'</i></div><div class="lgnd-group"></div></div>');r.push(x);D(0,x)}else{var n=!1;prspdata.e.g.ts.forEach(function(a,
c){var d=PData.tByID(a),k=t.getLocAtts(c);if(k&&0<k.length||!(g&V_FLAG_LOC)){var e=t.getFeatureAtts(c);if(0<e.length){n&&m.append("<hr/>");var f=jQuery('<div class="lgnd-template" data-index="'+c+'"><div class="lgnd-title">'+d.l+"</div></div>");k&&k.forEach(function(a,c){var d=PData.aByID(a);f.append('<div class="lgnd-entry lgnd-locate" data-id="'+a+'"><input type="checkbox" checked="checked" class="lgnd-entry-check"/><span class="lgnd-value-title">'+d.def.l+"</span></div>")});var q='<select class="lgnd-select">';
e.forEach(function(a,c){var d=PData.aByID(a);q+='<option value="'+a+'">'+d.def.l+"</option>"});q+="</select>";d=jQuery(q);d.change(w);jQuery(f).append(d);jQuery(f).append('<div class="lgnd-entry lgnd-sh"><input type="checkbox" checked="checked" class="lgnd-entry-check"/><i>'+dlText.sha+'</i></div><div class="lgnd-group"></div>');m.append(f);e=e[0];r.push(e);D(c,e);n=!0}}})}q.find("div.lgnd-container").show()}else q.find("button.hslgnd").button("disable"),q.find("div.lgnd-container").hide();c(!1);
g&V_FLAG_SEL?(q.find(".hilite").button("enable"),jQuery("#save-prspctv-h"+a).prop("disabled",!1).prop("checked",!1)):(q.find(".hilite").button("disable"),jQuery("#save-prspctv-h"+a).prop("disabled",!0).prop("checked",!1));g&V_FLAG_OPT?q.find(".vopts").button("enable"):q.find(".vopts").button("disable");(x=t.hint())||"string"===typeof f.n&&""!==f.n?(q.find(".vnote").button("enable"),x=x?"string"===typeof f.n&&""!==f.n?x+(".<br/>"+f.n):x+".":f.n,jQuery("#vnotes-txt").empty().append(x)):q.find(".vnote").button("disable");
t.setup();h(!1);u&&e&&t.render(u);v=t}var l={},z=0,v=null,r=[],B=null,u=null;l.getFrameID=d;l.getIndex=function(){return a};l.setViz=function(a,c){a!=z&&(jQuery(d()+" div.view-controls select.view-viz-select").val(a),x(a,c))};l.initDOM=function(c){var t=document.getElementById("dltext-view-controls").innerHTML;jQuery("#viz-frame").append('<div id="view-frame-'+a+'">'+t+"</div>");var t=jQuery(d()),l=prspdata.bClrs.vf;l&&0<l.length&&t.find("div.view-controls").css("background-color",l);t.find("div.lgnd-container").draggable({handle:t.find("div.lgnd-handle"),
containment:"parent"});var h=t.find("div.view-controls select.view-viz-select");prspdata.e.vf.forEach(function(a,c){h.append('<option value="'+c+'">'+a.l+"</option>")});h.val(c);h.change(e);t.find("div.view-controls button:first").button({icons:{primary:"ui-icon-bookmark"},text:!1}).click(f).next().button({icons:{primary:"ui-icon-wrench"},text:!1}).click(p).next().button({icons:{primary:"ui-icon-info"},text:!1}).click(k).next().button({icons:{primary:"ui-icon-star"},text:!1}).click(m).next().button({icons:{primary:"ui-icon-cancel"},
text:!1}).click(n).next().button({icons:{primary:"ui-icon-search"},text:!1}).click(g).next();t.find("div.lgnd-container").click(q);x(c,!1)};l.getSelLocAtts=function(a){var c=[];jQuery(d()+' div.lgnd-container div.lgnd-scroll div.lgnd-template[data-index="'+a+'"] div.lgnd-locate input:checked').each(function(){var a=jQuery(this).parent().data("id");c.push(a)});return c};l.getSelFeatAtts=function(a){var c=[],k,e;jQuery(d()+' div.lgnd-container div.lgnd-scroll div.lgnd-template[data-index="'+a+'"] div.lgnd-group div.lgnd-value input:checked').each(function(){k=
jQuery(this).parent().data("index");"number"==typeof k?c.push(k):-1!=(e=k.indexOf(","))?c.push([parseInt(k.substring(0,e),10),parseInt(k.substring(e+1),10)]):c.push(parseInt(k,10))});return c};l.getSelLegend=function(a){return r[a]};l.getLgndSels=function(){return r.slice(0)};l.setLgndSels=function(a){a.forEach(function(a,c){a&&(jQuery(d()+' div.lgnd-container div.lgnd-scroll div.lgnd-template[data-index="'+c+'"] select.lgnd-select').val(a),D(c,a))})};l.getState=function(){return v?v.getState():null};
l.setState=function(a){v&&v.setState(a)};l.showStream=function(a){u=a;v&&v.render(a);c(!1)};l.setStream=function(a){u=a};l.selBtns=function(a){h(a)};l.clearSel=function(){v&&v.clearSel();h(!1)};l.setSel=function(a){return v&&v.flags()&V_FLAG_SEL?(v.setSel(a),h(0<a.length),!0):!1};l.resize=function(){v&&v.resize()};l.title=function(){return PData.vByN(z).l};l.flushLgnd=function(){jQuery(d()).find("div.lgnd-container").css("left","10px")};l.getBMData=function(){return v?{t:v.tUsed,r:v.rMap}:null};return l}
var PData=function(){function a(a,d,e){jQuery.ajax({type:"POST",url:prspdata.ajax_url,data:{action:"prsp_get_records",tmplt_id:prspdata.t[a].id,from:d,count:e},success:function(d,f,t){f=m[a];d=JSON.parse(d);f.d=f.d?f.d.concat(d):d;f.n+=e;c()},error:function(a,c,d){alert(d)}})}function c(){for(var c=!0,e=0;e<prspdata.t.length;e++){var f=m[e].n,g=prspdata.t[e].n;if(f<g){c=!1;g-=f;a(e,f,g<d?g:d);break}}c&&(p=!0,setTimeout(function(){jQuery("body").trigger("prospect",{s:PSTATE_PROCESS})},500))}var d=
1E3,e,f,g,h=[31,28,31,30,31,30,31,31,30,31,30,31],m=[],n=0,p=!1;return{init:function(){e=document.getElementById("dltext-to").innerHTML;f=document.getElementById("dltext-approximately").innerHTML;g=document.getElementById("dltext-now").innerHTML;"number"==typeof prspdata.chunk&&0<prspdata.chunk&&(d=prspdata.chunk);prspdata.t.forEach(function(a){m.push({i:n,n:0,d:null});n+=a.n});c()},rSize:function(){return n},intersect:function(a,c){for(var d=[],e=a.length,f=c.length,g,l,h=0,m=0;h<e&&m<f;)g=a[h],
...
case "t":return c;case "P":if(0<c.length){var h="";c.forEach(function(a){if(a=PData.rByID(a))0<h.length&&(h+=", "),h+='<a href="'+prspdata.site_url+"?p="+a.wp+'" target="_blank">'+a.l+"</a>"});return h}}return null},rAV:function(a,c,d){for(var e=0;e<m.length;e++){var f=m[e];if(0<f.n&&f.i<=a&&a<f.i+f.n){a=f.d[a-f.i].a[c];if(null==a||"undefined"===typeof a)break;return d?a:PData.procAttTxt(c,a)}}return null},nByID:function(a){for(var c=0;c<m.length;c++){var d=m[c];if(0<d.n)for(var e=0,f=d.n-1,g,l;e<=
f;)if(g=e+f>>1,l=d.d[g],l=PData.strcmp(a,l.id),0>l)e=g+1;else if(0<l)f=g-1;else return d.i+g}return null},rByID:function(a){for(var c=0;c<m.length;c++){var d=m[c];if(0<d.n)for(var e=0,f=d.n-1,g,l,h;e<=f;)if(g=e+f>>1,h=d.d[g],l=PData.strcmp(a,h.id),0>l)e=g+1;else if(0<l)f=g-1;else return h}return null},aByID:function(a){for(var c=0,d=prspdata.a.length-1,e,f;c<=d;)if(e=c+d>>1,f=PData.strcmp(a,prspdata.a[e].id),0>f)c=e+1;else if(0<f)d=e-1;else return prspdata.a[e];return null},aByN:function(a){return prspdata.a[a]},
eTNum:function(){return prspdata.e.g.ts.length},eTByN:function(a){return prspdata.e.g.ts[a]},tByID:function(a){for(var c=0;c<prspdata.t.length;c++)if(a==prspdata.t[c].id)return prspdata.t[c].def},lRecs:function(a,c,d,e){var f,g=d.length,l;switch(c.def.t){case "V":var h=function(a){for(var e=0;e<g;e++)if(f=d[e],"number"===typeof f){if(l=c.l[f],l.l===a)return l}else{l=c.l[f[0]];var k=l.z[f[1]];if(k.l===a)return k.v&&""!==k.v?k:l}return null};if(e&&""!==c.def.d){var m=[],r;a.forEach(function(a){r=h(a);
null!=r&&m.push(r)});return 0<m.length?m:null}if(""!=c.def.d){for(e=0;e<a.length;e++)if(r=h(a[e]),null!=r)return r;break}else return h(a[0]);case "T":for(r=0;r<g;r++)if(f=d[r],l=c.l[f],-1!=a.indexOf(l.d))return l;break;case "N":r=0;if(-1===d[0]){if("?"===a){if("undefined"===typeof c.r.u)break;return c.r.u}r=1}if("?"===a)break;for(;r<g;r++)if(f=d[r],l=c.l[f],"undefined"!==typeof l.d.min){if(l.d.min<=a)if("undefined"!==typeof l.d.max){if(a<=l.d.max)return l}else return l}else if(a<=l.d.max)return l;
break;case "D":r=0;if(-1===d[0]){if("?"===a){if("undefined"===typeof c.r.u)break;return c.r.u}r=1}if("?"!==a)for(;r<g;r++)if(f=d[r],l=c.l[f],"undefined"!==typeof l.d.max.y){if("undefined"!==typeof a.max&&"open"!==a.max){if(a.max.y<l.d.min.y)continue;if(a.max.y===l.d.min.y&&a.max.m&&l.d.min.m){if(a.max.m<l.d.min.m)continue;if(a.max.m==l.d.min.m&&a.max.d&&l.d.min.d&&a.max.d<l.d.min.d)continue}}if(!(a.min.y>l.d.max.y)){if(a.min.y===l.d.max.y&&a.min.m&&l.d.max.m){if(a.min.m>l.d.max.m)continue;if(a.min.m===
l.d.max.m&&a.min.d&&l.d.max.d&&a.min.d>l.d.max.d)continue}return l}}else if("undefined"!==typeof a.max){if("open"===a.max)return l;if(!(a.max.y<l.d.min.y)){if(a.max.y===l.d.min.y&&a.max.m&&l.d.min.m){if(a.max.m<l.d.min.m)continue;if(a.max.m===l.d.min.m&&a.max.d&&l.d.min.d&&a.max.d<l.d.min.d)continue}return l}}else if(!(a.min.y<l.d.min.y)){if(a.min.y===l.d.min.y&&a.min.m&&l.d.min.m){if(a.min.m<l.d.min.m)continue;if(a.min.m===l.d.min.m&&a.min.d&&l.d.min.d&&a.min.d<l.d.min.d)continue}return l}}return null},
...
c:a.v,i:[]}):e.push({l:a.l,c:a.v});a.z.forEach(function(d){var f=""===d?a.v:d.v;c?e.push({l:d.l,c:f,i:[]}):e.push({l:d.l,c:f})})}),e;case "N":if("undefined"===typeof a.r.min||"undefined"===typeof a.r.max)return null;d&&"undefined"!==typeof a.r.u&&(c?e.push({l:"?",c:a.r.u.v,min:"?",max:"?",i:[]}):e.push({l:"?",c:a.r.u.v,min:"?",max:"?"}));var f=Math.pow(10,a.r.g),g=a.r.min,h=0,m,v,r;for(0<a.l.length&&(m=a.l[0]);g<=a.r.max;){for(;h<a.l.length&&"undefined"!==typeof m.d.max&&g>m.d.max;)m=a.l[++h];r=0==
a.l.length||g<m.d.min?"#777777":h===a.l.length?"#777777":"undefined"===typeof m.d.max||g<=m.d.max?m.v:"#777777";v=g;g+=f;max=g-1;max>a.r.max&&(max=a.r.max);var n=v.toString();1<f&&4>n.length&&v!==max&&(n+="-"+max.toString());c?e.push({l:n,c:r,min:v,max:max,i:[]}):e.push({l:n,c:r,min:v,max:max})}return e;case "D":g=function(a){var c,d;if("undefined"===typeof a.y)return TODAY;c=a.y;"undefined"===typeof a.m?(d=12,a=31):(d=a.m,a="undefined"===typeof a.d?PData.lenMnth(c,d):a.d);return PData.d3Nums(c,d,
a,!1)};v=function(a,c,d,e){"undefined"!==typeof e.m&&(c=e.m,"undefined"!==typeof e.d&&(d=e.d));return PData.d3Nums(a,c,d,!1)};r=g(a.r.max);var f=a.r.g,n=a.r.min.y,u=1,p=1;"undefined"!==typeof a.r.min.m&&(u=a.r.min.m,"undefined"!==typeof a.r.min.d&&(p=a.r.min.d));var A=PData.d3Nums(n,u,p,!1),h=0,C,E;0<a.l.length&&(m=a.l[0],C=v(m.d.min.y,1,1,m.d.min),E=g(m.d.max));for(d&&"undefined"!==typeof a.r.u&&(c?e.push({l:"?",c:a.r.u.v,min:"?",max:"?",i:[]}):e.push({l:"?",c:a.r.u.v,min:"?",max:"?"}));A<=r;){d=
{};c&&(d.i=[]);switch(f){case "d":d.l=n.toString()+"-"+u.toString()+"-"+p.toString();break;case "m":d.l=n.toString()+"-"+u.toString();break;case "y":case "t":case "c":d.l=n.toString()}for(;h<a.l.length&&A>E;)m=a.l[++h],h<a.l.length&&(C=v(m.d.min.y,1,1,m.d.min),E=g(m.d.max));d.c=0==a.l.length||A<C?"#777777":h==a.l.length?"#777777":A<=E?m.v:"#777777";d.min=A;switch(f){case "d":++p>PData.lenMnth(n,u)&&(p=1,12<++u&&(u=1,n++));break;case "m":12<++u&&(u=1,n++);break;case "y":n++;break;case "t":n+=10;break;
case "c":n+=100}A=PData.d3Nums(n,u,p,!1);A>TODAY&&(A=TODAY);A.setTime(A.getTime()+10);d.max=A;e.push(d);A=PData.d3Nums(n,u,p,!1)}return e}},cFill:function(a,c,d,e){var f=PData.eTNum(),g=0,h,m=0,n,r,p,u,y=PData.aByID(c);for(h=e.t[0];m<e.l;){for(;0===h.n||h.i+h.n===m||!PData.aInT(c,g)||d&&!PData.aInT(d,g);){if(++g===f)return;h=e.t[g];m=h.i}n=e.s[m];r=PData.rByN(n);r=r.a[c];if("undefined"!==typeof r)switch(y.def.t){case "T":for(p=0;p<a.length;p++)if(u=a[p],-1!==r.indexOf(u.x)){u.i.push(n);break}break;
case "g":r.forEach(function(c){for(p=0;p<a.length;p++)if(u=a[p],c===u.l){u.i.push(n);break}p===a.length&&a.push({l:c,i:[n],c:"#"+Math.floor(16777215*Math.random()).toString(16)})});break;case "V":r.forEach(function(c){for(p=0;p<a.length;p++)if(u=a[p],c==u.l){u.i.push(n);break}});break;case "N":p=0;u=a[0];if("?"===u.min){if("?"===r){u.i.push(n);break}p=1}if("?"===r)break;for(;p<a.length;p++){u=a[p];if(r<u.min)break;if(u.min<=r&&r<=u.max){u.i.push(n);break}}break;case "D":p=0;u=a[0];if("?"===u.min){if("?"===
r){u.i.push(n);break}p=1}if("?"!==r)for(r=PData.dObj(r.min,1,!1);p<a.length;p++){u=a[p];if(r<u.min)break;if(u.min<=r&&r<u.max){u.i.push(n);break}}}m++}"g"==y.def.t&&a.sort(function(a,c){return PData.strcmp(c.l,a.l)})},cSort:function(a,c,d){var e=c.id,f,g,h;a.forEach(function(a){f=PData.rByN(a);datum=f.a[e];if("undefined"!==typeof datum)switch(c.def.t){case "T":for(g=0;g<d.length;g++)if(h=d[g],-1!==datum.indexOf(h.x)){h.i.push(a);break}break;case "g":datum.forEach(function(c){for(g=0;g<d.length;g++)if(h=
...
1,!1);for(g=0;g<d.length;g++){h=d[g];if(k<h.min)break;if(h.min<=k&&k<h.max){h.i.push(a);break}}}}});"g"==c.def.t&&d.sort(function(a,c){return PData.strcmp(c.l,a.l)})},rTOrder:function(a,c,d){function e(a){return a}function f(a){return a[0]}function g(a){if("?"===a)return"?";var c=1,d=1;"undefined"!==typeof a.min.m&&(c=a.min.m,"undefined"!==typeof a.min.d&&(d=a.min.d));return PData.d3Nums(a.min.y,c,d,!1)}var h,n;switch(a.def.t){case "T":h=e;n="~";break;case "V":h=f;n="~";break;case "g":h=f;n="~";break;
case "N":h=e;n=a.r.max;break;case "D":h=g,n=TODAY}var p=[],r=c.t[d];d=m[d];for(var B=0,u,y;B<r.n;)u=c.s[r.i+B++],y=d.d[u-d.i],y=y.a[a.id],"undefined"===typeof y?p.push({i:u,v:n}):p.push({i:u,v:h(y)});switch(a.def.t){case "T":case "g":case "V":p.sort(function(a,c){return PData.strcmp(c.v,a.v)});break;case "D":case "N":p.sort(function(a,c){return"?"===a.v?-1:"?"===c.v?1:a.v-c.v})}return p},vByN:function(a){return prspdata.e.vf[a]},ready:function(){return p}}}();
jQuery(document).ready(function(a){function c(){var a;PState.set(PSTATE_PROCESS);null==u&&(u=PData.sNew(!0));y=u;var c=!1,d,e;for(d=0;d<v.length;d++)if(e=v[d],a=jQuery('div.filter-instance[data-id="'+e.id+'"]'),c||e.f.isDirty(null)){c=!0;e=e.f;e.evalPrep();for(var f=PData.sNew(!1),g=0,h,k,m=0,n=y.t[0],p=0,q=0,r=a.find(".apply-tmplt-0").is(":checked");g<y.l;){for(;0===n.n||n.i+n.n===g;)f.t.push({i:f.l-p,n:p}),p=0,n=y.t[++m],r=a.find(".apply-tmplt-"+m).is(":checked");h=y.s[g++];r?(k=PData.rByN(h),e.eval(k)&&
(f.s[f.l++]=h,p++),q++):(f.s[f.l++]=h,p++)}for(;m++<PData.eTNum();)f.t.push({i:f.l-p,n:p}),p=0;e.isDirty(!1);e.out=f;e.evalDone(q);y=f}else y=e.f.out;PState.set(PSTATE_BUILD);l.forEach(function(a){a&&a.showStream(y)});0<v.length?jQuery("#btn-f-state").prop("disabled",!0).html(dlText.filtered):jQuery("#btn-f-state").prop("disabled",!0).html(dlText.nofilter)}function d(a){var c=jQuery("#annote");c.text(a);0<a.length?(jQuery("#btn-annote").button("enable"),c.show()):(jQuery("#btn-annote").button("disable"),
c.hide())}function e(a){var c=_.find(prspdata.p,function(c){return a==c.id});return c?c:null==A||0==C.length?null:(c=_.find(C,function(c){return a==c.id}))?c:null}function f(a,c){var d=jQuery("input[name=save-prspctv-dest]:checked").val();if(""==d)return null;var e=jQuery("#save-prspctv-note").val(),e=e.replace(/"/g,""),f={f:[],h0:null,h1:null,v0:null,v1:null};l.forEach(function(a,c){a&&(f["v"+c]={l:a.title(),s:a.getState()})});v.forEach(function(a){for(var c=[],d=jQuery('div.filter-instance[data-id="'+
a.id+'"]'),e=0;e<PData.eTNum();e++)c.push(d.find(".apply-tmplt-"+e).is(":checked"));f.f.push({id:a.attID,a:c,s:a.f.getState()})});for(var g=0;2>g;g++){var h=r[g];null!==h&&jQuery("#save-prspctv-h"+g).is(":checked")&&(f["h"+g]={id:B[g],s:h.getState()})}var k={id:a,l:c,n:e,s:f};"local"==d?(C.push(k),A.setItem(prspdata.e.id,JSON.stringify(C))):"server"==d&&jQuery.ajax({type:"POST",url:prspdata.ajax_url,data:{action:"prsp_save_prspctv",id:a,l:c,x:prspdata.e.id,n:e,s:JSON.stringify(f)},success:function(a,
...
JSON.stringify(C)));break;case "x":a=f.data("xindex"),e=c[a],a=e.ps.findIndex(function(a){return h==a.id}),-1!=a&&(e.ps.splice(a,1),d=!0)}f.remove()}else{var k;switch(g){case "l":k=_.find(C,function(a){return h==a.id});break;case "x":a=f.data("xindex"),e=c[a],k=_.find(e.ps,function(a){return h==a.id})}jQuery("#edit-prspctv-lbl").val(k.l);jQuery("#edit-prspctv-note").val(k.n);var l=jQuery("#dialog-edit-prsrctv").dialog({width:340,height:270,modal:!0,buttons:[{text:dlText.ok,click:function(){k.l=jQuery("#edit-prspctv-lbl").val();
k.n=jQuery("#edit-prspctv-note").val();f.find(".label").text(k.l);"x"==g?d=!0:A.setItem(prspdata.e.id,JSON.stringify(C));l.dialog("close")}},{text:dlText.cancel,click:function(){l.dialog("close")}}]})}}});a=jQuery("#dialog-manage-prsrctv").dialog({width:450,height:350,modal:!0,buttons:[{text:dlText.ok,click:function(){d&&c.forEach(function(a){0<a.ps.length?A.setItem(a.id,JSON.stringify(a.ps)):A.removeItem(a.id)});jQuery("#prspctv-mlist").off("click");a.dialog("close")}}]})}function h(a){window.location.href=
...
function q(a){PState.set(PSTATE_PROCESS);var c=l[a],d=c.getBMData(),e=[];a=r[a];if(null!==y){a.evalPrep();var f=0,g,h,k=0,m=y.t[0];a:for(;f<y.l;){for(;!d.t[k]||0==m.n||m.i+m.n==f;){if(++k===PData.eTNum())break a;m=y.t[k];f=m.i}g=y.s[f++];d.r[g>>4]&1<<(g&15)&&(h=PData.rByN(g),a.eval(h)&&e.push(g))}a.evalDone(y.l)}PState.set(PSTATE_UPDATE);0<e.length?c.setSel(e):c.clearSel();PState.set(PSTATE_READY)}function w(a,c){var d;d=jQuery("#dialog-hilite-"+a).dialog({height:275,width:Math.min(jQuery(window).width()-
20,675),modal:!0,appendTo:"#dialog-1",buttons:[{text:dlText.chsatt,click:function(){t(!1,!0,c,function(c){B[a]=c;r[a]=k(c,null,a)})}},{text:dlText.ok,click:function(){d.dialog("close");null!==r[a]&&q(a)}},{text:dlText.cancel,click:function(){d.dialog("close")}}]})}function D(a){function f(a){return prspdata.e.vf.findIndex(function(c){return a==c.l})}a=e(a);if(null==a)return!1;PState.set(PSTATE_PROCESS);jQuery("#filter-frame").hide();v.forEach(function(a){a.f.teardown()});v=[];jQuery("#filter-instances").empty();
a.s.f.forEach(function(a){k(a.id,a.a,null).setState(a.s)});jQuery("#filter-instances").hide();jQuery("#btn-toggle-filters").button(0==a.s.f.length?"disable":"enable");for(var g=0;2>g;g++)if(null!=a.s["h"+g]){var h=a.s["h"+g];B[g]=h.id;var m=k(h.id,null,g);r[g]=m;m.setState(h.s)}else r[g]=null,B[g]=null;var h=l[0],m=l[1],n=!1;PState.set(PSTATE_BUILD);g=f(a.s.v0.l);h?(h.setViz(g,!1),h.selBtns(!1)):(l[0]=PViewFrame(0),h=l[0],h.initDOM(g));null!==a.s.v1?(g=f(a.s.v1.l),m?(m.selBtns(!1),m.setViz(g,!1),
m.setState(a.s.v1.s)):(h.flushLgnd(),l[1]=PViewFrame(1),m=l[1],m.initDOM(g),m.setState(a.s.v1.s),n=!0)):m&&(l[1]=null,jQuery("#view-frame-1").remove(),n=!0);n&&h.resize();h.setState(a.s.v0.s);d(a.n);if(PData.ready()&&u)for(c(),g=0;2>g;g++)null!==B[g]&&q(g);return!0}function x(a,c){var d=prspdata.bClrs[a];d&&0<d.length&&jQuery(c).css("background-color",d)}var l=[null,null],z,v=[],r=[null,null],B=[null,null],u,y,A=null,C=[];jQuery("body").addClass("waiting");x("cb","#command-bar");x("fs","#filter-frame");
...
jQuery("#title").text(prspdata.e.g.l);try{var E=window.localStorage;E.setItem("__storage_test__","__storage_test__");E.removeItem("__storage_test__");var F=E.getItem(prspdata.e.id),A=E;0<F.length&&(C=JSON.parse(F))}catch(G){}jQuery("#btn-about").button({icons:{primary:"ui-icon-power"},text:!1}).click(function(a){var c;jQuery("#dialog-about img").removeClass("zoomin");c=jQuery("#dialog-about").dialog({height:390,width:350,modal:!0,buttons:[{text:dlText.ok,click:function(){c.dialog("close")}}]});jQuery("#dialog-about img").addClass("zoomin");
...
text:!1}).click(function(a){var c=jQuery("#prspctv-slist");c.empty();prspdata.p.forEach(function(a){c.append('<li data-src="server" data-id="'+a.id+'">'+a.l+"</li>")});C.forEach(function(a){c.append('<li data-src="local" data-id="'+a.id+'">'+a.l+"</li>")});var d=[{text:dlText.ok,click:function(){e.dialog("close");var a=c.find("li.selected");a.length&&(a=a.data("id"),D(a),PState.set(PSTATE_READY))}},{text:dlText.cancel,click:function(){e.dialog("close")}}];A&&d.push({text:dlText.manage,click:function(){e.dialog("close");
...
"LI"==a.target.nodeName&&(jQuery("#filter-list li").removeClass("selected"),jQuery(a.target).addClass("selected"))});jQuery("#prspctv-slist").click(function(a){"LI"==a.target.nodeName&&(jQuery("#prspctv-slist li").removeClass("selected"),jQuery(a.target).addClass("selected"))});jQuery("#btn-new-filter").button({icons:{primary:"ui-icon-plus"},text:!1}).click(function(a){t(!0,!1,null,function(a){jQuery("#filter-instances").show(400);k(a,[!0,!0,!0,!0],null);jQuery("#btn-toggle-filters").button("enable")});
...
text:!1});(function(){jQuery("#filter-list").append('<li class="remove" data-id="_remove"><i>'+dlText.rha+"</i></li>");prspdata.a.forEach(function(a){switch(a.def.t){case "V":case "T":case "g":case "N":case "D":jQuery("#filter-list").append('<li data-id="'+a.id+'">'+a.def.l+"</li>")}})})();0!=prspdata.show_prspctv.length&&D(prspdata.show_prspctv)||(l[0]=PViewFrame(0),l[0].initDOM(0),d(""));jQuery(window).resize(function(){l.forEach(function(a){a&&a.resize()})});jQuery("body").on("prospect",function(a,
d){switch(d.s){case PSTATE_PROCESS:PState.set(PSTATE_PROCESS);c();for(var e=0;2>e;e++)null!==r[e]&&q(e);PState.set(PSTATE_READY);jQuery("body").removeClass("waiting");break;case PSTATE_FDIRTY:jQuery("#btn-f-state").prop("disabled",!1).html(dlText.dofilters);break;case PSTATE_HILITE:w(d.v,d.t)}});PState.set(PSTATE_LOAD);PData.init()});function onYouTubeIframeAPIReady(){widgetData.ytCall&&widgetData.ytCall()};