...
h.empty();var m=jQuery('<div class="op-layer" data-i="-1">Base Map <input type=range class="op-slider" min=0 max=100 value=100 step=5></div>');h.append(m);_.each(this.settings.lyrs,function(c,l){g=c.o||1;var d;d=PMapHub.createMapLayer(c.lid,g,a.lMap,null);a.mapLayers.push(d);m=jQuery('<div class="op-layer" data-i="'+l+'">'+d.options.layerName+' <input type=range class="op-slider" min=0 max=100 value='+100*c.o+" step=5></div>");h.append(m)});var q=_.template(document.getElementById("dltext-v-map").innerHTML);
...
VizMap.prototype.render=function(a){function c(a){if(a.target&&a.target.options){var c=a.target.options._aid,l=d.toggleSel(c);a=PData.n2T(c);1<d.tLCnt[a]?(PState.set(PSTATE_UPDATE),e.eachLayer(function(a){a.options._aid===c&&(l?a.setStyle({color:"yellow",weight:2}):a.setStyle({color:"#000",weight:1}))}),PState.set(PSTATE_READY)):l?this.setStyle({color:"yellow",weight:2}):this.setStyle({color:"#000",weight:1})}}var d=this,e=this.markerLayer;0<this.recSel.length&&(this.recSel=[]);this.preRender();e.clearLayers();
var f=this.lineLayer;f.clearLayers();var g=PData.eTNum(),h=0,m,q=0,p,l,n,r,u,w,z,k,A,v,t,y,x,B,D,C,E;B=this.settings.min;"string"===typeof B&&(B=parseInt(B));q=this.settings.max;"string"===typeof q&&(q=parseInt(q));D=q-B;for(h=0;h<g;h++)this.tLCnt[h]=0;for(var F,h=0;h<g;h++)if("disable"!==this.settings.pAtts[h]){F=[];break}h=0;q=-1;a:for(;h<a.l;){if(null==w){do{if(++q==g)break a;p=a.t[q]}while(0===p.n||p.i+p.n===h);w=this.vFrame.getSelLocAtts(q);if(0===w.length){w=null;continue}z=d.vFrame.getSelFeatAtts(q);
if(0===z.length){w=null;continue}d.tLCnt[q]=w.length;d.tUsed[q]=!0;r=d.vFrame.getSelLegend(q);u=PData.aByID(r);k=d.settings.pAtts[q];l=d.settings.lClrs[q];if(y=d.settings.sAtts[q])x=PData.aByID(y),"number"===typeof x.r.min&&"number"===typeof x.r.max?(C=x.r.min,E=x.r.max-C):y=null}m=a.s[h];n=PData.rByN(m);var G;F&&(G={id:n.id,c:[],p:n.a[k],l:l});w.forEach(function(a){if(A=n.a[a])if(v=n.a[r],"undefined"!==typeof v&&(v=PData.lClr(v,u,z))){d.rMap[m>>4]|=1<<(m&15);if("number"===typeof A[0])y?(x=n.a[y],
x="number"===typeof x?Math.floor((x-C)*D/E)+B:B):x=B,t=L.circleMarker(A,{_aid:m,weight:1,radius:x,fillColor:v,color:"#000",opacity:1,fillOpacity:1}),G&&G.c.push(A);else if(t=2===A.length?L.polyline(A,{_aid:m,weight:1,fillColor:v,color:"#000",opacity:1,fillOpacity:1}):L.polygon(A,{_aid:m,weight:1,fillColor:v,color:"#000",opacity:1,fillOpacity:1}),G){var l=[0,0];A.forEach(function(a){l[0]+=a[0];l[1]+=a[1]});l[0]/=A.length;l[1]/=A.length;G.c.push(l)}t.on("click",c);e.addLayer(t)}});G&&0<G.c.length&&
F.push(G);++h==p.i+p.n&&(w=null)}if(F){F.sort(function(a,c){return PData.strcmp(c.id,a.id)});var H=[];F.forEach(function(a){a.p&&a.p.forEach(function(c){h=_.sortedIndex(F,{id:c},"id");if(h<F.length){var l=F[h];l.id===c&&a.c.forEach(function(c){l.c.forEach(function(l){c[0]===l[0]&&c[1]===l[1]||H.push({p:[c,l],c:a.l})})})}})});H.forEach(function(a){f.addLayer(L.polyline(a.p,{color:a.c,weight:2}))})}};VizMap.prototype.teardown=function(){var a=this.vFrame.getIndex();jQuery("#view-frame-"+a+" div.view-controls div.iconbar").remove()};
...
VizCards.prototype.render=function(a){var c=this;this.stream=a;var d=PData.eTNum(),e,f,g,h,m,q,p,l,n,r,u,w,z,k,A=jQuery(this.frameID);A.empty();0<this.recSel.length&&(this.recSel=[]);this.preRender();var v,t="w"+this.settings.w+" h"+this.settings.h;f=a.t[0];for(e=0;e<d;){for(;0===f.n;){if(++e===d)return;f=a.t[e]}f=PData.eTByN(e);f=PData.tByID(f);q=c.vFrame.getSelFeatAtts(e);0!==q.length&&(A.append('<div class="template-label">'+f.l+'</div><div class="cards" data-ti="'+e+'"></div>'),v=jQuery('div.cards[data-ti="'+
e+'"]'),this.tUsed[e]=!0,g=c.vFrame.getSelLegend(e),h=PData.aByID(g),m=c.settings.iAtts[e],r=c.settings.cnt[e],f=c.sAtts[e],f=PData.aByID(f),f=PData.rTOrder(f,a,e),f.forEach(function(a){p=PData.rByN(a.i);u=p.a[g];"undefined"!==typeof u&&(l=PData.lRecs(u,h,q,!1))&&(c.rMap[a.i>>4]|=1<<(a.i&15),z=c.settings.lOn?'<div class="card-title">'+p.l+"</div>":"",n=!1,w="",r&&0<r.length&&(k=l.b?' style="color:black"':"",r.forEach(function(a){if(u=p.a[a])if(u=PData.procAttTxt(a,u))n=!0,w+=u+"<br/>"})),w=m&&(u=
p.a[m])?n?'<div class="card-body"><img src="'+u+'"/><div class="card-cnt"'+k+">"+w+"</div></div>":'<div class="card-body"><img class="full" src="'+u+'"/></div>':'<div class="card-body"><div class="card-cnt"'+k+">"+w+"</div>",v.append('<div class="card '+t+'" style="background-color:'+l.v+'" data-ai="'+a.i+'">'+z+w+"</div>"))}));f=a.t[++e]}};VizCards.prototype.teardown=function(){jQuery(this.frameID).off("click.vf")};
VizCards.prototype.rerender=function(a){var c=this,d=jQuery(this.frameID+' div.cards[data-ti="'+a+'"]');d.empty();var e,f,g,h,m,q,p,l,n,r,u,w,z,k="w"+this.settings.w+" h"+this.settings.h;e=c.vFrame.getSelFeatAtts(a);0!=e.length&&(f=c.vFrame.getSelLegend(a),g=PData.aByID(f),h=c.settings.iAtts[a],m=c.settings.cnt[a],q=c.sAtts[a],q=PData.aByID(q),a=PData.rTOrder(q,c.stream,a),a.forEach(function(a){p=PData.rByN(a.i);l=p.a[f];"undefined"!==typeof l&&(n=PData.lRecs(l,g,e,!1))&&(w=c.settings.lOn?'<div class="card-title">'+
p.l+"</div>":"",r=!1,u="",m&&0<m.length&&(z=n.b?' style="color:black"':"",m.forEach(function(a){if(l=p.a[a])if(l=PData.procAttTxt(a,l))r=!0,u+=l+"<br/>"})),u=h&&(l=p.a[h])?r?'<div class="card-body"><img src="'+l+'"/><div class="card-cnt"'+z+">"+u+"</div></div>":'<div class="card-body"><img class="full" src="'+l+'"/></div>':'<div class="card-body"><div class="card-cnt"'+z+">"+u+"</div>",d.append('<div class="card '+k+(c.isSel(a.i)?" obj-sel":"")+'" style="background-color:'+n.v+'" data-ai="'+a.i+'">'+
...
VizPinboard.prototype.render=function(a){var c=this;this.gRecs.selectAll(".recobj").remove();this.gRecs.selectAll(".recline").remove();0<this.recSel.length&&(this.recSel=[]);this.preRender();var d=PData.eTNum(),e,f,g=0,h,m,q,p,l,n,r,u,w,z,k,A,v,t,y,x;for(e=0;e<d;e++)if("disable"!==this.settings.pAtts[e]){x=[];break}A=this.settings.min;"string"===typeof A&&(A=parseInt(A));f=this.settings.max;"string"===typeof f&&(f=parseInt(f));v=f-A;var B=[];e=0;g=-1;a:for(;e<a.l;){if(null==n){do{if(++g===d)break a;
h=a.t[g]}while(0===h.n||h.i+h.n===e);n=this.vFrame.getSelLocAtts(g);if(0===n.length){n=null;continue}n=n[0];r=c.vFrame.getSelFeatAtts(g);if(0===r.length){n=null;continue}c.tUsed[g]=!0;p=c.vFrame.getSelLegend(g);l=PData.aByID(p);u=c.settings.pAtts[g];m=c.settings.lClrs[g];if(k=c.settings.sAtts[g])q=PData.aByID(k),"number"===typeof q.r.min&&"number"===typeof q.r.max?(t=q.r.min,y=q.r.max-t):k=null}f=a.s[e];q=PData.rByN(f);var D;x&&(D={id:q.id,c:null,p:q.a[u],l:m});w=q.a[n];"undefined"!==typeof w&&(z=
q.a[p],"undefined"!==typeof z&&(z=PData.lClr(z,l,r)))&&(c.rMap[f>>4]|=1<<(f&15),k?(q=q.a[k],q="number"===typeof q?Math.floor((q-t)*v/y)+A:A):q=A,B.push({ai:f,v:z,x:w[0],y:w[1],r:q}),D&&(D.c=w));D&&D.c&&x.push(D);++e==h.i+h.n&&(n=null)}this.gRecs.selectAll(".recobj").data(B).enter().append("circle").attr("class","recobj").attr("cx",function(a){return c.xScale(a.x)}).attr("cy",function(a){return c.yScale(a.y)}).attr("r",function(a){return c.yScale(a.r)}).style("fill",function(a){return a.v}).on("click",
function(a,l){var d=c.toggleSel(a.ai);d3.select(this).classed("obj-sel",d)});if(x){x.sort(function(a,c){return PData.strcmp(c.id,a.id)});var C=[];x.forEach(function(a){a.p&&a.p.forEach(function(c){e=_.sortedIndex(x,{id:c},"id");if(e<x.length){var l=x[e];l.id===c&&C.push({f:a.c,t:l.c,c:a.l})}})});this.gRecs.selectAll(".recline").data(C).enter().append("line").attr("class","recline").attr("x1",function(a){return c.xScale(a.f[0])}).attr("y1",function(a){return c.yScale(a.f[1])}).attr("x2",function(a){return c.xScale(a.t[0])}).attr("y2",
...
VizTime.prototype.setup=function(){function a(a){var c={id:a,l:0,t:0,h:0,w:g[1],svgID:"#tl-b-"+m+"-"+a,tHt:0,iHt:0,xScale:d3.time.scale(),yScale:function(a){return a*c.tHt},parts:[],g:null,labels:null,labelSVGs:null,redraw:function(){}};a?(c.tHt=e.settings.bHt,c.iHt=c.tHt-2):(c.tHt=3,c.iHt=2);if(1==a){var l=e.minDate,d=e.maxDate;0<e.settings.zFrom.length&&(l=PData.dStr(e.settings.zFrom,!1));0<e.settings.zTo.length&&(d=PData.dStr(e.settings.zTo,!0));c.xScale.domain([l,d]);e.zMinDate=l;e.zMaxDate=d}else c.xScale.domain([e.minDate,
e.maxDate]);c.xScale.range([0,c.w]);c.g=e.chart.append("g").attr("id",c.svgID.substring(1)).attr("class","tl-band").attr("width",c.w);e.bands[a]=c;e.cmpnts.push(c)}function c(a){var c=e.bands[a],l=d3.svg.axis().scale(c.xScale).orient("bottom").tickSize(6,0);localD3&&l.tickFormat(localD3);var d=c.g.append("g").attr("id","axis-"+m+"-"+a).attr("class","axis").style("font-size","10px");a={redraw:function(){d.call(l)}};c.parts.push(a);e.cmpnts.push(a)}function d(a){var c=e.bands[a],l;l=1===a?32:16;c.labels=
...
e.settings.xLbl).attr("height",l);var r=d.append("text").attr("class","bMinMaxLbl").attr("id",function(a){return"txt-"+a.name}).attr("x",function(a){return a.x()+a.tDelta}).attr("y",12).attr("text-anchor",function(a){return a.anchor}),f={redraw:function(){var a=c.xScale.domain(),l=a[0],d=a[1];r.text(function(a){return a.whichDate(l,d).getUTCFullYear()})}};c.parts.push(f);e.cmpnts.push(f);if(1===a){var w=d.append("text").attr("class","bMinMaxLbl").attr("id",function(a){return"m-txt-"+a.name}).attr("x",
function(a){return a.x()+a.tDelta}).attr("y",l-4).attr("text-anchor",function(a){return a.anchor});a={redraw:function(){var a=c.xScale.domain(),l=a[0],d=a[1];w.text(function(a){return d.getUTCFullYear()-l.getUTCFullYear()>e.threshold?"":months[a.whichDate(l,d).getMonth()]})}};c.parts.push(a);e.cmpnts.push(a)}c.labelSVGs=d}var e=this;"number"!==typeof this.settings.xLbl&&(this.settings.xLbl=parseInt(this.settings.xLbl));this.brushSVG=this.brush=null;var f=this.settings;"string"===typeof f.bHt&&(f.bHt=
parseInt(f.bHt,10));(function(){var a,c,l,d,r,u;f.dAtts.forEach(function(e){null!=e&&"disable"!==e&&(e=PData.aByID(e))&&(null==a||e.r.min.y<a?(a=e.r.min.y,"undefined"!==typeof e.r.min.m?(c=e.r.min.m,l="undefined"!==typeof e.r.min.d?e.r.min.d:1):l=c=1):e.r.min.y===a&&"undefined"!==typeof e.r.min.m&&(e.r.min.m<c?(c=e.r.min.m,l="undefined"!==typeof e.r.min.d?e.r.min.d:1):e.r.min.m===c&&"undefined"!==typeof e.r.min.d&&e.r.min.d<l&&(l=e.r.min.d)),null==d?"undefined"===typeof e.r.max.y?(d=TODAY.getUTCFullYear(),
...
e.r.max.d>u&&(u=e.r.max.d)))});e.minDate=0<f.from.length?PData.dStr(f.from,!1):PData.d3Nums(a,c,l,!1);e.maxDate=0<f.to.length?PData.dStr(f.to,!0):PData.d3Nums(d,r,u,!0);e.instGap=.015*(e.maxDate-e.minDate)})();var g=e.getWidths(),h=d3.select(this.frameID).append("svg").attr("class","tl-vf").attr("width",g[1]);(function(){var a=[];f.lgnds.forEach(function(c){c.forEach(function(c){a.push(c)})});var a=_.uniq(a),c=[];a.forEach(function(a){(a=PData.aByID(a))&&a.l.forEach(function(a){c.push(a.v)})});c=
_.uniq(c);c.sort();var l=h.append("defs"),d,e;c.forEach(function(a){e=a.substr(1);d=l.append("linearGradient").attr("id",e+"-fs");d.append("stop").attr("offset","0%").attr("stop-color","#C0C0C0");d.append("stop").attr("offset","5%").attr("stop-color",a);d.append("stop").attr("offset","100%").attr("stop-color",a);d=l.append("linearGradient").attr("id",e+"-fe");d.append("stop").attr("offset","0%").attr("stop-color",a);d.append("stop").attr("offset","95%").attr("stop-color",a);d.append("stop").attr("offset",
"100%").attr("stop-color","#C0C0C0");d=l.append("linearGradient").attr("id",e+"-fb");d.append("stop").attr("offset","0%").attr("stop-color","#C0C0C0");d.append("stop").attr("offset","5%").attr("stop-color",a);d.append("stop").attr("offset","95%").attr("stop-color",a);d.append("stop").attr("offset","100%").attr("stop-color","#C0C0C0")})})();var m=this.vFrame.getIndex();h.append("clipPath").attr("id","tl-clip-"+m).append("rect").attr("width",g[1]);e.chart=h.append("g").attr("class","chart").attr("clip-path",
"url(#tl-clip-"+m+")");e.instRad=f.bHt/2-1;e.bands=Array(2);e.cmpnts=[];a(0);a(1);c(0);c(1);d(0);d(1)};
VizTime.prototype.render=function(a){function c(a,c){var l=a.s-c.s;if(0>l)return 1;if(0<l)return-1;l=c.e-a.e;return 0>l?1:0<l?-1:0}function d(a){function c(a){a=g.toggleSel(a.ai);d3.select(this).classed("obj-sel",a)}var l,d,e,f,w=g.bands[a];a?(l=g.bands[0],w.t=l.t+l.h+37,l=d=e=g.instRad,f=2*g.instRad+3):(w.t=0,l=d=e=1);w.h=m*w.tHt+2;w.g.attr("transform","translate(0,"+w.t+")").attr("height",w.h);var h,k;a&&(h=.75*w.iHt+"px",k=.8*w.iHt);var A;A=d3.select(w.svgID).selectAll(".lgBd").remove();A=d3.select(w.svgID).selectAll(".lgBd").data(g.lgBds).enter().append("svg").attr("class",
"lgBd").attr("y",function(a){return w.yScale(a.t)}).attr("height",function(a){return w.yScale(a.h)});A.append("rect").attr("width","100%").attr("height","100%").attr("fill",function(a){return a.d.v});1===a&&A.append("text").attr("class","lgBdLbl").attr("x",2).attr("y",k).attr("fill",function(a){return a.d.b?"#000000":"#FFFFFF"}).style("font-size",h).text(function(a){return a.d.l});var v;d3.select(w.svgID).selectAll(".event").remove();v=d3.select(w.svgID).selectAll(".event").data(g.events).enter().append("svg").attr("class",
...
1===a&&t.append("text").attr("class","rangeLbl").attr("x",4).attr("y",k).attr("fill",function(a){return a.c.b?"#000000":"#FFFFFF"}).style("font-size",h).text(function(a){return a.l});t=d3.select(w.svgID).selectAll(".instant");t.append("circle").attr("cx",l).attr("cy",d).attr("r",e).attr("fill",function(a){return a.c.v});1===a&&t.append("text").attr("class","instantLbl").attr("x",f).attr("y",k).style("font-size",h).text(function(a){return a.l});w.redraw=function(){A.attr("x",function(a){return w.xScale(a.s)}).attr("width",
function(a){return w.xScale(a.e)-w.xScale(a.s)});v.attr("x",function(a){return w.xScale(a.s)}).attr("width",function(a){return w.xScale(a.e)-w.xScale(a.s)});w.parts.forEach(function(a){a.redraw()})}}function e(a){a=g.bands[a];d3.select(a.svgID).selectAll(".axis").attr("transform","translate(0,"+a.h+")")}function f(a){a=g.bands[a];d3.select(a.svgID).selectAll(".bLblCntr").attr("transform","translate(0,"+(a.h+1).toString()+")")}var g=this,h=this.vFrame.getIndex();0<this.recSel.length&&(this.recSel=
[]);this.preRender();this.events=[];this.lgBds=[];var m=0;(function(){for(var d=PData.eTNum(),e=0,l,n,r,f,h,z,k,A;e<d;){for(l=a.t[e];0===l.n;){if(++e==d)return;l=a.t[e]}r=g.vFrame.getSelLocAtts(e);if(0!==r.length&&(r=g.vFrame.getSelFeatAtts(e),0!==r.length)){g.tUsed[e]=!0;A=g.vFrame.getSelLegend(e);k=PData.aByID(A);f=g.settings.dAtts[e];for(var v,t,y,x,B,D,C,E,F=[],G=l.i;G<l.i+l.n;G++)n=a.s[G],E=PData.rByN(n),h=E.a[A],"undefined"!==typeof h&&(h=PData.lRecs(h,k,r,!1))&&(z=E.a[f])&&"?"!==z&&(g.rMap[n>>
4]|=1<<(n&15),D=z.min.f?EVENT_F_START:0,v=z.min.y,"undefined"===typeof z.min.m?y=t=1:(t=z.min.m,y="undefined"===typeof z.min.d?1:z.min.d),x=PData.d3Nums(v,t,y,!1),"undefined"===typeof z.max?(D|=EVENT_INSTANT,B=x.getTime()+g.instGap):"open"===z.max?B=TODAY:(z.max.f&&(D|=EVENT_F_END),v=z.max.y,"undefined"===typeof z.max.m?(t=12,y=31):(t=z.max.m,y="undefined"===typeof z.max.d?PData.lenMnth(v,t):z.max.d),B=PData.d3Nums(v,t,y,!0)),F.push({s:x,e:B,ai:n,f:D,c:h,l:E.l,t:0}));F.sort(c);var H=[],I;F.forEach(function(a){for(I=
0;I<H.length&&!(a.e<H[I]);I++);a.t=I+m+1;H[I]=a.s});l=PData.aByID(f);l.l.forEach(function(a){C=a.d;v=C.min.y;"undefined"===typeof C.min.m?y=t=1:(t=C.min.m,y="undefined"===typeof C.min.d?1:C.min.d);x=PData.d3Nums(v,t,y,!1);"undefined"===typeof C.max.y?B=TODAY:(v=C.max.y,"undefined"===typeof C.max.m?(t=12,y=31):(t=C.max.m,y="undefined"===typeof C.max.d?PData.lenMnth(v,t):C.max.d),B=PData.d3Nums(v,t,y,!0));g.lgBds.push({s:x,e:B,t:m,h:H.length+1,d:a})});m+=H.length+1;g.events=g.events.concat(F)}e++}})();
...
c[1];d3.select(this).call(g.brush.extent(c));zoom=g.bands[1];zoom.xScale.domain(c);zoom.redraw()});g.brushSVG=a.g.append("g");g.brushSVG.attr("class","brush").call(g.brush);g.brushSVG.selectAll("rect").attr("y",-1).attr("height",a.h);g.brushSVG.selectAll(".resize").append("path").attr("d",function(c){var d=(c=+("e"==c))?1:-1,e=a.h/4;return"M"+.5*d+","+e+"A6,6 0 0 "+c+" "+6.5*d+","+(e+6)+"V"+(2*e-6)+"A6,6 0 0 "+c+" "+.5*d+","+2*e+"ZM"+2.5*d+","+(e+8)+"V"+(2*e-8)+"M"+4.5*d+","+(e+8)+"V"+(2*e-8)})})();
...
VizDirectory.prototype.render=function(a){var c=this,d=PData.eTNum(),e=0,f,g,h,m,q,p,l=jQuery(this.frameID);l.empty();0<this.recSel.length&&(this.recSel=[]);this.preRender();this.stream=a;for(f=a.t[0];e<d;){for(;0===f.n;){if(++e===d)return;f=a.t[e]}c.tUsed[e]=!0;f=PData.eTByN(e);f=PData.tByID(f);l.append('<div class="template-label">'+f.l+'</div><table cellspacing="0" class="viz-directory" data-ti='+e+"></table>");g=l.find('table[data-ti="'+e+'"]');h=c.settings.cnt[e];p="<thead><tr>";h.forEach(function(a){a=
...
VizTextStream.prototype.render=function(a){var c=this,d=PData.eTNum(),e=0,f,g,h,m,q,p,l,n,r,u,w,z,k,A,v,t,y,x=jQuery(this.frameID);x.empty();0<this.recSel.length&&(this.recSel=[]);this.preRender();t=this.settings.max-this.settings.min;for(g=a.t[0];e<d;){for(;0===g.n;){if(++e===d)return;g=a.t[e]}r=c.vFrame.getSelLocAtts(e);if(0!==r.length&&(r=c.vFrame.getSelFeatAtts(e),0!==r.length)){c.tUsed[e]=!0;u=c.vFrame.getSelLegend(e);w=PData.aByID(u);x.append('<div class="viz-textstream" data-ti='+e+"></div>");
h=x.find("div.viz-textstream[data-ti="+e+"]");f=PData.eTByN(e);f=PData.tByID(f);h.append('<div class="template-label">'+f.l+"</div>");n=c.settings.cnt[e];if(A=c.settings.sAtts[e])k=PData.aByID(A),"number"===typeof k.r.min&&"number"===typeof k.r.max?v=k.r.max-k.r.min:A=null;n&&(f=PData.aByID(c.settings.order[e]),f=PData.rTOrder(f,a,e),f.forEach(function(a){m=PData.rByN(a.i);q=m.a[u];"undefined"!==typeof q&&(z=PData.lRecs(q,w,r,!1))&&((p=m.a[n])&&(p=PData.procAttTxt(n,p)),p&&(c.rMap[a.i>>4]|=1<<(a.i&
15),A?(l=m.a[A],l="number"===typeof l?Math.floor((l-k.r.min)*t/v)+c.settings.min:c.settings.min):l=c.settings.min,y=z.b?";background-color:black":"",h.append('<div class="recitem" data-ai='+a.i+' style="color:'+z.v+y+";font-size:"+l+'px">'+p+"</div>")))}))}e++}};VizTextStream.prototype.teardown=function(){jQuery(this.frameID).off("click.vf")};
...
c:a.c,y:h,h:a.i.length,a:a.i}),h+=a.i.length)});d=Math.max(d,h)}c.yScale.domain([0,d]);c.svg.select(".y.axis").call(c.yAxis);a=c.colW-7;this.svg.selectAll(".block").data(c.blocks).enter().append("rect").attr("class","block").attr("x",function(a){return D3SC_MARGINS.left+5+c.xScale(a.x)}).attr("y",function(a){return c.yScale(a.y)+D3SC_MARGINS.top}).attr("fill",function(a){return a.c}).attr("height",function(a){return Math.max(1,c.yScale(a.h)-1)}).attr("width",a).on("click",function(a,d){var e=c.bSel.length,
l=_.sortedIndex(c.bSel,d);c.bSel[l]===d?(d3.select(this).classed("obj-sel",!1),c.bSel.splice(l,1),0<e&&0==c.bSel.length&&c.vFrame.selBtns(!1)):(d3.select(this).classed("obj-sel",!0),c.bSel.splice(l,0,d),0==e&&0<c.bSel.length&&c.vFrame.selBtns(!0))})};VizStackChart.prototype.setSel=function(a){};VizStackChart.prototype.clearSel=function(){0<this.bSel.length&&(this.bSel=[],this.svg.selectAll(".block").classed("obj-sel",!1))};
...
VizNetWheel.prototype.render=function(a){var c=this,d=[],e,f,g;this.svg.selectAll(".node").remove();this.svg.selectAll(".link").remove();this.inc=360/(a.l+a.t.length);f=Math.max((14*a.l+20)/(2*Math.PI),30);var h=this.settings.lw;"string"===typeof h&&(h=parseInt(h));this.cr=h+12+f;h=2*this.cr;this.svg.attr("width",h).attr("height",h);this.center.attr("transform","translate("+this.cr+","+this.cr+")");0<this.recSel.length&&(this.recSel=[]);this.preRender();var m={children:[]};(function(){var d,e=0,l=
0,n,r,f,g=[],h=null,k,A;d=a.t[0];A=c.vFrame.getSelLegend(0);k=PData.aByID(A);h=c.vFrame.getSelFeatAtts(0);0<h.length&&0<d.n&&(c.tUsed[0]=!0);a:for(;l<a.l;){for(;0===d.n||d.i+d.n===l||0===h.length;){0<g.length&&(m.children.push({ti:e,children:g}),g=[]);if(++e===PData.eTNum())break a;g=[];d=a.t[e];A=c.vFrame.getSelLegend(e);k=PData.aByID(A);h=c.vFrame.getSelFeatAtts(e);0<h.length&&0<d.n&&(c.tUsed[e]=!0)}f=a.s[l];n=PData.rByN(f);r=n.a[A];"undefined"!==typeof r&&(fData=PData.lRecs(r,k,h,!1))&&(c.rMap[f>>
4]|=1<<(f&15),g.push({r:n,ai:f,c:fData.v,children:[]}));l++}0<g.length&&m.children.push({ti:e,children:g})})();f=d3.layout.cluster().size([360,f]).sort(null).nodes(m);g=this.center.append("g").selectAll(".node").data(f.filter(function(a){return!a.children})).enter().append("g").attr("class","node").attr("transform",function(a){return"rotate("+(a.x-90)+")translate("+(a.y+8)+",0)"});g.append("circle").attr("r","5").style("fill",function(a){return a.c}).on("click",function(a){a=c.toggleSel(a.ai);d3.select(this).classed("obj-sel",
...
180*Math.PI});m.children.forEach(function(a){var e=c.settings.pAtts[a.ti],l;a.children.forEach(function(a){e.forEach(function(c){l=a.r.a[c.pid];"undefined"!==typeof l&&l.forEach(function(e){var l=!1,f,k=0;a:for(;k<m.children.length;k++)for(var g=m.children[k],h=0;h<g.children.length;h++)if(f=g.children[h],f.r.id==e){l=!0;break a}l&&d.push({source:a,target:f,c:c.clr})})})})});e=this.center.append("g").selectAll(".link").data(f(d)).enter().append("path").each(function(a){a.s=a[0];a.t=a[a.length-1]}).attr("class",
...
p=0;p<g.c.length;p++){for(var l=0,m=0;m<a.c.length;m++)0<h[m][p].length&&l++;q[p]=l-1}for(var n=Array(g.c.length),p=0;p<g.c.length;p++)n[p]=0;var r=0;a.c.forEach(function(l,f){for(var z=0,k=0;k<g.c.length;k++)0<h[f][k].length&&z++;--z;var p=l.i.length*d/a.t,m=0,t=0;g.c.forEach(function(k,x){var B=h[f][x];if(0<B.length){var D=B.length*d,C=D/a.t,D=D/g.t,E=k.i.length*d/g.t;c.ints.push({i:B,c:l.c,l:l.l+" > "+k.l,x1:5+r*d/a.t+(z?(p-C)*m/z:0),x2:5+t*d/g.t+(q[x]?(E-D)*n[x]/q[x]:0),w1:C,w2:D,y1:a.y+10,y2:g.y-
1});m++;n[x]++}t+=k.i.length});r+=l.i.length})}});this.flowG.selectAll(".flow").data(c.ints).enter().append("path").attr("class","flow").attr("d",function(a){return"M "+a.x1+" "+a.y1+"  L "+(a.x1+a.w1)+" "+a.y1+" L "+(a.x2+a.w2)+" "+a.y2+" L "+a.x2+" "+a.y2+" L "+a.x1+" "+a.y1}).attr("fill",function(a){return a.c}).on("click",function(a,d){var g=c.fSel.length,h=_.sortedIndex(c.fSel,d);c.fSel[h]===d?(d3.select(this).classed("obj-sel",!1),c.fSel.splice(h,1),0<g&&0===c.fSel.length&&0===c.bSel.length&&
...
var VizBrowser=function(a,c){PVizModel.call(this,a,c);this.stream=null};VizBrowser.prototype=Object.create(PVizModel.prototype);VizBrowser.prototype.constructor=VizBrowser;VizBrowser.prototype.flags=function(){return V_FLAG_VSCRL|V_FLAG_HSCRL};VizBrowser.prototype.setup=function(){var a=250*this.settings.fcts.length;this.svg=d3.select(this.frameID).append("svg").attr("width",a)};
...
VizBrowser.prototype.render=function(a){var c=this,d=this.vFrame.getIndex();this.recSel=[];this.stream=a;this.svg.selectAll(".facet-col").remove();var e=0;this.fcts=[];this.settings.fcts.forEach(function(d,f){var g,p=PData.aByID(d);g="g"===p.def.t?[]:c.settings.gr?PData.cRNew(p,!0,!0):PData.cLNew(p,null,!0);PData.cFill(g,d,null,a);var l=[],n=0;g.forEach(function(a){0<a.i.length&&(a.n=n++,l.push(a))});c.fcts.push({c:l,x:250*f,i:f,l:p.def.l,s:-1});e=Math.max(e,27+22*(l.length+1))});c.svg.attr("height",
e);var f=c.svg.selectAll(".facet-col").data(c.fcts).enter().append("g").attr("transform",function(a){return"translate("+a.x+", 0)"}).attr("class","facet-col").attr("id",function(a){return"facet-"+d+"-"+a.i});f.append("rect").attr("class","facet-lbl").attr("height",24).attr("width",242);f.append("text").attr("class","facet-lbl-txt").attr("x",3).attr("y",18).attr("text-anchor","start").text(function(a){return a.l});var g;c.fcts.forEach(function(e){var f="#facet-"+d+"-"+e.i;g=c.svg.select(f).selectAll(".facet-reset").data([1]).enter().append("g").attr("transform",
"translate(0,26)").attr("class","facet-reset inactive").attr("height",19).on("click",function(a){-1!==e.s&&(e.s=-1,c.svg.select(f).selectAll(".facet-val").classed("inactive",!1),d3.select(this).classed("inactive",!0),c.update())});g.append("rect").attr("class","facet-reset-btn").attr("height",19).attr("width",242);g.append("text").attr("class","facet-reset-txt").attr("x",3).attr("y",13).text(dlText.reset);g=c.svg.select(f).selectAll(".facet-val").data(e.c).enter().append("g").attr("transform",function(a,
c){return"translate(0,"+(27+22*(c+1))+")"}).attr("class","facet-val").on("click",function(a,d){var l=c.svg.select(f).select(".facet-reset");e.s!==d?(e.s=d,c.svg.select(f).selectAll(".facet-val").classed("inactive",function(a){return d!==a.n}),l.classed("inactive",!1)):(c.svg.select(f).selectAll(".facet-val").classed("inactive",!1),e.s=-1,l.classed("inactive",!0));c.update()});g.append("rect").attr("class","facet-val-btn").attr("height",21).attr("width",242);g.append("rect").attr("class","facet-val-bar").attr("height",
21).attr("width",function(c){return 0<a.l?242*c.i.length/a.l:0});g.append("text").attr("class","facet-val-txt").attr("x",3).attr("y",16).text(function(a){return a.l});g.append("text").attr("class","facet-val-num").attr("x",239).attr("y",16).text(function(a){return a.i.length})})};VizBrowser.prototype.setSel=function(a){};
VizBrowser.prototype.clearSel=function(){var a=this,c=this.vFrame.getIndex();this.fcts.forEach(function(d){d.s=-1;d="#facet-"+c+"-"+d.i;a.svg.select(d).select(".facet-reset").classed("inactive",!0);a.svg.select(d).selectAll(".facet-val").classed("inactive",!1)});this.update()};VizBrowser.prototype.getSel=function(){return this.recSel};var VizMBMap=function(a,c){PVizModel.call(this,a,c)};VizMBMap.prototype=Object.create(PVizModel.prototype);VizMBMap.prototype.constructor=VizMBMap;
VizMBMap.prototype.flags=function(){return V_FLAG_VSCRL|V_FLAG_HSCRL};
...
VizMBMap.prototype.render=function(a){var c=this;this.sbkSel=this.bkSel=null;this.attSel=0;var d=this.settings.w;this.attsG.selectAll(".bar").remove();this.attsG.selectAll(".mbm-att-title").remove();this.infoG.select(".mbm-select").remove();this.facets=[];this.bars=[];this.settings.fcts.forEach(function(e,f){var l,n=PData.aByID(e),r=30*f;l="g"!==n.def.t?c.settings.gr?PData.cRNew(n,!0,!0):PData.cLNew(n,null,!0):[];PData.cFill(l,e,null,a);var g=[],h=0;l.forEach(function(a){0<a.i.length&&(g.push(a),
h+=a.i.length)});var z=0;g.forEach(function(a){c.bars.push({x0:z*d/h,w0:a.i.length*d/h,x:0,w:0,y:r+18,c:a});z+=a.i.length});c.facets.push({i:f,l:n.def.l,y:r+14,c:g})});this.attsG.selectAll(".mbm-att-title").data(c.facets).enter().append("text").attr("class",function(a,c){return 0===c?"mbm-att-title obj-sel":"mbm-att-title"}).attr("x","0").attr("y",function(a){return a.y}).text(function(a){return a.l}).on("click",function(a,d){c.attSel!=d&&(PState.set(PSTATE_UPDATE),c.attsG.selectAll(".mbm-att-title").classed("obj-sel",
...
!0,!0):PData.cLNew(f,null,!0):[];PData.cFill(g,e,null,a);var h=this.vFrame.getIndex();c.trees=[];c.facets.forEach(function(a,d){var l={z:[],id:h+"."+d};g.forEach(function(c,e){if(0<c.i.length){var f=[],g={i:c.i,l:c.l,s:!1,z:f,id:h+"."+d+"."+e};a.c.forEach(function(a,l){var m=[],m=PData.intersect(c.i,a.i);0<m.length&&f.push({i:m,p:g,c:a.c,l:c.l+" + "+a.l+" ("+m.length+")",id:h+"."+d+"."+e+"."+l})});l.z.push(g)}});c.trees.push(l)});var m=d3.layout.treemap().padding([14,3,3,3]).size([d,this.settings.h]).round(!0).children(function(a,
...
PFilterNum.prototype.evalBoxes=function(a){function c(c,h){function l(){n=!0;a.find(c).addClass("error")}var n=!1,r,u=a.find(c).val();(u=e.exec(u))?(a.find(c).removeClass("error"),r=parseInt(u[1],10)):l();n||(0==h?null!==f&&r<f&&l():null!==g&&r>g&&l());d.uNums[h]=r;return n}var d=this,e=/^(\d+)$/,f="undefined"===typeof this.att.r.min?null:this.att.r.min,g="undefined"===typeof this.att.r.max?null:this.att.r.max,h,m;h=c(".from",0);m=c(".to",1);this.uNums[0]>this.uNums[1]&&(m=!0);a.find(".filter-update").prop("disabled",
...
PFilterDates.prototype.evalBoxes=function(a){function c(c,g){function h(d){n=!0;a.find(c+d).addClass("error")}function l(d){a.find(c+d).removeClass("error")}var n=!1,r={y:0,m:0,d:0,ms:null},u=a.find(c+"-y"),u=u.val();(u=e.exec(u))?(l("-y"),r.y=parseInt(u[1],10)):h("-y");u=a.find(c+"-m");u=u.val();(u=f.exec(u))?(r.m=parseInt(u[1],10),1>r.m||12<r.m?h("-m"):l("-m")):h("-m");u=a.find(c+"-d");u=u.val();(u=f.exec(u))?(r.d=parseInt(u[1],10),1>r.d||31<r.d?h("-d"):l("-d")):h("-d");n||(r.ms=PData.d3Nums(r.y,
...
function PViewFrame(a){function c(a){a!==y&&(y=a,jQuery(d()+" div.lgnd-container div.lgnd-handle button.lgnd-update").prop("disabled",!a))}function d(){return"#view-frame-"+a}function e(a){a=jQuery(d()+" div.view-controls select.view-viz-select option:selected").val();PState.set(PSTATE_BUILD);z(a,!0);PState.set(PSTATE_READY)}function f(a){v.flags()&V_FLAG_LGND&&jQuery(d()+" div.lgnd-container").toggle("slide",{direction:"left"});a.preventDefault()}function g(a){function c(a){return a.replace(/^[ \f\t\v\u200b]+|[ \f\t\v\u200b]+$/g,
"")}function d(a){var c=new Number,e=parseTC.exec(a);if(null!==e)c=1E3*(3600*parseInt(e[1])+60*parseInt(e[2])+parseFloat(e[3])),c=1==e[4].length?c+100*parseInt(e[4]):c+10*parseInt(e[4]);else throw Error("Error in transcript file: Cannot parse "+a+" as timecode.");return c}function e(a,d){var l=new String(a),l=c(l).split(/\r\n|\r|\n/g),f=[];if(l){var n,k=0;_.each(l,function(a){a=c(a);0<a.length&&("["===a.charAt(0)?(0<k&&f.push(n),n=""):(0<n.length&&(n+="<br/>"),n+=a),k++)})}_.each(f,function(a,c){d.find('div.timecode[data-tcindex="'+
c+'"]').next().after('<div class="xscript">'+a+"</div>")})}function l(a){widgetData.tcArray=[];widgetData.tcIndex=-1;var f=widgetData.tcArray;a=new String(a);if(a=c(a).split(/\r\n|\r|\n/g)){var n=jQuery("#xscript-tbl"),k=0,r,g=0,u=0,h="";_.each(a,function(a){a=c(a);1<a.length&&("["===a.charAt(0)&&"0"<=a.charAt(1)&&"9">=a.charAt(1)?(r=d(a),0<h.length&&(u&&f.push({s:g,e:r}),n.append('<div class="row"><div class="timecode" data-timecode="'+g+'" data-tcindex="'+k++ +'">'+u+'</div><div class="xscript">'+
h+"</div></div>"),h=""),u=a,g=r):(0<h.length&&(h+="<br/>"),h+=a))});0<h.length&&(f.push({s:g,e:324E5}),n.append('<div class="row"><div class="timecode" data-timecode="'+g+'" data-tcindex="'+k+'">'+u+'</div><div class="xscript">'+h+"</div></div>"));"undefined"!==typeof A&&null!=A&&jQuery.ajax({type:"POST",url:prspdata.ajax_url,data:{action:"prsp_get_transcript",transcript:A,excerpt:widgetData.extract},success:function(a,c,d){e(JSON.parse(a),n)},error:function(a,c,d){alert(d)}})}}function f(a){var c,
d=widgetData.tcIndex;_.find(widgetData.tcArray,function(e,l){if((c=e.s<=a&&a<e.e)&&l!=d){var f=jQuery("#xscript-tbl");if(document.getElementById("sync-xscript").checked){var n=f.find('[data-tcindex="'+l+'"]').offset().top-f.offset().top,n=f.scrollTop()+n;f.animate({scrollTop:n},300)}-1!=d&&f.find('[data-tcindex="'+d+'"]').removeClass("current");f.find('[data-tcindex="'+l+'"]').addClass("current");widgetData.tcIndex=l}return c})}function n(){widgetData.widget=new YT.Player("yt-widget",{width:"426",
...
widgetData.widget.cueVideoById({videoId:widgetData.ytCode,startSeconds:widgetData.sTime/1E3,endSeconds:widgetData.eTime/1E3})}}})}function k(){function a(){widgetData.sTime=widgetData.eTime=null;var c;(c=prspdata.e.i.t.tcAtts[g])&&(c=y.a[c])&&""!==c&&(widgetData.extract=c,c=c.split("-"),widgetData.sTime=d(c[0]),widgetData.eTime=d(c[1]))}var c=t[q];y=PData.rByN(c);var e=" "+y.l+" ("+(q+1)+"/"+t.length+") ",r=jQuery("#inspect-name");r.text(e);r.prop("title",y.id);var g=PData.n2T(c);w.empty();prspdata.e.i.modal.atts[g].forEach(function(a){var d=
PData.rAV(c,a,!1);if(d){a=PData.aByID(a);var e;"_"==a.def.l.charAt(0)?e="<div>"+d+"</div>":(e='<div><span class="att-label">'+a.def.l+":</span> ","I"==a.def.t&&(e+="<br/>"),e+=d+"</div>");w.append(e)}});z=null;m=0;widgetData.extract=null;widgetData.xscriptOn=!1;widgetData.playing=!1;if(prspdata.e.i.modal.scOn&&(z=prspdata.e.i.sc.atts[g])&&(e=y.a[z])){var h=!0;a();m=1;w.append('<iframe id="sc-widget" class="player" width="95%" height="150" src="http://w.soundcloud.com/player/?url='+e+'"></iframe></p>');
var u=SC.Widget(document.getElementById("sc-widget"));widgetData.widget=u;u.bind(SC.Widget.Events.READY,function(){u.play();u.bind(SC.Widget.Events.PLAY,function(){widgetData.playing=!0});u.bind(SC.Widget.Events.PAUSE,function(){widgetData.playing=!1});u.bind(SC.Widget.Events.PLAY_PROGRESS,function(a){h&&(u.pause(),h=!1,widgetData.playing=!1);widgetData.extract&&(a.currentPosition<widgetData.sTime?u.seekTo(widgetData.sTime):a.currentPosition>widgetData.eTime&&(u.pause(),widgetData.playing=!1));widgetData.playing&&
widgetData.xscriptOn&&f(a.currentPosition)});u.bind(SC.Widget.Events.FINISH,function(){widgetData.playing=!1})})}0===m&&prspdata.e.i.modal.ytOn&&(z=prspdata.e.i.yt.atts[g])&&(e=y.a[z])&&(a(),widgetData.ytCode=e,w.append('<div id="yt-widget"></div>'),widgetData.ytCall=n,widgetData.ytLoaded?n():(widgetData.ytLoaded=!0,e=document.createElement("script"),e.src="https://www.youtube.com/iframe_api",r=document.getElementsByTagName("script")[0],r.parentNode.insertBefore(e,r)),m=2);prspdata.e.i.modal.tOn&&
(e=prspdata.e.i.t.t1Atts[g])&&""!==e&&"disable"!==e&&(e=y.a[e],"string"===typeof e&&""!==e&&(0<m&&w.append("<div>"+document.getElementById("dltext-sync-xscript").innerHTML+"</div>"),w.find("#xscript-tbl").remove(),w.append('<div id="xscript-tbl"><div>'),widgetData.xscriptOn=!0,jQuery("#xscript-tbl").click(function(a){if(m&&jQuery(a.target).hasClass("timecode"))switch(a=jQuery(a.target).data("timecode"),m){case 1:widgetData.playing||(widgetData.playing=!0,widgetData.widget.play());widgetData.widget.seekTo(a);
break;case 2:widgetData.playing||(widgetData.playing=!0,widgetData.widget.playVideo()),widgetData.widget.seekTo(a/1E3)}}),A=null,(r=prspdata.e.i.t.t2Atts[g])&&""!==r&&"disable"!==r&&(A=y.a[r]),jQuery.ajax({type:"POST",url:prspdata.ajax_url,data:{action:"prsp_get_transcript",transcript:e,excerpt:widgetData.extract},success:function(a,c,d){l(JSON.parse(a))},error:function(a,c,d){alert(d)}})))}function r(a){a=q+a;-1==a?a=t.length-1:a==t.length&&(a=0);a!=q&&(q=a,k())}function g(a){r(-1)}function u(a){r(1)}
var w=jQuery("#inspect-content"),z=null,m=0,A,t=null;v&&(t=v.getSel());if(null!=t&&0!=t.length){var x,y,q=0;k();jQuery("#btn-inspect-left").click(g);jQuery("#btn-inspect-right").click(u);var p=450,J=400;prspdata.e.i.modal.scOn&&(p=550);prspdata.e.i.modal.ytOn&&(p=Math.max(p,475),J=500);prspdata.e.i.modal.tOn&&(J+=100,prspdata.e.i.modal.t2On?(p=Math.max(750,Math.floor(.8*jQuery(document).width())),p=Math.min(900,p)):p=Math.max(p,550));h(!1);x=jQuery("#dialog-inspector").dialog({width:p,height:J,modal:!0,
buttons:[{text:dlText.seerec,click:function(){window.open(prspdata.site_url+"?p="+y.wp,"_blank")}},{text:dlText.close,click:function(){x.dialog("close")}}]});x.on("dialogclose",function(a,c){switch(m){case 1:null!=widgetData.widget&&widgetData.playing&&widgetData.widget.pause();widgetData.playing=!1;widgetData.widget=null;break;case 2:widgetData.ytCall=null,null!=widgetData.widget&&widgetData.playing&&widgetData.widget.stopVideo(),widgetData.widget=null,widgetData.playing=!1,null!=widgetData.timer&&
(window.clearInterval(widgetData.timer),widgetData.timer=null)}jQuery("#btn-inspect-left").off("click");jQuery("#btn-inspect-right").off("click");h(!0)});a.preventDefault()}}function h(a){var c=jQuery(d()+" div.view-controls");a?(c.find(".osel").button("enable"),c.find(".osel").addClass("pulse"),c.find(".xsel").button("enable")):(c.find(".osel").button("disable"),c.find(".osel").removeClass("pulse"),c.find(".xsel").button("disable"))}function m(c){jQuery("body").trigger("prospect",{s:PSTATE_HILITE,
v:a,t:v.tUsed,r:v.rMap});c.preventDefault()}function q(a){PState.set(PSTATE_UPDATE);v&&v.clearSel();h(!1);PState.set(PSTATE_READY);a.preventDefault()}function p(a){v&&v.doOptions();a.preventDefault()}function l(a){var c=jQuery("#dialog-vnotes").dialog({width:300,height:300,modal:!0,buttons:[{text:dlText.ok,click:function(){c.dialog("close")}}]});a.preventDefault()}function n(a,e){jQuery(d()+' div.lgnd-container div.lgnd-scroll div.lgnd-template[data-index="'+a+'"] div.lgnd-group input.lgnd-entry-check').prop("checked",
e);c(!0)}function r(a){var e=jQuery(a.target).closest("div.lgnd-template").data("index"),l=a.target.className;switch(l){case "lgnd-update":v&&x&&(PState.set(PSTATE_BUILD),h(!1),v.render(x),c(!1),PState.set(PSTATE_READY));break;case "lgnd-entry-check":l=jQuery(a.target).closest("div.lgnd-entry");a=jQuery(a.target).is(":checked");l.hasClass("lgnd-sh")?n(e,a):l.hasClass("lgnd-locate")?(l.data("id"),c(!0)):l.hasClass("lgnd-value")&&(l.data("index"),c(!0));break;case "lgnd-viz":case "lgnd-value-title":l=
jQuery(a.target).closest("div.lgnd-entry");l.hasClass("lgnd-locate")?(a=l.data("id"),jQuery(d()+' div.lgnd-container div.lgnd-scroll div.lgnd-template[data-index="'+e+'"] div.lgnd-locate input.lgnd-entry-check').prop("checked",!1),jQuery(d()+' div.lgnd-container div.lgnd-scroll div.lgnd-template[data-index="'+e+'"] div.lgnd-locate[data-id="'+a+'"] input.lgnd-entry-check').prop("checked",!0),c(!0)):l.hasClass("lgnd-value")&&(a=l.data("index"),jQuery(d()+' div.lgnd-container div.lgnd-scroll div.lgnd-template[data-index="'+
e+'"] div.lgnd-group input.lgnd-entry-check').prop("checked",!1),jQuery(d()+' div.lgnd-container div.lgnd-scroll div.lgnd-template[data-index="'+e+'"] div.lgnd-group div.lgnd-value[data-index="'+a+'"] input.lgnd-entry-check').prop("checked",!0),c(!0));break;case "lgnd-template":case "lgnd-select":case "":break;default:l.match(/lgnd-sh/i)&&(l=jQuery(a.target).find("input.lgnd-entry-check"),a=!l.is(":checked"),l.prop("checked",a),n(e,a))}}function u(a){var d=jQuery(a.target).closest("div.lgnd-template").data("index");
a=jQuery(a.target).val();w(d,a);c(!0)}function w(a,c){var e,l=jQuery(d()+' div.lgnd-container div.lgnd-scroll div.lgnd-template[data-index="'+a+'"] div.lgnd-group');l.empty();t[a]=c;var f=PData.aByID(c);"undefined"!==typeof f.r.u&&(e='<div class="lgnd-value lgnd-entry" data-index="-1"><input type="checkbox" checked="checked" class="lgnd-entry-check"/><div class="lgnd-viz" style="background-color: '+f.r.u.v+'"> </div> <span class="lgnd-value-title">'+dlText.undef+"</span></div>",l.append(e));f.l.forEach(function(a,
c){e='<div class="lgnd-value lgnd-entry" data-index="'+c+'"><input type="checkbox" checked="checked" class="lgnd-entry-check"/><div class="lgnd-viz" style="background-color: '+a.v+'"> </div> <span class="lgnd-value-title">'+a.l+"</span></div>";l.append(e);a.z&&0<a.z.length&&a.z.forEach(function(a,d){e='<div class="lgnd-value lgnd-entry" data-index="'+c+","+d+'"><input type="checkbox" checked="checked" class="lgnd-entry-check"/>';e=a.v&&""!==a.v?e+('<div class="lgnd-viz" style="background-color: '+
a.v+'"></div>'):e+'<div class="lgnd-viz lgnd-viz-empty"></div>';e+=' <span class="lgnd-value-title">&raquo; '+a.l+"</span></div>";l.append(e)})});jQuery(d()+' div.lgnd-container div.lgnd-scroll div.lgnd-template[data-index="'+a+'"] div.lgnd-sh input').prop("checked",!0)}function z(e,l){var f=PData.vByN(e);v&&(v.teardown(),v=null);var n=jQuery(d());n.find("div.viz-content div.viz-result").empty();var r;switch(f.vf){case "M":r=new VizMap(k,f.c);break;case "C":r=new VizCards(k,f.c);break;case "P":r=
new VizPinboard(k,f.c);break;case "T":r=new VizTime(k,f.c);break;case "D":r=new VizDirectory(k,f.c);break;case "t":r=new VizTextStream(k,f.c);break;case "S":r=new VizStackChart(k,f.c);break;case "N":r=new VizNetWheel(k,f.c);break;case "F":r=new VizFlow(k,f.c);break;case "B":r=new VizBrowser(k,f.c);break;case "m":r=new VizMBMap(k,f.c)}A=e;var g=r.flags();g&V_FLAG_HSCRL?(n.find("div.viz-content").addClass("h-scroll"),n.find("div.viz-result").addClass("viz-fit-w"),n.find("div.viz-result").removeClass("viz-max-w")):
(n.find("div.viz-content").removeClass("h-scroll"),n.find("div.viz-result").removeClass("viz-fit-w"),n.find("div.viz-result").addClass("viz-max-w"));g&V_FLAG_VSCRL?(n.find("div.viz-content").addClass("v-scroll"),n.find("div.viz-result").addClass("viz-fit-h"),n.find("div.viz-result").removeClass("viz-max-h")):(n.find("div.viz-content").removeClass("v-scroll"),n.find("div.viz-result").removeClass("viz-fit-h"),n.find("div.viz-result").addClass("viz-max-h"));t=[];if(g&V_FLAG_LGND){n.find(".hslgnd").button("enable");
var z=n.find("div.lgnd-container div.lgnd-scroll");z.empty();if(g&V_FLAG_SLGND){var m=r.getFeatureAtts(),K=PData.aByID(m);z.append('<div class="lgnd-template" data-index="0"><div class="lgnd-title">'+K.def.l+'</div><div class="lgnd-entry lgnd-sh"><input type="checkbox" checked="checked" class="lgnd-entry-check"/><i>'+dlText.sha+'</i></div><div class="lgnd-group"></div></div>');t.push(m);w(0,m)}else{var y=!1;prspdata.e.g.ts.forEach(function(a,c){var d=PData.tByID(a),e=r.getLocAtts(c);if(e&&0<e.length||
!(g&V_FLAG_LOC)){var l=r.getFeatureAtts(c);if(0<l.length){y&&z.append("<hr/>");var f=jQuery('<div class="lgnd-template" data-index="'+c+'"><div class="lgnd-title">'+d.l+"</div></div>");e&&e.forEach(function(a,c){var d=PData.aByID(a);f.append('<div class="lgnd-entry lgnd-locate" data-id="'+a+'"><input type="checkbox" checked="checked" class="lgnd-entry-check"/><span class="lgnd-value-title">'+d.def.l+"</span></div>")});var n='<select class="lgnd-select">';l.forEach(function(a,c){var d=PData.aByID(a);
n+='<option value="'+a+'">'+d.def.l+"</option>"});n+="</select>";d=jQuery(n);d.change(u);jQuery(f).append(d);jQuery(f).append('<div class="lgnd-entry lgnd-sh"><input type="checkbox" checked="checked" class="lgnd-entry-check"/><i>'+dlText.sha+'</i></div><div class="lgnd-group"></div>');z.append(f);l=l[0];t.push(l);w(c,l);y=!0}}})}n.find("div.lgnd-container").show()}else n.find("button.hslgnd").button("disable"),n.find("div.lgnd-container").hide();c(!1);g&V_FLAG_SEL?(n.find(".hilite").button("enable"),
jQuery("#save-prspctv-h"+a).prop("disabled",!1).prop("checked",!1)):(n.find(".hilite").button("disable"),jQuery("#save-prspctv-h"+a).prop("disabled",!0).prop("checked",!1));g&V_FLAG_OPT?n.find(".vopts").button("enable"):n.find(".vopts").button("disable");(m=r.hint())||"string"===typeof f.n&&""!==f.n?(n.find(".vnote").button("enable"),m=m?"string"===typeof f.n&&""!==f.n?m+(".<br/>"+f.n):m+".":f.n,jQuery("#vnotes-txt").empty().append(m)):n.find(".vnote").button("disable");r.setup();h(!1);x&&l&&r.render(x);
v=r}var k={},A=0,v=null,t=[],y=null,x=null;k.getFrameID=d;k.getIndex=function(){return a};k.setViz=function(a,c){a!=A&&(jQuery(d()+" div.view-controls select.view-viz-select").val(a),z(a,c))};k.initDOM=function(c){var n=document.getElementById("dltext-view-controls").innerHTML;jQuery("#viz-frame").append('<div id="view-frame-'+a+'">'+n+"</div>");var n=jQuery(d()),k=prspdata.bClrs.vf;k&&0<k.length&&n.find("div.view-controls").css("background-color",k);n.find("div.lgnd-container").draggable({handle:n.find("div.lgnd-handle"),
containment:"parent"});var u=n.find("div.view-controls select.view-viz-select");prspdata.e.vf.forEach(function(a,c){u.append('<option value="'+c+'">'+a.l+"</option>")});u.val(c);u.change(e);n.find("div.view-controls button:first").button({icons:{primary:"ui-icon-bookmark"},text:!1}).click(f).next().button({icons:{primary:"ui-icon-wrench"},text:!1}).click(p).next().button({icons:{primary:"ui-icon-info"},text:!1}).click(l).next().button({icons:{primary:"ui-icon-star"},text:!1}).click(m).next().button({icons:{primary:"ui-icon-cancel"},
text:!1}).click(q).next().button({icons:{primary:"ui-icon-search"},text:!1}).click(g).next();n.find("div.lgnd-container").click(r);z(c,!1)};k.getSelLocAtts=function(a){var c=[];jQuery(d()+' div.lgnd-container div.lgnd-scroll div.lgnd-template[data-index="'+a+'"] div.lgnd-locate input:checked').each(function(){var a=jQuery(this).parent().data("id");c.push(a)});return c};k.getSelFeatAtts=function(a){var c=[],e,l;jQuery(d()+' div.lgnd-container div.lgnd-scroll div.lgnd-template[data-index="'+a+'"] div.lgnd-group div.lgnd-value input:checked').each(function(){e=
jQuery(this).parent().data("index");"number"==typeof e?c.push(e):-1!=(l=e.indexOf(","))?c.push([parseInt(e.substring(0,l),10),parseInt(e.substring(l+1),10)]):c.push(parseInt(e,10))});return c};k.getSelLegend=function(a){return t[a]};k.getLgndSels=function(){return t.slice(0)};k.setLgndSels=function(a){a.forEach(function(a,c){jQuery(d()+' div.lgnd-container div.lgnd-scroll div.lgnd-template[data-index="'+c+'"] select.lgnd-select').val(a);w(c,a)})};k.getState=function(){return v?v.getState():null};
k.setState=function(a){v&&v.setState(a)};k.showStream=function(a){x=a;v&&v.render(a);c(!1)};k.setStream=function(a){x=a};k.selBtns=function(a){h(a)};k.clearSel=function(){v&&v.clearSel();h(!1)};k.setSel=function(a){return v&&v.flags()&V_FLAG_SEL?(v.setSel(a),h(0<a.length),!0):!1};k.resize=function(){v&&v.resize()};k.title=function(){return PData.vByN(A).l};k.flushLgnd=function(){jQuery(d()).find("div.lgnd-container").css("left","10px")};return k}
...
c.length){var h="";c.forEach(function(a){(a=PData.rByID(a))&&(h+='<a href="'+prspdata.site_url+"?p="+a.wp+'" target="_blank">'+a.l+"</a> ")});return h}}return null},rAV:function(a,c,d){for(var e=0;e<m.length;e++){var f=m[e];if(0<f.n&&f.i<=a&&a<f.i+f.n){a=f.d[a-f.i].a[c];if(null==a||"undefined"===typeof a)break;return d?a:PData.procAttTxt(c,a)}}return null},nByID:function(a){for(var c=0;c<m.length;c++){var d=m[c];if(0<d.n)for(var e=0,f=d.n-1,g,k;e<=f;)if(g=e+f>>1,k=d.d[g],k=PData.strcmp(a,k.id),0>
k)e=g+1;else if(0<k)f=g-1;else return d.i+g}return null},rByID:function(a){for(var c=0;c<m.length;c++){var d=m[c];if(0<d.n)for(var e=0,f=d.n-1,g,k,h;e<=f;)if(g=e+f>>1,h=d.d[g],k=PData.strcmp(a,h.id),0>k)e=g+1;else if(0<k)f=g-1;else return h}return null},aByID:function(a){for(var c=0,d=prspdata.a.length-1,e,f;c<=d;)if(e=c+d>>1,f=PData.strcmp(a,prspdata.a[e].id),0>f)c=e+1;else if(0<f)d=e-1;else return prspdata.a[e];return null},aByN:function(a){return prspdata.a[a]},eTNum:function(){return prspdata.e.g.ts.length},
eTByN:function(a){return prspdata.e.g.ts[a]},tByID:function(a){for(var c=0;c<prspdata.t.length;c++)if(a==prspdata.t[c].id)return prspdata.t[c].def},lRecs:function(a,c,d,e){var f,g=d.length,k;switch(c.def.t){case "V":var h=function(a){for(var e=0;e<g;e++)if(f=d[e],"number"===typeof f){if(k=c.l[f],k.l===a)return k}else{k=c.l[f[0]];var l=k.z[f[1]];if(l.l===a)return l.v&&""!==l.v?l:k}return null};if(e&&""!==c.def.d){var m=[],t;a.forEach(function(a){t=h(a);null!=t&&m.push(t)});return 0<m.length?m:null}if(""!=
c.def.d){for(e=0;e<a.length;e++)if(t=h(a[e]),null!=t)return t;break}else return h(a[0]);case "T":for(t=0;t<g;t++)if(f=d[t],k=c.l[f],-1!=a.indexOf(k.d))return k;break;case "N":t=0;if(-1===d[0]){if("?"===a){if("undefined"===typeof c.r.u)break;return c.r.u}t=1}if("?"===a)break;for(;t<g;t++)if(f=d[t],k=c.l[f],"undefined"!==typeof k.d.min){if(k.d.min<=a)if("undefined"!==typeof k.d.max){if(a<=k.d.max)return k}else return k}else if(a<=k.d.max)return k;break;case "D":t=0;if(-1===d[0]){if("?"===a){if("undefined"===
typeof c.r.u)break;return c.r.u}t=1}if("?"!==a)for(;t<g;t++)if(f=d[t],k=c.l[f],"undefined"!==typeof k.d.max.y){if("undefined"!==typeof a.max&&"open"!==a.max){if(a.max.y<k.d.min.y)continue;if(a.max.y===k.d.min.y&&a.max.m&&k.d.min.m){if(a.max.m<k.d.min.m)continue;if(a.max.m==k.d.min.m&&a.max.d&&k.d.min.d&&a.max.d<k.d.min.d)continue}}if(!(a.min.y>k.d.max.y)){if(a.min.y===k.d.max.y&&a.min.m&&k.d.max.m){if(a.min.m>k.d.max.m)continue;if(a.min.m===k.d.max.m&&a.min.d&&k.d.max.d&&a.min.d>k.d.max.d)continue}return k}}else if("undefined"!==
typeof a.max){if("open"===a.max)return k;if(!(a.max.y<k.d.min.y)){if(a.max.y===k.d.min.y&&a.max.m&&k.d.min.m){if(a.max.m<k.d.min.m)continue;if(a.max.m===k.d.min.m&&a.max.d&&k.d.min.d&&a.max.d<k.d.min.d)continue}return k}}else if(!(a.min.y<k.d.min.y)){if(a.min.y===k.d.min.y&&a.min.m&&k.d.min.m){if(a.min.m<k.d.min.m)continue;if(a.min.m===k.d.min.m&&a.min.d&&k.d.min.d&&a.min.d<k.d.min.d)continue}return k}}return null},lClr:function(a,c,d){var e;return(e=PData.lRecs(a,c,d,!1))?e.v:null},lenMnth:function(a,
...
c:f,i:[]}):e.push({l:d.l,c:f})})}),e;case "N":if("undefined"===typeof a.r.min||"undefined"===typeof a.r.max)return null;d&&"undefined"!==typeof a.r.u&&(c?e.push({l:"?",c:a.r.u.v,min:"?",max:"?",i:[]}):e.push({l:"?",c:a.r.u.v,min:"?",max:"?"}));var f=Math.pow(10,a.r.g),g=a.r.min,k=0,h,m,t;for(0<a.l.length&&(h=a.l[0]);g<=a.r.max;){for(;k<a.l.length&&"undefined"!==typeof h.d.max&&g>h.d.max;)h=a.l[++k];t=0==a.l.length||g<h.d.min?"#777777":k===a.l.length?"#777777":"undefined"===typeof h.d.max||g<=h.d.max?
h.v:"#777777";m=g;g+=f;max=g-1;max>a.r.max&&(max=a.r.max);var y=m.toString();1<f&&4>y.length&&m!==max&&(y+="-"+max.toString());c?e.push({l:y,c:t,min:m,max:max,i:[]}):e.push({l:y,c:t,min:m,max:max})}return e;case "D":g=function(a){var c,d;if("undefined"===typeof a.y)return TODAY;c=a.y;"undefined"===typeof a.m?(d=12,a=31):(d=a.m,a="undefined"===typeof a.d?PData.lenMnth(c,d):a.d);return PData.d3Nums(c,d,a,!1)};m=function(a,c,d,e){"undefined"!==typeof e.m&&(c=e.m,"undefined"!==typeof e.d&&(d=e.d));return PData.d3Nums(a,
c,d,!1)};t=g(a.r.max);var f=a.r.g,y=a.r.min.y,x=1,q=1;"undefined"!==typeof a.r.min.m&&(x=a.r.min.m,"undefined"!==typeof a.r.min.d&&(q=a.r.min.d));var p=PData.d3Nums(y,x,q,!1),k=0,C,E;0<a.l.length&&(h=a.l[0],C=m(h.d.min.y,1,1,h.d.min),E=g(h.d.max));for(d&&"undefined"!==typeof a.r.u&&(c?e.push({l:"?",c:a.r.u.v,min:"?",max:"?",i:[]}):e.push({l:"?",c:a.r.u.v,min:"?",max:"?"}));p<=t;){d={};c&&(d.i=[]);switch(f){case "d":d.l=y.toString()+"-"+x.toString()+"-"+q.toString();break;case "m":d.l=y.toString()+
"-"+x.toString();break;case "y":case "t":case "c":d.l=y.toString()}for(;k<a.l.length&&p>E;)h=a.l[++k],k<a.l.length&&(C=m(h.d.min.y,1,1,h.d.min),E=g(h.d.max));d.c=0==a.l.length||p<C?"#777777":k==a.l.length?"#777777":p<=E?h.v:"#777777";d.min=p;switch(f){case "d":++q>PData.lenMnth(y,x)&&(q=1,12<++x&&(x=1,y++));break;case "m":12<++x&&(x=1,y++);break;case "y":y++;break;case "t":y+=10;break;case "c":y+=100}p=PData.d3Nums(y,x,q,!1);p>TODAY&&(p=TODAY);p.setTime(p.getTime()+10);d.max=p;e.push(d);p=PData.d3Nums(y,
x,q,!1)}return e}},cFill:function(a,c,d,e){var f=PData.eTNum(),g=0,k,h=0,m,t,p,q,B=PData.aByID(c);for(k=e.t[0];h<e.l;){for(;0==k.n||k.i+k.n==h||!PData.aInT(c,g)||d&&!PData.aInT(d,g);){if(++g==f)return;k=e.t[g];h=k.i}m=e.s[h];t=PData.rByN(m);t=t.a[c];if("undefined"!==typeof t)switch(B.def.t){case "T":for(p=0;p<a.length;p++)if(q=a[p],-1!==t.indexOf(q.x)){q.i.push(m);break}break;case "g":t.forEach(function(c){for(p=0;p<a.length;p++)if(q=a[p],c===q.l){q.i.push(m);break}p===a.length&&a.push({l:c,i:[m],
c:"#"+Math.floor(16777215*Math.random()).toString(16)})});break;case "V":t.forEach(function(c){for(p=0;p<a.length;p++)if(q=a[p],c==q.l){q.i.push(m);break}});break;case "N":p=0;q=a[0];if("?"===q.min){if("?"===t){q.i.push(m);break}p=1}if("?"===t)break;for(;p<a.length;p++){q=a[p];if(t<q.min)break;if(q.min<=t&&t<=q.max){q.i.push(m);break}}break;case "D":p=0;q=a[0];if("?"===q.min){if("?"===t){q.i.push(m);break}p=1}if("?"!==t)for(t=PData.dObj(t.min,1,!1);p<a.length;p++){q=a[p];if(t<q.min)break;if(q.min<=
t&&t<q.max){q.i.push(m);break}}}h++}"g"==B.def.t&&a.sort(function(a,c){return PData.strcmp(c.l,a.l)})},cSort:function(a,c,d){var e=c.id,f,g,k;a.forEach(function(a){f=PData.rByN(a);datum=f.a[e];if("undefined"!==typeof datum)switch(c.def.t){case "T":for(g=0;g<d.length;g++)if(k=d[g],-1!==datum.indexOf(k.x)){k.i.push(a);break}break;case "g":datum.forEach(function(c){for(g=0;g<d.length;g++)if(k=d[g],c===k.l){k.i.push(a);break}g===d.length&&d.push({l:c,i:[a],c:"#777777"})});break;case "V":datum.forEach(function(c){for(g=
0;g<d.length;g++)if(k=d[g],c===k.l){k.i.push(a);break}});break;case "N":g=0;k=d[0];if("?"===k.min){if("?"===datum){k.i.push(a);break}g=1}if("?"===datum)break;for(;g<d.length;g++){k=d[g];if(datum<k.min)break;if(k.min<=datum&&datum<=k.max){k.i.push(a);break}}break;case "D":g=0;k=d[0];if("?"===k.min){if("?"===datum){k.i.push(a);break}g=1}if("?"!==datum){var h=PData.dObj(datum.min,1,!1);for(g=0;g<d.length;g++){k=d[g];if(h<k.min)break;if(k.min<=h&&h<k.max){k.i.push(a);break}}}}});"g"==c.def.t&&d.sort(function(a,
c){return PData.strcmp(c.l,a.l)})},rTOrder:function(a,c,d){function e(a){return a}function f(a){return a[0]}function g(a){if("?"===a)return"?";var c=1,d=1;"undefined"!==typeof a.min.m&&(c=a.min.m,"undefined"!==typeof a.min.d&&(d=a.min.d));return PData.d3Nums(a.min.y,c,d,!1)}var k,h;switch(a.def.t){case "T":k=e;h="~";break;case "V":k=f;h="~";break;case "g":k=f;h="~";break;case "N":k=e;h=a.r.max;break;case "D":k=g,h=TODAY}var p=[],q=c.t[d];d=m[d];for(var y=0,x,B;y<q.n;)x=c.s[q.i+y++],B=d.d[x-d.i],B=
B.a[a.id],"undefined"===typeof B?p.push({i:x,v:h}):p.push({i:x,v:k(B)});switch(a.def.t){case "T":case "g":case "V":p.sort(function(a,c){return PData.strcmp(c.v,a.v)});break;case "D":case "N":p.sort(function(a,c){return"?"===a.v?-1:"?"===c.v?1:a.v-c.v})}return p},vByN:function(a){return prspdata.e.vf[a]},ready:function(){return p}}}();
jQuery(document).ready(function(a){function c(){var a;PState.set(PSTATE_PROCESS);null==x&&(x=PData.sNew(!0));B=x;var c=!1,d,e;for(d=0;d<v.length;d++)if(e=v[d],a=jQuery('div.filter-instance[data-id="'+e.id+'"]'),c||e.f.isDirty(null)){c=!0;e=e.f;e.evalPrep();for(var f=PData.sNew(!1),g=0,h,l,m=0,n=B.t[0],p=0,q=0,r=a.find(".apply-tmplt-0").is(":checked");g<B.l;){for(;0==n.n||n.i+n.n==g;)f.t.push({i:f.l-p,n:p}),p=0,n=B.t[++m],r=a.find(".apply-tmplt-"+m).is(":checked");h=B.s[g++];r?(l=PData.rByN(h),e.eval(l)&&
(f.s[f.l++]=h,p++),q++):(f.s[f.l++]=h,p++)}for(;m++<PData.eTNum();)f.t.push({i:f.l-p,n:p}),p=0;e.isDirty(!1);e.out=f;e.evalDone(q);B=f}else B=e.f.out;PState.set(PSTATE_BUILD);k.forEach(function(a){a&&a.showStream(B)});0<v.length?jQuery("#btn-f-state").prop("disabled",!0).html(dlText.filtered):jQuery("#btn-f-state").prop("disabled",!0).html(dlText.nofilter)}function d(a){var c=jQuery("#annote");c.text(a);0<a.length?(jQuery("#btn-annote").button("enable"),c.show()):(jQuery("#btn-annote").button("disable"),
c.hide())}function e(a){var c=_.find(prspdata.p,function(c){return a==c.id});return c?c:null==D||0==C.length?null:(c=_.find(C,function(c){return a==c.id}))?c:null}function f(a,c){var d=jQuery("input[name=save-prspctv-dest]:checked").val();if(""==d)return null;var e=jQuery("#save-prspctv-note").val(),e=e.replace(/"/,""),f={f:[],h0:null,h1:null,v0:null,v1:null};k.forEach(function(a,c){a&&(f["v"+c]={l:a.title(),s:a.getState()})});v.forEach(function(a){for(var c=[],d=jQuery('div.filter-instance[data-id="'+
a.id+'"]'),e=0;e<PData.eTNum();e++)c.push(d.find(".apply-tmplt-"+e).is(":checked"));f.f.push({id:a.attID,a:c,s:a.f.getState()})});for(var g=0;2>g;g++){var h=t[g];null!==h&&jQuery("#save-prspctv-h"+g).is(":checked")&&(f["h"+g]={id:y[g],s:h.getState()})}var l={id:a,l:c,n:e,s:f};"local"==d?(C.push(l),D.setItem(prspdata.e.id,JSON.stringify(C))):"server"==d&&jQuery.ajax({type:"POST",url:prspdata.ajax_url,data:{action:"prsp_save_prspctv",id:a,l:c,x:prspdata.e.id,n:e,s:JSON.stringify(f)},success:function(a,
...
1);if(f>=v.length){var h;h=0===v.length?x:v[f-1].out;k.forEach(function(a){a&&a.setStream(h)})}else v[f].f.isDirty(!0);d.remove();0===v.length?(jQuery("#btn-toggle-filters").button("disable"),k.forEach(function(a){a&&a.clearSel(h)}),c(),PState.set(PSTATE_READY)):jQuery("#btn-f-state").prop("disabled",!1).html(dlText.dofilters);a.preventDefault()}}function l(a,c,d){var e,f,g;if(null!==d)e=d;else{do e=Math.floor(1E3*Math.random()+2),-1!=v.findIndex(function(a){return a.id==e})&&(e=-1);while(-1==e)}if("_remove"==
...
function r(a,c,d){PState.set(PSTATE_PROCESS);var e=[],f=t[a];if(null!==B){f.evalPrep();var g=0,h,l,m=0,n=B.t[0];a:for(;g<B.l;){for(;!c[m]||0==n.n||n.i+n.n==g;){if(++m===PData.eTNum())break a;n=B.t[m];g=n.i}h=B.s[g++];d[h>>4]&1<<(h&15)&&(l=PData.rByN(h),f.eval(l)&&e.push(h))}f.evalDone(B.l)}PState.set(PSTATE_UPDATE);0<e.length?k[a].setSel(e):k[a].clearSel();PState.set(PSTATE_READY)}function u(a,c,d){var e;e=jQuery("#dialog-hilite-"+a).dialog({height:275,width:Math.min(jQuery(window).width()-20,675),
modal:!0,appendTo:"#dialog-1",buttons:[{text:dlText.chsatt,click:function(){n(!1,!0,c,function(c){y[a]=c;t[a]=l(c,null,a)})}},{text:dlText.ok,click:function(){e.dialog("close");null!==t[a]&&r(a,c,d)}},{text:dlText.cancel,click:function(){e.dialog("close")}}]})}function w(a){function f(a){return prspdata.e.vf.findIndex(function(c){return a==c.l})}a=e(a);if(null==a)return!1;PState.set(PSTATE_PROCESS);jQuery("#filter-frame").hide();v.forEach(function(a){a.f.teardown()});v=[];jQuery("#filter-instances").empty();
a.s.f.forEach(function(a){l(a.id,a.a,null).setState(a.s)});jQuery("#filter-instances").hide();jQuery("#btn-toggle-filters").button(0==a.s.f.length?"disable":"enable");for(var g=0;2>g;g++)if(null!=a.s["h"+g]){var h=a.s["h"+g];y[g]=h.id;var m=l(h.id,null,g);t[g]=m;m.setState(h.s)}else t[g]=null,y[g]=null;var h=k[0],m=k[1],n=!1;PState.set(PSTATE_BUILD);g=f(a.s.v0.l);h?(h.setViz(g,!1),h.selBtns(!1)):(k[0]=PViewFrame(0),h=k[0],h.initDOM(g));null!==a.s.v1?(g=f(a.s.v1.l),m?(m.selBtns(!1),m.setViz(g,!1),
m.setState(a.s.v1.s)):(h.flushLgnd(),k[1]=PViewFrame(1),m=k[1],m.initDOM(g),m.setState(a.s.v1.s),n=!0)):m&&(k[1]=null,jQuery("#view-frame-1").remove(),n=!0);n&&h.resize();h.setState(a.s.v0.s);d(a.n);if(PData.ready()&&x)for(c(),g=0;2>g;g++)null!==y[g]&&r(g);return!0}function z(a,c){var d=prspdata.bClrs[a];d&&0<d.length&&jQuery(c).css("background-color",d)}var k=[null,null],A,v=[],t=[null,null],y=[null,null],x,B,D=null,C=[];jQuery("body").addClass("waiting");z("cb","#command-bar");z("fs","#filter-frame");
...
a.preventDefault()});jQuery("#btn-set-layout").button({icons:{primary:"ui-icon-newwin"},text:!1}).click(function(){null!==k[1]?(k[1]=null,jQuery("#view-frame-1").remove()):(k[0].flushLgnd(),PState.set(PSTATE_BUILD),k[1]=PViewFrame(1),k[1].initDOM(0),k[1].showStream(B),PState.set(PSTATE_READY));k[0].resize()});jQuery("#btn-hs-bars").button({icons:{primary:"ui-icon-carat-2-n-s"},text:!1}).click(function(a){jQuery("#filter-frame").slideToggle(400);a.preventDefault()});jQuery("#btn-show-prspctv").button({icons:{primary:"ui-icon-image"},
text:!1}).click(function(a){var c=jQuery("#prspctv-slist");c.empty();prspdata.p.forEach(function(a){c.append('<li data-src="server" data-id="'+a.id+'">'+a.l+"</li>")});C.forEach(function(a){c.append('<li data-src="local" data-id="'+a.id+'">'+a.l+"</li>")});var d=[{text:dlText.ok,click:function(){e.dialog("close");var a=c.find("li.selected");a.length&&(a=a.data("id"),w(a),PState.set(PSTATE_READY))}},{text:dlText.cancel,click:function(){e.dialog("close")}}];D&&d.push({text:dlText.manage,click:function(){e.dialog("close");
...
!1);jQuery("#save-prspctv-h1").prop("checked",!1);for(var g=0;2>g;g++){var h=null===t[g]||null===k[g];jQuery("#save-prspctv-h"+g).prop("disabled",h)}c=jQuery("#dialog-save-prsrctv").dialog({width:350,height:370,modal:!0,buttons:[{text:dlText.ok,click:function(){var a=jQuery("#save-prspctv-id").val().trim(),g=a.match(d),h=jQuery("#save-prspctv-lbl").val().trim(),h=h.replace(/"/,"");if(0===a.length||20<a.length||g)g="#dialog-prspctv-id-badchars";else if(e(a))g="#dialog-prspctv-id-used";else if(0===
