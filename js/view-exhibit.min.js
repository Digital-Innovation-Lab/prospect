...
var f=this.lineLayer;f.clearLayers();var g=PData.eTNum(),h=0,l,n=0,q,k,r,p,v,C,x,m,A,w,z,u,t,y,B,D,E;y=this.settings.min;"string"===typeof y&&(y=parseInt(y));n=this.settings.max;"string"===typeof n&&(n=parseInt(n));B=n-y;for(h=0;h<g;h++)this.tLCnt[h]=0;for(var F,h=0;h<g;h++)if("disable"!==this.settings.pAtts[h]){F=[];break}h=0;n=-1;a:for(;h<a.l;){if(null==C){do{if(++n==g)break a;q=a.t[n]}while(0===q.n||q.i+q.n===h);C=this.vFrame.getSelLocAtts(n);if(0===C.length){C=null;continue}x=d.vFrame.getSelFeatAtts(n);
if(0===x.length){C=null;continue}d.tLCnt[n]=C.length;d.tUsed[n]=!0;p=d.vFrame.getSelLegend(n);v=PData.aByID(p);m=d.settings.pAtts[n];k=d.settings.lClrs[n];if(u=d.settings.sAtts[n])t=PData.aByID(u),"number"===typeof t.r.min&&"number"===typeof t.r.max?(D=t.r.min,E=t.r.max-D):u=null}l=a.s[h];r=PData.rByN(l);var G;F&&(G={id:r.id,c:[],p:r.a[m],l:k});C.forEach(function(a){if(A=r.a[a])if(w=r.a[p],"undefined"!==typeof w&&(w=PData.lClr(w,v,x))){d.rMap[l>>4]|=1<<(l&15);if("number"===typeof A[0])u?(t=r.a[u],
t="number"===typeof t?Math.floor((t-D)*B/E)+y:y):t=y,z=L.circleMarker(A,{_aid:l,weight:1,radius:t,fillColor:w,color:"#000",opacity:1,fillOpacity:1}),G&&G.c.push(A);else if(z=2===A.length?L.polyline(A,{_aid:l,weight:1,fillColor:w,color:"#000",opacity:1,fillOpacity:1}):L.polygon(A,{_aid:l,weight:1,fillColor:w,color:"#000",opacity:1,fillOpacity:1}),G){var k=[0,0];A.forEach(function(a){k[0]+=a[0];k[1]+=a[1]});k[0]/=A.length;k[1]/=A.length;G.c.push(k)}z.on("click",c);e.addLayer(z)}});G&&0<G.c.length&&
F.push(G);++h==q.i+q.n&&(C=null)}if(F){F.sort(function(a,c){return PData.strcmp(c.id,a.id)});var I=[];F.forEach(function(a){a.p&&a.p.forEach(function(c){h=_.sortedIndex(F,{id:c},"id");if(h<F.length){var k=F[h];k.id===c&&a.c.forEach(function(c){k.c.forEach(function(k){c[0]===k[0]&&c[1]===k[1]||I.push({p:[c,k],c:a.l})})})}})});I.forEach(function(a){f.addLayer(L.polyline(a.p,{color:a.c,weight:2}))})}};VizMap.prototype.teardown=function(){var a=this.vFrame.getIndex();jQuery("#view-frame-"+a+" div.view-controls div.iconbar").remove()};
...
VizCards.prototype.render=function(a){var c=this;this.stream=a;var d=PData.eTNum(),e,f,g,h,l,n,q,k,r,p,v,C,x,m,A=jQuery(this.frameID);A.empty();0<this.recSel.length&&(this.recSel=[]);this.preRender();var w,z="w"+this.settings.w+" h"+this.settings.h;f=a.t[0];for(e=0;e<d;){for(;0===f.n;){if(++e===d)return;f=a.t[e]}f=PData.eTByN(e);f=PData.tByID(f);n=c.vFrame.getSelFeatAtts(e);0!==n.length&&(A.append('<div class="template-label">'+f.l+'</div><div class="cards" data-ti="'+e+'"></div>'),w=jQuery('div.cards[data-ti="'+
e+'"]'),this.tUsed[e]=!0,g=c.vFrame.getSelLegend(e),h=PData.aByID(g),l=c.settings.iAtts[e],p=c.settings.cnt[e],f=c.sAtts[e],f=PData.aByID(f),f=PData.rTOrder(f,a,e),f.forEach(function(a){q=PData.rByN(a.i);v=q.a[g];"undefined"!==typeof v&&(k=PData.lRecs(v,h,n,!1))&&(c.rMap[a.i>>4]|=1<<(a.i&15),x=c.settings.lOn?'<div class="card-title">'+q.l+"</div>":"",r=!1,C="",p&&0<p.length&&(m=k.b?' style="color:black"':"",p.forEach(function(a){if(v=q.a[a])if(v=PData.procAttTxt(a,v))r=!0,C+=v+"<br/>"})),C=l&&(v=
q.a[l])?r?'<div class="card-body"><img src="'+v+'"/><div class="card-cnt"'+m+">"+C+"</div></div>":'<div class="card-body"><img class="full" src="'+v+'"/></div>':'<div class="card-body"><div class="card-cnt"'+m+">"+C+"</div>",w.append('<div class="card '+z+'" style="background-color:'+k.v+'" data-ai="'+a.i+'">'+x+C+"</div>"))}));f=a.t[++e]}};VizCards.prototype.teardown=function(){jQuery(this.frameID).off("click.vf")};
VizCards.prototype.rerender=function(a){var c=this,d=jQuery(this.frameID+' div.cards[data-ti="'+a+'"]');d.empty();var e,f,g,h,l,n,q,k,r,p,v,C,x,m="w"+this.settings.w+" h"+this.settings.h;e=c.vFrame.getSelFeatAtts(a);0!=e.length&&(f=c.vFrame.getSelLegend(a),g=PData.aByID(f),h=c.settings.iAtts[a],l=c.settings.cnt[a],n=c.sAtts[a],n=PData.aByID(n),a=PData.rTOrder(n,c.stream,a),a.forEach(function(a){q=PData.rByN(a.i);k=q.a[f];"undefined"!==typeof k&&(r=PData.lRecs(k,g,e,!1))&&(C=c.settings.lOn?'<div class="card-title">'+
q.l+"</div>":"",p=!1,v="",l&&0<l.length&&(x=r.b?' style="color:black"':"",l.forEach(function(a){if(k=q.a[a])if(k=PData.procAttTxt(a,k))p=!0,v+=k+"<br/>"})),v=h&&(k=q.a[h])?p?'<div class="card-body"><img src="'+k+'"/><div class="card-cnt"'+x+">"+v+"</div></div>":'<div class="card-body"><img class="full" src="'+k+'"/></div>':'<div class="card-body"><div class="card-cnt"'+x+">"+v+"</div>",d.append('<div class="card '+m+(c.isSel(a.i)?" obj-sel":"")+'" style="background-color:'+r.v+'" data-ai="'+a.i+'">'+
...
VizPinboard.prototype.render=function(a){var c=this;this.gRecs.selectAll(".recobj").remove();this.gRecs.selectAll(".recline").remove();0<this.recSel.length&&(this.recSel=[]);this.preRender();var d=PData.eTNum(),e,f,g=0,h,l,n,q,k,r,p,v,C,x,m,A,w,z,u,t;for(e=0;e<d;e++)if("disable"!==this.settings.pAtts[e]){t=[];break}A=this.settings.min;"string"===typeof A&&(A=parseInt(A));f=this.settings.max;"string"===typeof f&&(f=parseInt(f));w=f-A;var y=[];e=0;g=-1;a:for(;e<a.l;){if(null==r){do{if(++g===d)break a;
h=a.t[g]}while(0===h.n||h.i+h.n===e);r=this.vFrame.getSelLocAtts(g);if(0===r.length){r=null;continue}r=r[0];p=c.vFrame.getSelFeatAtts(g);if(0===p.length){r=null;continue}c.tUsed[g]=!0;q=c.vFrame.getSelLegend(g);k=PData.aByID(q);v=c.settings.pAtts[g];l=c.settings.lClrs[g];if(m=c.settings.sAtts[g])n=PData.aByID(m),"number"===typeof n.r.min&&"number"===typeof n.r.max?(z=n.r.min,u=n.r.max-z):m=null}f=a.s[e];n=PData.rByN(f);var B;t&&(B={id:n.id,c:null,p:n.a[v],l:l});C=n.a[r];"undefined"!==typeof C&&(x=
n.a[q],"undefined"!==typeof x&&(x=PData.lClr(x,k,p)))&&(c.rMap[f>>4]|=1<<(f&15),m?(n=n.a[m],n="number"===typeof n?Math.floor((n-z)*w/u)+A:A):n=A,y.push({ai:f,v:x,x:C[0],y:C[1],r:n}),B&&(B.c=C));B&&B.c&&t.push(B);++e==h.i+h.n&&(r=null)}this.gRecs.selectAll(".recobj").data(y).enter().append("circle").attr("class","recobj").attr("cx",function(a){return c.xScale(a.x)}).attr("cy",function(a){return c.yScale(a.y)}).attr("r",function(a){return c.yScale(a.r)}).style("fill",function(a){return a.v}).on("click",
...
e.settings.xLbl).attr("height",k);var p=d.append("text").attr("class","bMinMaxLbl").attr("id",function(a){return"txt-"+a.name}).attr("x",function(a){return a.x()+a.tDelta}).attr("y",12).attr("text-anchor",function(a){return a.anchor}),f={redraw:function(){var a=c.xScale.domain(),k=a[0],d=a[1];p.text(function(a){return a.whichDate(k,d).getUTCFullYear()})}};c.parts.push(f);e.cmpnts.push(f);if(1===a){var C=d.append("text").attr("class","bMinMaxLbl").attr("id",function(a){return"m-txt-"+a.name}).attr("x",
function(a){return a.x()+a.tDelta}).attr("y",k-4).attr("text-anchor",function(a){return a.anchor});a={redraw:function(){var a=c.xScale.domain(),k=a[0],d=a[1];C.text(function(a){return d.getUTCFullYear()-k.getUTCFullYear()>e.threshold?"":months[a.whichDate(k,d).getMonth()]})}};c.parts.push(a);e.cmpnts.push(a)}c.labelSVGs=d}var e=this;"number"!==typeof this.settings.xLbl&&(this.settings.xLbl=parseInt(this.settings.xLbl));this.brushSVG=this.brush=null;var f=this.settings;"string"===typeof f.bHt&&(f.bHt=
parseInt(f.bHt,10));(function(){var a,c,k,d,p,v;f.dAtts.forEach(function(e){null!=e&&"disable"!==e&&(e=PData.aByID(e))&&(null==a||e.r.min.y<a?(a=e.r.min.y,"undefined"!==typeof e.r.min.m?(c=e.r.min.m,k="undefined"!==typeof e.r.min.d?e.r.min.d:1):k=c=1):e.r.min.y===a&&"undefined"!==typeof e.r.min.m&&(e.r.min.m<c?(c=e.r.min.m,k="undefined"!==typeof e.r.min.d?e.r.min.d:1):e.r.min.m===c&&"undefined"!==typeof e.r.min.d&&e.r.min.d<k&&(k=e.r.min.d)),null==d?"undefined"===typeof e.r.max.y?(d=TODAY.getUTCFullYear(),
p=TODAY.getMonth()+1,v=TODAY.getDate()):(d=e.r.max.y,"undefined"!==typeof e.r.max.m?(p=e.r.max.m,v="undefined"!==typeof e.r.max.d?e.r.max.d:PData.lenMnth(d,p)):(p=12,v=31)):e.r.max.y>d?(d=e.r.max.y,"undefined"!==typeof e.r.max.m?(p=e.r.max.m,v="undefined"!==typeof e.r.max.d?e.r.max.d:PData.lenMnth(d,p)):(p=12,v=31)):e.r.max.y===d&&"undefined"!==typeof e.r.max.m&&(e.r.max.m>p?(p=e.r.max.m,v="undefined"!==typeof e.r.max.d?e.r.max.d:PData.lenMnth(d,p)):e.r.max.m===p&&"undefined"!==typeof e.r.max.d&&
e.r.max.d>v&&(v=e.r.max.d)))});e.minDate=0<f.from.length?PData.dStr(f.from,!1):PData.d3Nums(a,c,k,!1);e.maxDate=0<f.to.length?PData.dStr(f.to,!0):PData.d3Nums(d,p,v,!0);e.instGap=.015*(e.maxDate-e.minDate)})();var g=e.getWidths(),h=d3.select(this.frameID).append("svg").attr("class","tl-vf").attr("width",g[1]);(function(){var a=[];f.lgnds.forEach(function(c){c.forEach(function(c){a.push(c)})});var a=_.uniq(a),c=[];a.forEach(function(a){(a=PData.aByID(a))&&a.l.forEach(function(a){c.push(a.v)})});c=
...
VizTime.prototype.render=function(a){function c(a,c){var k=a.s-c.s;if(0>k)return 1;if(0<k)return-1;k=c.e-a.e;return 0>k?1:0<k?-1:0}function d(a){function c(a){a=g.toggleSel(a.ai);d3.select(this).classed("obj-sel",a)}var k,d,e,f,h=g.bands[a];a?(k=g.bands[0],h.t=k.t+k.h+37,k=d=e=g.instRad,f=2*g.instRad+3):(h.t=0,k=d=e=1);h.h=l*h.tHt+2;h.g.attr("transform","translate(0,"+h.t+")").attr("height",h.h);var x,m;a&&(x=.75*h.iHt+"px",m=.8*h.iHt);var A;A=d3.select(h.svgID).selectAll(".lgBd").remove();A=d3.select(h.svgID).selectAll(".lgBd").data(g.lgBds).enter().append("svg").attr("class",
"lgBd").attr("y",function(a){return h.yScale(a.t)}).attr("height",function(a){return h.yScale(a.h)});A.append("rect").attr("width","100%").attr("height","100%").attr("fill",function(a){return a.d.v});1===a&&A.append("text").attr("class","lgBdLbl").attr("x",2).attr("y",m).attr("fill",function(a){return a.d.b?"#000000":"#FFFFFF"}).style("font-size",x).text(function(a){return a.d.l});var w;d3.select(h.svgID).selectAll(".event").remove();w=d3.select(h.svgID).selectAll(".event").data(g.events).enter().append("svg").attr("class",
function(a){return a.f&EVENT_INSTANT?"event instant":"event range"}).attr("y",function(a){return h.yScale(a.t)}).attr("height",h.iHt);if(1===a)w.on("click",c);var z=d3.select(h.svgID).selectAll(".range");z.append("rect").attr("width","100%").attr("height","100%").attr("fill",function(c){return 1===a&&c.f&(EVENT_F_START|EVENT_F_END)?(c.f&(EVENT_F_START|EVENT_F_END))===(EVENT_F_START|EVENT_F_END)?"url("+c.c.v+"-fb)":(c.f&EVENT_F_START)===EVENT_F_START?"url("+c.c.v+"-fs)":"url("+c.c.v+"-fe)":c.c.v});
1===a&&z.append("text").attr("class","rangeLbl").attr("x",4).attr("y",m).attr("fill",function(a){return a.c.b?"#000000":"#FFFFFF"}).style("font-size",x).text(function(a){return a.l});z=d3.select(h.svgID).selectAll(".instant");z.append("circle").attr("cx",k).attr("cy",d).attr("r",e).attr("fill",function(a){return a.c.v});1===a&&z.append("text").attr("class","instantLbl").attr("x",f).attr("y",m).style("font-size",x).text(function(a){return a.l});h.redraw=function(){A.attr("x",function(a){return h.xScale(a.s)}).attr("width",
function(a){return h.xScale(a.e)-h.xScale(a.s)});w.attr("x",function(a){return h.xScale(a.s)}).attr("width",function(a){return h.xScale(a.e)-h.xScale(a.s)});h.parts.forEach(function(a){a.redraw()})}}function e(a){a=g.bands[a];d3.select(a.svgID).selectAll(".axis").attr("transform","translate(0,"+a.h+")")}function f(a){a=g.bands[a];d3.select(a.svgID).selectAll(".bLblCntr").attr("transform","translate(0,"+(a.h+1).toString()+")")}var g=this,h=this.vFrame.getIndex();0<this.recSel.length&&(this.recSel=
[]);this.preRender();this.events=[];this.lgBds=[];var l=0;(function(){for(var d=PData.eTNum(),e=0,k,r,p,f,h,x,m,A;e<d;){for(k=a.t[e];0===k.n;){if(++e==d)return;k=a.t[e]}p=g.vFrame.getSelLocAtts(e);if(0!==p.length&&(p=g.vFrame.getSelFeatAtts(e),0!==p.length)){g.tUsed[e]=!0;A=g.vFrame.getSelLegend(e);m=PData.aByID(A);f=g.settings.dAtts[e];for(var w,z,u,t,y,B,D,E,F=[],G=k.i;G<k.i+k.n;G++)r=a.s[G],E=PData.rByN(r),h=E.a[A],"undefined"!==typeof h&&(h=PData.lRecs(h,m,p,!1))&&(x=E.a[f])&&"?"!==x&&(g.rMap[r>>
4]|=1<<(r&15),B=x.min.f?EVENT_F_START:0,w=x.min.y,"undefined"===typeof x.min.m?u=z=1:(z=x.min.m,u="undefined"===typeof x.min.d?1:x.min.d),t=PData.d3Nums(w,z,u,!1),"undefined"===typeof x.max?(B|=EVENT_INSTANT,y=t.getTime()+g.instGap):"open"===x.max?y=TODAY:(x.max.f&&(B|=EVENT_F_END),w=x.max.y,"undefined"===typeof x.max.m?(z=12,u=31):(z=x.max.m,u="undefined"===typeof x.max.d?PData.lenMnth(w,z):x.max.d),y=PData.d3Nums(w,z,u,!0)),F.push({s:t,e:y,ai:r,f:B,c:h,l:E.l,t:0}));F.sort(c);var I=[],K;F.forEach(function(a){for(K=
0;K<I.length&&!(a.e<I[K]);K++);a.t=K+l+1;I[K]=a.s});k=PData.aByID(f);k.l.forEach(function(a){D=a.d;w=D.min.y;"undefined"===typeof D.min.m?u=z=1:(z=D.min.m,u="undefined"===typeof D.min.d?1:D.min.d);t=PData.d3Nums(w,z,u,!1);"undefined"===typeof D.max.y?y=TODAY:(w=D.max.y,"undefined"===typeof D.max.m?(z=12,u=31):(z=D.max.m,u="undefined"===typeof D.max.d?PData.lenMnth(w,z):D.max.d),y=PData.d3Nums(w,z,u,!0));g.lgBds.push({s:t,e:y,t:l,h:I.length+1,d:a})});l+=I.length+1;g.events=g.events.concat(F)}e++}})();
...
VizDirectory.prototype.render=function(a){var c=this,d=PData.eTNum(),e=0,f,g,h,l,n,q,k,r=jQuery(this.frameID);r.empty();0<this.recSel.length&&(this.recSel=[]);this.preRender();this.stream=a;for(f=a.t[0];e<d;){for(;0===f.n;){if(++e===d)return;f=a.t[e]}c.tUsed[e]=!0;f=PData.eTByN(e);f=PData.tByID(f);r.append('<div class="template-label">'+f.l+'</div><table cellspacing="0" class="viz-directory" data-ti='+e+"></table>");g=r.find('table[data-ti="'+e+'"]');h=c.settings.cnt[e];k=c.sAtts[e];q="<thead><tr>";
h.forEach(function(a){var c=PData.aByID(a);q+='<th data-aid="'+a;a===k&&(q+='" class="sel');q+='">'+c.def.l+"</th>"});g.append(q+"</tr></thead><tbody></tbody>");g=g.find("tbody");f=PData.aByID(k);f=PData.rTOrder(f,c.stream,e);f.forEach(function(a){n=PData.rByN(a.i);c.rMap[a.i>>4]|=1<<(a.i&15);q='<tr data-id="'+n.id+'" data-ai='+a.i+">";h.forEach(function(a){l=n.a[a];"undefined"!==typeof l?q=(l=PData.procAttTxt(a,l))?q+("<td>"+l+"</td>"):q+"<td></td>":q+="<td></td>"});g.append(q+"</tr>")});f=a.t[++e]}};
...
VizTextStream.prototype.render=function(a){var c=this,d=PData.eTNum(),e=0,f,g,h,l,n,q,k,r,p,v,C,x,m,A,w,z,u,t=jQuery(this.frameID);t.empty();0<this.recSel.length&&(this.recSel=[]);this.preRender();z=this.settings.max-this.settings.min;for(g=a.t[0];e<d;){for(;0===g.n;){if(++e===d)return;g=a.t[e]}p=c.vFrame.getSelLocAtts(e);if(0!==p.length&&(p=c.vFrame.getSelFeatAtts(e),0!==p.length)){c.tUsed[e]=!0;v=c.vFrame.getSelLegend(e);C=PData.aByID(v);t.append('<div class="viz-textstream" data-ti='+e+"></div>");
h=t.find("div.viz-textstream[data-ti="+e+"]");f=PData.eTByN(e);f=PData.tByID(f);h.append('<div class="template-label">'+f.l+"</div>");r=c.settings.cnt[e];if(A=c.settings.sAtts[e])m=PData.aByID(A),"number"===typeof m.r.min&&"number"===typeof m.r.max?w=m.r.max-m.r.min:A=null;r&&(f=PData.aByID(c.settings.order[e]),f=PData.rTOrder(f,a,e),f.forEach(function(a){l=PData.rByN(a.i);n=l.a[v];"undefined"!==typeof n&&(x=PData.lRecs(n,C,p,!1))&&((q=l.a[r])&&(q=PData.procAttTxt(r,q)),q&&(c.rMap[a.i>>4]|=1<<(a.i&
15),A?(k=l.a[A],k="number"===typeof k?Math.floor((k-m.r.min)*z/w)+c.settings.min:c.settings.min):k=c.settings.min,u=x.b?";background-color:black":"",h.append('<div class="recitem" data-ai='+a.i+' style="color:'+x.v+u+";font-size:"+k+'px">'+q+"</div>")))}))}e++}};VizTextStream.prototype.teardown=function(){jQuery(this.frameID).off("click.vf")};
...
this.svg.attr("width",a+D3SC_MARGINS.left+D3SC_MARGINS.right).attr("height",d+D3SC_MARGINS.top+D3SC_MARGINS.bottom);this.svg.selectAll(".block").remove();this.blocks=[];f=PData.aByID(f);a=0;for(var d=c.vFrame.getSelFeatAtts(0),d=PData.cLNew(f,d,!0),h=0;h<this.cats.length;h++){if(0<h)for(e=0;e<d.length;e++)d[e].i=[];PData.cSort(c.cats[h].i,f,d);var l=0;d.forEach(function(a){0<a.i.length&&(c.blocks.push({x:h,c:a.c,y:l,h:a.i.length,a:a.i}),l+=a.i.length)});a=Math.max(a,l)}c.yScale.domain([0,a]);c.svg.select(".x.axis").call(c.xAxis);
...
VizNetWheel.prototype.render=function(a){var c=this,d=[],e,f,g;a?this.stream=a:a=this.stream;this.svg.selectAll(".node").remove();this.svg.selectAll(".link").remove();0<this.recSel.length&&(this.recSel=[]);this.preRender();var h={children:[]};(function(){var d,k=0,e=0,p,f,g,x=[],m=null,l,n;d=a.t[0];n=c.vFrame.getSelLegend(0);l=PData.aByID(n);m=c.vFrame.getSelFeatAtts(0);0<m.length&&0<d.n&&(c.tUsed[0]=!0);a:for(;e<a.l;){for(;0===d.n||d.i+d.n===e||0===m.length;){0<x.length&&(h.children.push({ti:k,children:x}),
x=[]);if(++k===PData.eTNum())break a;x=[];d=a.t[k];n=c.vFrame.getSelLegend(k);l=PData.aByID(n);m=c.vFrame.getSelFeatAtts(k);0<m.length&&0<d.n&&(c.tUsed[k]=!0)}g=a.s[e];p=PData.rByN(g);f=p.a[n];"undefined"!==typeof f&&(fData=PData.lRecs(f,l,m,!1))&&(c.rMap[g>>4]|=1<<(g&15),x.push({r:p,ai:g,c:fData.v,l:!1,children:[]}));e++}0<x.length&&h.children.push({ti:k,children:x})})();h.children.forEach(function(a){var k=c.settings.pAtts[a.ti],e;a.children.forEach(function(a){k.forEach(function(c){e=a.r.a[c.pid];
"undefined"!==typeof e&&e.forEach(function(k){var e=!1,r,f=0;a:for(;f<h.children.length;f++)for(var g=h.children[f],q=0;q<g.children.length;q++)if(r=g.children[q],r.r.id==k){e=!0;break a}e&&(a.l=!0,r.l=!0,d.push({source:a,target:r,c:c.clr}))})})})});this.prune&&h.children.forEach(function(a){for(var c=a.children.length-1;0<c;c--)a.children[c].l||a.children.splice(c,1)});var l=0;h.children.forEach(function(a){l+=a.children.length});this.inc=360/(l+h.children.length);f=Math.max((14*l+20)/(2*Math.PI),
30);var n=this.settings.lw;"string"===typeof n&&(n=parseInt(n));this.cr=n+12+f;n=2*this.cr;this.svg.attr("width",n).attr("height",n);this.center.attr("transform","translate("+this.cr+","+this.cr+")");f=d3.layout.cluster().size([360,f]).sort(null).nodes(h);g=this.center.append("g").selectAll(".node").data(f.filter(function(a){return!a.children})).enter().append("g").attr("class","node").attr("transform",function(a){return"rotate("+(a.x-90)+")translate("+(a.y+8)+",0)"});g.append("circle").attr("r",
...
!0;for(var e=0;e<d.length;e++){var p=d[e];if(p.source===a&&p.target===c.t){d3.select(this).attr("stroke",p.c).classed("thick",!0);this.parentElement.appendChild(this);break}}}else if(c.t===a)for(c.s.linked=!0,e=0;e<d.length;e++){if(p=d[e],p.target===a&&p.source===c.s){d3.select(this).attr("stroke",p.c).classed("thick",!0);this.parentElement.appendChild(this);break}}else d3.select(this).attr("stroke","black").classed("thick",!1)});g.select("text").attr("fill",function(a){return a.linked?"white":"black"});
d3.select(this).attr("fill","yellow");PState.set(PSTATE_READY)});f=d3.layout.bundle();n=d3.svg.line.radial().interpolate("bundle").tension(.85).radius(function(a){return a.y}).angle(function(a){return a.x/180*Math.PI});e=this.center.append("g").selectAll(".link").data(f(d)).enter().append("path").each(function(a){a.s=a[0];a.t=a[a.length-1]}).attr("class","link").attr("d",n).attr("stroke","black")};VizNetWheel.prototype.teardown=function(){var a=this.vFrame.getIndex();jQuery("#view-frame-"+a+" div.view-controls div.iconbar").remove()};
...
VizNetWheel.prototype.setState=function(a){this.vFrame.setLgndSels(a.l)};var VizFlow=function(a,c){PVizModel.call(this,a,c)};VizFlow.prototype=Object.create(PVizModel.prototype);VizFlow.prototype.constructor=VizFlow;VizFlow.prototype.flags=function(){return V_FLAG_VSCRL|V_FLAG_HSCRL};
...
VizFlow.prototype.render=function(a){var c=this;this.bSel=[];this.fSel=[];this.barG.selectAll(".bar").remove();this.flowG.selectAll(".flow").remove();this.titleG.selectAll(".att-title").remove();var d=this.settings.w;c.bars=[];c.atts=[];c.settings.fcts.forEach(function(e,f){var g,h=PData.aByID(e);g="g"!==h.def.t?c.settings.gr?PData.cRNew(h,!0,!0):PData.cLNew(h,null,!0):[];PData.cFill(g,e,null,a);var l=[],n=0;g.forEach(function(a){0<a.i.length&&(l.push(a),n+=a.i.length)});var q=0,k=31+f*c.bH;l.forEach(function(a){c.bars.push({x:5+
q*d/n,w:a.i.length*d/n,y:k,c:a});q+=a.i.length});c.atts.push({l:h.def.l,c:l,t:n,y:k})});this.barG.selectAll(".bar").data(c.bars).enter().append("rect").attr("class","bar").attr("x",function(a){return a.x}).attr("y",function(a){return a.y}).attr("fill",function(a){return a.c.c}).attr("height","8").attr("width",function(a){return a.w}).on("click",function(a,d){var g=c.bSel.length,h=_.sortedIndex(c.bSel,d);c.bSel[h]===d?(d3.select(this).classed("obj-sel",!1),c.bSel.splice(h,1),0<g&&0===c.bSel.length&&
0===c.fSel.length&&c.vFrame.selBtns(!1)):(d3.select(this).classed("obj-sel",!0),c.bSel.splice(h,0,d),0===g&&0===c.fSel.length&&0<c.bSel.length&&c.vFrame.selBtns(!0))}).append("title").text(function(a){return a.c.l+" ("+a.c.i.length+")"});c.ints=[];c.atts.forEach(function(a,f){if(f!==c.atts.length-1){for(var g=c.atts[f+1],h=Array(a.c.length),l=0;l<a.c.length;l++)h[l]=Array(g.c.length);a.c.forEach(function(a,c){g.c.forEach(function(d,k){h[c][k]=PData.intersect(a.i,d.i)})});for(var n=Array(g.c.length),
q=0;q<g.c.length;q++){for(var k=0,l=0;l<a.c.length;l++)0<h[l][q].length&&k++;n[q]=k-1}for(var r=Array(g.c.length),q=0;q<g.c.length;q++)r[q]=0;var p=0;a.c.forEach(function(k,f){for(var x=0,m=0;m<g.c.length;m++)0<h[f][m].length&&x++;--x;var l=k.i.length*d/a.t,q=0,z=0;g.c.forEach(function(m,t){var y=h[f][t];if(0<y.length){var B=y.length*d,D=B/a.t,B=B/g.t,E=m.i.length*d/g.t;c.ints.push({i:y,c:k.c,l:k.l+" > "+m.l,x1:5+p*d/a.t+(x?(l-D)*q/x:0),x2:5+z*d/g.t+(n[t]?(E-B)*r[t]/n[t]:0),w1:D,w2:B,y1:a.y+10,y2:g.y-
1});q++;r[t]++}z+=m.i.length});p+=k.i.length})}});this.flowG.selectAll(".flow").data(c.ints).enter().append("path").attr("class","flow").attr("d",function(a){return"M "+a.x1+" "+a.y1+"  L "+(a.x1+a.w1)+" "+a.y1+" L "+(a.x2+a.w2)+" "+a.y2+" L "+a.x2+" "+a.y2+" L "+a.x1+" "+a.y1}).attr("fill",function(a){return a.c}).on("click",function(a,d){var g=c.fSel.length,h=_.sortedIndex(c.fSel,d);c.fSel[h]===d?(d3.select(this).classed("obj-sel",!1),c.fSel.splice(h,1),0<g&&0===c.fSel.length&&0===c.bSel.length&&
...
VizBrowser.prototype.render=function(a){var c=this,d=this.vFrame.getIndex();this.recSel=[];this.stream=a;this.svg.selectAll(".facet-col").remove();var e=0;this.fcts=[];this.settings.fcts.forEach(function(d,f){var g,q=PData.aByID(d);g="g"===q.def.t?[]:c.settings.gr?PData.cRNew(q,!0,!0):PData.cLNew(q,null,!0);PData.cFill(g,d,null,a);var k=[],r=0;g.forEach(function(a){0<a.i.length&&(a.n=r++,k.push(a))});c.fcts.push({c:k,x:250*f,i:f,l:q.def.l,n:q.id,s:-1});e=Math.max(e,27+22*(k.length+1))});c.svg.attr("height",
e);var f=c.svg.selectAll(".facet-col").data(c.fcts).enter().append("g").attr("transform",function(a){return"translate("+a.x+", 0)"}).attr("class","facet-col").attr("id",function(a){return"facet-"+d+"-"+a.i});f.append("rect").attr("class","facet-lbl").attr("height",24).attr("width",242);f.append("text").attr("class","facet-lbl-txt").attr("x",3).attr("y",18).attr("text-anchor","start").text(function(a){return a.l});var g;c.fcts.forEach(function(e){var f="#facet-"+d+"-"+e.i,n=null,q;null!=c.pState&&
c.pState.p.find(function(a){return e.n===a.f?(-1!==(q=e.c.findIndex(function(c){return a.v===c.l}))&&(e.s=q,n=a),!0):!1});g=c.svg.select(f).selectAll(".facet-reset").data([1]).enter().append("g").attr("transform","translate(0,26)").attr("class",function(a){return n?"facet-reset":"facet-reset inactive"}).attr("height",19).on("click",function(a){-1!==e.s&&(e.s=-1,c.svg.select(f).selectAll(".facet-val").classed("inactive",!1),d3.select(this).classed("inactive",!0),c.update())});g.append("rect").attr("class",
"facet-reset-btn").attr("height",19).attr("width",242);g.append("text").attr("class","facet-reset-txt").attr("x",3).attr("y",13).text(dlText.reset);g=c.svg.select(f).selectAll(".facet-val").data(e.c).enter().append("g").attr("transform",function(a,c){return"translate(0,"+(27+22*(c+1))+")"}).attr("class",function(a,c){return n?c===q?"facet-val":"facet-val inactive":"facet-val"}).on("click",function(a,d){var p=c.svg.select(f).select(".facet-reset");e.s!==d?(e.s=d,c.svg.select(f).selectAll(".facet-val").classed("inactive",
function(a){return d!==a.n}),p.classed("inactive",!1)):(c.svg.select(f).selectAll(".facet-val").classed("inactive",!1),e.s=-1,p.classed("inactive",!0));c.update()});g.append("rect").attr("class","facet-val-btn").attr("height",21).attr("width",242);g.append("rect").attr("class","facet-val-bar").attr("height",21).attr("width",function(c){return 0<a.l?242*c.i.length/a.l:0});g.append("text").attr("class","facet-val-txt").attr("x",3).attr("y",16).text(function(a){return a.l});g.append("text").attr("class",
...
VizMBMap.prototype.renderTree=function(a){function c(){var a=0,c=d.settings.w,g=null!==d.sbkSel?d.sbkSel.i:d.bkSel.i;PState.set(PSTATE_UPDATE);d.fcts.forEach(function(h,l){var n=[],q=0;h.c.forEach(function(a){a=PData.intersect(g,a.i);n.push(a);q+=a.length});var k=0,r;n.forEach(function(p){r=d.bars[a++];r.x=q?k*c/q:0;r.w=q?p.length*c/q:0;k+=p.length})});d.attsG.selectAll(".bar").transition().attr("x",function(a){return a.x}).attr("width",function(a){return a.w});PState.set(PSTATE_READY)}var d=this;
...
VizMBMap.prototype.render=function(a){var c=this;this.sbkSel=this.bkSel=null;this.attSel=0;var d=this.settings.w;this.attsG.selectAll(".bar").remove();this.attsG.selectAll(".mbm-att-title").remove();this.infoG.select(".mbm-select").remove();this.fcts=[];this.bars=[];this.settings.fcts.forEach(function(e,f){var k,r=PData.aByID(e),p=30*f;k="g"!==r.def.t?c.settings.gr?PData.cRNew(r,!0,!0):PData.cLNew(r,null,!0):[];PData.cFill(k,e,null,a);var g=[],h=0;k.forEach(function(a){0<a.i.length&&(g.push(a),h+=
a.i.length)});var x=0;g.forEach(function(a){c.bars.push({x0:x*d/h,w0:a.i.length*d/h,x:0,w:0,y:p+18,c:a});x+=a.i.length});c.fcts.push({i:f,l:r.def.l,y:p+14,c:g})});this.attsG.selectAll(".mbm-att-title").data(c.fcts).enter().append("text").attr("class",function(a,c){return 0===c?"mbm-att-title obj-sel":"mbm-att-title"}).attr("x","0").attr("y",function(a){return a.y}).text(function(a){return a.l}).on("click",function(a,d){c.attSel!=d&&(PState.set(PSTATE_UPDATE),c.attsG.selectAll(".mbm-att-title").classed("obj-sel",
...
!0,!0):PData.cLNew(f,null,!0):[];PData.cFill(g,e,null,a);var h=this.vFrame.getIndex();c.trees=[];c.fcts.forEach(function(a,d){var k={z:[],id:h+"."+d};g.forEach(function(c,e){if(0<c.i.length){var f=[],g={i:c.i,l:c.l,s:!1,z:f,id:h+"."+d+"."+e};a.c.forEach(function(a,k){var l=[],l=PData.intersect(c.i,a.i);0<l.length&&f.push({i:l,p:g,c:a.c,l:c.l+" + "+a.l+" ("+l.length+")",id:h+"."+d+"."+e+"."+k})});k.z.push(g)}});c.trees.push(k)});var l=d3.layout.treemap().padding([14,3,3,3]).size([d,this.settings.h]).round(!0).children(function(a,
c){return 2===c?null:a.z}).value(function(a){return a.i.length});c.treemaps=[];c.trees.forEach(function(a){c.treemaps.push(l.nodes(a))});c.renderTree(0)};VizMBMap.prototype.setSel=function(a){};VizMBMap.prototype.clearSel=function(){this.bkSel&&(this.bkSel.s=!1);this.infoG.select(".mbm-select").remove();this.sbkSel=this.bkSel=null;this.svg.selectAll(".mbm-cell").classed("obj-sel",!1);this.svg.selectAll(".mbm-title").classed("obj-sel",!1);this.resetAttBars();this.vFrame.selBtns(!1)};
...
PFilterNum.prototype.evalBoxes=function(a){function c(c,h){function k(){r=!0;a.find(c).addClass("error")}var r=!1,p,v=a.find(c).val();(v=e.exec(v))?(a.find(c).removeClass("error"),p=parseInt(v[1],10)):k();r||(0==h?null!==f&&p<f&&k():null!==g&&p>g&&k());d.uNums[h]=p;return r}var d=this,e=/^(\d+)$/,f="undefined"===typeof this.att.r.min?null:this.att.r.min,g="undefined"===typeof this.att.r.max?null:this.att.r.max,h,l;h=c(".from",0);l=c(".to",1);this.uNums[0]>this.uNums[1]&&(l=!0);a.find(".filter-update").prop("disabled",
...
this.rCats[0].min;this.max=this.rCats[this.b1].max;var d=80-D3FG_MARGINS.top-D3FG_MARGINS.bottom,e=0;this.rCats.forEach(function(a){e=Math.max(e,a.l.length)});var e=Math.max(D3FG_BAR_WIDTH,7*e),f=this.rCats.length*e,g=d3.scale.linear().domain([0,this.rCats.length]).rangeRound([0,f]),h=d3.scale.linear().domain([0,100]).range([d,0]);this.yScale=h;var l=d3.scale.ordinal().rangeRoundBands([0,f]);l.domain(this.rCats.map(function(a){return a.l}));var l=d3.svg.axis().scale(l).orient("bottom"),n=d3.svg.axis().scale(h).orient("left").ticks(4);
this.chart=f=d3.select(c.get(0)).append("svg").attr("width",f+D3FG_MARGINS.left+D3FG_MARGINS.right).attr("height",d+D3FG_MARGINS.top+D3FG_MARGINS.bottom).append("g").attr("transform","translate("+D3FG_MARGINS.left+","+D3FG_MARGINS.top+")");f.append("g").attr("class","x axis").attr("transform","translate(0,"+d+")").call(l);f.append("g").attr("class","y axis").call(n);f.selectAll(".bar").data(this.rCats).enter().append("rect").attr("class","bar").attr("x",function(a,c){return g(c)+2}).attr("y",function(a){return h(100)}).attr("fill",
...
PFilterDates.prototype.evalBoxes=function(a){function c(c,g){function h(d){r=!0;a.find(c+d).addClass("error")}function k(d){a.find(c+d).removeClass("error")}var r=!1,p={y:0,m:0,d:0,ms:null},v=a.find(c+"-y"),v=v.val();(v=e.exec(v))?(k("-y"),p.y=parseInt(v[1],10)):h("-y");v=a.find(c+"-m");v=v.val();(v=f.exec(v))?(p.m=parseInt(v[1],10),1>p.m||12<p.m?h("-m"):k("-m")):h("-m");v=a.find(c+"-d");v=v.val();(v=f.exec(v))?(p.d=parseInt(v[1],10),1>p.d||31<p.d?h("-d"):k("-d")):h("-d");r||(p.ms=PData.d3Nums(p.y,
...
function PViewFrame(a){function c(a){a!==u&&(u=a,jQuery(d()+" div.lgnd-container div.lgnd-handle button.lgnd-update").prop("disabled",!a))}function d(){return"#view-frame-"+a}function e(a){a=jQuery(d()+" div.view-controls select.view-viz-select option:selected").val();PState.set(PSTATE_BUILD);x(a,!0);PState.set(PSTATE_READY)}function f(a){w.flags()&V_FLAG_LGND&&jQuery(d()+" div.lgnd-container").toggle("slide",{direction:"left"});a.preventDefault()}function g(a){function c(a){return a.replace(/^[ \f\t\v\u200b]+|[ \f\t\v\u200b]+$/g,
"")}function d(a){var c=new Number,k=parseTC.exec(a);if(null!==k)c=1E3*(3600*parseInt(k[1])+60*parseInt(k[2])+parseFloat(k[3])),c=1==k[4].length?c+100*parseInt(k[4]):c+10*parseInt(k[4]);else throw Error("Error in transcript file: Cannot parse "+a+" as timecode.");return c}function k(a,d){var e=new String(a),e=c(e).split(/\r\n|\r|\n/g),f=[];if(e){var p,r=0;_.each(e,function(a){a=c(a);0<a.length&&("["===a.charAt(0)?(0<r&&f.push(p),p=""):(0<p.length&&(p+="<br/>"),p+=a),r++)})}_.each(f,function(a,c){d.find('div.timecode[data-tcindex="'+
c+'"]').next().after('<div class="xscript">'+a+"</div>")})}function e(a){widgetData.tcArray=[];widgetData.tcIndex=-1;var p=widgetData.tcArray;a=new String(a);if(a=c(a).split(/\r\n|\r|\n/g)){var f=jQuery("#xscript-tbl"),r=0,m,g=0,h=0,v="";_.each(a,function(a){a=c(a);1<a.length&&("["===a.charAt(0)&&"0"<=a.charAt(1)&&"9">=a.charAt(1)?(m=d(a),0<v.length&&(h&&p.push({s:g,e:m}),f.append('<div class="row"><div class="timecode" data-timecode="'+g+'" data-tcindex="'+r++ +'">'+h+'</div><div class="xscript">'+
v+"</div></div>"),v=""),h=a,g=m):(0<v.length&&(v+="<br/>"),v+=a))});0<v.length&&(p.push({s:g,e:324E5}),f.append('<div class="row"><div class="timecode" data-timecode="'+g+'" data-tcindex="'+r+'">'+h+'</div><div class="xscript">'+v+"</div></div>"));"undefined"!==typeof q&&null!=q&&jQuery.ajax({type:"POST",url:prspdata.ajax_url,data:{action:"prsp_get_transcript",transcript:q,excerpt:widgetData.extract},success:function(a,c,d){k(JSON.parse(a),f)},error:function(a,c,d){alert(d)}})}}function f(a){var c,
d=widgetData.tcIndex;_.find(widgetData.tcArray,function(k,e){if((c=k.s<=a&&a<k.e)&&e!=d){var p=jQuery("#xscript-tbl");if(document.getElementById("sync-xscript").checked){var f=p.find('[data-tcindex="'+e+'"]').offset().top-p.offset().top,f=p.scrollTop()+f;p.animate({scrollTop:f},300)}-1!=d&&p.find('[data-tcindex="'+d+'"]').removeClass("current");p.find('[data-tcindex="'+e+'"]').addClass("current");widgetData.tcIndex=e}return c})}function p(){widgetData.widget=new YT.Player("yt-widget",{width:u-40,
height:Math.floor(9*(u-40)/16),videoId:widgetData.ytCode,events:{onError:function(a){console.log("YouTube Error: "+a.data)},onStateChange:function(a){var c;switch(a.data){case 1:widgetData.playing=!0;null==widgetData.timer&&(widgetData.timer=setInterval(function(){c=1E3*widgetData.widget.getCurrentTime();widgetData.playing&&widgetData.xscriptOn&&f(c)},300));break;case 0:case 2:widgetData.playing=!1;window.clearInterval(widgetData.timer);widgetData.timer=null;break;case 3:case 5:widgetData.playing=
!1}},onReady:function(){widgetData.extract&&widgetData.widget.cueVideoById({videoId:widgetData.ytCode,startSeconds:widgetData.sTime/1E3,endSeconds:widgetData.eTime/1E3})}}})}function m(){widgetData.playing=!0}function r(){widgetData.playing=!1}function g(){widgetData.playing&&widgetData.xscriptOn&&f(1E3*widgetData.widget.currentTime)}function v(){switch(t){case 3:null!=widgetData.widget&&(widgetData.widget.removeEventListener("ended",r),widgetData.widget.removeEventListener("pause",r),widgetData.widget.removeEventListener("playing",
m),widgetData.widget.removeEventListener("timeupdate",g));case 1:null!=widgetData.widget&&widgetData.playing&&widgetData.widget.pause();widgetData.playing=!1;widgetData.widget=null;break;case 2:widgetData.ytCall=null,null!=widgetData.widget&&widgetData.playing&&widgetData.widget.stopVideo(),widgetData.widget=null,widgetData.playing=!1,null!=widgetData.timer&&(window.clearInterval(widgetData.timer),widgetData.timer=null)}}function x(){function a(){widgetData.sTime=widgetData.eTime=null;var c;(c=prspdata.e.i.t.tcAtts[v])&&
(c=H.a[c])&&""!==c&&(widgetData.extract=c,c=c.split("-"),widgetData.sTime=d(c[0]),widgetData.eTime=d(c[1]))}var c=J[M];H=PData.rByN(c);var k=" "+H.l+" ("+(M+1)+"/"+J.length+") ",h=jQuery("#inspect-name");h.text(k);h.prop("title",H.id);var v=PData.n2T(c);n.empty();A=null;t=0;widgetData.extract=null;widgetData.xscriptOn=!1;widgetData.playing=!1;if(prspdata.e.i.modal.scOn||"boolean"===typeof prspdata.e.i.modal.aOn&&prspdata.e.i.modal.aOn)if(A=prspdata.e.i.sc.atts[v])if(k=H.a[A])if(a(),k.match(/soundcloud\.com/)){var l=
!0;t=1;n.append('<iframe id="sc-widget" class="player" width="100%" height="110" src="http://w.soundcloud.com/player/?url='+k+'"></iframe>');var y=SC.Widget(document.getElementById("sc-widget"));widgetData.widget=y;y.bind(SC.Widget.Events.READY,function(){y.play();y.bind(SC.Widget.Events.PLAY,function(){widgetData.playing=!0});y.bind(SC.Widget.Events.PAUSE,function(){widgetData.playing=!1});y.bind(SC.Widget.Events.PLAY_PROGRESS,function(a){l&&(y.pause(),l=!1,widgetData.playing=!1);widgetData.extract&&
(a.currentPosition<widgetData.sTime?y.seekTo(widgetData.sTime):a.currentPosition>widgetData.eTime&&(y.pause(),widgetData.playing=!1));widgetData.playing&&widgetData.xscriptOn&&f(a.currentPosition)});y.bind(SC.Widget.Events.FINISH,function(){widgetData.playing=!1})})}else t=3,widgetData.extract&&(h=widgetData.extract.split("-"),k+="#t="+h[0]+","+h[1]),n.append('<audio id="na-widget" controls src="'+k+'"></audio>'),widgetData.widget=document.getElementById("na-widget"),widgetData.widget.addEventListener("ended",
r),widgetData.widget.addEventListener("pause",r),widgetData.widget.addEventListener("playing",m),widgetData.widget.addEventListener("timeupdate",g);0===t&&prspdata.e.i.modal.ytOn&&(A=prspdata.e.i.yt.atts[v])&&(k=H.a[A])&&(a(),widgetData.ytCode=k,n.append('<div id="yt-widget"></div>'),widgetData.ytCall=p,widgetData.ytLoaded?p():(widgetData.ytLoaded=!0,k=document.createElement("script"),k.src="https://www.youtube.com/iframe_api",h=document.getElementsByTagName("script")[0],h.parentNode.insertBefore(k,
h)),t=2);prspdata.e.i.modal.tOn&&(k=prspdata.e.i.t.t1Atts[v])&&""!==k&&"disable"!==k&&(k=H.a[k],"string"===typeof k&&""!==k&&(0<t&&n.append("<div>"+document.getElementById("dltext-sync-xscript").innerHTML+"</div>"),n.find("#xscript-tbl").remove(),n.append('<div id="xscript-tbl"></div>'),widgetData.xscriptOn=!0,jQuery("#xscript-tbl").click(function(a){if(t&&jQuery(a.target).hasClass("timecode"))switch(a=jQuery(a.target).data("timecode"),t){case 1:widgetData.playing||(widgetData.playing=!0,widgetData.widget.play());
widgetData.widget.seekTo(a);break;case 2:widgetData.playing||(widgetData.playing=!0,widgetData.widget.playVideo());widgetData.widget.seekTo(a/1E3);break;case 3:widgetData.playing||(widgetData.playing=!0,widgetData.widget.play()),widgetData.widget.currentTime=a/1E3}}),q=null,(h=prspdata.e.i.t.t2Atts[v])&&""!==h&&"disable"!==h&&(q=H.a[h]),jQuery.ajax({type:"POST",url:prspdata.ajax_url,data:{action:"prsp_get_transcript",transcript:k,excerpt:widgetData.extract},success:function(a,c,d){e(JSON.parse(a))},
error:function(a,c,d){alert(d)}})));prspdata.e.i.modal.atts[v].forEach(function(a){var d=PData.rAV(c,a,!1);if(d){a=PData.aByID(a);var k;"_"==a.def.l.charAt(0)?k="<div>"+d+"</div>":(k='<div><span class="att-label">'+a.def.l+":</span> ","I"==a.def.t&&(k+="<br/>"),k+=d+"</div>");n.append(k)}})}function l(a){a=M+a;-1==a?a=J.length-1:a==J.length&&(a=0);a!=M&&(M=a,v(),x())}function C(a){l(-1)}function z(a){l(1)}var n=jQuery("#inspect-content"),A=null,t=0,q,u=450,N=400,J=null;w&&(J=w.getSel());if(null!=
J&&0!=J.length){var O,H,M=0;prspdata.e.i.modal.scOn&&(u=550);prspdata.e.i.modal.ytOn&&(u=Math.max(u,475),N=500);prspdata.e.i.modal.tOn&&(N+=100,prspdata.e.i.modal.t2On?(u=Math.max(750,Math.floor(.8*jQuery(document).width())),u=Math.min(900,u)):u=Math.max(u,550));"number"===typeof prspdata.e.i.modal.w&&(u=prspdata.e.i.modal.w);"number"===typeof prspdata.e.i.modal.h&&(N=prspdata.e.i.modal.h);h(!1);x();jQuery("#btn-inspect-left").click(C);jQuery("#btn-inspect-right").click(z);O=jQuery("#dialog-inspector").dialog({width:u,
...
(c.find(".osel").button("disable"),c.find(".osel").removeClass("pulse"),c.find(".xsel").button("disable"))}function l(c){jQuery("body").trigger("prospect",{s:PSTATE_HILITE,v:a,t:w.tUsed});c.preventDefault()}function n(a){PState.set(PSTATE_UPDATE);w&&w.clearSel();h(!1);PState.set(PSTATE_READY);a.preventDefault()}function q(a){w&&w.doOptions();a.preventDefault()}function k(a){var c=jQuery("#dialog-vnotes").dialog({width:300,height:300,modal:!0,buttons:[{text:dlText.ok,click:function(){c.dialog("close")}}]});
a.preventDefault()}function r(a,k){jQuery(d()+' div.lgnd-container div.lgnd-scroll div.lgnd-template[data-index="'+a+'"] div.lgnd-group input.lgnd-entry-check').prop("checked",k);c(!0)}function p(a){var k=jQuery(a.target).closest("div.lgnd-template").data("index"),e=a.target.className;switch(e){case "lgnd-update":w&&t&&(PState.set(PSTATE_BUILD),h(!1),w.render(t),c(!1),PState.set(PSTATE_READY));break;case "lgnd-entry-check":e=jQuery(a.target).closest("div.lgnd-entry");a=jQuery(a.target).is(":checked");
...
(e=jQuery(a.target).find("input.lgnd-entry-check"),a=!e.is(":checked"),e.prop("checked",a),r(k,a))}}function v(a){var d=jQuery(a.target).closest("div.lgnd-template").data("index");a=jQuery(a.target).val();C(d,a);c(!0)}function C(a,c){var k,e=jQuery(d()+' div.lgnd-container div.lgnd-scroll div.lgnd-template[data-index="'+a+'"] div.lgnd-group');e.empty();z[a]=c;var p=PData.aByID(c);"undefined"!==typeof p.r.u&&(k='<div class="lgnd-value lgnd-entry" data-index="-1"><input type="checkbox" checked="checked" class="lgnd-entry-check"/><div class="lgnd-viz" style="background-color: '+
p.r.u.v+'"> </div> <span class="lgnd-value-title">'+dlText.undef+"</span></div>",e.append(k));p.l.forEach(function(a,c){k='<div class="lgnd-value lgnd-entry" data-index="'+c+'"><input type="checkbox" checked="checked" class="lgnd-entry-check"/><div class="lgnd-viz" style="background-color: '+a.v+'"> </div> <span class="lgnd-value-title">'+a.l+"</span></div>";e.append(k);a.z&&0<a.z.length&&a.z.forEach(function(a,d){k='<div class="lgnd-value lgnd-entry" data-index="'+c+","+d+'"><input type="checkbox" checked="checked" class="lgnd-entry-check"/>';
k=a.v&&""!==a.v?k+('<div class="lgnd-viz" style="background-color: '+a.v+'"></div>'):k+'<div class="lgnd-viz lgnd-viz-empty"></div>';k+=' <span class="lgnd-value-title">&raquo; '+a.l+"</span></div>";e.append(k)})});jQuery(d()+' div.lgnd-container div.lgnd-scroll div.lgnd-template[data-index="'+a+'"] div.lgnd-sh input').prop("checked",!0)}function x(k,e){var p=PData.vByN(k);w&&(w.teardown(),w=null);var f=jQuery(d());f.find("div.viz-content div.viz-result").empty();var r;switch(p.vf){case "M":r=new VizMap(m,
p.c);break;case "C":r=new VizCards(m,p.c);break;case "P":r=new VizPinboard(m,p.c);break;case "T":r=new VizTime(m,p.c);break;case "D":r=new VizDirectory(m,p.c);break;case "t":r=new VizTextStream(m,p.c);break;case "S":r=new VizStackChart(m,p.c);break;case "N":r=new VizNetWheel(m,p.c);break;case "F":r=new VizFlow(m,p.c);break;case "B":r=new VizBrowser(m,p.c);break;case "m":r=new VizMBMap(m,p.c)}A=k;var g=r.flags();g&V_FLAG_HSCRL?(f.find("div.viz-content").addClass("h-scroll"),f.find("div.viz-result").addClass("viz-fit-w"),
...
z=[];if(g&V_FLAG_LGND){f.find(".hslgnd").button("enable");var x=f.find("div.lgnd-container div.lgnd-scroll");x.empty();if(g&V_FLAG_SLGND){var l=r.getFeatureAtts(),n=PData.aByID(l);x.append('<div class="lgnd-template" data-index="0"><div class="lgnd-title">'+n.def.l+'</div><div class="lgnd-entry lgnd-sh"><input type="checkbox" checked="checked" class="lgnd-entry-check"/><i>'+dlText.sha+'</i></div><div class="lgnd-group"></div></div>');z.push(l);C(0,l)}else{var u=!1;prspdata.e.g.ts.forEach(function(a,
c){var d=PData.tByID(a),k=r.getLocAtts(c);if(k&&0<k.length||!(g&V_FLAG_LOC)){var e=r.getFeatureAtts(c);if(0<e.length){u&&x.append("<hr/>");var p=jQuery('<div class="lgnd-template" data-index="'+c+'"><div class="lgnd-title">'+d.l+"</div></div>");k&&k.forEach(function(a,c){var d=PData.aByID(a);p.append('<div class="lgnd-entry lgnd-locate" data-id="'+a+'"><input type="checkbox" checked="checked" class="lgnd-entry-check"/><span class="lgnd-value-title">'+d.def.l+"</span></div>")});var f='<select class="lgnd-select">';
e.forEach(function(a,c){var d=PData.aByID(a);f+='<option value="'+a+'">'+d.def.l+"</option>"});f+="</select>";d=jQuery(f);d.change(v);jQuery(p).append(d);jQuery(p).append('<div class="lgnd-entry lgnd-sh"><input type="checkbox" checked="checked" class="lgnd-entry-check"/><i>'+dlText.sha+'</i></div><div class="lgnd-group"></div>');x.append(p);e=e[0];z.push(e);C(c,e);u=!0}}})}f.find("div.lgnd-container").show()}else f.find("button.hslgnd").button("disable"),f.find("div.lgnd-container").hide();c(!1);
g&V_FLAG_SEL?(f.find(".hilite").button("enable"),jQuery("#save-prspctv-h"+a).prop("disabled",!1).prop("checked",!1)):(f.find(".hilite").button("disable"),jQuery("#save-prspctv-h"+a).prop("disabled",!0).prop("checked",!1));g&V_FLAG_OPT?f.find(".vopts").button("enable"):f.find(".vopts").button("disable");(l=r.hint())||"string"===typeof p.n&&""!==p.n?(f.find(".vnote").button("enable"),l=l?"string"===typeof p.n&&""!==p.n?l+(".<br/>"+p.n):l+".":p.n,jQuery("#vnotes-txt").empty().append(l)):f.find(".vnote").button("disable");
r.setup();h(!1);t&&e&&r.render(t);w=r}var m={},A=0,w=null,z=[],u=null,t=null;m.getFrameID=d;m.getIndex=function(){return a};m.setViz=function(a,c){a!=A&&(jQuery(d()+" div.view-controls select.view-viz-select").val(a),x(a,c))};m.initDOM=function(c){var r=document.getElementById("dltext-view-controls").innerHTML;jQuery("#viz-frame").append('<div id="view-frame-'+a+'">'+r+"</div>");var r=jQuery(d()),m=prspdata.bClrs.vf;m&&0<m.length&&r.find("div.view-controls").css("background-color",m);r.find("div.lgnd-container").draggable({handle:r.find("div.lgnd-handle"),
containment:"parent"});var h=r.find("div.view-controls select.view-viz-select");prspdata.e.vf.forEach(function(a,c){h.append('<option value="'+c+'">'+a.l+"</option>")});h.val(c);h.change(e);r.find("div.view-controls button:first").button({icons:{primary:"ui-icon-bookmark"},text:!1}).click(f).next().button({icons:{primary:"ui-icon-wrench"},text:!1}).click(q).next().button({icons:{primary:"ui-icon-info"},text:!1}).click(k).next().button({icons:{primary:"ui-icon-star"},text:!1}).click(l).next().button({icons:{primary:"ui-icon-cancel"},
text:!1}).click(n).next().button({icons:{primary:"ui-icon-search"},text:!1}).click(g).next();r.find("div.lgnd-container").click(p);x(c,!1)};m.getSelLocAtts=function(a){var c=[];jQuery(d()+' div.lgnd-container div.lgnd-scroll div.lgnd-template[data-index="'+a+'"] div.lgnd-locate input:checked').each(function(){var a=jQuery(this).parent().data("id");c.push(a)});return c};m.getSelFeatAtts=function(a){var c=[],k,e;jQuery(d()+' div.lgnd-container div.lgnd-scroll div.lgnd-template[data-index="'+a+'"] div.lgnd-group div.lgnd-value input:checked').each(function(){k=
jQuery(this).parent().data("index");"number"==typeof k?c.push(k):-1!=(e=k.indexOf(","))?c.push([parseInt(k.substring(0,e),10),parseInt(k.substring(e+1),10)]):c.push(parseInt(k,10))});return c};m.getSelLegend=function(a){return z[a]};m.getLgndSels=function(){return z.slice(0)};m.setLgndSels=function(a){a.forEach(function(a,c){a&&(jQuery(d()+' div.lgnd-container div.lgnd-scroll div.lgnd-template[data-index="'+c+'"] select.lgnd-select').val(a),C(c,a))})};m.getState=function(){return w?w.getState():null};
m.setState=function(a){w&&w.setState(a)};m.showStream=function(a){t=a;w&&w.render(a);c(!1)};m.setStream=function(a){t=a};m.selBtns=function(a){h(a)};m.clearSel=function(){w&&w.clearSel();h(!1)};m.setSel=function(a){return w&&w.flags()&V_FLAG_SEL?(w.setSel(a),h(0<a.length),!0):!1};m.resize=function(){w&&w.resize()};m.title=function(){return PData.vByN(A).l};m.flushLgnd=function(){jQuery(d()).find("div.lgnd-container").css("left","10px")};m.getBMData=function(){return w?{t:w.tUsed,r:w.rMap}:null};return m}
var PData=function(){function a(a,d,e){jQuery.ajax({type:"POST",url:prspdata.ajax_url,data:{action:"prsp_get_records",tmplt_id:prspdata.t[a].id,from:d,count:e},success:function(d,f,r){f=l[a];d=JSON.parse(d);f.d=f.d?f.d.concat(d):d;f.n+=e;c()},error:function(a,c,d){alert(d)}})}function c(){for(var c=!0,e=0;e<prspdata.t.length;e++){var f=l[e].n,g=prspdata.t[e].n;if(f<g){c=!1;g-=f;a(e,f,g<d?g:d);break}}c&&(q=!0,setTimeout(function(){jQuery("body").trigger("prospect",{s:PSTATE_PROCESS})},500))}var d=
1E3,e,f,g,h=[31,28,31,30,31,30,31,31,30,31,30,31],l=[],n=0,q=!1;return{init:function(){e=document.getElementById("dltext-to").innerHTML;f=document.getElementById("dltext-approximately").innerHTML;g=document.getElementById("dltext-now").innerHTML;"number"==typeof prspdata.chunk&&0<prspdata.chunk&&(d=prspdata.chunk);prspdata.t.forEach(function(a){l.push({i:n,n:0,d:null});n+=a.n});c()},rSize:function(){return n},intersect:function(a,c){for(var d=[],e=a.length,f=c.length,g,m,h=0,l=0;h<e&&l<f;)g=a[h],
m=c[l],g>m?l++:m>g?h++:(d.push(g),h++,l++);return d},union:function(a,c){for(var d=[],e=0,f=0,g,m;e<a.length&&f<c.length;)g=a[e],m=c[f],g<m?(d.push(g),e++):(g==m?(d.push(g),e++):d.push(m),f++);for(;e<a.length;e++)d.push(a[e]);for(;f<c.length;f++)d.push(c[f]);return d},strcmp:function(a,c){for(var d=0,e=Math.max(a.length,c.length);d<e&&a.charAt(d)===c.charAt(d);++d);return d===e?0:a.charAt(d)>c.charAt(d)?-1:1},sNew:function(a){var c={};c.s=new Uint16Array(n);c.t=[];c.l=0;if(a){for(a=0;a<n;a++)c.s[a]=
a;for(a=0;a<l.length;a++){var d=l[a];c.t.push({i:d.i,n:d.n})}c.l=n}return c},s1stT:function(a,c){var d=a.t[c];return 0==d.n?-1:d.i},n2T:function(a){for(var c=0;c<l.length;c++){var d=l[c];if(d.i<=a&&a<d.i+d.n)return c}},aInT:function(a,c){return-1!=prspdata.t[c].def.a.findIndex(function(c){return c==a})},rByN:function(a){for(var c=0;c<l.length;c++){var d=l[c];if(0<d.n&&d.i<=a&&a<d.i+d.n)return d.d[a-d.i]}return null},procAttTxt:function(a,c){var d=PData.aByID(a);switch(d.def.t){case "V":case "g":return c.join(", ");
...
case "t":return c;case "P":if(0<c.length){var h="";c.forEach(function(a){if(a=PData.rByID(a))0<h.length&&(h+=", "),h+='<a href="'+prspdata.site_url+"?p="+a.wp+'" target="_blank">'+a.l+"</a>"});return h}}return null},rAV:function(a,c,d){for(var e=0;e<l.length;e++){var f=l[e];if(0<f.n&&f.i<=a&&a<f.i+f.n){a=f.d[a-f.i].a[c];if(null==a||"undefined"===typeof a)break;return d?a:PData.procAttTxt(c,a)}}return null},nByID:function(a){for(var c=0;c<l.length;c++){var d=l[c];if(0<d.n)for(var e=0,f=d.n-1,g,m;e<=
f;)if(g=e+f>>1,m=d.d[g],m=PData.strcmp(a,m.id),0>m)e=g+1;else if(0<m)f=g-1;else return d.i+g}return null},rByID:function(a){for(var c=0;c<l.length;c++){var d=l[c];if(0<d.n)for(var e=0,f=d.n-1,g,m,h;e<=f;)if(g=e+f>>1,h=d.d[g],m=PData.strcmp(a,h.id),0>m)e=g+1;else if(0<m)f=g-1;else return h}return null},aByID:function(a){for(var c=0,d=prspdata.a.length-1,e,f;c<=d;)if(e=c+d>>1,f=PData.strcmp(a,prspdata.a[e].id),0>f)c=e+1;else if(0<f)d=e-1;else return prspdata.a[e];return null},aByN:function(a){return prspdata.a[a]},
eTNum:function(){return prspdata.e.g.ts.length},eTByN:function(a){return prspdata.e.g.ts[a]},tByID:function(a){for(var c=0;c<prspdata.t.length;c++)if(a==prspdata.t[c].id)return prspdata.t[c].def},lRecs:function(a,c,d,e){var f,g=d.length,m;switch(c.def.t){case "V":var h=function(a){for(var e=0;e<g;e++)if(f=d[e],"number"===typeof f){if(m=c.l[f],m.l===a)return m}else{m=c.l[f[0]];var k=m.z[f[1]];if(k.l===a)return k.v&&""!==k.v?k:m}return null};if(e&&""!==c.def.d){var l=[],n;a.forEach(function(a){n=h(a);
null!=n&&l.push(n)});return 0<l.length?l:null}if(""!=c.def.d){for(e=0;e<a.length;e++)if(n=h(a[e]),null!=n)return n;break}else return h(a[0]);case "T":for(n=0;n<g;n++)if(f=d[n],m=c.l[f],-1!=a.indexOf(m.d))return m;break;case "N":n=0;if(-1===d[0]){if("?"===a){if("undefined"===typeof c.r.u)break;return c.r.u}n=1}if("?"===a)break;for(;n<g;n++)if(f=d[n],m=c.l[f],"undefined"!==typeof m.d.min){if(m.d.min<=a)if("undefined"!==typeof m.d.max){if(a<=m.d.max)return m}else return m}else if(a<=m.d.max)return m;
break;case "D":n=0;if(-1===d[0]){if("?"===a){if("undefined"===typeof c.r.u)break;return c.r.u}n=1}if("?"!==a)for(;n<g;n++)if(f=d[n],m=c.l[f],"undefined"!==typeof m.d.max.y){if("undefined"!==typeof a.max&&"open"!==a.max){if(a.max.y<m.d.min.y)continue;if(a.max.y===m.d.min.y&&a.max.m&&m.d.min.m){if(a.max.m<m.d.min.m)continue;if(a.max.m==m.d.min.m&&a.max.d&&m.d.min.d&&a.max.d<m.d.min.d)continue}}if(!(a.min.y>m.d.max.y)){if(a.min.y===m.d.max.y&&a.min.m&&m.d.max.m){if(a.min.m>m.d.max.m)continue;if(a.min.m===
m.d.max.m&&a.min.d&&m.d.max.d&&a.min.d>m.d.max.d)continue}return m}}else if("undefined"!==typeof a.max){if("open"===a.max)return m;if(!(a.max.y<m.d.min.y)){if(a.max.y===m.d.min.y&&a.max.m&&m.d.min.m){if(a.max.m<m.d.min.m)continue;if(a.max.m===m.d.min.m&&a.max.d&&m.d.min.d&&a.max.d<m.d.min.d)continue}return m}}else if(!(a.min.y<m.d.min.y)){if(a.min.y===m.d.min.y&&a.min.m&&m.d.min.m){if(a.min.m<m.d.min.m)continue;if(a.min.m===m.d.min.m&&a.min.d&&m.d.min.d&&a.min.d<m.d.min.d)continue}return m}}return null},
...
c:a.v,i:[]}):e.push({l:a.l,c:a.v});a.z.forEach(function(d){var f=""===d?a.v:d.v;c?e.push({l:d.l,c:f,i:[]}):e.push({l:d.l,c:f})})}),e;case "N":if("undefined"===typeof a.r.min||"undefined"===typeof a.r.max)return null;d&&"undefined"!==typeof a.r.u&&(c?e.push({l:"?",c:a.r.u.v,min:"?",max:"?",i:[]}):e.push({l:"?",c:a.r.u.v,min:"?",max:"?"}));var f=Math.pow(10,a.r.g),g=a.r.min,h=0,l,n,q;for(0<a.l.length&&(l=a.l[0]);g<=a.r.max;){for(;h<a.l.length&&"undefined"!==typeof l.d.max&&g>l.d.max;)l=a.l[++h];q=0==
a.l.length||g<l.d.min?"#777777":h===a.l.length?"#777777":"undefined"===typeof l.d.max||g<=l.d.max?l.v:"#777777";n=g;g+=f;max=g-1;max>a.r.max&&(max=a.r.max);var u=n.toString();1<f&&4>u.length&&n!==max&&(u+="-"+max.toString());c?e.push({l:u,c:q,min:n,max:max,i:[]}):e.push({l:u,c:q,min:n,max:max})}return e;case "D":g=function(a){var c,d;if("undefined"===typeof a.y)return TODAY;c=a.y;"undefined"===typeof a.m?(d=12,a=31):(d=a.m,a="undefined"===typeof a.d?PData.lenMnth(c,d):a.d);return PData.d3Nums(c,d,
a,!1)};n=function(a,c,d,e){"undefined"!==typeof e.m&&(c=e.m,"undefined"!==typeof e.d&&(d=e.d));return PData.d3Nums(a,c,d,!1)};q=g(a.r.max);var f=a.r.g,u=a.r.min.y,t=1,y=1;"undefined"!==typeof a.r.min.m&&(t=a.r.min.m,"undefined"!==typeof a.r.min.d&&(y=a.r.min.d));var B=PData.d3Nums(u,t,y,!1),h=0,D,E;0<a.l.length&&(l=a.l[0],D=n(l.d.min.y,1,1,l.d.min),E=g(l.d.max));for(d&&"undefined"!==typeof a.r.u&&(c?e.push({l:"?",c:a.r.u.v,min:"?",max:"?",i:[]}):e.push({l:"?",c:a.r.u.v,min:"?",max:"?"}));B<=q;){d=
{};c&&(d.i=[]);switch(f){case "d":d.l=u.toString()+"-"+t.toString()+"-"+y.toString();break;case "m":d.l=u.toString()+"-"+t.toString();break;case "y":case "t":case "c":d.l=u.toString()}for(;h<a.l.length&&B>E;)l=a.l[++h],h<a.l.length&&(D=n(l.d.min.y,1,1,l.d.min),E=g(l.d.max));d.c=0==a.l.length||B<D?"#777777":h==a.l.length?"#777777":B<=E?l.v:"#777777";d.min=B;switch(f){case "d":++y>PData.lenMnth(u,t)&&(y=1,12<++t&&(t=1,u++));break;case "m":12<++t&&(t=1,u++);break;case "y":u++;break;case "t":u+=10;break;
case "c":u+=100}B=PData.d3Nums(u,t,y,!1);B>TODAY&&(B=TODAY);B.setTime(B.getTime()+10);d.max=B;e.push(d);B=PData.d3Nums(u,t,y,!1)}return e}},cFill:function(a,c,d,e){var f=PData.eTNum(),g=0,h,l=0,n,q,u,t,y=PData.aByID(c);for(h=e.t[0];l<e.l;){for(;0===h.n||h.i+h.n===l||!PData.aInT(c,g)||d&&!PData.aInT(d,g);){if(++g===f)return;h=e.t[g];l=h.i}n=e.s[l];q=PData.rByN(n);q=q.a[c];if("undefined"!==typeof q)switch(y.def.t){case "T":for(u=0;u<a.length;u++)if(t=a[u],-1!==q.indexOf(t.x)){t.i.push(n);break}break;
case "g":q.forEach(function(c){for(u=0;u<a.length;u++)if(t=a[u],c===t.l){t.i.push(n);break}u===a.length&&a.push({l:c,i:[n],c:"#"+Math.floor(16777215*Math.random()).toString(16)})});break;case "V":q.forEach(function(c){for(u=0;u<a.length;u++)if(t=a[u],c==t.l){t.i.push(n);break}});break;case "N":u=0;t=a[0];if("?"===t.min){if("?"===q){t.i.push(n);break}u=1}if("?"===q)break;for(;u<a.length;u++){t=a[u];if(q<t.min)break;if(t.min<=q&&q<=t.max){t.i.push(n);break}}break;case "D":u=0;t=a[0];if("?"===t.min){if("?"===
q){t.i.push(n);break}u=1}if("?"!==q)for(q=PData.dObj(q.min,1,!1);u<a.length;u++){t=a[u];if(q<t.min)break;if(t.min<=q&&q<t.max){t.i.push(n);break}}}l++}"g"==y.def.t&&a.sort(function(a,c){return PData.strcmp(c.l,a.l)})},cSort:function(a,c,d){var e=c.id,f,g,h;a.forEach(function(a){f=PData.rByN(a);datum=f.a[e];if("undefined"!==typeof datum)switch(c.def.t){case "T":for(g=0;g<d.length;g++)if(h=d[g],-1!==datum.indexOf(h.x)){h.i.push(a);break}break;case "g":datum.forEach(function(c){for(g=0;g<d.length;g++)if(h=
...
case "N":h=e;n=a.r.max;break;case "D":h=g,n=TODAY}var q=[],z=c.t[d];d=l[d];for(var u=0,t,y;u<z.n;)t=c.s[z.i+u++],y=d.d[t-d.i],y=y.a[a.id],"undefined"===typeof y?q.push({i:t,v:n}):q.push({i:t,v:h(y)});switch(a.def.t){case "T":case "g":case "V":q.sort(function(a,c){return PData.strcmp(c.v,a.v)});break;case "D":case "N":q.sort(function(a,c){return"?"===a.v?-1:"?"===c.v?1:a.v-c.v})}return q},vByN:function(a){return prspdata.e.vf[a]},ready:function(){return q}}}();
jQuery(document).ready(function(a){function c(){var a;PState.set(PSTATE_PROCESS);null==t&&(t=PData.sNew(!0));y=t;var c=!1,d,e;for(d=0;d<w.length;d++)if(e=w[d],a=jQuery('div.filter-instance[data-id="'+e.id+'"]'),c||e.f.isDirty(null)){c=!0;e=e.f;e.evalPrep();for(var f=PData.sNew(!1),g=0,h,k,l=0,n=y.t[0],p=0,q=0,r=a.find(".apply-tmplt-0").is(":checked");g<y.l;){for(;0===n.n||n.i+n.n===g;)f.t.push({i:f.l-p,n:p}),p=0,n=y.t[++l],r=a.find(".apply-tmplt-"+l).is(":checked");h=y.s[g++];r?(k=PData.rByN(h),e.eval(k)&&
(f.s[f.l++]=h,p++),q++):(f.s[f.l++]=h,p++)}for(;l++<PData.eTNum();)f.t.push({i:f.l-p,n:p}),p=0;e.isDirty(!1);e.out=f;e.evalDone(q);y=f}else y=e.f.out;PState.set(PSTATE_BUILD);m.forEach(function(a){a&&a.showStream(y)});0<w.length?jQuery("#btn-f-state").prop("disabled",!0).html(dlText.filtered):jQuery("#btn-f-state").prop("disabled",!0).html(dlText.nofilter)}function d(a){var c=jQuery("#annote");c.text(a);0<a.length?(jQuery("#btn-annote").button("enable"),c.show()):(jQuery("#btn-annote").button("disable"),
c.hide())}function e(a){var c=_.find(prspdata.p,function(c){return a==c.id});return c?c:null==B||0==D.length?null:(c=_.find(D,function(c){return a==c.id}))?c:null}function f(a,c){var d=jQuery("input[name=save-prspctv-dest]:checked").val();if(""==d)return null;var e=jQuery("#save-prspctv-note").val(),e=e.replace(/"/g,""),f={f:[],h0:null,h1:null,v0:null,v1:null};m.forEach(function(a,c){a&&(f["v"+c]={l:a.title(),s:a.getState()})});w.forEach(function(a){for(var c=[],d=jQuery('div.filter-instance[data-id="'+
a.id+'"]'),e=0;e<PData.eTNum();e++)c.push(d.find(".apply-tmplt-"+e).is(":checked"));f.f.push({id:a.attID,a:c,s:a.f.getState()})});for(var g=0;2>g;g++){var h=z[g];null!==h&&jQuery("#save-prspctv-h"+g).is(":checked")&&(f["h"+g]={id:u[g],s:h.getState()})}var k={id:a,l:c,n:e,s:f};"local"==d?(D.push(k),B.setItem(prspdata.e.id,JSON.stringify(D))):"server"==d&&jQuery.ajax({type:"POST",url:prspdata.ajax_url,data:{action:"prsp_save_prspctv",id:a,l:c,x:prspdata.e.id,n:e,s:JSON.stringify(f)},success:function(a,
...
prspdata.e.g.hurl;a.preventDefault()}function l(a){jQuery(this).parent().next().slideToggle(400);a.preventDefault()}function n(a){if(a=jQuery(this).closest("div.filter-instance")){var c=a.data("id");c&&""!==c&&(a=w.find(function(a){return a.id==c}),null==a?alert("Bad Filter ID "+c):a.f.isDirty(!0))}}function q(a){var d=jQuery(this).closest("div.filter-instance"),e=d.data("id"),f,g;f=w.findIndex(function(a){return a.id==e});if(-1===f)alert("Bad Filter ID "+e);else{g=w[f].f;g.teardown();w.splice(f,
1);if(f>=w.length){var h;h=0===w.length?t:w[f-1].out;m.forEach(function(a){a&&a.setStream(h)})}else w[f].f.isDirty(!0);d.remove();0===w.length?(jQuery("#btn-toggle-filters").button("disable"),m.forEach(function(a){a&&a.clearSel(h)}),c(),PState.set(PSTATE_READY)):jQuery("#btn-f-state").prop("disabled",!1).html(dlText.dofilters);a.preventDefault()}}function k(a,c,d){var e,f,g;if(null!==d)e=d;else{do e=Math.floor(1E3*Math.random()+2),-1!=w.findIndex(function(a){return a.id==e})&&(e=-1);while(-1==e)}if("_remove"==
...
title:f.title(),apply:A}));d=jQuery('div.filter-instance[data-id="'+e+'"]');for(a=0;a<PData.eTNum();a++){var h=d.find(".apply-tmplt-"+a);h.prop("disabled",!g.t[a]);h.prop("checked",c[a]&&g.t[a]);h.click(n)}d.find("button.btn-filter-toggle").button({text:!1,icons:{primary:"ui-icon-carat-2-n-s"}}).click(l);d.find("button.btn-filter-del").button({text:!1,icons:{primary:"ui-icon-trash"}}).click(q);jQuery("#btn-f-state").prop("disabled",!1).html(dlText.dofilters)}f.setup();return f}function r(a,c,d,e){jQuery("#filter-list li").removeClass("selected");
...
function p(a){PState.set(PSTATE_PROCESS);var c=m[a],d=c.getBMData(),e=[];a=z[a];if(null!==y){a.evalPrep();var f=0,g,h,k=0,l=y.t[0];a:for(;f<y.l;){for(;!d.t[k]||0==l.n||l.i+l.n==f;){if(++k===PData.eTNum())break a;l=y.t[k];f=l.i}g=y.s[f++];d.r[g>>4]&1<<(g&15)&&(h=PData.rByN(g),a.eval(h)&&e.push(g))}a.evalDone(y.l)}PState.set(PSTATE_UPDATE);0<e.length?c.setSel(e):c.clearSel();PState.set(PSTATE_READY)}function v(a,c){var d;d=jQuery("#dialog-hilite-"+a).dialog({height:275,width:Math.min(jQuery(window).width()-
20,675),modal:!0,appendTo:"#dialog-1",buttons:[{text:dlText.chsatt,click:function(){r(!1,!0,c,function(c){u[a]=c;z[a]=k(c,null,a)})}},{text:dlText.ok,click:function(){d.dialog("close");null!==z[a]&&p(a)}},{text:dlText.cancel,click:function(){d.dialog("close")}}]})}function C(a){function f(a){return prspdata.e.vf.findIndex(function(c){return a==c.l})}a=e(a);if(null==a)return!1;PState.set(PSTATE_PROCESS);jQuery("#filter-frame").hide();w.forEach(function(a){a.f.teardown()});w=[];jQuery("#filter-instances").empty();
a.s.f.forEach(function(a){k(a.id,a.a,null).setState(a.s)});jQuery("#filter-instances").hide();jQuery("#btn-toggle-filters").button(0==a.s.f.length?"disable":"enable");for(var g=0;2>g;g++)if(null!=a.s["h"+g]){var h=a.s["h"+g];u[g]=h.id;var l=k(h.id,null,g);z[g]=l;l.setState(h.s)}else z[g]=null,u[g]=null;var h=m[0],l=m[1],n=!1;PState.set(PSTATE_BUILD);g=f(a.s.v0.l);h?(h.setViz(g,!1),h.selBtns(!1)):(m[0]=PViewFrame(0),h=m[0],h.initDOM(g));null!==a.s.v1?(g=f(a.s.v1.l),l?(l.selBtns(!1),l.setViz(g,!1),
l.setState(a.s.v1.s)):(h.flushLgnd(),m[1]=PViewFrame(1),l=m[1],l.initDOM(g),l.setState(a.s.v1.s),n=!0)):l&&(m[1]=null,jQuery("#view-frame-1").remove(),n=!0);n&&h.resize();h.setState(a.s.v0.s);d(a.n);if(PData.ready()&&t)for(c(),g=0;2>g;g++)null!==u[g]&&p(g);return!0}function x(a,c){var d=prspdata.bClrs[a];d&&0<d.length&&jQuery(c).css("background-color",d)}var m=[null,null],A,w=[],z=[null,null],u=[null,null],t,y,B=null,D=[];jQuery("body").addClass("waiting");x("cb","#command-bar");x("fs","#filter-frame");
...
a.preventDefault()});jQuery("#btn-set-layout").button({icons:{primary:"ui-icon-newwin"},text:!1}).click(function(){null!==m[1]?(m[1]=null,jQuery("#view-frame-1").remove()):(m[0].flushLgnd(),PState.set(PSTATE_BUILD),m[1]=PViewFrame(1),m[1].initDOM(0),m[1].showStream(y),PState.set(PSTATE_READY));m[0].resize()});jQuery("#btn-hs-bars").button({icons:{primary:"ui-icon-carat-2-n-s"},text:!1}).click(function(a){jQuery("#filter-frame").slideToggle(400);a.preventDefault()});jQuery("#btn-show-prspctv").button({icons:{primary:"ui-icon-image"},
text:!1}).click(function(a){var c=jQuery("#prspctv-slist");c.empty();prspdata.p.forEach(function(a){c.append('<li data-src="server" data-id="'+a.id+'">'+a.l+"</li>")});D.forEach(function(a){c.append('<li data-src="local" data-id="'+a.id+'">'+a.l+"</li>")});var d=[{text:dlText.ok,click:function(){e.dialog("close");var a=c.find("li.selected");a.length&&(a=a.data("id"),C(a),PState.set(PSTATE_READY))}},{text:dlText.cancel,click:function(){e.dialog("close")}}];B&&d.push({text:dlText.manage,click:function(){e.dialog("close");
...
!1);jQuery("#save-prspctv-h1").prop("checked",!1);for(var g=0;2>g;g++){var h=null===z[g]||null===m[g];jQuery("#save-prspctv-h"+g).prop("disabled",h)}c=jQuery("#dialog-save-prsrctv").dialog({width:350,height:370,modal:!0,buttons:[{text:dlText.ok,click:function(){var a=jQuery("#save-prspctv-id").val().trim(),g=a.match(d),h=jQuery("#save-prspctv-lbl").val().trim(),h=h.replace(/"/g,"");if(0===a.length||20<a.length||g)g="#dialog-prspctv-id-badchars";else if(e(a))g="#dialog-prspctv-id-used";else if(0===
...
a.preventDefault()});jQuery("#btn-toggle-filters").button({icons:{primary:"ui-icon-arrow-2-n-s"},text:!1}).click(function(a){jQuery("#filter-instances").slideToggle(400);a.preventDefault()});jQuery("#btn-f-state").click(function(a){m.forEach(function(a){a&&a.clearSel()});c();PState.set(PSTATE_READY);a.preventDefault()});jQuery("#dialog-about .logo").attr("src",prspdata.assets+"prospectlogo.jpg");jQuery("#btn-inspect-left").button({icons:{primary:"ui-icon-arrowthick-1-w"},text:!1});jQuery("#btn-inspect-right").button({icons:{primary:"ui-icon-arrowthick-1-e"},
text:!1});(function(){jQuery("#filter-list").append('<li class="remove" data-id="_remove"><i>'+dlText.rha+"</i></li>");prspdata.a.forEach(function(a){switch(a.def.t){case "V":case "T":case "g":case "N":case "D":jQuery("#filter-list").append('<li data-id="'+a.id+'">'+a.def.l+"</li>")}})})();0!=prspdata.show_prspctv.length&&C(prspdata.show_prspctv)||(m[0]=PViewFrame(0),m[0].initDOM(0),d(""));jQuery(window).resize(function(){m.forEach(function(a){a&&a.resize()})});jQuery("body").on("prospect",function(a,
d){switch(d.s){case PSTATE_PROCESS:PState.set(PSTATE_PROCESS);c();for(var e=0;2>e;e++)null!==z[e]&&p(e);PState.set(PSTATE_READY);jQuery("body").removeClass("waiting");break;case PSTATE_FDIRTY:jQuery("#btn-f-state").prop("disabled",!1).html(dlText.dofilters);break;case PSTATE_HILITE:v(d.v,d.t)}});PState.set(PSTATE_LOAD);PData.init()});function onYouTubeIframeAPIReady(){widgetData.ytCall&&widgetData.ytCall()};