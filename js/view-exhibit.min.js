...
var f=this.lineLayer;f.clearLayers();var g=PData.eTNum(),h=0,m,n=0,q,k,t,p,v,C,y,l,z,w,r,x,u,A,D,B,E;A=this.settings.min;"string"===typeof A&&(A=parseInt(A));n=this.settings.max;"string"===typeof n&&(n=parseInt(n));D=n-A;for(h=0;h<g;h++)this.tLCnt[h]=0;for(var F,h=0;h<g;h++)if("disable"!==this.settings.pAtts[h]){F=[];break}h=0;n=-1;a:for(;h<a.l;){if(null==C){do{if(++n==g)break a;q=a.t[n]}while(0===q.n||q.i+q.n===h);C=this.vFrame.getSelLocAtts(n);if(0===C.length){C=null;continue}y=d.vFrame.getSelFeatAtts(n);
if(0===y.length){C=null;continue}d.tLCnt[n]=C.length;d.tUsed[n]=!0;p=d.vFrame.getSelLegend(n);v=PData.aByID(p);l=d.settings.pAtts[n];k=d.settings.lClrs[n];if(x=d.settings.sAtts[n])u=PData.aByID(x),"number"===typeof u.r.min&&"number"===typeof u.r.max?(B=u.r.min,E=u.r.max-B):x=null}m=a.s[h];t=PData.rByN(m);var G;F&&(G={id:t.id,c:[],p:t.a[l],l:k});C.forEach(function(a){if(z=t.a[a])if(w=t.a[p],"undefined"!==typeof w&&(w=PData.lClr(w,v,y))){d.rMap[m>>4]|=1<<(m&15);if("number"===typeof z[0])x?(u=t.a[x],
u="number"===typeof u?Math.floor((u-B)*D/E)+A:A):u=A,r=L.circleMarker(z,{_aid:m,weight:1,radius:u,fillColor:w,color:"#000",opacity:1,fillOpacity:1}),G&&G.c.push(z);else if(r=2===z.length?L.polyline(z,{_aid:m,weight:1,fillColor:w,color:"#000",opacity:1,fillOpacity:1}):L.polygon(z,{_aid:m,weight:1,fillColor:w,color:"#000",opacity:1,fillOpacity:1}),G){var k=[0,0];z.forEach(function(a){k[0]+=a[0];k[1]+=a[1]});k[0]/=z.length;k[1]/=z.length;G.c.push(k)}r.on("click",c);e.addLayer(r)}});G&&0<G.c.length&&
...
VizCards.prototype.render=function(a){var c=this;this.stream=a;var d=PData.eTNum(),e,f,g,h,m,n,q,k,t,p,v,C,y,l,z=jQuery(this.frameID);z.empty();0<this.recSel.length&&(this.recSel=[]);this.preRender();var w,r="w"+this.settings.w+" h"+this.settings.h;f=a.t[0];for(e=0;e<d;){for(;0===f.n;){if(++e===d)return;f=a.t[e]}f=PData.eTByN(e);f=PData.tByID(f);n=c.vFrame.getSelFeatAtts(e);0!==n.length&&(z.append('<div class="template-label">'+f.l+'</div><div class="cards" data-ti="'+e+'"></div>'),w=jQuery('div.cards[data-ti="'+
e+'"]'),this.tUsed[e]=!0,g=c.vFrame.getSelLegend(e),h=PData.aByID(g),m=c.settings.iAtts[e],p=c.settings.cnt[e],f=c.sAtts[e],f=PData.aByID(f),f=PData.rTOrder(f,a,e),f.forEach(function(a){q=PData.rByN(a.i);v=q.a[g];"undefined"!==typeof v&&(k=PData.lRecs(v,h,n,!1))&&(c.rMap[a.i>>4]|=1<<(a.i&15),y=c.settings.lOn?'<div class="card-title">'+q.l+"</div>":"",t=!1,C="",p&&0<p.length&&(l=k.b?' style="color:black"':"",p.forEach(function(a){if(v=q.a[a])if(v=PData.procAttTxt(a,v))t=!0,C+=v+"<br/>"})),C=m&&(v=
q.a[m])?t?'<div class="card-body"><img src="'+v+'"/><div class="card-cnt"'+l+">"+C+"</div></div>":'<div class="card-body"><img class="full" src="'+v+'"/></div>':'<div class="card-body"><div class="card-cnt"'+l+">"+C+"</div>",w.append('<div class="card '+r+'" style="background-color:'+k.v+'" data-ai="'+a.i+'">'+y+C+"</div>"))}));f=a.t[++e]}};VizCards.prototype.teardown=function(){jQuery(this.frameID).off("click.vf")};
VizCards.prototype.rerender=function(a){var c=this,d=jQuery(this.frameID+' div.cards[data-ti="'+a+'"]');d.empty();var e,f,g,h,m,n,q,k,t,p,v,C,y,l="w"+this.settings.w+" h"+this.settings.h;e=c.vFrame.getSelFeatAtts(a);0!=e.length&&(f=c.vFrame.getSelLegend(a),g=PData.aByID(f),h=c.settings.iAtts[a],m=c.settings.cnt[a],n=c.sAtts[a],n=PData.aByID(n),a=PData.rTOrder(n,c.stream,a),a.forEach(function(a){q=PData.rByN(a.i);k=q.a[f];"undefined"!==typeof k&&(t=PData.lRecs(k,g,e,!1))&&(C=c.settings.lOn?'<div class="card-title">'+
q.l+"</div>":"",p=!1,v="",m&&0<m.length&&(y=t.b?' style="color:black"':"",m.forEach(function(a){if(k=q.a[a])if(k=PData.procAttTxt(a,k))p=!0,v+=k+"<br/>"})),v=h&&(k=q.a[h])?p?'<div class="card-body"><img src="'+k+'"/><div class="card-cnt"'+y+">"+v+"</div></div>":'<div class="card-body"><img class="full" src="'+k+'"/></div>':'<div class="card-body"><div class="card-cnt"'+y+">"+v+"</div>",d.append('<div class="card '+l+(c.isSel(a.i)?" obj-sel":"")+'" style="background-color:'+t.v+'" data-ai="'+a.i+'">'+
...
VizPinboard.prototype.render=function(a){var c=this;this.gRecs.selectAll(".recobj").remove();this.gRecs.selectAll(".recline").remove();0<this.recSel.length&&(this.recSel=[]);this.preRender();var d=PData.eTNum(),e,f,g=0,h,m,n,q,k,t,p,v,C,y,l,z,w,r,x,u;for(e=0;e<d;e++)if("disable"!==this.settings.pAtts[e]){u=[];break}z=this.settings.min;"string"===typeof z&&(z=parseInt(z));f=this.settings.max;"string"===typeof f&&(f=parseInt(f));w=f-z;var A=[];e=0;g=-1;a:for(;e<a.l;){if(null==t){do{if(++g===d)break a;
h=a.t[g]}while(0===h.n||h.i+h.n===e);t=this.vFrame.getSelLocAtts(g);if(0===t.length){t=null;continue}t=t[0];p=c.vFrame.getSelFeatAtts(g);if(0===p.length){t=null;continue}c.tUsed[g]=!0;q=c.vFrame.getSelLegend(g);k=PData.aByID(q);v=c.settings.pAtts[g];m=c.settings.lClrs[g];if(l=c.settings.sAtts[g])n=PData.aByID(l),"number"===typeof n.r.min&&"number"===typeof n.r.max?(r=n.r.min,x=n.r.max-r):l=null}f=a.s[e];n=PData.rByN(f);var D;u&&(D={id:n.id,c:null,p:n.a[v],l:m});C=n.a[t];"undefined"!==typeof C&&(y=
n.a[q],"undefined"!==typeof y&&(y=PData.lClr(y,k,p)))&&(c.rMap[f>>4]|=1<<(f&15),l?(n=n.a[l],n="number"===typeof n?Math.floor((n-r)*w/x)+z:z):n=z,A.push({ai:f,v:y,x:C[0],y:C[1],r:n}),D&&(D.c=C));D&&D.c&&u.push(D);++e==h.i+h.n&&(t=null)}this.gRecs.selectAll(".recobj").data(A).enter().append("circle").attr("class","recobj").attr("cx",function(a){return c.xScale(a.x)}).attr("cy",function(a){return c.yScale(a.y)}).attr("r",function(a){return c.yScale(a.r)}).style("fill",function(a){return a.v}).on("click",
function(a,k){var d=c.toggleSel(a.ai);d3.select(this).classed("obj-sel",d)});if(u){u.sort(function(a,c){return PData.strcmp(c.id,a.id)});var B=[];u.forEach(function(a){a.p&&a.p.forEach(function(c){e=_.sortedIndex(u,{id:c},"id");if(e<u.length){var k=u[e];k.id===c&&B.push({f:a.c,t:k.c,c:a.l})}})});this.gRecs.selectAll(".recline").data(B).enter().append("line").attr("class","recline").attr("x1",function(a){return c.xScale(a.f[0])}).attr("y1",function(a){return c.yScale(a.f[1])}).attr("x2",function(a){return c.xScale(a.t[0])}).attr("y2",
...
VizTime.prototype.render=function(a){function c(a,c){var k=a.s-c.s;if(0>k)return 1;if(0<k)return-1;k=c.e-a.e;return 0>k?1:0<k?-1:0}function d(a){function c(a){a=g.toggleSel(a.ai);d3.select(this).classed("obj-sel",a)}var k,e,d,f,h=g.bands[a];a?(k=g.bands[0],h.t=k.t+k.h+37,k=e=d=g.instRad,f=2*g.instRad+3):(h.t=0,k=e=d=1);h.h=m*h.tHt+2;h.g.attr("transform","translate(0,"+h.t+")").attr("height",h.h);var y,l;a&&(y=.75*h.iHt+"px",l=.8*h.iHt);var z;z=d3.select(h.svgID).selectAll(".lgBd").remove();z=d3.select(h.svgID).selectAll(".lgBd").data(g.lgBds).enter().append("svg").attr("class",
"lgBd").attr("y",function(a){return h.yScale(a.t)}).attr("height",function(a){return h.yScale(a.h)});z.append("rect").attr("width","100%").attr("height","100%").attr("fill",function(a){return a.d.v});1===a&&z.append("text").attr("class","lgBdLbl").attr("x",2).attr("y",l).attr("fill",function(a){return a.d.b?"#000000":"#FFFFFF"}).style("font-size",y).text(function(a){return a.d.l});var w;d3.select(h.svgID).selectAll(".event").remove();w=d3.select(h.svgID).selectAll(".event").data(g.events).enter().append("svg").attr("class",
function(a){return a.f&EVENT_INSTANT?"event instant":"event range"}).attr("y",function(a){return h.yScale(a.t)}).attr("height",h.iHt);if(1===a)w.on("click",c);var r=d3.select(h.svgID).selectAll(".range");r.append("rect").attr("width","100%").attr("height","100%").attr("fill",function(c){return 1===a&&c.f&(EVENT_F_START|EVENT_F_END)?(c.f&(EVENT_F_START|EVENT_F_END))===(EVENT_F_START|EVENT_F_END)?"url("+c.c.v+"-fb)":(c.f&EVENT_F_START)===EVENT_F_START?"url("+c.c.v+"-fs)":"url("+c.c.v+"-fe)":c.c.v});
1===a&&r.append("text").attr("class","rangeLbl").attr("x",4).attr("y",l).attr("fill",function(a){return a.c.b?"#000000":"#FFFFFF"}).style("font-size",y).text(function(a){return a.l});r=d3.select(h.svgID).selectAll(".instant");r.append("circle").attr("cx",k).attr("cy",e).attr("r",d).attr("fill",function(a){return a.c.v});1===a&&r.append("text").attr("class","instantLbl").attr("x",f).attr("y",l).style("font-size",y).text(function(a){return a.l});h.redraw=function(){z.attr("x",function(a){return h.xScale(a.s)}).attr("width",
...
[]);this.preRender();this.events=[];this.lgBds=[];var m=0;(function(){for(var e=PData.eTNum(),d=0,k,t,p,f,h,y,l,z;d<e;){for(k=a.t[d];0===k.n;){if(++d==e)return;k=a.t[d]}p=g.vFrame.getSelLocAtts(d);if(0!==p.length&&(p=g.vFrame.getSelFeatAtts(d),0!==p.length)){g.tUsed[d]=!0;z=g.vFrame.getSelLegend(d);l=PData.aByID(z);f=g.settings.dAtts[d];for(var w,r,x,u,A,D,B,E,F=[],G=k.i;G<k.i+k.n;G++)t=a.s[G],E=PData.rByN(t),h=E.a[z],"undefined"!==typeof h&&(h=PData.lRecs(h,l,p,!1))&&(y=E.a[f])&&"?"!==y&&(g.rMap[t>>
4]|=1<<(t&15),D=y.min.f?EVENT_F_START:0,w=y.min.y,"undefined"===typeof y.min.m?x=r=1:(r=y.min.m,x="undefined"===typeof y.min.d?1:y.min.d),u=PData.d3Nums(w,r,x,!1),"undefined"===typeof y.max?(D|=EVENT_INSTANT,A=u.getTime()+g.instGap):"open"===y.max?A=TODAY:(y.max.f&&(D|=EVENT_F_END),w=y.max.y,"undefined"===typeof y.max.m?(r=12,x=31):(r=y.max.m,x="undefined"===typeof y.max.d?PData.lenMnth(w,r):y.max.d),A=PData.d3Nums(w,r,x,!0)),F.push({s:u,e:A,ai:t,f:D,c:h,l:E.l,t:0}));F.sort(c);var I=[],K;F.forEach(function(a){for(K=
0;K<I.length&&!(a.e<I[K]);K++);a.t=K+m+1;I[K]=a.s});k=PData.aByID(f);k.l.forEach(function(a){B=a.d;w=B.min.y;"undefined"===typeof B.min.m?x=r=1:(r=B.min.m,x="undefined"===typeof B.min.d?1:B.min.d);u=PData.d3Nums(w,r,x,!1);"undefined"===typeof B.max.y?A=TODAY:(w=B.max.y,"undefined"===typeof B.max.m?(r=12,x=31):(r=B.max.m,x="undefined"===typeof B.max.d?PData.lenMnth(w,r):B.max.d),A=PData.d3Nums(w,r,x,!0));g.lgBds.push({s:u,e:A,t:m,h:I.length+1,d:a})});m+=I.length+1;g.events=g.events.concat(F)}d++}})();
...
VizDirectory.prototype.render=function(a){var c=this,d=PData.eTNum(),e=0,f,g,h,m,n,q,k,t=jQuery(this.frameID);t.empty();0<this.recSel.length&&(this.recSel=[]);this.preRender();this.stream=a;for(f=a.t[0];e<d;){for(;0===f.n;){if(++e===d)return;f=a.t[e]}c.tUsed[e]=!0;f=PData.eTByN(e);f=PData.tByID(f);t.append('<div class="template-label">'+f.l+'</div><table cellspacing="0" class="viz-directory" data-ti='+e+"></table>");g=t.find('table[data-ti="'+e+'"]');h=c.settings.cnt[e];k=c.sAtts[e];q="<thead><tr>";
h.forEach(function(a){var c=PData.aByID(a);q+='<th data-aid="'+a;a===k&&(q+='" class="sel');q+='">'+c.def.l+"</th>"});g.append(q+"</tr></thead><tbody></tbody>");g=g.find("tbody");f=PData.aByID(k);f=PData.rTOrder(f,c.stream,e);f.forEach(function(a){n=PData.rByN(a.i);c.rMap[a.i>>4]|=1<<(a.i&15);q='<tr data-id="'+n.id+'" data-ai='+a.i+">";h.forEach(function(a){m=n.a[a];"undefined"!==typeof m?q=(m=PData.procAttTxt(a,m))?q+("<td>"+m+"</td>"):q+"<td></td>":q+="<td></td>"});g.append(q+"</tr>")});f=a.t[++e]}};
...
VizTextStream.prototype.render=function(a){var c=this,d=PData.eTNum(),e=0,f,g,h,m,n,q,k,t,p,v,C,y,l,z,w,r,x,u=jQuery(this.frameID);u.empty();0<this.recSel.length&&(this.recSel=[]);this.preRender();r=this.settings.max-this.settings.min;for(g=a.t[0];e<d;){for(;0===g.n;){if(++e===d)return;g=a.t[e]}p=c.vFrame.getSelLocAtts(e);if(0!==p.length&&(p=c.vFrame.getSelFeatAtts(e),0!==p.length)){c.tUsed[e]=!0;v=c.vFrame.getSelLegend(e);C=PData.aByID(v);u.append('<div class="viz-textstream" data-ti='+e+"></div>");
h=u.find("div.viz-textstream[data-ti="+e+"]");f=PData.eTByN(e);f=PData.tByID(f);h.append('<div class="template-label">'+f.l+"</div>");t=c.settings.cnt[e];if(z=c.settings.sAtts[e])l=PData.aByID(z),"number"===typeof l.r.min&&"number"===typeof l.r.max?w=l.r.max-l.r.min:z=null;t&&(f=PData.aByID(c.settings.order[e]),f=PData.rTOrder(f,a,e),f.forEach(function(a){m=PData.rByN(a.i);n=m.a[v];"undefined"!==typeof n&&(y=PData.lRecs(n,C,p,!1))&&((q=m.a[t])&&(q=PData.procAttTxt(t,q)),q&&(c.rMap[a.i>>4]|=1<<(a.i&
15),z?(k=m.a[z],k="number"===typeof k?Math.floor((k-l.r.min)*r/w)+c.settings.min:c.settings.min):k=c.settings.min,x=y.b?";background-color:black":"",h.append('<div class="recitem" data-ai='+a.i+' style="color:'+y.v+x+";font-size:"+k+'px">'+q+"</div>")))}))}e++}};VizTextStream.prototype.teardown=function(){jQuery(this.frameID).off("click.vf")};
...
k=_.sortedIndex(c.bSel,d);c.bSel[k]===d?(d3.select(this).classed("obj-sel",!1),c.bSel.splice(k,1),0<e&&0==c.bSel.length&&c.vFrame.selBtns(!1)):(d3.select(this).classed("obj-sel",!0),c.bSel.splice(k,0,d),0==e&&0<c.bSel.length&&c.vFrame.selBtns(!0))})};VizStackChart.prototype.setSel=function(a){};VizStackChart.prototype.clearSel=function(){0<this.bSel.length&&(this.bSel=[],this.svg.selectAll(".block").classed("obj-sel",!1))};
...
0,t,p,f,h=[],g=null,l,z;d=a.t[0];z=c.vFrame.getSelLegend(0);l=PData.aByID(z);g=c.vFrame.getSelFeatAtts(0);0<g.length&&0<d.n&&(c.tUsed[0]=!0);a:for(;k<a.l;){for(;0===d.n||d.i+d.n===k||0===g.length;){0<h.length&&(m.children.push({ti:e,children:h}),h=[]);if(++e===PData.eTNum())break a;h=[];d=a.t[e];z=c.vFrame.getSelLegend(e);l=PData.aByID(z);g=c.vFrame.getSelFeatAtts(e);0<g.length&&0<d.n&&(c.tUsed[e]=!0)}f=a.s[k];t=PData.rByN(f);p=t.a[z];"undefined"!==typeof p&&(fData=PData.lRecs(p,l,g,!1))&&(c.rMap[f>>
...
q=0;q<g.c.length;q++){for(var k=0,m=0;m<a.c.length;m++)0<h[m][q].length&&k++;n[q]=k-1}for(var t=Array(g.c.length),q=0;q<g.c.length;q++)t[q]=0;var p=0;a.c.forEach(function(k,f){for(var y=0,l=0;l<g.c.length;l++)0<h[f][l].length&&y++;--y;var m=k.i.length*d/a.t,q=0,r=0;g.c.forEach(function(l,u){var A=h[f][u];if(0<A.length){var D=A.length*d,B=D/a.t,D=D/g.t,E=l.i.length*d/g.t;c.ints.push({i:A,c:k.c,l:k.l+" > "+l.l,x1:5+p*d/a.t+(y?(m-B)*q/y:0),x2:5+r*d/g.t+(n[u]?(E-D)*t[u]/n[u]:0),w1:B,w2:D,y1:a.y+10,y2:g.y-
1});q++;t[u]++}r+=l.i.length});p+=k.i.length})}});this.flowG.selectAll(".flow").data(c.ints).enter().append("path").attr("class","flow").attr("d",function(a){return"M "+a.x1+" "+a.y1+"  L "+(a.x1+a.w1)+" "+a.y1+" L "+(a.x2+a.w2)+" "+a.y2+" L "+a.x2+" "+a.y2+" L "+a.x1+" "+a.y1}).attr("fill",function(a){return a.c}).on("click",function(a,d){var g=c.fSel.length,h=_.sortedIndex(c.fSel,d);c.fSel[h]===d?(d3.select(this).classed("obj-sel",!1),c.fSel.splice(h,1),0<g&&0===c.fSel.length&&0===c.bSel.length&&
...
VizBrowser.prototype.render=function(a){var c=this,d=this.vFrame.getIndex();this.recSel=[];this.stream=a;this.svg.selectAll(".facet-col").remove();var e=0;this.fcts=[];this.settings.fcts.forEach(function(d,f){var g,q=PData.aByID(d);g="g"===q.def.t?[]:c.settings.gr?PData.cRNew(q,!0,!0):PData.cLNew(q,null,!0);PData.cFill(g,d,null,a);var k=[],t=0;g.forEach(function(a){0<a.i.length&&(a.n=t++,k.push(a))});c.fcts.push({c:k,x:250*f,i:f,l:q.def.l,n:q.id,s:-1});e=Math.max(e,27+22*(k.length+1))});c.svg.attr("height",
...
VizMBMap.prototype.renderTree=function(a){function c(){var a=0,c=d.settings.w,g=null!==d.sbkSel?d.sbkSel.i:d.bkSel.i;PState.set(PSTATE_UPDATE);d.fcts.forEach(function(h,m){var n=[],q=0;h.c.forEach(function(a){a=PData.intersect(g,a.i);n.push(a);q+=a.length});var k=0,t;n.forEach(function(p){t=d.bars[a++];t.x=q?k*c/q:0;t.w=q?p.length*c/q:0;k+=p.length})});d.attsG.selectAll(".bar").transition().attr("x",function(a){return a.x}).attr("width",function(a){return a.w});PState.set(PSTATE_READY)}var d=this;
...
PFilterNum.prototype.evalBoxes=function(a){function c(c,h){function k(){t=!0;a.find(c).addClass("error")}var t=!1,p,v=a.find(c).val();(v=e.exec(v))?(a.find(c).removeClass("error"),p=parseInt(v[1],10)):k();t||(0==h?null!==f&&p<f&&k():null!==g&&p>g&&k());d.uNums[h]=p;return t}var d=this,e=/^(\d+)$/,f="undefined"===typeof this.att.r.min?null:this.att.r.min,g="undefined"===typeof this.att.r.max?null:this.att.r.max,h,m;h=c(".from",0);m=c(".to",1);this.uNums[0]>this.uNums[1]&&(m=!0);a.find(".filter-update").prop("disabled",
...
PFilterDates.prototype.evalBoxes=function(a){function c(c,g){function h(d){t=!0;a.find(c+d).addClass("error")}function k(d){a.find(c+d).removeClass("error")}var t=!1,p={y:0,m:0,d:0,ms:null},v=a.find(c+"-y"),v=v.val();(v=e.exec(v))?(k("-y"),p.y=parseInt(v[1],10)):h("-y");v=a.find(c+"-m");v=v.val();(v=f.exec(v))?(p.m=parseInt(v[1],10),1>p.m||12<p.m?h("-m"):k("-m")):h("-m");v=a.find(c+"-d");v=v.val();(v=f.exec(v))?(p.d=parseInt(v[1],10),1>p.d||31<p.d?h("-d"):k("-d")):h("-d");t||(p.ms=PData.d3Nums(p.y,
p.m,p.d,!1),0==g?p.ms<d.rCats[0].min&&(h("-y"),h("-m"),h("-d")):p.ms>d.rCats[d.rCats.length-1].max&&(h("-y"),h("-m"),h("-d")));d.uDates[g]=p;return t}var d=this,e=/^(-?\d+)$/,f=/^(\d{1,2})$/,g,h;g=c(".from",0);h=c(".to",1);this.uDates[0].ms>this.uDates[1].ms&&(h=!0);a.find(".filter-update").prop("disabled",g||h);return!(g||h)};
...
(c=H.a[c])&&""!==c&&(widgetData.extract=c,c=c.split("-"),widgetData.sTime=d(c[0]),widgetData.eTime=d(c[1]))}var c=J[M];H=PData.rByN(c);var k=" "+H.l+" ("+(M+1)+"/"+J.length+") ",h=jQuery("#inspect-name");h.text(k);h.prop("title",H.id);var v=PData.n2T(c);r.empty();u=null;n=0;widgetData.extract=null;widgetData.xscriptOn=!1;widgetData.playing=!1;if(prspdata.e.i.modal.scOn||"boolean"===typeof prspdata.e.i.modal.aOn&&prspdata.e.i.modal.aOn)if(u=prspdata.e.i.sc.atts[v])if(k=H.a[u])if(a(),k.match(/soundcloud\.com/)){var A=
!0;n=1;r.append('<iframe id="sc-widget" class="player" width="100%" height="110" src="http://w.soundcloud.com/player/?url='+k+'"></iframe>');var m=SC.Widget(document.getElementById("sc-widget"));widgetData.widget=m;m.bind(SC.Widget.Events.READY,function(){m.play();m.bind(SC.Widget.Events.PLAY,function(){widgetData.playing=!0});m.bind(SC.Widget.Events.PAUSE,function(){widgetData.playing=!1});m.bind(SC.Widget.Events.PLAY_PROGRESS,function(a){A&&(m.pause(),A=!1,widgetData.playing=!1);widgetData.extract&&
(a.currentPosition<widgetData.sTime?m.seekTo(widgetData.sTime):a.currentPosition>widgetData.eTime&&(m.pause(),widgetData.playing=!1));widgetData.playing&&widgetData.xscriptOn&&f(a.currentPosition)});m.bind(SC.Widget.Events.FINISH,function(){widgetData.playing=!1})})}else n=3,widgetData.extract&&(h=widgetData.extract.split("-"),k+="#t="+h[0]+","+h[1]),r.append('<audio id="na-widget" controls src="'+k+'"></audio>'),widgetData.widget=document.getElementById("na-widget"),widgetData.widget.addEventListener("ended",
p),widgetData.widget.addEventListener("pause",p),widgetData.widget.addEventListener("playing",t),widgetData.widget.addEventListener("timeupdate",g);0===n&&prspdata.e.i.modal.ytOn&&(u=prspdata.e.i.yt.atts[v])&&(k=H.a[u])&&(a(),widgetData.ytCode=k,r.append('<div id="yt-widget"></div>'),widgetData.ytCall=l,widgetData.ytLoaded?l():(widgetData.ytLoaded=!0,k=document.createElement("script"),k.src="https://www.youtube.com/iframe_api",h=document.getElementsByTagName("script")[0],h.parentNode.insertBefore(k,
h)),n=2);prspdata.e.i.modal.tOn&&(k=prspdata.e.i.t.t1Atts[v])&&""!==k&&"disable"!==k&&(k=H.a[k],"string"===typeof k&&""!==k&&(0<n&&r.append("<div>"+document.getElementById("dltext-sync-xscript").innerHTML+"</div>"),r.find("#xscript-tbl").remove(),r.append('<div id="xscript-tbl"><div>'),widgetData.xscriptOn=!0,jQuery("#xscript-tbl").click(function(a){if(n&&jQuery(a.target).hasClass("timecode"))switch(a=jQuery(a.target).data("timecode"),n){case 1:widgetData.playing||(widgetData.playing=!0,widgetData.widget.play());
...
error:function(a,c,d){alert(d)}})));prspdata.e.i.modal.atts[v].forEach(function(a){var d=PData.rAV(c,a,!1);if(d){a=PData.aByID(a);var k;"_"==a.def.l.charAt(0)?k="<div>"+d+"</div>":(k='<div><span class="att-label">'+a.def.l+":</span> ","I"==a.def.t&&(k+="<br/>"),k+=d+"</div>");r.append(k)}})}function m(a){a=M+a;-1==a?a=J.length-1:a==J.length&&(a=0);a!=M&&(M=a,v(),y())}function z(a){m(-1)}function C(a){m(1)}var r=jQuery("#inspect-content"),u=null,n=0,q,x=450,N=400,J=null;w&&(J=w.getSel());if(null!=
J&&0!=J.length){var O,H,M=0;prspdata.e.i.modal.scOn&&(x=550);prspdata.e.i.modal.ytOn&&(x=Math.max(x,475),N=500);prspdata.e.i.modal.tOn&&(N+=100,prspdata.e.i.modal.t2On?(x=Math.max(750,Math.floor(.8*jQuery(document).width())),x=Math.min(900,x)):x=Math.max(x,550));"number"===typeof prspdata.e.i.modal.w&&(x=prspdata.e.i.modal.w);"number"===typeof prspdata.e.i.modal.h&&(N=prspdata.e.i.modal.h);h(!1);y();jQuery("#btn-inspect-left").click(z);jQuery("#btn-inspect-right").click(C);O=jQuery("#dialog-inspector").dialog({width:x,
...
a.preventDefault()}function t(a,k){jQuery(d()+' div.lgnd-container div.lgnd-scroll div.lgnd-template[data-index="'+a+'"] div.lgnd-group input.lgnd-entry-check').prop("checked",k);c(!0)}function p(a){var k=jQuery(a.target).closest("div.lgnd-template").data("index"),e=a.target.className;switch(e){case "lgnd-update":w&&u&&(PState.set(PSTATE_BUILD),h(!1),w.render(u),c(!1),PState.set(PSTATE_READY));break;case "lgnd-entry-check":e=jQuery(a.target).closest("div.lgnd-entry");a=jQuery(a.target).is(":checked");
...
(e=jQuery(a.target).find("input.lgnd-entry-check"),a=!e.is(":checked"),e.prop("checked",a),t(k,a))}}function v(a){var d=jQuery(a.target).closest("div.lgnd-template").data("index");a=jQuery(a.target).val();C(d,a);c(!0)}function C(a,c){var k,e=jQuery(d()+' div.lgnd-container div.lgnd-scroll div.lgnd-template[data-index="'+a+'"] div.lgnd-group');e.empty();r[a]=c;var l=PData.aByID(c);"undefined"!==typeof l.r.u&&(k='<div class="lgnd-value lgnd-entry" data-index="-1"><input type="checkbox" checked="checked" class="lgnd-entry-check"/><div class="lgnd-viz" style="background-color: '+
l.r.u.v+'"> </div> <span class="lgnd-value-title">'+dlText.undef+"</span></div>",e.append(k));l.l.forEach(function(a,c){k='<div class="lgnd-value lgnd-entry" data-index="'+c+'"><input type="checkbox" checked="checked" class="lgnd-entry-check"/><div class="lgnd-viz" style="background-color: '+a.v+'"> </div> <span class="lgnd-value-title">'+a.l+"</span></div>";e.append(k);a.z&&0<a.z.length&&a.z.forEach(function(a,d){k='<div class="lgnd-value lgnd-entry" data-index="'+c+","+d+'"><input type="checkbox" checked="checked" class="lgnd-entry-check"/>';
k=a.v&&""!==a.v?k+('<div class="lgnd-viz" style="background-color: '+a.v+'"></div>'):k+'<div class="lgnd-viz lgnd-viz-empty"></div>';k+=' <span class="lgnd-value-title">&raquo; '+a.l+"</span></div>";e.append(k)})});jQuery(d()+' div.lgnd-container div.lgnd-scroll div.lgnd-template[data-index="'+a+'"] div.lgnd-sh input').prop("checked",!0)}function y(k,e){var f=PData.vByN(k);w&&(w.teardown(),w=null);var p=jQuery(d());p.find("div.viz-content div.viz-result").empty();var t;switch(f.vf){case "M":t=new VizMap(l,
f.c);break;case "C":t=new VizCards(l,f.c);break;case "P":t=new VizPinboard(l,f.c);break;case "T":t=new VizTime(l,f.c);break;case "D":t=new VizDirectory(l,f.c);break;case "t":t=new VizTextStream(l,f.c);break;case "S":t=new VizStackChart(l,f.c);break;case "N":t=new VizNetWheel(l,f.c);break;case "F":t=new VizFlow(l,f.c);break;case "B":t=new VizBrowser(l,f.c);break;case "m":t=new VizMBMap(l,f.c)}z=k;var g=t.flags();g&V_FLAG_HSCRL?(p.find("div.viz-content").addClass("h-scroll"),p.find("div.viz-result").addClass("viz-fit-w"),
p.find("div.viz-result").removeClass("viz-max-w")):(p.find("div.viz-content").removeClass("h-scroll"),p.find("div.viz-result").removeClass("viz-fit-w"),p.find("div.viz-result").addClass("viz-max-w"));g&V_FLAG_VSCRL?(p.find("div.viz-content").addClass("v-scroll"),p.find("div.viz-result").addClass("viz-fit-h"),p.find("div.viz-result").removeClass("viz-max-h")):(p.find("div.viz-content").removeClass("v-scroll"),p.find("div.viz-result").removeClass("viz-fit-h"),p.find("div.viz-result").addClass("viz-max-h"));
r=[];if(g&V_FLAG_LGND){p.find(".hslgnd").button("enable");var y=p.find("div.lgnd-container div.lgnd-scroll");y.empty();if(g&V_FLAG_SLGND){var m=t.getFeatureAtts(),P=PData.aByID(m);y.append('<div class="lgnd-template" data-index="0"><div class="lgnd-title">'+P.def.l+'</div><div class="lgnd-entry lgnd-sh"><input type="checkbox" checked="checked" class="lgnd-entry-check"/><i>'+dlText.sha+'</i></div><div class="lgnd-group"></div></div>');r.push(m);C(0,m)}else{var x=!1;prspdata.e.g.ts.forEach(function(a,
c){var d=PData.tByID(a),k=t.getLocAtts(c);if(k&&0<k.length||!(g&V_FLAG_LOC)){var e=t.getFeatureAtts(c);if(0<e.length){x&&y.append("<hr/>");var f=jQuery('<div class="lgnd-template" data-index="'+c+'"><div class="lgnd-title">'+d.l+"</div></div>");k&&k.forEach(function(a,c){var d=PData.aByID(a);f.append('<div class="lgnd-entry lgnd-locate" data-id="'+a+'"><input type="checkbox" checked="checked" class="lgnd-entry-check"/><span class="lgnd-value-title">'+d.def.l+"</span></div>")});var p='<select class="lgnd-select">';
e.forEach(function(a,c){var d=PData.aByID(a);p+='<option value="'+a+'">'+d.def.l+"</option>"});p+="</select>";d=jQuery(p);d.change(v);jQuery(f).append(d);jQuery(f).append('<div class="lgnd-entry lgnd-sh"><input type="checkbox" checked="checked" class="lgnd-entry-check"/><i>'+dlText.sha+'</i></div><div class="lgnd-group"></div>');y.append(f);e=e[0];r.push(e);C(c,e);x=!0}}})}p.find("div.lgnd-container").show()}else p.find("button.hslgnd").button("disable"),p.find("div.lgnd-container").hide();c(!1);
g&V_FLAG_SEL?(p.find(".hilite").button("enable"),jQuery("#save-prspctv-h"+a).prop("disabled",!1).prop("checked",!1)):(p.find(".hilite").button("disable"),jQuery("#save-prspctv-h"+a).prop("disabled",!0).prop("checked",!1));g&V_FLAG_OPT?p.find(".vopts").button("enable"):p.find(".vopts").button("disable");(m=t.hint())||"string"===typeof f.n&&""!==f.n?(p.find(".vnote").button("enable"),m=m?"string"===typeof f.n&&""!==f.n?m+(".<br/>"+f.n):m+".":f.n,jQuery("#vnotes-txt").empty().append(m)):p.find(".vnote").button("disable");
t.setup();h(!1);u&&e&&t.render(u);w=t}var l={},z=0,w=null,r=[],x=null,u=null;l.getFrameID=d;l.getIndex=function(){return a};l.setViz=function(a,c){a!=z&&(jQuery(d()+" div.view-controls select.view-viz-select").val(a),y(a,c))};l.initDOM=function(c){var l=document.getElementById("dltext-view-controls").innerHTML;jQuery("#viz-frame").append('<div id="view-frame-'+a+'">'+l+"</div>");var l=jQuery(d()),t=prspdata.bClrs.vf;t&&0<t.length&&l.find("div.view-controls").css("background-color",t);l.find("div.lgnd-container").draggable({handle:l.find("div.lgnd-handle"),
containment:"parent"});var h=l.find("div.view-controls select.view-viz-select");prspdata.e.vf.forEach(function(a,c){h.append('<option value="'+c+'">'+a.l+"</option>")});h.val(c);h.change(e);l.find("div.view-controls button:first").button({icons:{primary:"ui-icon-bookmark"},text:!1}).click(f).next().button({icons:{primary:"ui-icon-wrench"},text:!1}).click(q).next().button({icons:{primary:"ui-icon-info"},text:!1}).click(k).next().button({icons:{primary:"ui-icon-star"},text:!1}).click(m).next().button({icons:{primary:"ui-icon-cancel"},
text:!1}).click(n).next().button({icons:{primary:"ui-icon-search"},text:!1}).click(g).next();l.find("div.lgnd-container").click(p);y(c,!1)};l.getSelLocAtts=function(a){var c=[];jQuery(d()+' div.lgnd-container div.lgnd-scroll div.lgnd-template[data-index="'+a+'"] div.lgnd-locate input:checked').each(function(){var a=jQuery(this).parent().data("id");c.push(a)});return c};l.getSelFeatAtts=function(a){var c=[],k,e;jQuery(d()+' div.lgnd-container div.lgnd-scroll div.lgnd-template[data-index="'+a+'"] div.lgnd-group div.lgnd-value input:checked').each(function(){k=
jQuery(this).parent().data("index");"number"==typeof k?c.push(k):-1!=(e=k.indexOf(","))?c.push([parseInt(k.substring(0,e),10),parseInt(k.substring(e+1),10)]):c.push(parseInt(k,10))});return c};l.getSelLegend=function(a){return r[a]};l.getLgndSels=function(){return r.slice(0)};l.setLgndSels=function(a){a.forEach(function(a,c){a&&(jQuery(d()+' div.lgnd-container div.lgnd-scroll div.lgnd-template[data-index="'+c+'"] select.lgnd-select').val(a),C(c,a))})};l.getState=function(){return w?w.getState():null};
l.setState=function(a){w&&w.setState(a)};l.showStream=function(a){u=a;w&&w.render(a);c(!1)};l.setStream=function(a){u=a};l.selBtns=function(a){h(a)};l.clearSel=function(){w&&w.clearSel();h(!1)};l.setSel=function(a){return w&&w.flags()&V_FLAG_SEL?(w.setSel(a),h(0<a.length),!0):!1};l.resize=function(){w&&w.resize()};l.title=function(){return PData.vByN(z).l};l.flushLgnd=function(){jQuery(d()).find("div.lgnd-container").css("left","10px")};l.getBMData=function(){return w?{t:w.tUsed,r:w.rMap}:null};return l}
var PData=function(){function a(a,d,e){jQuery.ajax({type:"POST",url:prspdata.ajax_url,data:{action:"prsp_get_records",tmplt_id:prspdata.t[a].id,from:d,count:e},success:function(d,f,t){f=m[a];d=JSON.parse(d);f.d=f.d?f.d.concat(d):d;f.n+=e;c()},error:function(a,c,d){alert(d)}})}function c(){for(var c=!0,e=0;e<prspdata.t.length;e++){var f=m[e].n,g=prspdata.t[e].n;if(f<g){c=!1;g-=f;a(e,f,g<d?g:d);break}}c&&(q=!0,setTimeout(function(){jQuery("body").trigger("prospect",{s:PSTATE_PROCESS})},500))}var d=
1E3,e,f,g,h=[31,28,31,30,31,30,31,31,30,31,30,31],m=[],n=0,q=!1;return{init:function(){e=document.getElementById("dltext-to").innerHTML;f=document.getElementById("dltext-approximately").innerHTML;g=document.getElementById("dltext-now").innerHTML;"number"==typeof prspdata.chunk&&0<prspdata.chunk&&(d=prspdata.chunk);prspdata.t.forEach(function(a){m.push({i:n,n:0,d:null});n+=a.n});c()},rSize:function(){return n},intersect:function(a,c){for(var d=[],e=a.length,f=c.length,g,l,h=0,m=0;h<e&&m<f;)g=a[h],
...
c:f,i:[]}):e.push({l:d.l,c:f})})}),e;case "N":if("undefined"===typeof a.r.min||"undefined"===typeof a.r.max)return null;d&&"undefined"!==typeof a.r.u&&(c?e.push({l:"?",c:a.r.u.v,min:"?",max:"?",i:[]}):e.push({l:"?",c:a.r.u.v,min:"?",max:"?"}));var f=Math.pow(10,a.r.g),g=a.r.min,l=0,h,m,r;for(0<a.l.length&&(h=a.l[0]);g<=a.r.max;){for(;l<a.l.length&&"undefined"!==typeof h.d.max&&g>h.d.max;)h=a.l[++l];r=0==a.l.length||g<h.d.min?"#777777":l===a.l.length?"#777777":"undefined"===typeof h.d.max||g<=h.d.max?
h.v:"#777777";m=g;g+=f;max=g-1;max>a.r.max&&(max=a.r.max);var x=m.toString();1<f&&4>x.length&&m!==max&&(x+="-"+max.toString());c?e.push({l:x,c:r,min:m,max:max,i:[]}):e.push({l:x,c:r,min:m,max:max})}return e;case "D":g=function(a){var c,d;if("undefined"===typeof a.y)return TODAY;c=a.y;"undefined"===typeof a.m?(d=12,a=31):(d=a.m,a="undefined"===typeof a.d?PData.lenMnth(c,d):a.d);return PData.d3Nums(c,d,a,!1)};m=function(a,c,d,e){"undefined"!==typeof e.m&&(c=e.m,"undefined"!==typeof e.d&&(d=e.d));return PData.d3Nums(a,
c,d,!1)};r=g(a.r.max);var f=a.r.g,x=a.r.min.y,u=1,n=1;"undefined"!==typeof a.r.min.m&&(u=a.r.min.m,"undefined"!==typeof a.r.min.d&&(n=a.r.min.d));var q=PData.d3Nums(x,u,n,!1),l=0,B,E;0<a.l.length&&(h=a.l[0],B=m(h.d.min.y,1,1,h.d.min),E=g(h.d.max));for(d&&"undefined"!==typeof a.r.u&&(c?e.push({l:"?",c:a.r.u.v,min:"?",max:"?",i:[]}):e.push({l:"?",c:a.r.u.v,min:"?",max:"?"}));q<=r;){d={};c&&(d.i=[]);switch(f){case "d":d.l=x.toString()+"-"+u.toString()+"-"+n.toString();break;case "m":d.l=x.toString()+
"-"+u.toString();break;case "y":case "t":case "c":d.l=x.toString()}for(;l<a.l.length&&q>E;)h=a.l[++l],l<a.l.length&&(B=m(h.d.min.y,1,1,h.d.min),E=g(h.d.max));d.c=0==a.l.length||q<B?"#777777":l==a.l.length?"#777777":q<=E?h.v:"#777777";d.min=q;switch(f){case "d":++n>PData.lenMnth(x,u)&&(n=1,12<++u&&(u=1,x++));break;case "m":12<++u&&(u=1,x++);break;case "y":x++;break;case "t":x+=10;break;case "c":x+=100}q=PData.d3Nums(x,u,n,!1);q>TODAY&&(q=TODAY);q.setTime(q.getTime()+10);d.max=q;e.push(d);q=PData.d3Nums(x,
u,n,!1)}return e}},cFill:function(a,c,d,e){var f=PData.eTNum(),g=0,h,m=0,q,r,n,u,A=PData.aByID(c);for(h=e.t[0];m<e.l;){for(;0==h.n||h.i+h.n==m||!PData.aInT(c,g)||d&&!PData.aInT(d,g);){if(++g==f)return;h=e.t[g];m=h.i}q=e.s[m];r=PData.rByN(q);r=r.a[c];if("undefined"!==typeof r)switch(A.def.t){case "T":for(n=0;n<a.length;n++)if(u=a[n],-1!==r.indexOf(u.x)){u.i.push(q);break}break;case "g":r.forEach(function(c){for(n=0;n<a.length;n++)if(u=a[n],c===u.l){u.i.push(q);break}n===a.length&&a.push({l:c,i:[q],
c:"#"+Math.floor(16777215*Math.random()).toString(16)})});break;case "V":r.forEach(function(c){for(n=0;n<a.length;n++)if(u=a[n],c==u.l){u.i.push(q);break}});break;case "N":n=0;u=a[0];if("?"===u.min){if("?"===r){u.i.push(q);break}n=1}if("?"===r)break;for(;n<a.length;n++){u=a[n];if(r<u.min)break;if(u.min<=r&&r<=u.max){u.i.push(q);break}}break;case "D":n=0;u=a[0];if("?"===u.min){if("?"===r){u.i.push(q);break}n=1}if("?"!==r)for(r=PData.dObj(r.min,1,!1);n<a.length;n++){u=a[n];if(r<u.min)break;if(u.min<=
r&&r<u.max){u.i.push(q);break}}}m++}"g"==A.def.t&&a.sort(function(a,c){return PData.strcmp(c.l,a.l)})},cSort:function(a,c,d){var e=c.id,f,g,h;a.forEach(function(a){f=PData.rByN(a);datum=f.a[e];if("undefined"!==typeof datum)switch(c.def.t){case "T":for(g=0;g<d.length;g++)if(h=d[g],-1!==datum.indexOf(h.x)){h.i.push(a);break}break;case "g":datum.forEach(function(c){for(g=0;g<d.length;g++)if(h=d[g],c===h.l){h.i.push(a);break}g===d.length&&d.push({l:c,i:[a],c:"#777777"})});break;case "V":datum.forEach(function(c){for(g=
...
c){return PData.strcmp(c.l,a.l)})},rTOrder:function(a,c,d){function e(a){return a}function f(a){return a[0]}function g(a){if("?"===a)return"?";var c=1,d=1;"undefined"!==typeof a.min.m&&(c=a.min.m,"undefined"!==typeof a.min.d&&(d=a.min.d));return PData.d3Nums(a.min.y,c,d,!1)}var h,n;switch(a.def.t){case "T":h=e;n="~";break;case "V":h=f;n="~";break;case "g":h=f;n="~";break;case "N":h=e;n=a.r.max;break;case "D":h=g,n=TODAY}var q=[],r=c.t[d];d=m[d];for(var x=0,u,A;x<r.n;)u=c.s[r.i+x++],A=d.d[u-d.i],A=
A.a[a.id],"undefined"===typeof A?q.push({i:u,v:n}):q.push({i:u,v:h(A)});switch(a.def.t){case "T":case "g":case "V":q.sort(function(a,c){return PData.strcmp(c.v,a.v)});break;case "D":case "N":q.sort(function(a,c){return"?"===a.v?-1:"?"===c.v?1:a.v-c.v})}return q},vByN:function(a){return prspdata.e.vf[a]},ready:function(){return q}}}();
jQuery(document).ready(function(a){function c(){var a;PState.set(PSTATE_PROCESS);null==u&&(u=PData.sNew(!0));A=u;var c=!1,d,e;for(d=0;d<w.length;d++)if(e=w[d],a=jQuery('div.filter-instance[data-id="'+e.id+'"]'),c||e.f.isDirty(null)){c=!0;e=e.f;e.evalPrep();for(var f=PData.sNew(!1),g=0,h,k,m=0,n=A.t[0],p=0,q=0,r=a.find(".apply-tmplt-0").is(":checked");g<A.l;){for(;0==n.n||n.i+n.n==g;)f.t.push({i:f.l-p,n:p}),p=0,n=A.t[++m],r=a.find(".apply-tmplt-"+m).is(":checked");h=A.s[g++];r?(k=PData.rByN(h),e.eval(k)&&
(f.s[f.l++]=h,p++),q++):(f.s[f.l++]=h,p++)}for(;m++<PData.eTNum();)f.t.push({i:f.l-p,n:p}),p=0;e.isDirty(!1);e.out=f;e.evalDone(q);A=f}else A=e.f.out;PState.set(PSTATE_BUILD);l.forEach(function(a){a&&a.showStream(A)});0<w.length?jQuery("#btn-f-state").prop("disabled",!0).html(dlText.filtered):jQuery("#btn-f-state").prop("disabled",!0).html(dlText.nofilter)}function d(a){var c=jQuery("#annote");c.text(a);0<a.length?(jQuery("#btn-annote").button("enable"),c.show()):(jQuery("#btn-annote").button("disable"),
c.hide())}function e(a){var c=_.find(prspdata.p,function(c){return a==c.id});return c?c:null==D||0==B.length?null:(c=_.find(B,function(c){return a==c.id}))?c:null}function f(a,c){var d=jQuery("input[name=save-prspctv-dest]:checked").val();if(""==d)return null;var e=jQuery("#save-prspctv-note").val(),e=e.replace(/"/g,""),f={f:[],h0:null,h1:null,v0:null,v1:null};l.forEach(function(a,c){a&&(f["v"+c]={l:a.title(),s:a.getState()})});w.forEach(function(a){for(var c=[],d=jQuery('div.filter-instance[data-id="'+
a.id+'"]'),e=0;e<PData.eTNum();e++)c.push(d.find(".apply-tmplt-"+e).is(":checked"));f.f.push({id:a.attID,a:c,s:a.f.getState()})});for(var g=0;2>g;g++){var h=r[g];null!==h&&jQuery("#save-prspctv-h"+g).is(":checked")&&(f["h"+g]={id:x[g],s:h.getState()})}var k={id:a,l:c,n:e,s:f};"local"==d?(B.push(k),D.setItem(prspdata.e.id,JSON.stringify(B))):"server"==d&&jQuery.ajax({type:"POST",url:prspdata.ajax_url,data:{action:"prsp_save_prspctv",id:a,l:c,x:prspdata.e.id,n:e,s:JSON.stringify(f)},success:function(a,
...
title:f.title(),apply:z}));d=jQuery('div.filter-instance[data-id="'+e+'"]');for(a=0;a<PData.eTNum();a++){var h=d.find(".apply-tmplt-"+a);h.prop("disabled",!g.t[a]);h.prop("checked",c[a]&&g.t[a]);h.click(n)}d.find("button.btn-filter-toggle").button({text:!1,icons:{primary:"ui-icon-carat-2-n-s"}}).click(m);d.find("button.btn-filter-del").button({text:!1,icons:{primary:"ui-icon-trash"}}).click(q);jQuery("#btn-f-state").prop("disabled",!1).html(dlText.dofilters)}f.setup();return f}function t(a,c,d,e){jQuery("#filter-list li").removeClass("selected");
...
function p(a){PState.set(PSTATE_PROCESS);var c=l[a],d=c.getBMData(),e=[];a=r[a];if(null!==A){a.evalPrep();var f=0,g,h,k=0,m=A.t[0];a:for(;f<A.l;){for(;!d.t[k]||0==m.n||m.i+m.n==f;){if(++k===PData.eTNum())break a;m=A.t[k];f=m.i}g=A.s[f++];d.r[g>>4]&1<<(g&15)&&(h=PData.rByN(g),a.eval(h)&&e.push(g))}a.evalDone(A.l)}PState.set(PSTATE_UPDATE);0<e.length?c.setSel(e):c.clearSel();PState.set(PSTATE_READY)}function v(a,c){var d;d=jQuery("#dialog-hilite-"+a).dialog({height:275,width:Math.min(jQuery(window).width()-
20,675),modal:!0,appendTo:"#dialog-1",buttons:[{text:dlText.chsatt,click:function(){t(!1,!0,c,function(c){x[a]=c;r[a]=k(c,null,a)})}},{text:dlText.ok,click:function(){d.dialog("close");null!==r[a]&&p(a)}},{text:dlText.cancel,click:function(){d.dialog("close")}}]})}function C(a){function f(a){return prspdata.e.vf.findIndex(function(c){return a==c.l})}a=e(a);if(null==a)return!1;PState.set(PSTATE_PROCESS);jQuery("#filter-frame").hide();w.forEach(function(a){a.f.teardown()});w=[];jQuery("#filter-instances").empty();
a.s.f.forEach(function(a){k(a.id,a.a,null).setState(a.s)});jQuery("#filter-instances").hide();jQuery("#btn-toggle-filters").button(0==a.s.f.length?"disable":"enable");for(var g=0;2>g;g++)if(null!=a.s["h"+g]){var h=a.s["h"+g];x[g]=h.id;var m=k(h.id,null,g);r[g]=m;m.setState(h.s)}else r[g]=null,x[g]=null;var h=l[0],m=l[1],n=!1;PState.set(PSTATE_BUILD);g=f(a.s.v0.l);h?(h.setViz(g,!1),h.selBtns(!1)):(l[0]=PViewFrame(0),h=l[0],h.initDOM(g));null!==a.s.v1?(g=f(a.s.v1.l),m?(m.selBtns(!1),m.setViz(g,!1),
m.setState(a.s.v1.s)):(h.flushLgnd(),l[1]=PViewFrame(1),m=l[1],m.initDOM(g),m.setState(a.s.v1.s),n=!0)):m&&(l[1]=null,jQuery("#view-frame-1").remove(),n=!0);n&&h.resize();h.setState(a.s.v0.s);d(a.n);if(PData.ready()&&u)for(c(),g=0;2>g;g++)null!==x[g]&&p(g);return!0}function y(a,c){var d=prspdata.bClrs[a];d&&0<d.length&&jQuery(c).css("background-color",d)}var l=[null,null],z,w=[],r=[null,null],x=[null,null],u,A,D=null,B=[];jQuery("body").addClass("waiting");y("cb","#command-bar");y("fs","#filter-frame");
...
d){switch(d.s){case PSTATE_PROCESS:PState.set(PSTATE_PROCESS);c();for(var e=0;2>e;e++)null!==r[e]&&p(e);PState.set(PSTATE_READY);jQuery("body").removeClass("waiting");break;case PSTATE_FDIRTY:jQuery("#btn-f-state").prop("disabled",!1).html(dlText.dofilters);break;case PSTATE_HILITE:v(d.v,d.t)}});PState.set(PSTATE_LOAD);PData.init()});function onYouTubeIframeAPIReady(){widgetData.ytCall&&widgetData.ytCall()};