...
var f=this.lineLayer;f.clearLayers();var g=PData.eTNum(),h=0,m,p=0,n,k,t,q,v,C,y,l,A,u,r,w,x,z,D,B,E;z=this.settings.min;"string"===typeof z&&(z=parseInt(z));p=this.settings.max;"string"===typeof p&&(p=parseInt(p));D=p-z;for(h=0;h<g;h++)this.tLCnt[h]=0;for(var F,h=0;h<g;h++)if("disable"!==this.settings.pAtts[h]){F=[];break}h=0;p=-1;a:for(;h<a.l;){if(null==C){do{if(++p==g)break a;n=a.t[p]}while(0===n.n||n.i+n.n===h);C=this.vFrame.getSelLocAtts(p);if(0===C.length){C=null;continue}y=d.vFrame.getSelFeatAtts(p);
if(0===y.length){C=null;continue}d.tLCnt[p]=C.length;d.tUsed[p]=!0;q=d.vFrame.getSelLegend(p);v=PData.aByID(q);l=d.settings.pAtts[p];k=d.settings.lClrs[p];if(w=d.settings.sAtts[p])x=PData.aByID(w),"number"===typeof x.r.min&&"number"===typeof x.r.max?(B=x.r.min,E=x.r.max-B):w=null}m=a.s[h];t=PData.rByN(m);var G;F&&(G={id:t.id,c:[],p:t.a[l],l:k});C.forEach(function(a){if(A=t.a[a])if(u=t.a[q],"undefined"!==typeof u&&(u=PData.lClr(u,v,y))){d.rMap[m>>4]|=1<<(m&15);if("number"===typeof A[0])w?(x=t.a[w],
x="number"===typeof x?Math.floor((x-B)*D/E)+z:z):x=z,r=L.circleMarker(A,{_aid:m,weight:1,radius:x,fillColor:u,color:"#000",opacity:1,fillOpacity:1}),G&&G.c.push(A);else if(r=2===A.length?L.polyline(A,{_aid:m,weight:1,fillColor:u,color:"#000",opacity:1,fillOpacity:1}):L.polygon(A,{_aid:m,weight:1,fillColor:u,color:"#000",opacity:1,fillOpacity:1}),G){var k=[0,0];A.forEach(function(a){k[0]+=a[0];k[1]+=a[1]});k[0]/=A.length;k[1]/=A.length;G.c.push(k)}r.on("click",c);e.addLayer(r)}});G&&0<G.c.length&&
F.push(G);++h==n.i+n.n&&(C=null)}if(F){F.sort(function(a,c){return PData.strcmp(c.id,a.id)});var I=[];F.forEach(function(a){a.p&&a.p.forEach(function(c){h=_.sortedIndex(F,{id:c},"id");if(h<F.length){var k=F[h];k.id===c&&a.c.forEach(function(c){k.c.forEach(function(k){c[0]===k[0]&&c[1]===k[1]||I.push({p:[c,k],c:a.l})})})}})});I.forEach(function(a){f.addLayer(L.polyline(a.p,{color:a.c,weight:2}))})}};VizMap.prototype.teardown=function(){var a=this.vFrame.getIndex();jQuery("#view-frame-"+a+" div.view-controls div.iconbar").remove()};
...
VizMap.prototype.doOptions=function(){var a=this,c=jQuery("#dialog-opacities div.layer-list");c.empty();var d=jQuery('<div class="op-layer" data-i="-1">Base Map <input type=range class="op-slider" min=0 max=100 value='+this.bOp+" step=5></div>");c.append(d);_.each(this.settings.lyrs,function(e,g){d=jQuery('<div class="op-layer" data-i="'+g+'">'+a.mapLayers[g].options.layerName+' <input type=range class="op-slider" min=0 max=100 value='+a.lOps[g]+" step=5></div>");c.append(d)});var e=jQuery("#dialog-opacities").dialog({height:300,
width:500,modal:!0,buttons:[{text:dlText.ok,click:function(){e.dialog("close");var c,d;a.bOp=c=jQuery('.op-layer[data-i="-1"] .op-slider').val();a.baseMap.setOpacity(c/100);d=a.settings.lyrs.length;for(var h=0;h<d;h++)c=jQuery('.op-layer[data-i="'+h+'"] .op-slider').val(),a.lOps[h]=c,a.mapLayers[h].setOpacity(c/100)}},{text:dlText.cancel,click:function(){e.dialog("close")}}]})};var VizCards=function(a,c){PVizModel.call(this,a,c)};VizCards.prototype=Object.create(PVizModel.prototype);
VizCards.prototype.constructor=VizCards;VizCards.prototype.flags=function(){return V_FLAG_LGND|V_FLAG_SEL|V_FLAG_VSCRL|V_FLAG_OPT};VizCards.prototype.getFeatureAtts=function(a){return null!=a?this.settings.lgnds[a]:this.settings.lgnds};
...
VizCards.prototype.render=function(a){var c=this;this.stream=a;var d=PData.eTNum(),e,f,g,h,m,p,n,k,t,q,v,C,y,l,A=jQuery(this.frameID);A.empty();0<this.recSel.length&&(this.recSel=[]);this.preRender();var u,r="w"+this.settings.w+" h"+this.settings.h;f=a.t[0];for(e=0;e<d;){for(;0===f.n;){if(++e===d)return;f=a.t[e]}f=PData.eTByN(e);f=PData.tByID(f);p=c.vFrame.getSelFeatAtts(e);0!==p.length&&(A.append('<div class="template-label">'+f.l+'</div><div class="cards" data-ti="'+e+'"></div>'),u=jQuery('div.cards[data-ti="'+
e+'"]'),this.tUsed[e]=!0,g=c.vFrame.getSelLegend(e),h=PData.aByID(g),m=c.settings.iAtts[e],q=c.settings.cnt[e],f=c.sAtts[e],f=PData.aByID(f),f=PData.rTOrder(f,a,e),f.forEach(function(a){n=PData.rByN(a.i);v=n.a[g];"undefined"!==typeof v&&(k=PData.lRecs(v,h,p,!1))&&(c.rMap[a.i>>4]|=1<<(a.i&15),y=c.settings.lOn?'<div class="card-title">'+n.l+"</div>":"",t=!1,C="",q&&0<q.length&&(l=k.b?' style="color:black"':"",q.forEach(function(a){if(v=n.a[a])if(v=PData.procAttTxt(a,v))t=!0,C+=v+"<br/>"})),C=m&&(v=
n.a[m])?t?'<div class="card-body"><img src="'+v+'"/><div class="card-cnt"'+l+">"+C+"</div></div>":'<div class="card-body"><img class="full" src="'+v+'"/></div>':'<div class="card-body"><div class="card-cnt"'+l+">"+C+"</div>",u.append('<div class="card '+r+'" style="background-color:'+k.v+'" data-ai="'+a.i+'">'+y+C+"</div>"))}));f=a.t[++e]}};VizCards.prototype.teardown=function(){jQuery(this.frameID).off("click.vf")};
VizCards.prototype.rerender=function(a){var c=this,d=jQuery(this.frameID+' div.cards[data-ti="'+a+'"]');d.empty();var e,f,g,h,m,p,n,k,t,q,v,C,y,l="w"+this.settings.w+" h"+this.settings.h;e=c.vFrame.getSelFeatAtts(a);0!=e.length&&(f=c.vFrame.getSelLegend(a),g=PData.aByID(f),h=c.settings.iAtts[a],m=c.settings.cnt[a],p=c.sAtts[a],p=PData.aByID(p),a=PData.rTOrder(p,c.stream,a),a.forEach(function(a){n=PData.rByN(a.i);k=n.a[f];"undefined"!==typeof k&&(t=PData.lRecs(k,g,e,!1))&&(C=c.settings.lOn?'<div class="card-title">'+
n.l+"</div>":"",q=!1,v="",m&&0<m.length&&(y=t.b?' style="color:black"':"",m.forEach(function(a){if(k=n.a[a])if(k=PData.procAttTxt(a,k))q=!0,v+=k+"<br/>"})),v=h&&(k=n.a[h])?q?'<div class="card-body"><img src="'+k+'"/><div class="card-cnt"'+y+">"+v+"</div></div>":'<div class="card-body"><img class="full" src="'+k+'"/></div>':'<div class="card-body"><div class="card-cnt"'+y+">"+v+"</div>",d.append('<div class="card '+l+(c.isSel(a.i)?" obj-sel":"")+'" style="background-color:'+t.v+'" data-ai="'+a.i+'">'+
C+v+"</div>"))}))};VizCards.prototype.doOptions=function(){var a=this;this.sAtts.forEach(function(a,c){jQuery('#dialog-sortby select[data-ti="'+c+'"]').val(a)});var c=jQuery("#dialog-sortby").dialog({height:220,width:400,modal:!0,buttons:[{text:dlText.ok,click:function(){c.dialog("close");PState.set(PSTATE_BUILD);for(var d=0;d<PData.eTNum();d++){var e=jQuery('#dialog-sortby select[data-ti="'+d+'"]').val();e!=a.sAtts[d]&&(a.sAtts[d]=e,a.rerender(d))}PState.set(PSTATE_READY)}},{text:dlText.cancel,click:function(){c.dialog("close")}}]})};
...
VizPinboard.prototype.render=function(a){var c=this;this.gRecs.selectAll(".recobj").remove();this.gRecs.selectAll(".recline").remove();0<this.recSel.length&&(this.recSel=[]);this.preRender();var d=PData.eTNum(),e,f,g=0,h,m,p,n,k,t,q,v,C,y,l,A,u,r,w,x;for(e=0;e<d;e++)if("disable"!==this.settings.pAtts[e]){x=[];break}A=this.settings.min;"string"===typeof A&&(A=parseInt(A));f=this.settings.max;"string"===typeof f&&(f=parseInt(f));u=f-A;var z=[];e=0;g=-1;a:for(;e<a.l;){if(null==t){do{if(++g===d)break a;
h=a.t[g]}while(0===h.n||h.i+h.n===e);t=this.vFrame.getSelLocAtts(g);if(0===t.length){t=null;continue}t=t[0];q=c.vFrame.getSelFeatAtts(g);if(0===q.length){t=null;continue}c.tUsed[g]=!0;n=c.vFrame.getSelLegend(g);k=PData.aByID(n);v=c.settings.pAtts[g];m=c.settings.lClrs[g];if(l=c.settings.sAtts[g])p=PData.aByID(l),"number"===typeof p.r.min&&"number"===typeof p.r.max?(r=p.r.min,w=p.r.max-r):l=null}f=a.s[e];p=PData.rByN(f);var D;x&&(D={id:p.id,c:null,p:p.a[v],l:m});C=p.a[t];"undefined"!==typeof C&&(y=
p.a[n],"undefined"!==typeof y&&(y=PData.lClr(y,k,q)))&&(c.rMap[f>>4]|=1<<(f&15),l?(p=p.a[l],p="number"===typeof p?Math.floor((p-r)*u/w)+A:A):p=A,z.push({ai:f,v:y,x:C[0],y:C[1],r:p}),D&&(D.c=C));D&&D.c&&x.push(D);++e==h.i+h.n&&(t=null)}this.gRecs.selectAll(".recobj").data(z).enter().append("circle").attr("class","recobj").attr("cx",function(a){return c.xScale(a.x)}).attr("cy",function(a){return c.yScale(a.y)}).attr("r",function(a){return c.yScale(a.r)}).style("fill",function(a){return a.v}).on("click",
function(a,k){var d=c.toggleSel(a.ai);d3.select(this).classed("obj-sel",d)});if(x){x.sort(function(a,c){return PData.strcmp(c.id,a.id)});var B=[];x.forEach(function(a){a.p&&a.p.forEach(function(c){e=_.sortedIndex(x,{id:c},"id");if(e<x.length){var k=x[e];k.id===c&&B.push({f:a.c,t:k.c,c:a.l})}})});this.gRecs.selectAll(".recline").data(B).enter().append("line").attr("class","recline").attr("x1",function(a){return c.xScale(a.f[0])}).attr("y1",function(a){return c.yScale(a.f[1])}).attr("x2",function(a){return c.xScale(a.t[0])}).attr("y2",
...
VizPinboard.prototype.doOptions=function(){var a=this,c=this.vFrame.getIndex(),d=jQuery("#dialog-opacities div.layer-list");d.empty();var e=jQuery('<div class="op-layer" data-i="-1">Base Image <input type=range class="op-slider" min=0 max=100 value='+this.bOp+" step=5></div>");d.append(e);this.lOps.forEach(function(a,c){e=jQuery('<div class="op-layer" data-i="'+c+'">Overlay '+(c+1)+' <input type=range class="op-slider" min=0 max=100 value='+a+" step=5></div>");d.append(e)});var f=jQuery("#dialog-opacities").dialog({height:300,
width:320,modal:!0,buttons:[{text:dlText.ok,click:function(){f.dialog("close");var d,e;a.bOp=d=jQuery('.op-layer[data-i="-1"] .op-slider').val();d3.select("#base-"+c).attr("opacity",d/100);e=a.settings.lyrs.length;for(var m=0;m<e;m++)a.lOps[m]=d=jQuery('.op-layer[data-i="'+m+'"] .op-slider').val(),d3.select("#ol-"+c+"-"+m).attr("opacity",d/100)}},{text:dlText.cancel,click:function(){f.dialog("close")}}]})};VizPinboard.prototype.getState=function(){return{l:this.vFrame.getLgndSels()}};
VizPinboard.prototype.setState=function(a){this.vFrame.setLgndSels(a.l)};VizPinboard.prototype.hint=function(){for(var a="",c=PData.eTNum(),d=0;d<c;d++){var e=this.settings.sAtts[d];if(e)var a=0===a.length?dlText.markersize:a+",",e=PData.aByID(e),f=PData.eTByN(d),f=PData.tByID(f),a=a+(" "+e.def.l+" ("+f.l+")")}return 0<a.length?a:null};var VizTime=function(a,c){PVizModel.call(this,a,c)};VizTime.prototype=Object.create(PVizModel.prototype);VizTime.prototype.constructor=VizTime;
VizTime.prototype.flags=function(){return V_FLAG_LGND|V_FLAG_SEL|V_FLAG_LOC|V_FLAG_VSCRL};VizTime.prototype.getFeatureAtts=function(a){return null!=a?this.settings.lgnds[a]:this.settings.lgnds};VizTime.prototype.getLocAtts=function(a){return null!=a?(a=this.settings.dAtts[a],null==a?null:[a]):[this.settings.dAtts]};VizTime.prototype.getWidths=function(){var a=[],c=jQuery(this.frameID).width();a.push(c);c-=4;a.push(c);this.threshold=c/(6.25*this.settings.xLbl);return a};
...
e.settings.xLbl).attr("height",k);var q=d.append("text").attr("class","bMinMaxLbl").attr("id",function(a){return"txt-"+a.name}).attr("x",function(a){return a.x()+a.tDelta}).attr("y",12).attr("text-anchor",function(a){return a.anchor}),v={redraw:function(){var a=c.xScale.domain(),k=a[0],d=a[1];q.text(function(a){return a.whichDate(k,d).getUTCFullYear()})}};c.parts.push(v);e.cmpnts.push(v);if(1===a){var f=d.append("text").attr("class","bMinMaxLbl").attr("id",function(a){return"m-txt-"+a.name}).attr("x",
...
VizTime.prototype.render=function(a){function c(a,c){var k=a.s-c.s;if(0>k)return 1;if(0<k)return-1;k=c.e-a.e;return 0>k?1:0<k?-1:0}function d(a){function c(a){a=g.toggleSel(a.ai);d3.select(this).classed("obj-sel",a)}var k,d,e,f,h=g.bands[a];a?(k=g.bands[0],h.t=k.t+k.h+37,k=d=e=g.instRad,f=2*g.instRad+3):(h.t=0,k=d=e=1);h.h=m*h.tHt+2;h.g.attr("transform","translate(0,"+h.t+")").attr("height",h.h);var y,l;a&&(y=.75*h.iHt+"px",l=.8*h.iHt);var A;A=d3.select(h.svgID).selectAll(".lgBd").remove();A=d3.select(h.svgID).selectAll(".lgBd").data(g.lgBds).enter().append("svg").attr("class",
"lgBd").attr("y",function(a){return h.yScale(a.t)}).attr("height",function(a){return h.yScale(a.h)});A.append("rect").attr("width","100%").attr("height","100%").attr("fill",function(a){return a.d.v});1===a&&A.append("text").attr("class","lgBdLbl").attr("x",2).attr("y",l).attr("fill",function(a){return a.d.b?"#000000":"#FFFFFF"}).style("font-size",y).text(function(a){return a.d.l});var u;d3.select(h.svgID).selectAll(".event").remove();u=d3.select(h.svgID).selectAll(".event").data(g.events).enter().append("svg").attr("class",
function(a){return a.f&EVENT_INSTANT?"event instant":"event range"}).attr("y",function(a){return h.yScale(a.t)}).attr("height",h.iHt);if(1===a)u.on("click",c);var r=d3.select(h.svgID).selectAll(".range");r.append("rect").attr("width","100%").attr("height","100%").attr("fill",function(c){return 1===a&&c.f&(EVENT_F_START|EVENT_F_END)?(c.f&(EVENT_F_START|EVENT_F_END))===(EVENT_F_START|EVENT_F_END)?"url("+c.c.v+"-fb)":(c.f&EVENT_F_START)===EVENT_F_START?"url("+c.c.v+"-fs)":"url("+c.c.v+"-fe)":c.c.v});
1===a&&r.append("text").attr("class","rangeLbl").attr("x",4).attr("y",l).attr("fill",function(a){return a.c.b?"#000000":"#FFFFFF"}).style("font-size",y).text(function(a){return a.l});r=d3.select(h.svgID).selectAll(".instant");r.append("circle").attr("cx",k).attr("cy",d).attr("r",e).attr("fill",function(a){return a.c.v});1===a&&r.append("text").attr("class","instantLbl").attr("x",f).attr("y",l).style("font-size",y).text(function(a){return a.l});h.redraw=function(){A.attr("x",function(a){return h.xScale(a.s)}).attr("width",
function(a){return h.xScale(a.e)-h.xScale(a.s)});u.attr("x",function(a){return h.xScale(a.s)}).attr("width",function(a){return h.xScale(a.e)-h.xScale(a.s)});h.parts.forEach(function(a){a.redraw()})}}function e(a){a=g.bands[a];d3.select(a.svgID).selectAll(".axis").attr("transform","translate(0,"+a.h+")")}function f(a){a=g.bands[a];d3.select(a.svgID).selectAll(".bLblCntr").attr("transform","translate(0,"+(a.h+1).toString()+")")}var g=this,h=this.vFrame.getIndex();0<this.recSel.length&&(this.recSel=
[]);this.preRender();this.events=[];this.lgBds=[];var m=0;(function(){for(var d=PData.eTNum(),e=0,k,t,q,f,h,y,l,A;e<d;){for(k=a.t[e];0===k.n;){if(++e==d)return;k=a.t[e]}q=g.vFrame.getSelLocAtts(e);if(0!==q.length&&(q=g.vFrame.getSelFeatAtts(e),0!==q.length)){g.tUsed[e]=!0;A=g.vFrame.getSelLegend(e);l=PData.aByID(A);f=g.settings.dAtts[e];for(var u,r,w,x,z,D,B,E,F=[],G=k.i;G<k.i+k.n;G++)t=a.s[G],E=PData.rByN(t),h=E.a[A],"undefined"!==typeof h&&(h=PData.lRecs(h,l,q,!1))&&(y=E.a[f])&&"?"!==y&&(g.rMap[t>>
4]|=1<<(t&15),D=y.min.f?EVENT_F_START:0,u=y.min.y,"undefined"===typeof y.min.m?w=r=1:(r=y.min.m,w="undefined"===typeof y.min.d?1:y.min.d),x=PData.d3Nums(u,r,w,!1),"undefined"===typeof y.max?(D|=EVENT_INSTANT,z=x.getTime()+g.instGap):"open"===y.max?z=TODAY:(y.max.f&&(D|=EVENT_F_END),u=y.max.y,"undefined"===typeof y.max.m?(r=12,w=31):(r=y.max.m,w="undefined"===typeof y.max.d?PData.lenMnth(u,r):y.max.d),z=PData.d3Nums(u,r,w,!0)),F.push({s:x,e:z,ai:t,f:D,c:h,l:E.l,t:0}));F.sort(c);var I=[],K;F.forEach(function(a){for(K=
0;K<I.length&&!(a.e<I[K]);K++);a.t=K+m+1;I[K]=a.s});k=PData.aByID(f);k.l.forEach(function(a){B=a.d;u=B.min.y;"undefined"===typeof B.min.m?w=r=1:(r=B.min.m,w="undefined"===typeof B.min.d?1:B.min.d);x=PData.d3Nums(u,r,w,!1);"undefined"===typeof B.max.y?z=TODAY:(u=B.max.y,"undefined"===typeof B.max.m?(r=12,w=31):(r=B.max.m,w="undefined"===typeof B.max.d?PData.lenMnth(u,r):B.max.d),z=PData.d3Nums(u,r,w,!0));g.lgBds.push({s:x,e:z,t:m,h:I.length+1,d:a})});m+=I.length+1;g.events=g.events.concat(F)}e++}})();
...
VizDirectory.prototype.render=function(a){var c=this,d=PData.eTNum(),e=0,f,g,h,m,p,n,k,t=jQuery(this.frameID);t.empty();0<this.recSel.length&&(this.recSel=[]);this.preRender();this.stream=a;for(f=a.t[0];e<d;){for(;0===f.n;){if(++e===d)return;f=a.t[e]}c.tUsed[e]=!0;f=PData.eTByN(e);f=PData.tByID(f);t.append('<div class="template-label">'+f.l+'</div><table cellspacing="0" class="viz-directory" data-ti='+e+"></table>");g=t.find('table[data-ti="'+e+'"]');h=c.settings.cnt[e];k=c.sAtts[e];n="<thead><tr>";
h.forEach(function(a){var c=PData.aByID(a);n+='<th data-aid="'+a;a===k&&(n+='" class="sel');n+='">'+c.def.l+"</th>"});g.append(n+"</tr></thead><tbody></tbody>");g=g.find("tbody");f=PData.aByID(k);f=PData.rTOrder(f,c.stream,e);f.forEach(function(a){p=PData.rByN(a.i);c.rMap[a.i>>4]|=1<<(a.i&15);n='<tr data-id="'+p.id+'" data-ai='+a.i+">";h.forEach(function(a){m=p.a[a];"undefined"!==typeof m?n=(m=PData.procAttTxt(a,m))?n+("<td>"+m+"</td>"):n+"<td></td>":n+="<td></td>"});g.append(n+"</tr>")});f=a.t[++e]}};
...
VizTextStream.prototype.render=function(a){var c=this,d=PData.eTNum(),e=0,f,g,h,m,p,n,k,t,q,v,C,y,l,A,u,r,w,x=jQuery(this.frameID);x.empty();0<this.recSel.length&&(this.recSel=[]);this.preRender();r=this.settings.max-this.settings.min;for(g=a.t[0];e<d;){for(;0===g.n;){if(++e===d)return;g=a.t[e]}q=c.vFrame.getSelLocAtts(e);if(0!==q.length&&(q=c.vFrame.getSelFeatAtts(e),0!==q.length)){c.tUsed[e]=!0;v=c.vFrame.getSelLegend(e);C=PData.aByID(v);x.append('<div class="viz-textstream" data-ti='+e+"></div>");
h=x.find("div.viz-textstream[data-ti="+e+"]");f=PData.eTByN(e);f=PData.tByID(f);h.append('<div class="template-label">'+f.l+"</div>");t=c.settings.cnt[e];if(A=c.settings.sAtts[e])l=PData.aByID(A),"number"===typeof l.r.min&&"number"===typeof l.r.max?u=l.r.max-l.r.min:A=null;t&&(f=PData.aByID(c.settings.order[e]),f=PData.rTOrder(f,a,e),f.forEach(function(a){m=PData.rByN(a.i);p=m.a[v];"undefined"!==typeof p&&(y=PData.lRecs(p,C,q,!1))&&((n=m.a[t])&&(n=PData.procAttTxt(t,n)),n&&(c.rMap[a.i>>4]|=1<<(a.i&
15),A?(k=m.a[A],k="number"===typeof k?Math.floor((k-l.r.min)*r/u)+c.settings.min:c.settings.min):k=c.settings.min,w=y.b?";background-color:black":"",h.append('<div class="recitem" data-ai='+a.i+' style="color:'+y.v+w+";font-size:"+k+'px">'+n+"</div>")))}))}e++}};VizTextStream.prototype.teardown=function(){jQuery(this.frameID).off("click.vf")};
...
0,t,q,f,h=[],g=null,l,A;d=a.t[0];A=c.vFrame.getSelLegend(0);l=PData.aByID(A);g=c.vFrame.getSelFeatAtts(0);0<g.length&&0<d.n&&(c.tUsed[0]=!0);a:for(;k<a.l;){for(;0===d.n||d.i+d.n===k||0===g.length;){0<h.length&&(m.children.push({ti:e,children:h}),h=[]);if(++e===PData.eTNum())break a;h=[];d=a.t[e];A=c.vFrame.getSelLegend(e);l=PData.aByID(A);g=c.vFrame.getSelFeatAtts(e);0<g.length&&0<d.n&&(c.tUsed[e]=!0)}f=a.s[k];t=PData.rByN(f);q=t.a[A];"undefined"!==typeof q&&(fData=PData.lRecs(q,l,g,!1))&&(c.rMap[f>>
...
VizFlow.prototype.render=function(a){var c=this;this.bSel=[];this.fSel=[];this.barG.selectAll(".bar").remove();this.flowG.selectAll(".flow").remove();this.titleG.selectAll(".att-title").remove();var d=this.settings.w;c.bars=[];c.atts=[];c.settings.fcts.forEach(function(e,f){var g,h=PData.aByID(e);g="g"!==h.def.t?c.settings.gr?PData.cRNew(h,!0,!0):PData.cLNew(h,null,!0):[];PData.cFill(g,e,null,a);var m=[],p=0;g.forEach(function(a){0<a.i.length&&(m.push(a),p+=a.i.length)});var n=0,k=31+f*c.bH;m.forEach(function(a){c.bars.push({x:5+
n*d/p,w:a.i.length*d/p,y:k,c:a});n+=a.i.length});c.atts.push({l:h.def.l,c:m,t:p,y:k})});this.barG.selectAll(".bar").data(c.bars).enter().append("rect").attr("class","bar").attr("x",function(a){return a.x}).attr("y",function(a){return a.y}).attr("fill",function(a){return a.c.c}).attr("height","8").attr("width",function(a){return a.w}).on("click",function(a,d){var g=c.bSel.length,h=_.sortedIndex(c.bSel,d);c.bSel[h]===d?(d3.select(this).classed("obj-sel",!1),c.bSel.splice(h,1),0<g&&0===c.bSel.length&&
0===c.fSel.length&&c.vFrame.selBtns(!1)):(d3.select(this).classed("obj-sel",!0),c.bSel.splice(h,0,d),0===g&&0===c.fSel.length&&0<c.bSel.length&&c.vFrame.selBtns(!0))}).append("title").text(function(a){return a.c.l+" ("+a.c.i.length+")"});c.ints=[];c.atts.forEach(function(a,f){if(f!==c.atts.length-1){for(var g=c.atts[f+1],h=Array(a.c.length),m=0;m<a.c.length;m++)h[m]=Array(g.c.length);a.c.forEach(function(a,c){g.c.forEach(function(d,k){h[c][k]=PData.intersect(a.i,d.i)})});for(var p=Array(g.c.length),
n=0;n<g.c.length;n++){for(var k=0,m=0;m<a.c.length;m++)0<h[m][n].length&&k++;p[n]=k-1}for(var t=Array(g.c.length),n=0;n<g.c.length;n++)t[n]=0;var q=0;a.c.forEach(function(k,f){for(var y=0,l=0;l<g.c.length;l++)0<h[f][l].length&&y++;--y;var m=k.i.length*d/a.t,n=0,r=0;g.c.forEach(function(l,x){var z=h[f][x];if(0<z.length){var D=z.length*d,B=D/a.t,D=D/g.t,E=l.i.length*d/g.t;c.ints.push({i:z,c:k.c,l:k.l+" > "+l.l,x1:5+q*d/a.t+(y?(m-B)*n/y:0),x2:5+r*d/g.t+(p[x]?(E-D)*t[x]/p[x]:0),w1:B,w2:D,y1:a.y+10,y2:g.y-
1});n++;t[x]++}r+=l.i.length});q+=k.i.length})}});this.flowG.selectAll(".flow").data(c.ints).enter().append("path").attr("class","flow").attr("d",function(a){return"M "+a.x1+" "+a.y1+"  L "+(a.x1+a.w1)+" "+a.y1+" L "+(a.x2+a.w2)+" "+a.y2+" L "+a.x2+" "+a.y2+" L "+a.x1+" "+a.y1}).attr("fill",function(a){return a.c}).on("click",function(a,d){var g=c.fSel.length,h=_.sortedIndex(c.fSel,d);c.fSel[h]===d?(d3.select(this).classed("obj-sel",!1),c.fSel.splice(h,1),0<g&&0===c.fSel.length&&0===c.bSel.length&&
...
VizBrowser.prototype.render=function(a){var c=this,d=this.vFrame.getIndex();this.recSel=[];this.stream=a;this.svg.selectAll(".facet-col").remove();var e=0;this.fcts=[];this.settings.fcts.forEach(function(d,f){var g,n=PData.aByID(d);g="g"===n.def.t?[]:c.settings.gr?PData.cRNew(n,!0,!0):PData.cLNew(n,null,!0);PData.cFill(g,d,null,a);var k=[],t=0;g.forEach(function(a){0<a.i.length&&(a.n=t++,k.push(a))});c.fcts.push({c:k,x:250*f,i:f,l:n.def.l,n:n.id,s:-1});e=Math.max(e,27+22*(k.length+1))});c.svg.attr("height",
...
c.pState.p.find(function(a){return e.n===a.f?(-1!==(n=e.c.findIndex(function(c){return a.v===c.l}))&&(e.s=n,p=a),!0):!1});g=c.svg.select(f).selectAll(".facet-reset").data([1]).enter().append("g").attr("transform","translate(0,26)").attr("class",function(a){return p?"facet-reset":"facet-reset inactive"}).attr("height",19).on("click",function(a){-1!==e.s&&(e.s=-1,c.svg.select(f).selectAll(".facet-val").classed("inactive",!1),d3.select(this).classed("inactive",!0),c.update())});g.append("rect").attr("class",
"facet-reset-btn").attr("height",19).attr("width",242);g.append("text").attr("class","facet-reset-txt").attr("x",3).attr("y",13).text(dlText.reset);g=c.svg.select(f).selectAll(".facet-val").data(e.c).enter().append("g").attr("transform",function(a,c){return"translate(0,"+(27+22*(c+1))+")"}).attr("class",function(a,c){return p?c===n?"facet-val":"facet-val inactive":"facet-val"}).on("click",function(a,d){var q=c.svg.select(f).select(".facet-reset");e.s!==d?(e.s=d,c.svg.select(f).selectAll(".facet-val").classed("inactive",
...
VizMBMap.prototype.renderTree=function(a){function c(){var a=0,c=d.settings.w,g=null!==d.sbkSel?d.sbkSel.i:d.bkSel.i;PState.set(PSTATE_UPDATE);d.fcts.forEach(function(h,m){var p=[],n=0;h.c.forEach(function(a){a=PData.intersect(g,a.i);p.push(a);n+=a.length});var k=0,t;p.forEach(function(q){t=d.bars[a++];t.x=n?k*c/n:0;t.w=n?q.length*c/n:0;k+=q.length})});d.attsG.selectAll(".bar").transition().attr("x",function(a){return a.x}).attr("width",function(a){return a.w});PState.set(PSTATE_READY)}var d=this;
...
PFilterNum.prototype.evalBoxes=function(a){function c(c,h){function k(){t=!0;a.find(c).addClass("error")}var t=!1,q,v=a.find(c).val();(v=e.exec(v))?(a.find(c).removeClass("error"),q=parseInt(v[1],10)):k();t||(0==h?null!==f&&q<f&&k():null!==g&&q>g&&k());d.uNums[h]=q;return t}var d=this,e=/^(\d+)$/,f="undefined"===typeof this.att.r.min?null:this.att.r.min,g="undefined"===typeof this.att.r.max?null:this.att.r.max,h,m;h=c(".from",0);m=c(".to",1);this.uNums[0]>this.uNums[1]&&(m=!0);a.find(".filter-update").prop("disabled",
...
PFilterDates.prototype.evalBoxes=function(a){function c(c,g){function h(d){t=!0;a.find(c+d).addClass("error")}function k(d){a.find(c+d).removeClass("error")}var t=!1,q={y:0,m:0,d:0,ms:null},v=a.find(c+"-y"),v=v.val();(v=e.exec(v))?(k("-y"),q.y=parseInt(v[1],10)):h("-y");v=a.find(c+"-m");v=v.val();(v=f.exec(v))?(q.m=parseInt(v[1],10),1>q.m||12<q.m?h("-m"):k("-m")):h("-m");v=a.find(c+"-d");v=v.val();(v=f.exec(v))?(q.d=parseInt(v[1],10),1>q.d||31<q.d?h("-d"):k("-d")):h("-d");t||(q.ms=PData.d3Nums(q.y,
...
f]),h=d3.scale.linear().domain([0,100]).range([c,0]);this.yScale=h;var m=d3.scale.ordinal().rangeRoundBands([0,f]);m.domain(this.rCats.map(function(a){return a.l}));var m=d3.svg.axis().scale(m).orient("bottom"),p=d3.svg.axis().scale(h).orient("left").ticks(4),n=_.template(document.getElementById("dltext-filter-dates").innerHTML);d.append(n({id:this.id}));d.find("input[name=dctrl-"+a.id+"]").change(function(){a.isDirty(!0)});"undefined"===typeof this.att.r.u?d.find(".allow-undef").prop("disabled",
...
function PViewFrame(a){function c(a){a!==w&&(w=a,jQuery(d()+" div.lgnd-container div.lgnd-handle button.lgnd-update").prop("disabled",!a))}function d(){return"#view-frame-"+a}function e(a){a=jQuery(d()+" div.view-controls select.view-viz-select option:selected").val();PState.set(PSTATE_BUILD);y(a,!0);PState.set(PSTATE_READY)}function f(a){u.flags()&V_FLAG_LGND&&jQuery(d()+" div.lgnd-container").toggle("slide",{direction:"left"});a.preventDefault()}function g(a){function c(a){return a.replace(/^[ \f\t\v\u200b]+|[ \f\t\v\u200b]+$/g,
...
c+'"]').next().after('<div class="xscript">'+a+"</div>")})}function e(a){widgetData.tcArray=[];widgetData.tcIndex=-1;var l=widgetData.tcArray;a=new String(a);if(a=c(a).split(/\r\n|\r|\n/g)){var f=jQuery("#xscript-tbl"),q=0,t,g=0,h=0,v="";_.each(a,function(a){a=c(a);1<a.length&&("["===a.charAt(0)&&"0"<=a.charAt(1)&&"9">=a.charAt(1)?(t=d(a),0<v.length&&(h&&l.push({s:g,e:t}),f.append('<div class="row"><div class="timecode" data-timecode="'+g+'" data-tcindex="'+q++ +'">'+h+'</div><div class="xscript">'+
v+"</div></div>"),v=""),h=a,g=t):(0<v.length&&(v+="<br/>"),v+=a))});0<v.length&&(l.push({s:g,e:324E5}),f.append('<div class="row"><div class="timecode" data-timecode="'+g+'" data-tcindex="'+q+'">'+h+'</div><div class="xscript">'+v+"</div></div>"));"undefined"!==typeof n&&null!=n&&jQuery.ajax({type:"POST",url:prspdata.ajax_url,data:{action:"prsp_get_transcript",transcript:n,excerpt:widgetData.extract},success:function(a,c,d){k(JSON.parse(a),f)},error:function(a,c,d){alert(d)}})}}function f(a){var c,
...
height:Math.floor(9*(w-40)/16),videoId:widgetData.ytCode,events:{onError:function(a){console.log("YouTube Error: "+a.data)},onStateChange:function(a){var c;switch(a.data){case 1:widgetData.playing=!0;null==widgetData.timer&&(widgetData.timer=setInterval(function(){c=1E3*widgetData.widget.getCurrentTime();widgetData.playing&&widgetData.xscriptOn&&f(c)},300));break;case 0:case 2:widgetData.playing=!1;window.clearInterval(widgetData.timer);widgetData.timer=null;break;case 3:case 5:widgetData.playing=
!1}},onReady:function(){widgetData.extract&&widgetData.widget.cueVideoById({videoId:widgetData.ytCode,startSeconds:widgetData.sTime/1E3,endSeconds:widgetData.eTime/1E3})}}})}function t(){widgetData.playing=!0}function q(){widgetData.playing=!1}function g(){widgetData.playing&&widgetData.xscriptOn&&f(1E3*widgetData.widget.currentTime)}function v(){switch(p){case 3:null!=widgetData.widget&&(widgetData.widget.removeEventListener("ended",q),widgetData.widget.removeEventListener("pause",q),widgetData.widget.removeEventListener("playing",
t),widgetData.widget.removeEventListener("timeupdate",g));case 1:null!=widgetData.widget&&widgetData.playing&&widgetData.widget.pause();widgetData.playing=!1;widgetData.widget=null;break;case 2:widgetData.ytCall=null,null!=widgetData.widget&&widgetData.playing&&widgetData.widget.stopVideo(),widgetData.widget=null,widgetData.playing=!1,null!=widgetData.timer&&(window.clearInterval(widgetData.timer),widgetData.timer=null)}}function y(){function a(){widgetData.sTime=widgetData.eTime=null;var c;(c=prspdata.e.i.t.tcAtts[v])&&
(c=H.a[c])&&""!==c&&(widgetData.extract=c,c=c.split("-"),widgetData.sTime=d(c[0]),widgetData.eTime=d(c[1]))}var c=J[M];H=PData.rByN(c);var k=" "+H.l+" ("+(M+1)+"/"+J.length+") ",h=jQuery("#inspect-name");h.text(k);h.prop("title",H.id);var v=PData.n2T(c);r.empty();x=null;p=0;widgetData.extract=null;widgetData.xscriptOn=!1;widgetData.playing=!1;if(prspdata.e.i.modal.scOn||"boolean"===typeof prspdata.e.i.modal.aOn&&prspdata.e.i.modal.aOn)if(x=prspdata.e.i.sc.atts[v])if(k=H.a[x])if(a(),k.match(/soundcloud\.com/)){var m=
!0;p=1;r.append('<iframe id="sc-widget" class="player" width="100%" height="110" src="http://w.soundcloud.com/player/?url='+k+'"></iframe>');var z=SC.Widget(document.getElementById("sc-widget"));widgetData.widget=z;z.bind(SC.Widget.Events.READY,function(){z.play();z.bind(SC.Widget.Events.PLAY,function(){widgetData.playing=!0});z.bind(SC.Widget.Events.PAUSE,function(){widgetData.playing=!1});z.bind(SC.Widget.Events.PLAY_PROGRESS,function(a){m&&(z.pause(),m=!1,widgetData.playing=!1);widgetData.extract&&
(a.currentPosition<widgetData.sTime?z.seekTo(widgetData.sTime):a.currentPosition>widgetData.eTime&&(z.pause(),widgetData.playing=!1));widgetData.playing&&widgetData.xscriptOn&&f(a.currentPosition)});z.bind(SC.Widget.Events.FINISH,function(){widgetData.playing=!1})})}else p=3,widgetData.extract&&(h=widgetData.extract.split("-"),k+="#t="+h[0]+","+h[1]),r.append('<audio id="na-widget" controls src="'+k+'"></audio>'),widgetData.widget=document.getElementById("na-widget"),widgetData.widget.addEventListener("ended",
q),widgetData.widget.addEventListener("pause",q),widgetData.widget.addEventListener("playing",t),widgetData.widget.addEventListener("timeupdate",g);0===p&&prspdata.e.i.modal.ytOn&&(x=prspdata.e.i.yt.atts[v])&&(k=H.a[x])&&(a(),widgetData.ytCode=k,r.append('<div id="yt-widget"></div>'),widgetData.ytCall=l,widgetData.ytLoaded?l():(widgetData.ytLoaded=!0,k=document.createElement("script"),k.src="https://www.youtube.com/iframe_api",h=document.getElementsByTagName("script")[0],h.parentNode.insertBefore(k,
h)),p=2);prspdata.e.i.modal.tOn&&(k=prspdata.e.i.t.t1Atts[v])&&""!==k&&"disable"!==k&&(k=H.a[k],"string"===typeof k&&""!==k&&(0<p&&r.append("<div>"+document.getElementById("dltext-sync-xscript").innerHTML+"</div>"),r.find("#xscript-tbl").remove(),r.append('<div id="xscript-tbl"></div>'),widgetData.xscriptOn=!0,jQuery("#xscript-tbl").click(function(a){if(p&&jQuery(a.target).hasClass("timecode"))switch(a=jQuery(a.target).data("timecode"),p){case 1:widgetData.playing||(widgetData.playing=!0,widgetData.widget.play());
widgetData.widget.seekTo(a);break;case 2:widgetData.playing||(widgetData.playing=!0,widgetData.widget.playVideo());widgetData.widget.seekTo(a/1E3);break;case 3:widgetData.playing||(widgetData.playing=!0,widgetData.widget.play()),widgetData.widget.currentTime=a/1E3}}),n=null,(h=prspdata.e.i.t.t2Atts[v])&&""!==h&&"disable"!==h&&(n=H.a[h]),jQuery.ajax({type:"POST",url:prspdata.ajax_url,data:{action:"prsp_get_transcript",transcript:k,excerpt:widgetData.extract},success:function(a,c,d){e(JSON.parse(a))},
error:function(a,c,d){alert(d)}})));prspdata.e.i.modal.atts[v].forEach(function(a){var d=PData.rAV(c,a,!1);if(d){a=PData.aByID(a);var k;"_"==a.def.l.charAt(0)?k="<div>"+d+"</div>":(k='<div><span class="att-label">'+a.def.l+":</span> ","I"==a.def.t&&(k+="<br/>"),k+=d+"</div>");r.append(k)}})}function m(a){a=M+a;-1==a?a=J.length-1:a==J.length&&(a=0);a!=M&&(M=a,v(),y())}function A(a){m(-1)}function C(a){m(1)}var r=jQuery("#inspect-content"),x=null,p=0,n,w=450,N=400,J=null;u&&(J=u.getSel());if(null!=
J&&0!=J.length){var O,H,M=0;prspdata.e.i.modal.scOn&&(w=550);prspdata.e.i.modal.ytOn&&(w=Math.max(w,475),N=500);prspdata.e.i.modal.tOn&&(N+=100,prspdata.e.i.modal.t2On?(w=Math.max(750,Math.floor(.8*jQuery(document).width())),w=Math.min(900,w)):w=Math.max(w,550));"number"===typeof prspdata.e.i.modal.w&&(w=prspdata.e.i.modal.w);"number"===typeof prspdata.e.i.modal.h&&(N=prspdata.e.i.modal.h);h(!1);y();jQuery("#btn-inspect-left").click(A);jQuery("#btn-inspect-right").click(C);O=jQuery("#dialog-inspector").dialog({width:w,
...
(c.find(".osel").button("disable"),c.find(".osel").removeClass("pulse"),c.find(".xsel").button("disable"))}function m(c){jQuery("body").trigger("prospect",{s:PSTATE_HILITE,v:a,t:u.tUsed});c.preventDefault()}function p(a){PState.set(PSTATE_UPDATE);u&&u.clearSel();h(!1);PState.set(PSTATE_READY);a.preventDefault()}function n(a){u&&u.doOptions();a.preventDefault()}function k(a){var c=jQuery("#dialog-vnotes").dialog({width:300,height:300,modal:!0,buttons:[{text:dlText.ok,click:function(){c.dialog("close")}}]});
a.preventDefault()}function t(a,k){jQuery(d()+' div.lgnd-container div.lgnd-scroll div.lgnd-template[data-index="'+a+'"] div.lgnd-group input.lgnd-entry-check').prop("checked",k);c(!0)}function q(a){var k=jQuery(a.target).closest("div.lgnd-template").data("index"),e=a.target.className;switch(e){case "lgnd-update":u&&x&&(PState.set(PSTATE_BUILD),h(!1),u.render(x),c(!1),PState.set(PSTATE_READY));break;case "lgnd-entry-check":e=jQuery(a.target).closest("div.lgnd-entry");a=jQuery(a.target).is(":checked");
...
(e=jQuery(a.target).find("input.lgnd-entry-check"),a=!e.is(":checked"),e.prop("checked",a),t(k,a))}}function v(a){var d=jQuery(a.target).closest("div.lgnd-template").data("index");a=jQuery(a.target).val();C(d,a);c(!0)}function C(a,c){var k,e=jQuery(d()+' div.lgnd-container div.lgnd-scroll div.lgnd-template[data-index="'+a+'"] div.lgnd-group');e.empty();r[a]=c;var f=PData.aByID(c);"undefined"!==typeof f.r.u&&(k='<div class="lgnd-value lgnd-entry" data-index="-1"><input type="checkbox" checked="checked" class="lgnd-entry-check"/><div class="lgnd-viz" style="background-color: '+
...
c:a.v,i:[]}):e.push({l:a.l,c:a.v});a.z.forEach(function(d){var f=""===d?a.v:d.v;c?e.push({l:d.l,c:f,i:[]}):e.push({l:d.l,c:f})})}),e;case "N":if("undefined"===typeof a.r.min||"undefined"===typeof a.r.max)return null;d&&"undefined"!==typeof a.r.u&&(c?e.push({l:"?",c:a.r.u.v,min:"?",max:"?",i:[]}):e.push({l:"?",c:a.r.u.v,min:"?",max:"?"}));var f=Math.pow(10,a.r.g),g=a.r.min,h=0,m,u,r;for(0<a.l.length&&(m=a.l[0]);g<=a.r.max;){for(;h<a.l.length&&"undefined"!==typeof m.d.max&&g>m.d.max;)m=a.l[++h];r=0==
a.l.length||g<m.d.min?"#777777":h===a.l.length?"#777777":"undefined"===typeof m.d.max||g<=m.d.max?m.v:"#777777";u=g;g+=f;max=g-1;max>a.r.max&&(max=a.r.max);var w=u.toString();1<f&&4>w.length&&u!==max&&(w+="-"+max.toString());c?e.push({l:w,c:r,min:u,max:max,i:[]}):e.push({l:w,c:r,min:u,max:max})}return e;case "D":g=function(a){var c,d;if("undefined"===typeof a.y)return TODAY;c=a.y;"undefined"===typeof a.m?(d=12,a=31):(d=a.m,a="undefined"===typeof a.d?PData.lenMnth(c,d):a.d);return PData.d3Nums(c,d,
a,!1)};u=function(a,c,d,e){"undefined"!==typeof e.m&&(c=e.m,"undefined"!==typeof e.d&&(d=e.d));return PData.d3Nums(a,c,d,!1)};r=g(a.r.max);var f=a.r.g,w=a.r.min.y,x=1,p=1;"undefined"!==typeof a.r.min.m&&(x=a.r.min.m,"undefined"!==typeof a.r.min.d&&(p=a.r.min.d));var n=PData.d3Nums(w,x,p,!1),h=0,B,E;0<a.l.length&&(m=a.l[0],B=u(m.d.min.y,1,1,m.d.min),E=g(m.d.max));for(d&&"undefined"!==typeof a.r.u&&(c?e.push({l:"?",c:a.r.u.v,min:"?",max:"?",i:[]}):e.push({l:"?",c:a.r.u.v,min:"?",max:"?"}));n<=r;){d=
{};c&&(d.i=[]);switch(f){case "d":d.l=w.toString()+"-"+x.toString()+"-"+p.toString();break;case "m":d.l=w.toString()+"-"+x.toString();break;case "y":case "t":case "c":d.l=w.toString()}for(;h<a.l.length&&n>E;)m=a.l[++h],h<a.l.length&&(B=u(m.d.min.y,1,1,m.d.min),E=g(m.d.max));d.c=0==a.l.length||n<B?"#777777":h==a.l.length?"#777777":n<=E?m.v:"#777777";d.min=n;switch(f){case "d":++p>PData.lenMnth(w,x)&&(p=1,12<++x&&(x=1,w++));break;case "m":12<++x&&(x=1,w++);break;case "y":w++;break;case "t":w+=10;break;
case "c":w+=100}n=PData.d3Nums(w,x,p,!1);n>TODAY&&(n=TODAY);n.setTime(n.getTime()+10);d.max=n;e.push(d);n=PData.d3Nums(w,x,p,!1)}return e}},cFill:function(a,c,d,e){var f=PData.eTNum(),g=0,h,m=0,u,r,n,p,z=PData.aByID(c);for(h=e.t[0];m<e.l;){for(;0===h.n||h.i+h.n===m||!PData.aInT(c,g)||d&&!PData.aInT(d,g);){if(++g===f)return;h=e.t[g];m=h.i}u=e.s[m];r=PData.rByN(u);r=r.a[c];if("undefined"!==typeof r)switch(z.def.t){case "T":for(n=0;n<a.length;n++)if(p=a[n],-1!==r.indexOf(p.x)){p.i.push(u);break}break;
case "g":r.forEach(function(c){for(n=0;n<a.length;n++)if(p=a[n],c===p.l){p.i.push(u);break}n===a.length&&a.push({l:c,i:[u],c:"#"+Math.floor(16777215*Math.random()).toString(16)})});break;case "V":r.forEach(function(c){for(n=0;n<a.length;n++)if(p=a[n],c==p.l){p.i.push(u);break}});break;case "N":n=0;p=a[0];if("?"===p.min){if("?"===r){p.i.push(u);break}n=1}if("?"===r)break;for(;n<a.length;n++){p=a[n];if(r<p.min)break;if(p.min<=r&&r<=p.max){p.i.push(u);break}}break;case "D":n=0;p=a[0];if("?"===p.min){if("?"===
r){p.i.push(u);break}n=1}if("?"!==r)for(r=PData.dObj(r.min,1,!1);n<a.length;n++){p=a[n];if(r<p.min)break;if(p.min<=r&&r<p.max){p.i.push(u);break}}}m++}"g"==z.def.t&&a.sort(function(a,c){return PData.strcmp(c.l,a.l)})},cSort:function(a,c,d){var e=c.id,f,g,h;a.forEach(function(a){f=PData.rByN(a);datum=f.a[e];if("undefined"!==typeof datum)switch(c.def.t){case "T":for(g=0;g<d.length;g++)if(h=d[g],-1!==datum.indexOf(h.x)){h.i.push(a);break}break;case "g":datum.forEach(function(c){for(g=0;g<d.length;g++)if(h=
...
1,!1);for(g=0;g<d.length;g++){h=d[g];if(k<h.min)break;if(h.min<=k&&k<h.max){h.i.push(a);break}}}}});"g"==c.def.t&&d.sort(function(a,c){return PData.strcmp(c.l,a.l)})},rTOrder:function(a,c,d){function e(a){return a}function f(a){return a[0]}function g(a){if("?"===a)return"?";var c=1,d=1;"undefined"!==typeof a.min.m&&(c=a.min.m,"undefined"!==typeof a.min.d&&(d=a.min.d));return PData.d3Nums(a.min.y,c,d,!1)}var h,p;switch(a.def.t){case "T":h=e;p="~";break;case "V":h=f;p="~";break;case "g":h=f;p="~";break;
case "N":h=e;p=a.r.max;break;case "D":h=g,p=TODAY}var n=[],r=c.t[d];d=m[d];for(var w=0,x,z;w<r.n;)x=c.s[r.i+w++],z=d.d[x-d.i],z=z.a[a.id],"undefined"===typeof z?n.push({i:x,v:p}):n.push({i:x,v:h(z)});switch(a.def.t){case "T":case "g":case "V":n.sort(function(a,c){return PData.strcmp(c.v,a.v)});break;case "D":case "N":n.sort(function(a,c){return"?"===a.v?-1:"?"===c.v?1:a.v-c.v})}return n},vByN:function(a){return prspdata.e.vf[a]},ready:function(){return n}}}();
jQuery(document).ready(function(a){function c(){var a;PState.set(PSTATE_PROCESS);null==x&&(x=PData.sNew(!0));z=x;var c=!1,d,e;for(d=0;d<u.length;d++)if(e=u[d],a=jQuery('div.filter-instance[data-id="'+e.id+'"]'),c||e.f.isDirty(null)){c=!0;e=e.f;e.evalPrep();for(var f=PData.sNew(!1),g=0,h,k,m=0,p=z.t[0],n=0,q=0,r=a.find(".apply-tmplt-0").is(":checked");g<z.l;){for(;0===p.n||p.i+p.n===g;)f.t.push({i:f.l-n,n:n}),n=0,p=z.t[++m],r=a.find(".apply-tmplt-"+m).is(":checked");h=z.s[g++];r?(k=PData.rByN(h),e.eval(k)&&
(f.s[f.l++]=h,n++),q++):(f.s[f.l++]=h,n++)}for(;m++<PData.eTNum();)f.t.push({i:f.l-n,n:n}),n=0;e.isDirty(!1);e.out=f;e.evalDone(q);z=f}else z=e.f.out;PState.set(PSTATE_BUILD);l.forEach(function(a){a&&a.showStream(z)});0<u.length?jQuery("#btn-f-state").prop("disabled",!0).html(dlText.filtered):jQuery("#btn-f-state").prop("disabled",!0).html(dlText.nofilter)}function d(a){var c=jQuery("#annote");c.text(a);0<a.length?(jQuery("#btn-annote").button("enable"),c.show()):(jQuery("#btn-annote").button("disable"),
c.hide())}function e(a){var c=_.find(prspdata.p,function(c){return a==c.id});return c?c:null==D||0==B.length?null:(c=_.find(B,function(c){return a==c.id}))?c:null}function f(a,c){var d=jQuery("input[name=save-prspctv-dest]:checked").val();if(""==d)return null;var e=jQuery("#save-prspctv-note").val(),e=e.replace(/"/g,""),f={f:[],h0:null,h1:null,v0:null,v1:null};l.forEach(function(a,c){a&&(f["v"+c]={l:a.title(),s:a.getState()})});u.forEach(function(a){for(var c=[],d=jQuery('div.filter-instance[data-id="'+
a.id+'"]'),e=0;e<PData.eTNum();e++)c.push(d.find(".apply-tmplt-"+e).is(":checked"));f.f.push({id:a.attID,a:c,s:a.f.getState()})});for(var g=0;2>g;g++){var h=r[g];null!==h&&jQuery("#save-prspctv-h"+g).is(":checked")&&(f["h"+g]={id:w[g],s:h.getState()})}var k={id:a,l:c,n:e,s:f};"local"==d?(B.push(k),D.setItem(prspdata.e.id,JSON.stringify(B))):"server"==d&&jQuery.ajax({type:"POST",url:prspdata.ajax_url,data:{action:"prsp_save_prspctv",id:a,l:c,x:prspdata.e.id,n:e,s:JSON.stringify(f)},success:function(a,
...
c.id+'" data-xindex="'+d+'" data-id="'+e.id+'"><i class="label">'+e.l+'</i> <button class="del">'+dlText.del+'</button> <button class="edit">'+dlText.edit+"</button></li>")})})})();jQuery("#prspctv-mlist").click(function(a){if("BUTTON"==a.target.nodeName){var e=jQuery(a.target).hasClass("del"),f=jQuery(a.target).parent(),g=f.data("type"),h=f.data("id");if(e){switch(g){case "l":a=B.findIndex(function(a){return h==a.id});-1!=a&&(B.splice(a,1),0==B.length?D.removeItem(prspdata.e.id):D.setItem(prspdata.e.id,
JSON.stringify(B)));break;case "x":a=f.data("xindex"),e=c[a],a=e.ps.findIndex(function(a){return h==a.id}),-1!=a&&(e.ps.splice(a,1),d=!0)}f.remove()}else{var k;switch(g){case "l":k=_.find(B,function(a){return h==a.id});break;case "x":a=f.data("xindex"),e=c[a],k=_.find(e.ps,function(a){return h==a.id})}jQuery("#edit-prspctv-lbl").val(k.l);jQuery("#edit-prspctv-note").val(k.n);var l=jQuery("#dialog-edit-prsrctv").dialog({width:340,height:270,modal:!0,buttons:[{text:dlText.ok,click:function(){k.l=jQuery("#edit-prspctv-lbl").val();
k.n=jQuery("#edit-prspctv-note").val();f.find(".label").text(k.l);"x"==g?d=!0:D.setItem(prspdata.e.id,JSON.stringify(B));l.dialog("close")}},{text:dlText.cancel,click:function(){l.dialog("close")}}]})}}});a=jQuery("#dialog-manage-prsrctv").dialog({width:450,height:350,modal:!0,buttons:[{text:dlText.ok,click:function(){d&&c.forEach(function(a){0<a.ps.length?D.setItem(a.id,JSON.stringify(a.ps)):D.removeItem(a.id)});jQuery("#prspctv-mlist").off("click");a.dialog("close")}}]})}function h(a){window.location.href=
prspdata.e.g.hurl;a.preventDefault()}function m(a){jQuery(this).parent().next().slideToggle(400);a.preventDefault()}function p(a){if(a=jQuery(this).closest("div.filter-instance")){var c=a.data("id");c&&""!==c&&(a=u.find(function(a){return a.id==c}),null==a?alert("Bad Filter ID "+c):a.f.isDirty(!0))}}function n(a){var d=jQuery(this).closest("div.filter-instance"),e=d.data("id"),f,g;f=u.findIndex(function(a){return a.id==e});if(-1===f)alert("Bad Filter ID "+e);else{g=u[f].f;g.teardown();u.splice(f,
1);if(f>=u.length){var h;h=0===u.length?x:u[f-1].out;l.forEach(function(a){a&&a.setStream(h)})}else u[f].f.isDirty(!0);d.remove();0===u.length?(jQuery("#btn-toggle-filters").button("disable"),l.forEach(function(a){a&&a.clearSel(h)}),c(),PState.set(PSTATE_READY)):jQuery("#btn-f-state").prop("disabled",!1).html(dlText.dofilters);a.preventDefault()}}function k(a,c,d){var e,f,g;if(null!==d)e=d;else{do e=Math.floor(1E3*Math.random()+2),-1!=u.findIndex(function(a){return a.id==e})&&(e=-1);while(-1==e)}if("_remove"==
a)f=new PFilterRemove(e),g={t:[!0,!0,!0,!0]};else switch(g=PData.aByID(a),g.def.t){case "V":f=new PFilterVocab(e,g);break;case "T":f=new PFilterText(e,g);break;case "g":f=new PFilterTags(e,g);break;case "N":f=new PFilterNum(e,g);break;case "D":f=new PFilterDates(e,g)}if(null!==d)c=jQuery("#dialog-hilite-"+d+" span.filter-id").html(g.def.l),c=jQuery("#hilite-"+d),c.empty();else{u.push({id:e,attID:a,f:f,out:null});d=_.template(document.getElementById("dltext-filter-head").innerHTML);jQuery("#filter-instances").append(d({newID:e,
title:f.title(),apply:A}));d=jQuery('div.filter-instance[data-id="'+e+'"]');for(a=0;a<PData.eTNum();a++){var h=d.find(".apply-tmplt-"+a);h.prop("disabled",!g.t[a]);h.prop("checked",c[a]&&g.t[a]);h.click(p)}d.find("button.btn-filter-toggle").button({text:!1,icons:{primary:"ui-icon-carat-2-n-s"}}).click(m);d.find("button.btn-filter-del").button({text:!1,icons:{primary:"ui-icon-trash"}}).click(n);jQuery("#btn-f-state").prop("disabled",!1).html(dlText.dofilters)}f.setup();return f}function t(a,c,d,e){jQuery("#filter-list li").removeClass("selected");
...
function q(a){PState.set(PSTATE_PROCESS);var c=l[a],d=c.getBMData(),e=[];a=r[a];if(null!==z){a.evalPrep();var f=0,g,h,k=0,m=z.t[0];a:for(;f<z.l;){for(;!d.t[k]||0==m.n||m.i+m.n==f;){if(++k===PData.eTNum())break a;m=z.t[k];f=m.i}g=z.s[f++];d.r[g>>4]&1<<(g&15)&&(h=PData.rByN(g),a.eval(h)&&e.push(g))}a.evalDone(z.l)}PState.set(PSTATE_UPDATE);0<e.length?c.setSel(e):c.clearSel();PState.set(PSTATE_READY)}function v(a,c){var d;d=jQuery("#dialog-hilite-"+a).dialog({height:275,width:Math.min(jQuery(window).width()-
20,675),modal:!0,appendTo:"#dialog-1",buttons:[{text:dlText.chsatt,click:function(){t(!1,!0,c,function(c){w[a]=c;r[a]=k(c,null,a)})}},{text:dlText.ok,click:function(){d.dialog("close");null!==r[a]&&q(a)}},{text:dlText.cancel,click:function(){d.dialog("close")}}]})}function C(a){function f(a){return prspdata.e.vf.findIndex(function(c){return a==c.l})}a=e(a);if(null==a)return!1;PState.set(PSTATE_PROCESS);jQuery("#filter-frame").hide();u.forEach(function(a){a.f.teardown()});u=[];jQuery("#filter-instances").empty();
a.s.f.forEach(function(a){k(a.id,a.a,null).setState(a.s)});jQuery("#filter-instances").hide();jQuery("#btn-toggle-filters").button(0==a.s.f.length?"disable":"enable");for(var g=0;2>g;g++)if(null!=a.s["h"+g]){var h=a.s["h"+g];w[g]=h.id;var m=k(h.id,null,g);r[g]=m;m.setState(h.s)}else r[g]=null,w[g]=null;var h=l[0],m=l[1],n=!1;PState.set(PSTATE_BUILD);g=f(a.s.v0.l);h?(h.setViz(g,!1),h.selBtns(!1)):(l[0]=PViewFrame(0),h=l[0],h.initDOM(g));null!==a.s.v1?(g=f(a.s.v1.l),m?(m.selBtns(!1),m.setViz(g,!1),
m.setState(a.s.v1.s)):(h.flushLgnd(),l[1]=PViewFrame(1),m=l[1],m.initDOM(g),m.setState(a.s.v1.s),n=!0)):m&&(l[1]=null,jQuery("#view-frame-1").remove(),n=!0);n&&h.resize();h.setState(a.s.v0.s);d(a.n);if(PData.ready()&&x)for(c(),g=0;2>g;g++)null!==w[g]&&q(g);return!0}function y(a,c){var d=prspdata.bClrs[a];d&&0<d.length&&jQuery(c).css("background-color",d)}var l=[null,null],A,u=[],r=[null,null],w=[null,null],x,z,D=null,B=[];jQuery("body").addClass("waiting");y("cb","#command-bar");y("fs","#filter-frame");
...
jQuery("#title").text(prspdata.e.g.l);try{var E=window.localStorage;E.setItem("__storage_test__","__storage_test__");E.removeItem("__storage_test__");var F=E.getItem(prspdata.e.id),D=E;0<F.length&&(B=JSON.parse(F))}catch(G){}jQuery("#btn-about").button({icons:{primary:"ui-icon-power"},text:!1}).click(function(a){var c;jQuery("#dialog-about img").removeClass("zoomin");c=jQuery("#dialog-about").dialog({height:390,width:350,modal:!0,buttons:[{text:dlText.ok,click:function(){c.dialog("close")}}]});jQuery("#dialog-about img").addClass("zoomin");
...
text:!1}).click(function(a){var c=jQuery("#prspctv-slist");c.empty();prspdata.p.forEach(function(a){c.append('<li data-src="server" data-id="'+a.id+'">'+a.l+"</li>")});B.forEach(function(a){c.append('<li data-src="local" data-id="'+a.id+'">'+a.l+"</li>")});var d=[{text:dlText.ok,click:function(){e.dialog("close");var a=c.find("li.selected");a.length&&(a=a.data("id"),C(a),PState.set(PSTATE_READY))}},{text:dlText.cancel,click:function(){e.dialog("close")}}];D&&d.push({text:dlText.manage,click:function(){e.dialog("close");
...
text:!1});(function(){jQuery("#filter-list").append('<li class="remove" data-id="_remove"><i>'+dlText.rha+"</i></li>");prspdata.a.forEach(function(a){switch(a.def.t){case "V":case "T":case "g":case "N":case "D":jQuery("#filter-list").append('<li data-id="'+a.id+'">'+a.def.l+"</li>")}})})();0!=prspdata.show_prspctv.length&&C(prspdata.show_prspctv)||(l[0]=PViewFrame(0),l[0].initDOM(0),d(""));jQuery(window).resize(function(){l.forEach(function(a){a&&a.resize()})});jQuery("body").on("prospect",function(a,
d){switch(d.s){case PSTATE_PROCESS:PState.set(PSTATE_PROCESS);c();for(var e=0;2>e;e++)null!==r[e]&&q(e);PState.set(PSTATE_READY);jQuery("body").removeClass("waiting");break;case PSTATE_FDIRTY:jQuery("#btn-f-state").prop("disabled",!1).html(dlText.dofilters);break;case PSTATE_HILITE:v(d.v,d.t)}});PState.set(PSTATE_LOAD);PData.init()});function onYouTubeIframeAPIReady(){widgetData.ytCall&&widgetData.ytCall()};